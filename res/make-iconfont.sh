...
# cat icons.ttf | zlib-flate -compress=9 | C:/Users/Georg/Downloads/xxd/xxd.exe -i -n "furIcons_compressed_data" | sed -r "s/^ +//g;s/, /,/g;s/ = /=/g;s/unsigned/const unsigned/g;s/compressed_data_len/compressed_size/" >> ../src/gui/font_furicon.cpp
