...
void DivLocale::addTranslationsPortuguese()
{
    ...
    strings["Search..."].plurals[0] = "Procurar...";
    strings["Search recent files..."].plurals[0] = "Buscar em arquivos recentes...";
    strings["Search instruments..."].plurals[0] = "Procurar instrumentos...";
    strings["Search samples..."].plurals[0] = "Procurar samples...";
    strings["Search instruments (to change to)..."].plurals[0] = "Procurar insatrumentos (para selecionar)...";
    strings["Search chip (to add)..."].plurals[0] = "Procurar chip (para adicionar)...";
    strings["Cancel"].plurals[0] = "Cancelar";
    strings["cannot add chip! ("].plurals[0] = "não pôde adicionar chip! (";
    ...
    strings["Unknown"].plurals[0] = "Desconhecido";
    strings["duplicate##sgdl0"].plurals[0] = "duplicado";
    strings["replace...##sgdl0"].plurals[0] = "trocar...";
    strings["save##sgdl0"].plurals[0] = "salvar";
    strings["export (.dmp)"].plurals[0] = "exportar (.dmp)";
    strings["delete##sgdl0"].plurals[0] = "excluir";
    strings["%.2X: <INVALID>"].plurals[0] = "%.2X: <INVÁLIDO>";
    strings["- None -"].plurals[0] = "- Nenhum -";
    strings["out of memory for this sample!"].plurals[0] = "sem memória para esta sample!";
    strings["make instrument"].plurals[0] = "criar instrumento";
    strings["make me a drum kit"].plurals[0] = "faça um kit de bateria para mim";
    ...
    strings["replace instrument..."].plurals[0] = "trocar instrumento...";
    strings["load instrument from TX81Z"].plurals[0] = "carregar instrumento do TX81Z";
    strings["replace wavetable..."].plurals[0] = "trocar wavetable...";
    strings["replace sample..."].plurals[0] = "trocar sample...";
    strings["import raw sample..."].plurals[0] = "importar sample em formato raw...";
    strings["import raw sample (replace)..."].plurals[0] = "importar sample em formato raw (trocar)...";
    strings["replace...##sgdl2"].plurals[0] = "trocar...";
    strings["load from TX81Z"].plurals[0] = "carregar do TX81Z";
    strings["Open (insert; right-click to replace)"].plurals[0] = "Abrir (inserir; botão direito para trocar)";
    strings["Save##sgdl2"].plurals[0] = "Salvar";
    strings["save instrument as .dmp..."].plurals[0] = "salvar instrumento como .dmp...";
    strings["save wavetable as .dmw..."].plurals[0] = "salvar wavetable como .dmw...";
    strings["save raw wavetable..."].plurals[0] = "salvar wavetable em formato raw...";
    strings["save raw sample..."].plurals[0] = "salvar sample em formato raw...";
    strings["save as .dmp..."].plurals[0] = "salvar como .dmp...";
    ...
    strings["Instruments"].plurals[0] = "Instrumentos";
    ...
    strings["save as .dmw..."].plurals[0] = "salvar como .dmw...";
    ...
    strings["import raw..."].plurals[0] = "importar em formato raw...";
    strings["import raw (replace)..."].plurals[0] = "importar em formato raw (trocar)...";
    ...
    strings["Instrument %d"].plurals[0] = "Instrumento %d";
    strings["Sample %d"].plurals[0] = "Sample %d";
    strings["the song is over!0"].plurals[0] = "a música terminou!";
    strings["the song is over!1"].plurals[0] = "a música terminou!";
    strings["Open File"].plurals[0] = "Abrir arquivo";
    strings["compatible files0"].plurals[0] = "arquivos compatíveis";
    strings["all files0"].plurals[0] = "todos os arquivos";
    strings["no backups made yet!"].plurals[0] = "nenhum backup realizado ainda!";
    strings["Restore Backup"].plurals[0] = "Restaurar Backup";
    strings["Furnace or Furnace-B song"].plurals[0] = "Música do Furnace ou Furnace-B";
    strings["Furnace song0"].plurals[0] = "Música do Furnace";
    strings["Save File0"].plurals[0] = "Salvar Arquivo";
    strings["DefleMask 1.1.3 module"].plurals[0] = "Módulo do DefleMask 1.1.3";
    strings["Save File1"].plurals[0] = "Salvar Arquivo";
    strings["DefleMask 1.0/legacy module"].plurals[0] = "Módulo do DefleMask 1.0/legado";
    strings["Save File2"].plurals[0] = "Salvar arquivo";
    strings["Furnace-B song"].plurals[0] = "Música do Furnace-B";
    strings["Load Instrument"].plurals[0] = "Carregar Instrumento";
    strings["all compatible files1"].plurals[0] = "todos os arquivos compatíveis";
    strings["Furnace instrument0"].plurals[0] = "Instrumento do Furnace";
    strings["DefleMask preset0"].plurals[0] = "Predefinição do DefleMask";
    strings["TFM Music Maker instrument"].plurals[0] = "Instrumento do TFM Music Maker";
    strings["VGM Music Maker instrument"].plurals[0] = "Instrumento do VGM Music Maker";
    strings["Scream Tracker 3 instrument"].plurals[0] = "Instrumento do Scream Tracker 3";
    strings["SoundBlaster instrument"].plurals[0] = "Instrumento SoundBlaster";
    strings["Wohlstand OPL instrument"].plurals[0] = "Instrumento Wohlstand OPL";
    strings["Wohlstand OPN instrument"].plurals[0] = "Instrumento Wohlstand OPN";
    strings["Gens KMod patch dump"].plurals[0] = "Extrato de patch Gens KMod";
    strings["BNK file (AdLib)"].plurals[0] = "Arquivo BNK (AdLib)";
    strings["FF preset bank"].plurals[0] = "Banco de predefinições do FF";
    strings["2612edit GYB preset bank"].plurals[0] = "Banco de predefinições GYB do 2612edit";
    strings["VOPM preset bank"].plurals[0] = "Banco de predefinições do VOPM";
    strings["Wohlstand WOPL bank"].plurals[0] = "Banco de predefinições Wohlstand WOPL";
    strings["Wohlstand WOPN bank"].plurals[0] = "Banco de predefinições Wohlstand WOPN";
    strings["all files1"].plurals[0] = "todos os arquivos";
    strings["Save Instrument0"].plurals[0] = "Salvar Instrumento";
    strings["Furnace instrument1"].plurals[0] = "Instrumento do Furnace";
    strings["Save Instrument1"].plurals[0] = "Salvar Instrumento";
    strings["DefleMask preset1"].plurals[0] = "Predefinição do DefleMask";
    strings["Load Wavetable"].plurals[0] = "Carregar Wavetable";
    strings["compatible files2"].plurals[0] = "arquivos compatíveis";
    strings["all files2"].plurals[0] = "todos os arquivos";
    strings["Save Wavetable0"].plurals[0] = "Salvar Wavetable";
    strings["Furnace wavetable"].plurals[0] = "Wavetable do Furnace";
    strings["Save Wavetable1"].plurals[0] = "Salvar Wavetable";
    strings["DefleMask wavetable"].plurals[0] = "Wavetable do DefleMask";
    strings["Save Wavetable2"].plurals[0] = "Salvar Wavetable";
    strings["raw data"].plurals[0] = "dados raw";
    strings["Load Sample"].plurals[0] = "Carregar Sample";
    strings["compatible files3"].plurals[0] = "arquivos compatíveis";
    strings["all files3"].plurals[0] = "todos os arquivos";
    strings["Load Raw Sample"].plurals[0] = "Carregar Sample em Formato Raw";
    strings["all files4"].plurals[0] = "todos os arquivos";
    strings["Save Sample"].plurals[0] = "Salvar Sample";
    strings["Wave file0"].plurals[0] = "Arquivo Wave";
    strings["Save Raw Sample"].plurals[0] = "Salvar Sample em Formato Raw";
    strings["all files5"].plurals[0] = "todos os arquivos";
    strings["Export Audio0"].plurals[0] = "Exportar Áudio";
    strings["Wave file1"].plurals[0] = "Arquivo Wave";
    strings["Export Audio1"].plurals[0] = "Exportar Áudio";
    strings["Wave file2"].plurals[0] = "Arquivo Wave";
    strings["Export Audio2"].plurals[0] = "Exportar Áudio";
    strings["Wave file3"].plurals[0] = "Arquivo Wave";
    strings["Export VGM"].plurals[0] = "Exportar VGM";
    strings["VGM file"].plurals[0] = "Arquivo VGM";
    strings["Export ZSM"].plurals[0] = "Exportar ZSM";
    strings["ZSM file"].plurals[0] = "Arquivo ZSM";
    strings["Export Command Stream0"].plurals[0] = "Exportar Fluxo de Comandos";
    strings["text file0"].plurals[0] = "arquivo de texto";
    strings["Export Command Stream1"].plurals[0] = "Exportar Fluxo de Comandos";
    strings["text file1"].plurals[0] = "arquivo de texto";
    strings["Export Command Stream2"].plurals[0] = "Exportar Fluxo de Comandos";
    strings["binary file"].plurals[0] = "arquivo binário";
    strings["Export Furnace song"].plurals[0] = "Exportar Música do Furnace";
    strings["Furnace song2"].plurals[0] = "Música do Furnace";
    strings["Coming soon!"].plurals[0] = "em breve!";
    strings["Select Font0"].plurals[0] = "Selecione a Fonte";
    strings["compatible files4"].plurals[0] = "arquivos compatíveis";
    strings["Select Font1"].plurals[0] = "Selecione a Fonte";
    strings["compatible files5"].plurals[0] = "arquivos compatíveis";
    strings["Select Font2"].plurals[0] = "Selecione a Fonte";
    strings["compatible files6"].plurals[0] = "arquivos compatíveis";
    strings["Select Color File"].plurals[0] = "Selecione o Arquivo de Cores";
    strings["configuration files0"].plurals[0] = "arquivos de configuração";
    strings["Select Keybind File"].plurals[0] = "Selecione o Arquivo de Teclas de Atalho";
    strings["configuration files1"].plurals[0] = "arquivos de configuração";
    strings["Select Layout File"].plurals[0] = "Selecione o Arquivo de Leiaute";
    strings[".ini files0"].plurals[0] = "arquivos .ini";
    strings["Export Colors"].plurals[0] = "Exportar Cores";
    strings["configuration files2"].plurals[0] = "arquivos de configuração";
    strings["Export Keybinds"].plurals[0] = "Exportar Teclas de Atalho";
    strings["configuration files3"].plurals[0] = "arquivos de configuração";
    strings["Export Layout"].plurals[0] = "Exportar Leiaute";
    strings[".ini files1"].plurals[0] = "arquivos .ini";
    strings["Load ROM"].plurals[0] = "Carregar ROM";
    strings["compatible files7"].plurals[0] = "arquivos compatíveis";
    strings["all files6"].plurals[0] = "todos os arquivos";
    strings["Play Command Stream"].plurals[0] = "Reproduzir Fluxo de Comandos";
    strings["command stream"].plurals[0] = "fluxo de comandos";
    strings["all files7"].plurals[0] = "todos os arquivos";
    strings["Open Test"].plurals[0] = "Abrir Teste";
    strings["compatible files8"].plurals[0] = "arquivos compatíveis";
    strings["another option0"].plurals[0] = "outra opção";
    strings["all files8"].plurals[0] = "todos os arquivos";
    strings["Open Test (Multi)"].plurals[0] = "Abrir Teste (Multi)";
    strings["compatible files9"].plurals[0] = "arquivos compatíveis";
    strings["another option1"].plurals[0] = "outra opção";
    strings["all files9"].plurals[0] = "todos os arquivos";
    strings["Save Test"].plurals[0] = "Salvar Teste";
    strings["Furnace song"].plurals[0] = "Música do Furnace";
    strings["DefleMask module"].plurals[0] = "Módulo do DefleMask";
    strings["you have loaded a backup!\nif you need to, please save it somewhere.\n\nDO NOT RELY ON THE BACKUP SYSTEM FOR AUTO-SAVE!\nFurnace will not save backups of backups."].plurals[0] = "você carregou um backup!\nse você precisar, por favor salve-o em algum lugar.\n\nNÃO CONFIE NO SISTEMA DE BACKUP PARA SALVAMENTO AUTOMÁTICO!\nO Furnace não irá realizar backups de backups.";
    strings["cut"].plurals[0] = "recortar";
    strings["copy"].plurals[0] = "copiar";
    strings["paste0"].plurals[0] = "colar";
    strings["paste special..."].plurals[0] = "colar especial...";
    strings["paste mix"].plurals[0] = "colar e mesclar";
    strings["paste mix (background)"].plurals[0] = "colar e mesclar (por trás)";
    strings["paste with ins (foreground)"].plurals[0] = "colar+mesclar com instrumento (pela frente)";
    strings["no instruments available0"].plurals[0] = "nenhum instrumento disponível";
    strings["paste with ins (background)"].plurals[0] = "colar+mesclar com instrumento (por trás)";
    strings["no instruments available1"].plurals[0] = "nenhum instrumento disponível";
    strings["paste flood"].plurals[0] = "colar e repetir";
    strings["paste overflow"].plurals[0] = "colar através das bordas";
    strings["delete0"].plurals[0] = "excluir";
    strings["select all"].plurals[0] = "selecionar tudo";
    strings["operation mask..."].plurals[0] = "máscara de operação...";
    strings["delete1"].plurals[0] = "excluir";
    strings["pull delete"].plurals[0] = "excluir e puxar";
    strings["insert"].plurals[0] = "inserir";
    strings["paste1"].plurals[0] = "colar";
    strings["transpose (note)"].plurals[0] = "transpor (nota)";
    strings["transpose (value)"].plurals[0] = "transpor (valor)";
    strings["interpolate0"].plurals[0] = "interpolar";
    strings["fade"].plurals[0] = "degradê";
    strings["invert values0"].plurals[0] = "inverter valores";
    strings["scale"].plurals[0] = "escalonar";
    strings["randomize"].plurals[0] = "aleatorizar";
    strings["flip"].plurals[0] = "reverter";
    strings["collapse/expand"].plurals[0] = "contrair/expandir";
    strings["input latch"].plurals[0] = "máscara de entrada";
    strings["&&: selected instrument\n..: no instrument"].plurals[0] = "&&: instrumento selecionado\n..: nenhum instrumento";
    strings["Set"].plurals[0] = "Limpar"; // o comando "Set" limpa os valores do input latch
    strings["Reset"].plurals[0] = "Redefinir";
    strings["note up"].plurals[0] = "nota acima";
    strings["note down"].plurals[0] = "nota abaixo";
    strings["octave up"].plurals[0] = "oitava acima";
    strings["octave down"].plurals[0] = "oitava abaixo";
    strings["values up"].plurals[0] = "valores acima";
    strings["values down"].plurals[0] = "valores abaixo";
    strings["values up (+16)"].plurals[0] = "valores acima (+16)";
    strings["values down (-16)"].plurals[0] = "valores abaixo (-16)";
    strings["transpose"].plurals[0] = "transpor";
    strings["Notes"].plurals[0] = "Notas";
    strings["Values"].plurals[0] = "Valores";
    strings["interpolate1"].plurals[0] = "interpolar";
    strings["change instrument..."].plurals[0] = "mudar instrumento...";
    strings["no instruments available"].plurals[0] = "nenhum instrumento disponível";
    strings["gradient/fade..."].plurals[0] = "degradê...";
    strings["Start"].plurals[0] = "Início";
    strings["End"].plurals[0] = "Fim";
    strings["Nibble mode0"].plurals[0] = "Modo nibble";
    strings["Go ahead"].plurals[0] = "Vá em frente";
    strings["scale..."].plurals[0] = "escalonar...";
    strings["Scale"].plurals[0] = "Escalonar";
    strings["randomize..."].plurals[0] = "aleatorizar...";
    strings["Minimum"].plurals[0] = "Mínimo";
    strings["Maximum"].plurals[0] = "Máximo";
    strings["Nibble mode1"].plurals[0] = "Modo nibble";
    strings["Randomize"].plurals[0] = "Aleatorizar";
    strings["invert values1"].plurals[0] = "inverter valores";
    strings["flip selection"].plurals[0] = "reverter seleção";
    strings["collapse/expand amount##CollapseAmount"].plurals[0] = "contrair/expandir por quantidade##CollapseAmount";
    strings["collapse"].plurals[0] = "contrair";
    strings["expand"].plurals[0] = "expandir";
    strings["collapse pattern"].plurals[0] = "contrair sequência";
    strings["expand pattern"].plurals[0] = "expandir sequência";
    strings["collapse song"].plurals[0] = "contrair música";
    strings["expand song"].plurals[0] = "expandir música";
    strings["find/replace"].plurals[0] = "localizar/substituir";
    strings["Furnace has been started in Safe Mode.\nthis means that:\n\n- software rendering is being used\n- audio output may not work\n- font loading is disabled\n\ncheck any settings which may have made Furnace start up in this mode.\nfont loading is one of these."].plurals[0] = "Furnace foi inicializado no Modo de Segurança.\nisso significa que:\n\n- renderização via software está sendo utilizada\n- a saída de áudio pode não funcionar\n- o carregamento de fontes está desabilitado\n\nconfira quaisquer opções que podem ter feito o Furnace iniciar nesse modo.\no carregamento de fontes é uma delas.";
    strings["Unsaved changes! Save changes before opening file?0"].plurals[0] = "Há mudanças não salvas! Salvar mudanças antes de abrir o arquivo?";
    strings["Unsaved changes! Save changes before opening file?2"].plurals[0] = "Há mudanças não salvas! Salvar mudanças antes de abrir o arquivo?";
    strings["Error while loading file! (%s)0"].plurals[0] = "Erro ao abrir o arquivo! (%s)";
    strings["Unsaved changes! Save changes before quitting?"].plurals[0] = "Há mudanças não salvas! Salvar mudanças antes de sair?";
    strings["error while loading fonts! please check your settings.0"].plurals[0] = "erro ao carregar fontes! por favor cheque suas configurações.";
    strings["File##menubar"].plurals[0] = "Arquivo##menubar";
    strings["file##menubar"].plurals[0] = "arquivo##menubar";
    strings["new..."].plurals[0] = "novo...";
    strings["Unsaved changes! Save changes before creating a new song?"].plurals[0] = "Há mudanças não salvas! Salvar mudanças antes de criar uma nova música?";
    strings["open..."].plurals[0] = "abrir...";
    strings["Unsaved changes! Save changes before opening another file?"].plurals[0] = "Há mudanças não salvas! Salvar mudanças antes de abrir outro arquivo?";
    strings["open recent"].plurals[0] = "abrir recente";
    strings["Unsaved changes! Save changes before opening file?1"].plurals[0] = "Há mudanças não salvas! Salvar mudanças antes de abrir o arquivo?";
    strings["Error while loading file! (%s)1"].plurals[0] = "Erro ao abrir o arquivo! (%s)";
    strings["nothing here yet"].plurals[0] = "nada aqui ainda";
    strings["clear history"].plurals[0] = "limpar histórico";
    strings["Are you sure you want to clear the recent file list?"].plurals[0] = "Tem certeza que quer limpar o histórico de arquivos recentes?";
    strings["save"].plurals[0] = "salvar";
    strings["Error while saving file! (%s)0"].plurals[0] = "Erro ao salvar o arquivo! (%s)";
    strings["save as..."].plurals[0] = "salvar como...";
    strings["export audio...0"].plurals[0] = "exportar áudio...";
    strings["export VGM...0"].plurals[0] = "exportar VGM...";
    strings["export .dmf (1.1.3+)...0"].plurals[0] = "exportar .dmf (1.1.3+)...";
    strings["export .dmf (1.0/legacy)...0"].plurals[0] = "exportar .dmf (1.0/legado)...";
    strings["export ZSM...0"].plurals[0] = "exportar ZSM...";
    strings["export Amiga validation data...0"].plurals[0] = "exportar dados de validação do Amiga...";
    strings["export text...0"].plurals[0] = "exportar texto...";
    strings["export command stream...0"].plurals[0] = "exportar fluxo de comandos...";
    strings["export Furnace module..."].plurals[0] = "exportar módulo do Furnace...";
    strings["export audio...1"].plurals[0] = "exportar audio...";
    strings["export VGM...1"].plurals[0] = "exportar VGM...";
    strings["export .dmf (1.1.3+)...1"].plurals[0] = "exportar .dmf (1.1.3+)...";
    strings["export .dmf (1.0/legacy)...1"].plurals[0] = "exportar .dmf (1.0/legado)...";
    strings["export ZSM...1"].plurals[0] = "exportar ZSM...";
    strings["export Amiga validation data...1"].plurals[0] = "exportar dados de validação do Amiga...";
    strings["export text...1"].plurals[0] = "exportar texto...";
    strings["export command stream...1"].plurals[0] = "exportar fluxo de comandos...";
    strings["export..."].plurals[0] = "exportar...";
    strings["manage chips"].plurals[0] = "gerenciar chips";
    strings["add chip..."].plurals[0] = "adicionar chip...";
    strings["cannot add chip! ("].plurals[0] = "não pôde adicionar chip! (";
    strings["configure chip..."].plurals[0] = "configurar chip...";
    strings["change chip..."].plurals[0] = "trocar chip...";
    strings["Preserve channel positions0"].plurals[0] = "Preservar posições dos canais";
    strings["remove chip..."].plurals[0] = "remover chip...";
    strings["Preserve channel positions1"].plurals[0] = "Preservar posições dos canais";
    strings["cannot remove chip! ("].plurals[0] = "não pôde remover chip! (";
    strings["cannot change chip! ("].plurals[0] = "não pôde trocar chip! (";
    strings["open built-in assets directory"].plurals[0] = "abrir diretório de recursos embutidos";
    strings["restore backup"].plurals[0] = "restaurar backup";
    strings["exit..."].plurals[0] = "sair...";
    strings["Unsaved changes! Save before quitting?"].plurals[0] = "Há mudanças não salvas! Salvar antes de sair?";
    strings["Edit##menubar"].plurals[0] = "Editar##menubar";
    strings["edit##menubar"].plurals[0] = "editar##menubar";
    strings["undo"].plurals[0] = "desfazer";
    strings["redo"].plurals[0] = "refazer";
    strings["clear..."].plurals[0] = "apagar...";
    strings["Settings##menubar"].plurals[0] = "Opções##menubar";
    strings["settings##menubar"].plurals[0] = "opções##menubar";
    strings["full screen"].plurals[0] = "tela cheia";
    strings["lock layout"].plurals[0] = "travar leiaute";
    strings["pattern visualizer"].plurals[0] = "visualizador de sequência";
    strings["reset layout"].plurals[0] = "redefinir leiaute";
    strings["Are you sure you want to reset the workspace layout?"].plurals[0] = "Tem certeza de que quer redefinir o leiaute do espaço de trabalho?";
    strings["switch to mobile view"].plurals[0] = "trocar para leiaute otimizado para dispositivos móveis";
    strings["settings..."].plurals[0] = "configurações...";
    strings["Window##menubar"].plurals[0] = "Janela##menubar";
    strings["window##menubar"].plurals[0] = "janela##menubar";
    strings["song information"].plurals[0] = "informações da música";
    strings["subsongs"].plurals[0] = "subfaixas";
    strings["speed"].plurals[0] = "velocidade";
    strings["assets"].plurals[0] = "recursos";
    strings["instruments"].plurals[0] = "instrumentos";
    strings["wavetables"].plurals[0] = "wavetables";
    strings["samples"].plurals[0] = "samples";
    strings["orders"].plurals[0] = "ordens";
    strings["pattern"].plurals[0] = "sequência";
    strings["mixer"].plurals[0] = "mixer";
    strings["grooves"].plurals[0] = "grooves";
    strings["channels"].plurals[0] = "canais";
    strings["pattern manager"].plurals[0] = "gerenciador de sequências";
    strings["chip manager"].plurals[0] = "gerenciador de chips";
    strings["compatibility flags"].plurals[0] = "opções de compatibilidade";
    strings["song"].plurals[0] = "música";
    strings["visualizers"].plurals[0] = "visualizadores";
    strings["tempo"].plurals[0] = "tempo";
    strings["debug"].plurals[0] = "depuração";
    strings["song comments"].plurals[0] = "comentários da música";
    strings["instrument editor"].plurals[0] = "editor de instrumentos";
    strings["wavetable editor"].plurals[0] = "editor de wavetables";
    strings["sample editor"].plurals[0] = "editor de samples";
    strings["play/edit controls"].plurals[0] = "controles de reprodução/edição";
    strings["piano/input pad"].plurals[0] = "piano/teclado virtual";
    strings["oscilloscope (master)"].plurals[0] = "osciloscópio (mestre)";
    strings["oscilloscope (per-channel)"].plurals[0] = "osciloscópio (por canal)";
    strings["oscilloscope (X-Y)"].plurals[0] = "osciloscópio (X-Y)";
    strings["volume meter"].plurals[0] = "medidor de volume";
    strings["clock"].plurals[0] = "clock";
    strings["register view"].plurals[0] = "visualização de registradores";
    strings["log viewer"].plurals[0] = "visualizador de logs";
    strings["statistics"].plurals[0] = "estatísticas";
    strings["memory composition"].plurals[0] = "composição da memória";
    strings["spoiler"].plurals[0] = "spoiler";
    strings["Help##menubar"].plurals[0] = "Ajuda##menubar";
    strings["help##menubar"].plurals[0] = "ajuda##menubar";
    strings["effect list"].plurals[0] = "lista de efeitos";
    strings["debug menu"].plurals[0] = "menu de depuração";
    strings["inspector"].plurals[0] = "inspetor";
    strings["panic"].plurals[0] = "pânico";
    strings["about..."].plurals[0] = "sobre...";
    strings["| Speed %d:%d"].plurals[0] = "| Velocidade %d:%d";
    strings["| Speed %d"].plurals[0] = "| Velocidade %d";
    strings["| Groove"].plurals[0] = "| Groove";
    strings[" @ %gHz (%g BPM) "].plurals[0] = " em %gHz (%g BPM) ";
    strings["| Order %.2X/%.2X "].plurals[0] = "| Ordem %.2X/%.2X ";
    strings["| Order %d/%d "].plurals[0] = "| Ordem %d/%d ";
    strings["| Row %.2X/%.2X "].plurals[0] = "| Linha %.2X/%.2X ";
    strings["| Row %d/%d "].plurals[0] = "| Linha %d/%d ";
    strings["Don't you have anything better to do?"].plurals[0] = "Não tem mais o que fazer não?";
    strings["%d years "].plurals[0] = "%d ano ";
    strings["%d years "].plurals[1] = "%d anos ";
    strings["%d months "].plurals[0] = "%d mês ";
    strings["%d months "].plurals[1] = "%d meses ";
    strings["%d days "].plurals[0] = "%d dia ";
    strings["%d days "].plurals[1] = "%d dias ";
    strings["Note off (cut)"].plurals[0] = "Note off (corte)";
    strings["Note off (release)"].plurals[0] = "Note off (repouso)";
    strings["Macro release only"].plurals[0] = "Repouso de macro somente";
    strings["Note on: %s"].plurals[0] = "Note on: %s";
    strings["Ins %d: <invalid>"].plurals[0] = "Ins %d: <inválido>";
    strings["Ins %d: %s"].plurals[0] = "Ins %d: %s";
    strings["Set volume: %d (%.2X, INVALID!)"].plurals[0] = "Definir volume: %d (%.2X, INVÁLIDO!)";
    strings["Set volume: %d (%.2X, %d%%)"].plurals[0] = "Definir volume: %d (%.2X, %d%%)";
    strings["| modified"].plurals[0] = "| modificado";
    strings["there was an error in the file dialog! you may want to report this issue to:\nhttps://github.com/tildearrow/furnace/issues\ncheck the Log Viewer (window > log viewer) for more information.\n\nfor now please disable the system file picker in Settings > General."].plurals[0] = "houve um erro no diálogo de arquivo! você talvez queira reportar esse problema em:\nhttps://github.com/tildearrow/furnace/issues\nconfira o Visualizador de Logs (janela > visualizador de logs) para mais informações.\n\npor enquanto, por favor desabilite o diálogo de arquivos do sistema em Configurações > Geral.";
    strings["can't do anything without Storage permissions!"].plurals[0] = "impossível fazer algo sem permissões de Armazenamento!";
    strings["Zenity/KDialog not available!\nplease install one of these, or disable the system file picker in Settings > General."].plurals[0] = "Zenity/KDialog indisponíveis!\npor favor instale uma dessas bibliotecas, ou desabilite o diálogo de arquivos do sistema em Configurações > Geral.";
    strings["Error while loading file! (%s)2"].plurals[0] = "Erro ao carregar o arquivo! (%s)";
    strings["Error while saving file! (%s)1"].plurals[0] = "Erro ao salvar o arquivo! (%s)";
    strings["Error while loading file! (%s)3"].plurals[0] = "Erro ao carregar o arquivo! (%s)";
    strings["Error while saving file! (%s)2"].plurals[0] = "Erro ao salvar o arquivo! (%s)";
    strings["Error while saving file! (%s)3"].plurals[0] = "Erro ao salvar o arquivo! (%s)";
    strings["error while saving instrument! only the following instrument types are supported:\n- FM (OPN)\n- SN76489/Sega PSG\n- Game Boy\n- PC Engine\n- NES\n- C64\n- FM (OPLL)\n- FDS"].plurals[0] = "erro ao salvar o instrumento! somente os seguintes tipos de instrumento são suportados:\n- FM (OPN)\n- SN76489/Sega PSG\n- Game Boy\n- PC Engine\n- NES\n- C64\n- FM (OPLL)\n- FDS";
    strings["there were some errors while loading samples:\n#sggu"].plurals[0] = "ocorreram erros ao carregar as samples:\n";
    strings["...but you haven't selected a sample!0"].plurals[0] = "...mas você não selecionou uma sample!";
    strings["could not save sample! open Log Viewer for more information.0"].plurals[0] = "não foi possível salvar a sample! abra o Visualizador de Logs para mais informações.";
    strings["could not save sample! open Log Viewer for more information.1"].plurals[0] = "não foi possível salvar a sample! abra o Visualizador de Logs para mais informações.";
    ...
    strings["...but you haven't selected an instrument!0"].plurals[0] = "...mas você não selecionou um instrumento!";
    strings["cannot load instrument! ("].plurals[0] = "não pôde carregar o instrumento! (";
    strings["congratulations! you managed to load nothing.\nyou are entitled to a bug report."].plurals[0] = "parabéns! você foi capaz de carregar um monte de nada.\nvocê tem direito a um bug report.";
    strings["there were some errors while loading wavetables:\n"].plurals[0] = "ocorreram erros ao carregar as wavetables:\n";
    strings["cannot load wavetable! ("].plurals[0] = "não pôde carregar a wavetable! (";
    strings["...but you haven't selected a wavetable!"].plurals[0] = "...mas você não selecionou uma wavetable!";
    strings["could not open file!"].plurals[0] = "não pôde abrir o arquivo!";
    strings["Could not write ZSM! (%s)"].plurals[0] = "Não pôde escrever ZSM! (%s)";
    strings["could not write text! (%s)"].plurals[0] = "não pôde escrever texto! (%s)";
    strings["could not write command stream! (%s)"].plurals[0] = "não pôde escrever fluxo de comandos! (%s)";
    strings["could not write tildearrow version Furnace module! (%s)"].plurals[0] = "não pôde escrever módulo do Furnace versão tildearrow! (%s)";
    strings["Error while loading file! (%s)4"].plurals[0] = "Erro ao carregar o arquivo! (%s)";
    strings["You opened: %s"].plurals[0] = "Você abriu: %s";
    strings["You opened:"].plurals[0] = "Você abriu:";
    strings["You saved: %s"].plurals[0] = "Você salvou: %s";
    strings["Rendering...###Rendering..."].plurals[0] = "Renderizando...###Rendering...";
    strings["Please wait..."].plurals[0] = "Por favor aguarde...";
    strings["Abort"].plurals[0] = "Abortar";
    ...
    strings["Yes0"].plurals[0] = "Sim";
    strings["No0"].plurals[0] = "Não";
    strings["Yes1"].plurals[0] = "Sim";
    strings["No1"].plurals[0] = "Não";
    strings["Yes2"].plurals[0] = "Sim";
    strings["No2"].plurals[0] = "Não";
    strings["Yes3"].plurals[0] = "Sim";
    strings["No3"].plurals[0] = "Não";
    strings["Yes7"].plurals[0] = "Sim";
    strings["Yes8"].plurals[0] = "Sim";
    strings["Yes9"].plurals[0] = "Sim";
    strings["Yes10"].plurals[0] = "Sim";
    strings["Yes11"].plurals[0] = "Sim";
    strings["No8"].plurals[0] = "Não";
    strings["No9"].plurals[0] = "Não";
    strings["No10"].plurals[0] = "Não";
    strings["No11"].plurals[0] = "Não";
    strings["No12"].plurals[0] = "Não";
    strings["Cancel4"].plurals[0] = "Cancelar";
    strings["Cancel5"].plurals[0] = "Cancelar";
    strings["Cancel6"].plurals[0] = "Cancelar";
    strings["Cancel7"].plurals[0] = "Cancelar";
    strings["Cancel8"].plurals[0] = "Cancelar";
    strings["Cancel0"].plurals[0] = "Cancelar";
    strings["Erasing"].plurals[0] = "Apagando";
    strings["All subsongs"].plurals[0] = "Todas as subfaixas";
    strings["Current subsong"].plurals[0] = "Subfaixa atual";
    strings["Orders"].plurals[0] = "Ordens";
    strings["Pattern"].plurals[0] = "Sequência";
    strings["Instruments"].plurals[0] = "Instrumentos";
    strings["Wavetables"].plurals[0] = "Wavetables";
    strings["Samples"].plurals[0] = "Samples";
    strings["Optimization"].plurals[0] = "Otimização";
    strings["De-duplicate patterns"].plurals[0] = "Deduplicar sequências";
    strings["Remove unused instruments"].plurals[0] = "Remover instrumentos não utilizados";
    strings["Remove unused samples"].plurals[0] = "Remover samples não utilizadas";
    strings["Never mind! Cancel1"].plurals[0] = "Deixa pra lá! Cancelar";
    strings["Yes4"].plurals[0] = "Sim";
    strings["No4"].plurals[0] = "Não";
    strings["Yes5"].plurals[0] = "Sim";
    strings["No5"].plurals[0] = "Não";
    strings["Yes6"].plurals[0] = "Sim";
    strings["No6"].plurals[0] = "Não";
    strings["OK1"].plurals[0] = "OK";
    strings["Drum kit mode:"].plurals[0] = "Modo de kit de bateria:";
    strings["Normal"].plurals[0] = "Normal";
    strings["12 samples per octave"].plurals[0] = "12 samples por oitava";
    strings["Starting octave"].plurals[0] = "Oitava inicial";
    strings["too many instruments!"].plurals[0] = "há muitos instrumentos!";
    ...
    strings["this is an instrument bank! select which one to use:"].plurals[0] = "isto é um banco de instrumentos! selecione quais instrumentos carregar:";
    strings["this is an instrument bank! select which ones to load:"].plurals[0] = "isto é um banco de instrumentos! selecione quais instrumentos carregar:";
    strings["All"].plurals[0] = "Todos";
    strings["None"].plurals[0] = "Nenhum";
    strings["OK2"].plurals[0] = "OK";
    strings["Cancel2"].plurals[0] = "Cancelar";
    strings["...but you haven't selected an instrument!1"].plurals[0] = "...mas você não selecionou um instrumento!";
    strings["Import Raw Sample###Import Raw Sample"].plurals[0] = "Importar Sample em Formato Raw###Import Raw Sample";
    strings["Data type:"].plurals[0] = "Tipo de dado:";
    strings["Sample rate"].plurals[0] = "Taxa de amostragem";
    strings["Channels"].plurals[0] = "Canais";
    strings["(will be mixed down to mono)"].plurals[0] = "(será misturado para mono)";
    strings["Unsigned"].plurals[0] = "Sem sinal";
    strings["Big endian"].plurals[0] = "Big endian";
    strings["Swap nibbles"].plurals[0] = "Trocar nibbles";
    strings["Swap words"].plurals[0] = "Trocar palavras";
    strings["Encoding:"].plurals[0] = "Codificação:";
    strings["Reverse bit order"].plurals[0] = "Trocar ordem dos bits";
    strings["OK3"].plurals[0] = "OK";
    strings["...but you haven't selected a sample!1"].plurals[0] = "...mas você não selecionou uma sample!";
    strings["Cancel3"].plurals[0] = "Cancelar";
    strings["Error! No string provided!"].plurals[0] = "Erro! Não foi passada uma string!";
    strings["OK4"].plurals[0] = "OK";
    strings["error while loading fonts! please check your settings.1"].plurals[0] = "erro ao carregar fontes! por favor cheque suas configurações.";
    strings["it appears I couldn't load these fonts. any setting you can check?"].plurals[0] = "parece que eu não pude carregar essas fontes. alguma configuração que você poderia checar?";
    strings["could not init renderer! %s"].plurals[0] = "não pôde inicializar o renderizador! %s";
    ...
    strings["could not open window! %s"].plurals[0] = "não pôde abrir a janela! %s";
    strings["error while loading fonts! please check your settings.2"].plurals[0] = "erro ao carregar fontes! por favor cheque suas configurações.";
    strings["could NOT save layout! %s"].plurals[0] = "não pôde salvar o layout! %s";
    ...
    strings["%s: maximum sample rate is %d"].plurals[0] = "%s: a taxa de amostragem máxima é %d";
    strings["%s: minimum sample rate is %d"].plurals[0] = "%s: a taxa de amostragem mínima é %d";
    strings["%s: sample rate must be %d"].plurals[0] = "%s: a taxa de amostragem deve ser %d";
    strings["Sample Editor###Sample Editor"].plurals[0] = "Editor de Sample###Sample Editor";
    strings["no sample selected"].plurals[0] = "nenhuma sample selecionada";
    strings["select one..."].plurals[0] = "selecione uma...";
    strings["or##sgsed0"].plurals[0] = "ou";
    strings["Open##sgsed0"].plurals[0] = "Abrir";
    strings["or##sgsed1"].plurals[0] = "ou";
    strings["Create New"].plurals[0] = "Criar uma Nova";
    ...
    strings["import raw..."].plurals[0] = "importar dados raw...";
    strings["Save"].plurals[0] = "Salvar";
    strings["save raw..."].plurals[0] = "salvar dados raw...";
    strings["Name"].plurals[0] = "Nome";
    strings["SNES: loop start must be a multiple of 16 (try with %d)"].plurals[0] = "SNES: início do loop precisa ser múltiplo de 16 (tente com %d)";
    strings["SNES: loop end must be a multiple of 16 (try with %d)"].plurals[0] = "SNES: fim do loop precisa ser múltiplo de 16 (tente com %d)";
    strings["SNES: sample length will be padded to multiple of 16"].plurals[0] = "SNES: tamanho da sample precisa ser preenchida até um múltiplo de 16";
    strings["QSound: loop cannot be longer than 32767 samples"].plurals[0] = "QSound: loop não pode ser mais longo que 32767";
    strings["QSound: maximum sample length is 65535"].plurals[0] = "QSound: o tamanho máximo de uma sample é 65535";
    strings["NES: loop point ignored on DPCM (may only loop entire sample)"].plurals[0] = "NES: o ponto de repetição (loop) é ignorado no DPCM (só é possível repetir a sample inteira)";
    strings["NES: maximum DPCM sample length is 32648"].plurals[0] = "NES: o tamanho máximo de uma sample DPCM é 32648";
    strings["X1-010: samples can't loop"].plurals[0] = "X1-010: não é possível repetir (loop) samples";
    strings["X1-010: maximum sample length is 131072"].plurals[0] = "X1-010: o tamanho máximo de uma sample é 131072";
    strings["GA20: samples can't loop"].plurals[0] = "GA20: samples não podem repetir (loop)";
    strings["YM2608: loop point ignored on ADPCM (may only loop entire sample)"].plurals[0] = "YM2608: o ponto de repetição (loop) é ignorado no ADPCM (só é possível repetir a sample inteira)";
    strings["YM2608: sample length will be padded to multiple of 512"].plurals[0] = "YM2608: o comprimento da sample será preenchida até um múltiplo de 512";
    strings["YM2610: ADPCM-A samples can't loop"].plurals[0] = "YM2610: samples ADPCM-A não podem repetir (loop)";
    strings["YM2610: loop point ignored on ADPCM-B (may only loop entire sample)"].plurals[0] = "YM2610: o ponto de repetição (loop) é ignorado no ADPCM-B (só é possível repetir a sample inteira)";
    strings["YM2610: sample length will be padded to multiple of 512"].plurals[0] = "YM2610: o comprimento da sample será preenchida até um múltiplo de 512";
    strings["YM2610: maximum ADPCM-A sample length is 2097152"].plurals[0] = "YM2610: o comprimento máximo de uma sample ADPCM-A é 2097152";
    strings["Y8950: loop point ignored on ADPCM (may only loop entire sample)"].plurals[0] = "Y8950: o ponto de repetição (loop) é ignorado no ADPCM (só é possível repetir a sample inteira)";
    strings["Y8950: sample length will be padded to multiple of 512"].plurals[0] = "Y8950: o comprimento da sample será preenchida até um múltiplo de 512";
    strings["Amiga: loop start must be a multiple of 2"].plurals[0] = "Amiga: o início do loop precisa ser um múltiplo de 2";
    strings["Amiga: loop end must be a multiple of 2"].plurals[0] = "Amiga: o final do loop precisa ser um múltiplo de 2";
    strings["Amiga: maximum sample length is 131070"].plurals[0] = "Amiga: o comprimento máximo da sample é 131070";
    strings["SegaPCM: maximum sample length is 65280"].plurals[0] = "SegaPCM: o comprimento máximo da sample é 65280";
    strings["K053260: loop point ignored (may only loop entire sample)"].plurals[0] = "K053260: o ponto de repetição (loop) é ignorado (só é possível repetir a sample inteira)";
    strings["K053260: maximum sample length is 65535"].plurals[0] = "K053260: o comprimento máximo da sample é 65535";
    strings["C140: maximum sample length is 65535"].plurals[0] = "C140: o comprimento máximo da sample é 65535";
    strings["C219: loop start must be a multiple of 2"].plurals[0] = "C219: o início do loop precisa ser um múltiplo de 2";
    strings["C219: loop end must be a multiple of 2"].plurals[0] = "C219: o final do loop precisa ser um múltiplo de 2";
    strings["C219: maximum sample length is 131072"].plurals[0] = "C219: o comprimento máximo da sample é 131072";
    strings["MSM6295: samples can't loop"].plurals[0] = "MSM6295: não é possível repetir (loop) samples";
    strings["MSM6295: maximum bankswitched sample length is 129024"].plurals[0] = "MSM6295: o comprimento máximo da sample com bankswitching é 129024";
    strings["GBA DMA: loop start must be a multiple of 4"].plurals[0] = "GBA DMA: o início do loop precisa ser um múltiplo de 4";
    strings["GBA DMA: loop length must be a multiple of 16"].plurals[0] = "GBA DMA: o comprimento do loop precisa ser um múltiplo de 16";
    strings["GBA DMA: sample length will be padded to multiple of 16"].plurals[0] = "GBA DMA: o comprimento da sample será preenchida até um múltiplo de 16";
    strings["ES5506: backward loop mode isn't supported"].plurals[0] = "ES5506: modo de repetição (loop) reverso não é suportado";
    strings["backward/ping-pong only supported in Generic PCM DAC\nping-pong also on ES5506"].plurals[0] = "reverso/pingue-pongue suportado somente no DAC PCM Genérico\npingue-pongue também suportado no ES5506";
    strings["Info"].plurals[0] = "Informações";
    strings["Rate##sgsed0"].plurals[0] = "Taxa";
    strings["Compat Rate"].plurals[0] = "Taxa de Compatibilidade";
    strings["used in DefleMask-compatible sample mode (17xx), in where samples are mapped to an octave."].plurals[0] = "usado no modo de sample compatível com Deflemask (17xx), em que samples são mapeadas a uma oitava.";
    strings["Loop (length: %d)##Loop"].plurals[0] = "Loop (comprimento: %d)";
    strings["Loop"].plurals[0] = "Loop (repetição)";
    ...
    strings["Chips"].plurals[0] = "Chips";
    strings["Type"].plurals[0] = "Tipo";
    strings["BRR emphasis"].plurals[0] = "Ênfase BRR";
    strings["this is a BRR sample.\nenabling this option will muffle it (only affects non-SNES chips)."].plurals[0] = "esta é uma sample BRR.\nhabilitar essa opção irá abafá-la (afeta somente chips além do SNES).";
    strings["enable this option to slightly boost high frequencies\nto compensate for the SNES' Gaussian filter's muffle."].plurals[0] = "habilite essa opção para enfatizar levemente as frequências altas\npara compensar pelo abafamento do filtro gaussiano do SNES.";
    strings["8-bit dither"].plurals[0] = "Aplicar dither 8-bit";
    strings["dither the sample when used on a chip that only supports 8-bit samples."].plurals[0] = "Aplicar dithering 8-bit na sample quando utilizada em um chip que só suporta samples 8-bit.";
    strings["Note"].plurals[0] = "Nota";
    strings["%s"].plurals[0] = "%s";
    strings["Fine"].plurals[0] = "Ajuste fino";
    strings["Mode"].plurals[0] = "Modo";
    strings["Start"].plurals[0] = "Início";
    ...
    strings["Edit mode: Select"].plurals[0] = "Modo de edição: Selecionar";
    strings["Edit mode: Draw"].plurals[0] = "Modo de edição: Desenhar";
    ...
    strings["couldn't resize! make sure your sample is 8 or 16-bit."].plurals[0] = "não pôde redimensionar! verifique se sua sample é 8 or 16-bit.";
    strings["Resample##sgsed0"].plurals[0] = "Reamostrar";
    strings["Rate##sgsed1"].plurals[0] = "Taxa";
    strings["Factor"].plurals[0] = "Razão"; // TODO: tem uma palavra melhor?
    strings["Filter"].plurals[0] = "Filtro";
    strings["Resample##sgsed1"].plurals[0] = "Reamostrar";
    strings["couldn't resample! make sure your sample is 8 or 16-bit."].plurals[0] = "não pôde redimensionar! verifique se sua sample é 8 or 16-bit.";
    strings["Undo"].plurals[0] = "Desfazer";
    strings["Redo"].plurals[0] = "Refazer";
    strings["Amplify"].plurals[0] = "Amplificar";
    strings["Volume"].plurals[0] = "Volume";
    strings["Apply##sgsed0"].plurals[0] = "Aplicar";
    strings["Normalize"].plurals[0] = "Normalizar";
    strings["Fade in"].plurals[0] = "Fade in";
    strings["Fade out"].plurals[0] = "Fade out";
    strings["Insert silence"].plurals[0] = "Inserir silêncio";
    strings["Samples##sgsed1"].plurals[0] = "Amostras";
    strings["Go"].plurals[0] = "Aplicar";
    strings["couldn't insert! make sure your sample is 8 or 16-bit."].plurals[0] = "não pôde inserir! verifique se sua sample é 8 or 16-bit.";
    strings["Apply silence"].plurals[0] = "Aplicar silêncio";
    strings["Delete"].plurals[0] = "Excluir";
    strings["Trim"].plurals[0] = "Cortar";
    strings["Reverse"].plurals[0] = "Reverter";
    strings["Invert"].plurals[0] = "Inverter";
    strings["Signed/unsigned exchange"].plurals[0] = "Alternar sinalização (signed/unsigned)";
    strings["Apply filter"].plurals[0] = "Aplicar filtro";
    strings["Cutoff:"].plurals[0] = "Ponto de corte:";
    strings["From"].plurals[0] = "De";
    strings["To"].plurals[0] = "Até";
    strings["Resonance"].plurals[0] = "Ressonância";
    strings["Power"].plurals[0] = "Potência";
    strings["Low-pass"].plurals[0] = "Passa-baixa";
    strings["Band-pass"].plurals[0] = "Passa-banda";
    strings["High-pass"].plurals[0] = "Passa-alta";
    strings["Apply##sgsed1"].plurals[0] = "Aplicar";
    strings["Crossfade loop points"].plurals[0] = "Aplicar crossfade nos pontos de loop";
    strings["Number of samples"].plurals[0] = "Número de amostras";
    strings["Linear <-> Equal power"].plurals[0] = "Linear <-> Equipotente";
    strings["Apply##sgsed2"].plurals[0] = "Aplicar";
    strings["Crossfade: length would go out of bounds. Aborted..."].plurals[0] = "Crossfade: o comprimento estaria fora dos limites da sample. Abortado...";
    strings["Crossfade: length would overflow loopStart. Try a smaller random value."].plurals[0] = "Crossfade: o comprimento ultrapassaria o começo do loop. Tente um valor menor aleatório.";
    strings["Preview sample"].plurals[0] = "Prever sample";
    strings["Stop sample preview"].plurals[0] = "Interromper previsão da sample";
    strings["Create instrument from sample"].plurals[0] = "Criar instrumento a partir da sample";
    strings["Zoom##sgsed0"].plurals[0] = "Zoom";
    strings["Zoom##sgsed1"].plurals[0] = "Zoom";
    strings["Auto"].plurals[0] = "Automático";
    strings["cut"].plurals[0] = "recortar";
    strings["copy"].plurals[0] = "copiar";
    strings["paste"].plurals[0] = "colar";
    strings["paste (replace)"].plurals[0] = "colar (substituir)";
    strings["paste (mix)"].plurals[0] = "colar (mesclar)";
    strings["select all"].plurals[0] = "selecionar tudo";
    strings["set loop to selection"].plurals[0] = "definir loop para seleção";
    strings["create wavetable from selection"].plurals[0] = "criar wavetable a partir da seleção";
    strings["Draw"].plurals[0] = "Desenhar";
    strings["Select"].plurals[0] = "Selecionar";
    strings["%d samples"].plurals[0] = "%d sample";
    strings["%d samples"].plurals[1] = "%d samples";
    strings["%d bytes"].plurals[0] = "%d byte";
    strings["%d bytes"].plurals[1] = "%d bytes";
    strings[" (%d-%d: %d samples)"].plurals[0] = " (%d-%d: %d sample)";
    strings[" (%d-%d: %d samples)"].plurals[1] = " (%d-%d: %d samples)";
    strings["Non-8/16-bit samples cannot be edited without prior conversion."].plurals[0] = "Samples que não são 8/16-bit não podem ser editadas sem ser convertidas primeiro.";
    ...
    strings["Use software envelope"].plurals[0] = "Utilizar envelope em software";
    strings["Initialize envelope on every note"].plurals[0] = "Inicializar envelope em cada nota";
    strings["Volume##sgiGB0"].plurals[0] = "Volume";
    strings["Length"].plurals[0] = "Comprimento";
    strings["Sound Length##sgiGB0"].plurals[0] = "Comprimento do som";
    strings["Infinity"].plurals[0] = "Infinito";
    strings["Direction"].plurals[0] = "Direção";
    strings["Up##sgiGB0"].plurals[0] = "Cima";
    strings["Down##sgiGB0"].plurals[0] = "Baixo";
    strings["Hardware Sequence"].plurals[0] = "Sequência de Hardware";
    strings["Tick"].plurals[0] = "Tick";
    strings["Command"].plurals[0] = "Comando";
    strings["Move/Remove"].plurals[0] = "Mover/Remover";
    strings["Volume"].plurals[0] = "Volume";
    strings["Env Length"].plurals[0] = "Comprimento do Envelope";
    strings["Sound Length"].plurals[0] = "Comprimento do Som";
    strings["Up"].plurals[0] = "Cima";
    strings["Down"].plurals[0] = "Baixo";
    strings["Shift"].plurals[0] = "Deslocar";
    strings["Speed"].plurals[0] = "Velocidade";
    strings["Up"].plurals[0] = "Cima";
    strings["Down"].plurals[0] = "Baixo";
    strings["Ticks"].plurals[0] = "Ticks";
    strings["Position"].plurals[0] = "Posição";
    strings["Macros"].plurals[0] = "Macros";
    strings["Volume"].plurals[0] = "Volume";
    strings["Arpeggio"].plurals[0] = "Arpejo";
    strings["Pitch"].plurals[0] = "Tom";
    strings["Duty/Noise"].plurals[0] = "Ciclo de Trab./Ruído";
    strings["Waveform"].plurals[0] = "Forma de Onda";
    strings["Panning"].plurals[0] = "Balanço";
    strings["Phase Reset"].plurals[0] = "Redef. de Fase";
    ...
    strings["Sunsoft 5B standalone"].plurals[0] = "Sunsoft 5B independente";
    strings["Sunsoft 5B standalone (PAL)"].plurals[0] = "Sunsoft 5B independente (PAL)";
    strings["Overclocked Sunsoft 5B"].plurals[0] = "Sunsoft 5B (com overclock)";
    strings["Sega Genesis Extended Channel 3"].plurals[0] = "Sega Mega Drive com Canal 3 Estendido";
    strings["NTSC-J Sega Master System + drums"].plurals[0] = "Sega Master System NTSC-J + bateria";
    strings["MSX-MUSIC + drums"].plurals[0] = "MSX-MUSIC + bateria";
    strings["Commodore 64 with dual 6581"].plurals[0] = "Commodore 64 com dois 6581";
    strings["Commodore 64 with dual 8580"].plurals[0] = "Commodore 64 com dois 8580";
    strings["YM2151 + SegaPCM Arcade (compatibility)"].plurals[0] = "Arcade com YM2151 + SegaPCM (compatibilidade)";
    strings["YM2151 + SegaPCM Arcade"].plurals[0] = "Arcade com YM2151 + SegaPCM";
    strings["Game Boy with AY expansion"].plurals[0] = "Game Boy with expansão AY";
    strings["multi-system"].plurals[0] = "multi-sistema";
    strings["Unknown"].plurals[0] = "Desconhecido";
    strings["15xx: Set raw period"].plurals[0] = "15xx: Definir período (val. registrador)";
    strings["16xx: Set raw period higher nybble (0-F)"].plurals[0] = "16xx: Definir nibble superior do período (val. registrador) (0-F)";
    strings["20xx: Set channel mode (bit 0: square; bit 1: noise; bit 2: envelope)"].plurals[0] = "20xx: Definir modo do canal (bit 0: onda quadrada; bit 1: ruído; bit 2: envelope)";
    strings["21xx: Set noise frequency (0 to 1F)"].plurals[0] = "21xx: Definir frequência do ruído (0 a 1F)";
    strings["22xy: Set envelope mode (x: shape, y: enable for this channel)"].plurals[0] = "22xy: Definir modo do envelope (x: formato, y: habilitar para este canal)";
    strings["23xx: Set envelope period low byte"].plurals[0] = "23xx: Definir byte inferior do período do envelope";
    strings["24xx: Set envelope period high byte"].plurals[0] = "24xx: Definir byte superior do período do envelope";
    strings["25xx: Envelope slide up"].plurals[0] = "25xx: Slide de envelope para cima";
    strings["26xx: Envelope slide down"].plurals[0] = "26xx: Slide de envelope para baixo";
    strings["29xy: Set auto-envelope (x: numerator; y: denominator)"].plurals[0] = "29xy: Definir envelope automático (x: numerador; y: denominador)";
    strings["2Exx: Write to I/O port A"].plurals[0] = "2Exx: Escrever na porta E/S A";
    strings["2Fxx: Write to I/O port B"].plurals[0] = "2Fxx: Escrever na porta E/S B";
    strings["12xx: Set duty cycle (0 to 8)"].plurals[0] = "12xx: Definir ciclo de trabalho (0 a 8)";
    strings["16xx: Set raw period higher byte"].plurals[0] = "16xx: Definir byte superior do período (val. registrador)";
    strings["27xx: Set noise AND mask"].plurals[0] = "27xx: Definir máscara AND do ruído";
    strings["28xx: Set noise OR mask"].plurals[0] = "28xx: Definir máscara OR do ruído";
    strings["2Dxx: NOT TO BE EMPLOYED BY THE COMPOSER"].plurals[0] = "2Dxx: NÃO É PARA SER USADO PELO COMPOSITOR";
    strings["30xx: Toggle hard envelope reset on new notes"].plurals[0] = "30xx: Alternar reinício brusco do envelope em novas notas";
    strings["18xx: Toggle extended channel 3 mode"].plurals[0] = "18xx: Alternar modo de canal 3 estendido";
    strings["17xx: Toggle PCM mode (LEGACY)"].plurals[0] = "17xx: Alternar modo PCM (LEGADO)";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)"].plurals[0] = "DFxx: Definir direção da reprodução de samples (0: normal; 1: reversa)";
    strings["18xx: Toggle drums mode (1: enabled; 0: disabled)"].plurals[0] = "18xx: Alternar modo bateria (1: habilitado; 0: desabilitado)";
    strings["11xx: Set feedback (0 to 7)"].plurals[0] = "11xx: Definir feedback (0 a 7)";
    strings["12xx: Set level of operator 1 (0 highest, 7F lowest)"].plurals[0] = "12xx: Definir nível do operador 1 (0 é o mais alto, 7F o mais baixo)";
    strings["13xx: Set level of operator 2 (0 highest, 7F lowest)"].plurals[0] = "13xx: Definir nível do operador 2 (0 é o mais alto, 7F o mais baixo)";
    strings["14xx: Set level of operator 3 (0 highest, 7F lowest)"].plurals[0] = "14xx: Definir nível do operador 3 (0 é o mais alto, 7F o mais baixo)";
    strings["15xx: Set level of operator 4 (0 highest, 7F lowest)"].plurals[0] = "15xx: Definir nível do operador 4 (0 é o mais alto, 7F o mais baixo)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)"].plurals[0] = "16xy: Definir multiplicador do operador (x: operador de 1 a 4; y: multiplicador)";
    strings["19xx: Set attack of all operators (0 to 1F)"].plurals[0] = "19xx: Definir ataque de todos os operadores (0 a 1F)";
    strings["1Axx: Set attack of operator 1 (0 to 1F)"].plurals[0] = "1Axx: Definir ataque do operador 1 (0 a 1F)";
    strings["1Bxx: Set attack of operator 2 (0 to 1F)"].plurals[0] = "1Bxx: Definir ataque do operador 2 (0 a 1F)";
    strings["1Cxx: Set attack of operator 3 (0 to 1F)"].plurals[0] = "1Cxx: Definir ataque do operador 3 (0 a 1F)";
    strings["1Dxx: Set attack of operator 4 (0 to 1F)"].plurals[0] = "1Dxx: Definir ataque do operador 4 (0 a 1F)";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)"].plurals[0] = "50xy: Definir AM (x: operador de 1 a 4 (0 para todos os ops.); y: AM)";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)"].plurals[0] = "51xy: Definir nível de sustentação (x: operador de 1 a 4 (0 para todos os ops.); y: sustentação)";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)"].plurals[0] = "52xy: Definir repouso (x: operador de 1 a 4 (0 para todos os ops.); y: repouso)";
    strings["53xy: Set detune (x: operator from 1 to 4 (0 for all ops); y: detune where 3 is center)"].plurals[0] = "53xy: Definir desafinação (x: operador de 1 a 4 (0 para todos os ops.); y: desafinação, onde 3 é o centro)";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)"].plurals[0] = "54xy: Definir escalonamento do envelope (x: operador de 1 a 4 (0 para todos os ops.); y: escala de 0 a 3)";
    strings["56xx: Set decay of all operators (0 to 1F)"].plurals[0] = "56xx: Definir decaimento de todos os operadores (0 a 1F)";
    strings["57xx: Set decay of operator 1 (0 to 1F)"].plurals[0] = "57xx: Definir decaimento do operador 1 (0 a 1F)";
    strings["58xx: Set decay of operator 2 (0 to 1F)"].plurals[0] = "58xx: Definir decaimento do operador 2 (0 a 1F)";
    strings["59xx: Set decay of operator 3 (0 to 1F)"].plurals[0] = "59xx: Definir decaimento do operador 3 (0 a 1F)";
    strings["5Axx: Set decay of operator 4 (0 to 1F)"].plurals[0] = "5Axx: Definir decaimento do operador 4 (0 a 1F)";
    strings["5Bxx: Set decay 2 of all operators (0 to 1F)"].plurals[0] = "5Bxx: Definir decaimento 2 de todos os operadores (0 a 1F)";
    strings["5Cxx: Set decay 2 of operator 1 (0 to 1F)"].plurals[0] = "5Cxx: Definir decaimento 2 do operador 1 (0 a 1F)";
    strings["5Dxx: Set decay 2 of operator 2 (0 to 1F)"].plurals[0] = "5Dxx: Definir decaimento 2 do operador 2 (0 a 1F)";
    strings["5Exx: Set decay 2 of operator 3 (0 to 1F)"].plurals[0] = "5Exx: Definir decaimento 2 do operador 3 (0 a 1F)";
    strings["5Fxx: Set decay 2 of operator 4 (0 to 1F)"].plurals[0] = "5Fxx: Definir decaimento 2 do operador 4 (0 a 1F)";
    strings["10xx: Set noise frequency (xx: value; 0 disables noise)"].plurals[0] = "10xx: Definir frequência do ruído (xx: valor; 0 desabilita o ruído)";
    strings["17xx: Set LFO speed"].plurals[0] = "17xx: Definir velocidade do LFO";
    strings["18xx: Set LFO waveform (0 saw, 1 square, 2 triangle, 3 noise)"].plurals[0] = "18xx: Definir forma de onda do LFO (0 serra, 1 quadrada, 2 triângulo, 3 ruído)";
    strings["1Exx: Set AM depth (0 to 7F)"].plurals[0] = "1Exx: Definir profundidade do AM (0 a 7F)";
    strings["1Fxx: Set PM depth (0 to 7F)"].plurals[0] = "1Fxx: Definir profundidade do PM (0 a 7F)";
    strings["55xy: Set detune 2 (x: operator from 1 to 4 (0 for all ops); y: detune from 0 to 3)"].plurals[0] = "55xy: Definir desafinação 2 (x: operador de 1 a 4 (0 para todos os ops.); y: desafinação de 0 a 3)";
    strings["24xx: Set LFO 2 speed"].plurals[0] = "24xx: Definir velocidade do LFO 2";
    strings["25xx: Set LFO 2 waveform (0 saw, 1 square, 2 triangle, 3 noise)"].plurals[0] = "25xx: Definir forma de onda do LFO 2 (0 serra, 1 quadrada, 2 triângulo, 3 ruído)";
    strings["26xx: Set AM 2 depth (0 to 7F)"].plurals[0] = "26xx: Definir profundidade do AM 2 (0 ta 7F)";
    strings["27xx: Set PM 2 depth (0 to 7F)"].plurals[0] = "27xx: Definir profundidade do PM 2 (0 ta 7F)";
    strings["28xy: Set reverb (x: operator from 1 to 4 (0 for all ops); y: reverb from 0 to 7)"].plurals[0] = "28xy: Definir reverb (x: operador de 1 a 4 (0 para todos os ops.); y: reverb de 0 a 7)";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 7)"].plurals[0] = "2Axy: Definir forma de onda (x: operador de 1 a 4 (0 para todos os ops.); y: forma de onda de 0 a 7)";
    strings["2Bxy: Set envelope generator shift (x: operator from 1 to 4 (0 for all ops); y: shift from 0 to 3)"].plurals[0] = "2Bxy: Definir deslocamento do gerador de envelope x: operador de 1 a 4 (0 para todos os ops.); y: deslocamento de 0 a 3)";
    strings["2Cxy: Set fine multiplier (x: operator from 1 to 4 (0 for all ops); y: fine)"].plurals[0] = "2Cxy: Definir multiplicador fino (x: operador de 1 a 4 (0 para todos os ops.); y: multiplicador fino)";
    strings["3xyy: Set fixed frequency of operator 1 (x: octave from 0 to 7; y: frequency)"].plurals[0] = "3xyy: Definir frequência fixa do operador 1 (x: oitava de 0 a 7; y: frequência)";
    strings["3xyy: Set fixed frequency of operator 2 (x: octave from 8 to F; y: frequency)"].plurals[0] = "3xyy: Definir frequência fixa do operador 2 (x: oitava de 8 a F; y: frequência)";
    strings["4xyy: Set fixed frequency of operator 3 (x: octave from 0 to 7; y: frequency)"].plurals[0] = "4xyy: Definir frequência fixa do operador 3 (x: oitava de 0 a 7; y: frequência)";
    strings["4xyy: Set fixed frequency of operator 4 (x: octave from 8 to F; y: frequency)"].plurals[0] = "4xyy: Definir frequência fixa do operador 4 (x: oitava de 8 a F; y: frequência)";
    strings["10xy: Setup LFO (x: enable; y: speed)"].plurals[0] = "10xy: Configurar LFO (x: habilitar; y: velocidade)";
    strings["55xy: Set SSG envelope (x: operator from 1 to 4 (0 for all ops); y: 0-7 on, 8 off)"].plurals[0] = "55xy: Definir envelope SSG (x: operador de 1 a 4 (0 para todos os ops.); y: 0-7 ligado, 8 desligado)";
    strings["1Fxx: Set ADPCM-A global volume (0 to 3F)"].plurals[0] = "1Fxx: Definir volume global do ADPCM-A (0 a 3F)";
    strings["11xx: Set feedback (0 to 7)1"].plurals[0] = "11xx: Definir feedback (0 a 7)";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)"].plurals[0] = "12xx: Definir nível do operador 1 (0 é o mais alto, 3F o mais baixo)";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)"].plurals[0] = "13xx: Definir nível do operador 2 (0 é o mais alto, 3F o mais baixo)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 2; y: multiplier)"].plurals[0] = "16xy: Definir multiplicador do operador (x: operator de 1 a 2; y: multiplicador)";
    strings["19xx: Set attack of all operators (0 to F)"].plurals[0] = "19xx: Definir ataque de todos os operadores (0 a F)";
    strings["1Axx: Set attack of operator 1 (0 to F)"].plurals[0] = "1Axx: Definir ataque do operador 1 (0 a F)";
    strings["1Bxx: Set attack of operator 2 (0 to F)"].plurals[0] = "1Bxx: Definir ataque do operador 2 (0 a F)";
    strings["50xy: Set AM (x: operator from 1 to 2 (0 for all ops); y: AM)"].plurals[0] = "50xy: Definir AM (x: operador de 1 a 2 (0 para todos os ops.); y: AM)";
    strings["51xy: Set sustain level (x: operator from 1 to 2 (0 for all ops); y: sustain)"].plurals[0] = "51xy: Definir nível de sustentação (x: operador de 1 a 2 (0 para todos os ops.); y: sustentação)";
    strings["52xy: Set release (x: operator from 1 to 2 (0 for all ops); y: release)"].plurals[0] = "52xy: Definir repouso (x: operador de 1 a 2 (0 para todos os ops.); y: repouso)";
    strings["53xy: Set vibrato (x: operator from 1 to 2 (0 for all ops); y: enabled)"].plurals[0] = "53xy: Definir vibrato (x: operador de 1 a 2 (0 para todos os ops.); y: habilitado)";
    strings["54xy: Set envelope scale (x: operator from 1 to 2 (0 for all ops); y: scale from 0 to 3)"].plurals[0] = "54xy: Definir escalonamento de envelope (x: operador de 1 a 2 (0 para todos os ops.); y: escala de 0 a 3)";
    strings["55xy: Set envelope sustain (x: operator from 1 to 2 (0 for all ops); y: enabled)"].plurals[0] = "55xy: Definir modo de sustentação de envelope (x: operador de 1 a 2 (0 para todos os ops.); y: habilitado)";
    strings["56xx: Set decay of all operators (0 to F)"].plurals[0] = "56xx: Definir decaimento de todos os operadores (0 a F)";
    strings["57xx: Set decay of operator 1 (0 to F)"].plurals[0] = "57xx: Definir decaimento do operador 1 (0 a F)";
    strings["58xx: Set decay of operator 2 (0 to F)"].plurals[0] = "58xx: Definir decaimento do operador 2 (0 a F)";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 2 (0 for all ops); y: enabled)"].plurals[0] = "5Bxy: Definir se a nota irá escalonar a taxa do envelope (x: operador de 1 a 2 (0 para todos os ops.); y: habilitado)";
    strings["10xx: Set global AM depth (0: 1dB, 1: 4.8dB)"].plurals[0] = "10xx: Definir profundidade de AM global (0: 1dB, 1: 4.8dB)";
    strings["11xx: Set feedback (0 to 7)2"].plurals[0] = "11xx: Definir feedback (0 a 7)";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)1"].plurals[0] = "12xx: Definir nível do operador 1 (0 é o mais alto, 3F o mais baixo)";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)1"].plurals[0] = "13xx: Definir nível do operador 2 (0 é o mais alto, 3F o mais baixo)";
    strings["14xx: Set level of operator 3 (0 highest, 3F lowest)"].plurals[0] = "14xx: Definir nível do operador 3 (0 é o mais alto, 3F o mais baixo)";
    strings["15xx: Set level of operator 4 (0 highest, 3F lowest)"].plurals[0] = "15xx: Definir nível do operador 4 (0 é o mais alto, 3F o mais baixo)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)1"].plurals[0] = "16xy: Definir multiplicador do operador (x: operador de 1 a 4; y: multiplicador)";
    strings["17xx: Set global vibrato depth (0: normal, 1: double)"].plurals[0] = "17xx: Definir profundidade de vibrato global (0: normal, 1: dobro)";
    strings["19xx: Set attack of all operators (0 to F)1"].plurals[0] = "19xx: Definir ataque de todos os operadores (0 a F)";
    strings["1Axx: Set attack of operator 1 (0 to F)1"].plurals[0] = "1Axx: Definir ataque do operador 1 (0 a F)";
    strings["1Bxx: Set attack of operator 2 (0 to F)1"].plurals[0] = "1Bxx: Definir ataque do operador 2 (0 a F)";
    strings["1Cxx: Set attack of operator 3 (0 to F)"].plurals[0] = "1Cxx: Definir ataque do operador 3 (0 a F)";
    strings["1Dxx: Set attack of operator 4 (0 to F)"].plurals[0] = "1Dxx: Definir ataque do operador 4 (0 a F)";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 3 in OPL2 and 0 to 7 in OPL3)"].plurals[0] = "2Axy: Definir forma de onda (x: operador de 1 a 4 (0 para todos os ops.); y: forma de onda de 0 a 3 no OPL2 e 0 a 7 no OPL3)";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)1"].plurals[0] = "50xy: Definir AM (x: operador de 1 a 4 (0 para todos os ops.); y: AM)";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)1"].plurals[0] = "51xy: Definir nível de sustentação (x: operador de 1 a 4 (0 para todos os ops.); y: sustentação)";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)1"].plurals[0] = "52xy: Definir repouso (x: operador de 1 a 4 (0 para todos os ops.); y: repouso)";
    strings["53xy: Set vibrato (x: operator from 1 to 4 (0 for all ops); y: enabled)"].plurals[0] = "53xy: Definir vibrato (x: operador de 1 a 4 (0 para todos os ops.); y: habilitado)";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)1"].plurals[0] = "54xy: Definir escalonamento de envelope (x: operador de 1 a 4 (0 para todos os ops.); y: escala de 0 a 3)";
    strings["55xy: Set envelope sustain (x: operator from 1 to 4 (0 for all ops); y: enabled)"].plurals[0] = "55xy: Definir modo de sustentação de envelope (x: operador de 1 a 4 (0 para todos os ops.); y: habilitado)";
    strings["56xx: Set decay of all operators (0 to F)1"].plurals[0] = "56xx: Definir decaimento de todos os operadores (0 a F)";
    strings["57xx: Set decay of operator 1 (0 to F)1"].plurals[0] = "57xx: Definir decaimento do operador 1 (0 a F)";
    strings["58xx: Set decay of operator 2 (0 to F)1"].plurals[0] = "58xx: Definir decaimento do operador 2 (0 a F)";
    strings["59xx: Set decay of operator 3 (0 to F)"].plurals[0] = "59xx: Definir decaimento do operador 3 (0 a F)";
    strings["5Axx: Set decay of operator 4 (0 to F)"].plurals[0] = "5Axx: Definir decaimento do operador 4 (0 a F)";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 4 (0 for all ops); y: enabled)"].plurals[0] = "5Bxy: Definir se a nota irá escalonar a taxa do envelope (x: operador de 1 a 4 (0 para todos os ops.); y: habilitado)";
    strings["10xx: Set waveform (bit 0: triangle; bit 1: saw; bit 2: pulse; bit 3: noise)"].plurals[0] = "10xx: Definir forma de onda (bit 0: triângulo; bit 1: serra; bit 2: pulso; bit 3: ruído)";
    strings["11xx: Set coarse cutoff (not recommended; use 4xxx instead)"].plurals[0] = "11xx: Definir ponto de corte grosso (não recomendado; use o 4xxx ao invés desse)";
    strings["12xx: Set coarse pulse width (not recommended; use 3xxx instead)"].plurals[0] = "12xx: Definir largura de pulso grossa (não recomendado, use o 3xxx ao invés desse)";
    strings["13xx: Set resonance (0 to F)"].plurals[0] = "13xx: Definir ressonância (0 a F)";
    strings["14xx: Set filter mode (bit 0: low pass; bit 1: band pass; bit 2: high pass)"].plurals[0] = "14xx: Definir modo de filtro (bit 0: passa baixa; bit 1: passa banda; bit 2: passa alta)";
    strings["15xx: Set envelope reset time"].plurals[0] = "15xx: Definir tempo de reinício do envelope";
    strings["1Axx: Disable envelope reset for this channel (1 disables; 0 enables)"].plurals[0] = "1Axx: Desabilitar reinício do envelope para este canal (1 desabilita; 0 habilita)";
    strings["1Bxy: Reset cutoff (x: on new note; y: now)"].plurals[0] = "1Bxy: Redefinir ponto de corte (x: em nova nota; y: agora)";
    strings["1Cxy: Reset pulse width (x: on new note; y: now)"].plurals[0] = "1Cxy: Redefinir largura de pulso (x: em nova nota; y: agora)";
    strings["1Exy: Change other parameters (LEGACY)"].plurals[0] = "1Exy: Alterar outros parâmetros (LEGADO)";
    strings["20xy: Set attack/decay (x: attack; y: decay)"].plurals[0] = "20xy: Definir ataque/decaimento (x: ataque; y: decaimento)";
    strings["21xy: Set sustain/release (x: sustain; y: release)"].plurals[0] = "21xy: Definir sustentação/repouso (x: sustentação; y: repouso)";
    strings["22xx: Pulse width slide up"].plurals[0] = "22xx: Slide de largura de pulso para cima";
    strings["23xx: Pulse width slide down"].plurals[0] = "23xx: Slide de largura de pulso para baixo";
    strings["24xx: Cutoff slide up"].plurals[0] = "24xx: Slide de ponto de corte para cima";
    strings["25xx: Cutoff slide down"].plurals[0] = "25xx: Slide de ponto de corte para baixo";
    strings["3xxx: Set pulse width (0 to FFF)"].plurals[0] = "3xxx: Definir largura de pulso (0 a FFF)";
    strings["4xxx: Set cutoff (0 to 7FF)"].plurals[0] = "4xxx: Definir ponto de corte (0 to 7FF)";
    strings["10xx: Set waveform"].plurals[0] = "10xx: Definir forma de onda";
    strings["13xx: Set waveform (local)"].plurals[0] = "13xx: Definir forma de onda (local)";
    strings["11xx: Set raw period"].plurals[0] = "11xx: Definir período (val. registrador) (0-1F)";
    strings["11xx: Set waveform (local)"].plurals[0] = "11xx: Definir forma de onda (local)";
    strings["20xx: Set PCM frequency"].plurals[0] = "20xx: Definir frequência do PCM";
    strings["10xy: Set AM depth (x: operator from 1 to 4 (0 for all ops); y: depth (0: 1dB, 1: 4.8dB))"].plurals[0] = "10xy: Definir profundidade do AM (x: operador de 1 a 4 (0 para todos os ops.); y: profundidade (0: 1dB, 1: 4.8dB))";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)2"].plurals[0] = "12xx: Definir nível do operador 1 (0 é o mais alto, 3F o mais baixo)";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)2"].plurals[0] = "13xx: Definir nível do operador 2 (0 é o mais alto, 3F o mais baixo)";
    strings["14xx: Set level of operator 3 (0 highest, 3F lowest)1"].plurals[0] = "14xx: Definir nível do operador 3 (0 é o mais alto, 3F o mais baixo)";
    strings["15xx: Set level of operator 4 (0 highest, 3F lowest)1"].plurals[0] = "15xx: Definir nível do operador 4 (0 é o mais alto, 3F o mais baixo)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)2"].plurals[0] = "16xy: Definir multiplicador do operador (x: operador de 1 a 4; y: multiplicador)";
    strings["17xy: Set vibrato depth (x: operator from 1 to 4 (0 for all ops); y: depth (0: normal, 1: double))"].plurals[0] = "17xy: Definir profundidade do vibrato (x: operador de 1 a 4 (0 para todos os ops.); y: profundidade (0: normal, 1: dobro))";
    strings["19xx: Set attack of all operators (0 to F)"].plurals[0] = "19xx: Definir ataque de todos os operadores (0 a F)";
    strings["1Axx: Set attack of operator 1 (0 to F)2"].plurals[0] = "1Axx: Definir ataque do operador 1 (0 a F)";
    strings["1Bxx: Set attack of operator 2 (0 to F)2"].plurals[0] = "1Bxx: Definir ataque do operador 2 (0 a F)";
    strings["1Cxx: Set attack of operator 3 (0 to F)1"].plurals[0] = "1Cxx: Definir ataque do operador 3 (0 a F)";
    strings["1Dxx: Set attack of operator 4 (0 to F)1"].plurals[0] = "1Dxx: Definir ataque do operador 4 (0 a F)";
    strings["20xy: Set panning of operator 1 (x: left; y: right)"].plurals[0] = "20xy: Definir balanço do operador 1 (x: esquerda; y: direita)";
    strings["21xy: Set panning of operator 2 (x: left; y: right)"].plurals[0] = "21xy: Definir balanço do operador 2 (x: esquerda; y: direita)";
    strings["22xy: Set panning of operator 3 (x: left; y: right)"].plurals[0] = "22xy: Definir balanço do operador 3 (x: esquerda; y: direita)";
    strings["23xy: Set panning of operator 4 (x: left; y: right)"].plurals[0] = "23xy: Definir balanço do operador 4 (x: esquerda; y: direita)";
    strings["24xy: Set output level register (x: operator from 1 to 4 (0 for all ops); y: level from 0 to 7)"].plurals[0] = "24xy: Definir registrador de nível de saída (x: operador de 1 a 4 (0 para todos os ops.); y: nível de 0 a 7)";
    strings["25xy: Set modulation input level (x: operator from 1 to 4 (0 for all ops); y: level from 0 to 7)"].plurals[0] = "25xy: Definir nível de entrada de modulação (x: operador de 1 a 4 (0 para todos os ops.); y: nível de 0 a 7)";
    strings["26xy: Set envelope delay (x: operator from 1 to 4 (0 for all ops); y: delay from 0 to 7)"].plurals[0] = "26xy: Definir atraso de envelope (x: operador de 1 a 4 (0 para todos os ops.); y: atraso de 0 a 7)";
    strings["27xx: Set noise mode for operator 4 (x: mode from 0 to 3)"].plurals[0] = "27xx: Definir modo de ruído do operador 4 (x: modo de 0 a 3)";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 7)1"].plurals[0] = "2Axy: Definir forma de onda (x: operador de 1 a 4 (0 para todos os ops.); y: forma de onda de 0 a 7)";
    strings["2Fxy: Set fixed frequency block (x: operator from 1 to 4; y: octave from 0 to 7)"].plurals[0] = "2Fxy: Definir bloco da frequência fixa (x: operador de 1 a 4; y: oitava de 0 a 7)";
    strings["40xx: Set detune of operator 1 (80: center)"].plurals[0] = "40xx: Definir desafinação do operador 1 (80: centro)";
    strings["41xx: Set detune of operator 2 (80: center)"].plurals[0] = "41xx: Definir desafinação do operador 2 (80: centro)";
    strings["42xx: Set detune of operator 3 (80: center)"].plurals[0] = "42xx: Definir desafinação do operador 3 (80: centro)";
    strings["43xx: Set detune of operator 4 (80: center)"].plurals[0] = "43xx: Definir desafinação do operador 4 (80: centro)";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)2"].plurals[0] = "50xy: Set AM (x: operador de 1 a 4 (0 para todos os ops.); y: AM)";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)2"].plurals[0] = "51xy: Definir nível de sustentação (x: operador de 1 a 4 (0 para todos os ops.); y: sustentação)";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)2"].plurals[0] = "52xy: Definir repouso (x: operador de 1 a 4 (0 para todos os ops.); y: repouso)";
    strings["53xy: Set vibrato (x: operator from 1 to 4 (0 for all ops); y: enabled)1"].plurals[0] = "53xy: Definir vibrato (x: operador de 1 a 4 (0 para todos os ops.); y: habilitado)";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)2"].plurals[0] = "54xy: Definir escalonamento de envelope (x: operador de 1 a 4 (0 para todos os ops.); y: escala de 0 a 3)";
    strings["55xy: Set envelope sustain (x: operator from 1 to 4 (0 for all ops); y: enabled)1"].plurals[0] = "55xy: Definir modo de sustentação de envelope (x: operador de 1 a 4 (0 para todos os ops.); y: habilitado)";
    strings["56xx: Set decay of all operators (0 to F)2"].plurals[0] = "56xx: Definir decaimento de todos os operadores (0 a F)";
    strings["57xx: Set decay of operator 1 (0 to F)2"].plurals[0] = "57xx: Definir decaimento do operador 1 (0 a F)";
    strings["58xx: Set decay of operator 2 (0 to F)2"].plurals[0] = "58xx: Definir decaimento do operador 2 (0 a F)";
    strings["59xx: Set decay of operator 3 (0 to F)1"].plurals[0] = "59xx: Definir decaimento do operador 3 (0 a F)";
    strings["5Axx: Set decay of operator 4 (0 to F)1"].plurals[0] = "5Axx: Definir decaimento do operador 4 (0 a F)";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 4 (0 for all ops); y: enabled)1"].plurals[0] = "5Bxy: Definir se a nota irá escalonar a taxa do envalope (x: operador de 1 a 4 (0 para todos os ops.); y: habilitado)";
    strings["3xyy: Set fixed frequency F-num of operator 1 (x: high 2 bits from 0 to 3; y: low 8 bits of F-num)"].plurals[0] = "3xyy: Definir Número-Frequência da frequência fixa do operador 1 (x: 2 bits superiores de 0 a 3; y: 8 bits inferiores)";
    strings["3xyy: Set fixed frequency F-num of operator 2 (x: high 2 bits from 4 to 7; y: low 8 bits of F-num)"].plurals[0] = "3xyy: Definir Número-Frequência da frequência fixa do operador 2 (x: 2 bits superiores de 4 a 7; y: 8 bits inferiores)";
    strings["3xyy: Set fixed frequency F-num of operator 3 (x: high 2 bits from 8 to B; y: low 8 bits of F-num)"].plurals[0] = "3xyy: Definir Número-Frequência da frequência fixa do operador 3 (x: 2 bits superiores de 8 a B; y: 8 bits inferiores)";
    strings["3xyy: Set fixed frequency F-num of operator 4 (x: high 2 bits from C to F; y: low 8 bits of F-num)"].plurals[0] = "3xyy: Definir Número-Frequência da frequência fixa do operador 4 (x: 2 bits superiores de C a F; y: 8 bits inferiores)";
    strings["10xx: Set waveform (bit 0: triangle; bit 1: saw; bit 2: pulse; bit 3: noise)1"].plurals[0] = "10xx: Definir forma de onda (bit 0: triângulo; bit 1: serra; bit 2: pulso; bit 3: ruído)";
    strings["11xx: Set resonance (0 to FF)"].plurals[0] = "11xx: Definir ressonância (0 a FF)";
    strings["12xx: Set filter mode (bit 0: low pass; bit 1: band pass; bit 2: high pass)"].plurals[0] = "12xx: Definir modo de filtro (bit 0: passa baixa; bit 1: passa banda; bit 2: passa alta)";
    strings["13xx: Disable envelope reset for this channel (1 disables; 0 enables)"].plurals[0] = "13xx: Desabilitar reinício do envelope para este canal (1 desabilita; 0 habilita)";
    strings["14xy: Reset cutoff (x: on new note; y: now)"].plurals[0] = "14xy: Redefinir ponto de corte (x: em nova nota; y: agora)";
    strings["15xy: Reset pulse width (x: on new note; y: now)"].plurals[0] = "15xy: Redefinir largura de pulso (x: em nova nota; y: agora)";
    strings["16xy: Change other parameters"].plurals[0] = "16xy: Alterar outros parâmetros";
    strings["17xx: Pulse width slide up"].plurals[0] = "17xx: Slide de largura de pulso para cima";
    strings["18xx: Pulse width slide down"].plurals[0] = "18xx: Slide de largura de pulso para baixo";
    strings["19xx: Cutoff slide up"].plurals[0] = "19xx: Slide de ponto de corte para cima";
    strings["1Axx: Cutoff slide down"].plurals[0] = "1Axx: Slide de ponto de corte para baixo";
    strings["3xxx: Set pulse width (0 to FFF)1"].plurals[0] = "3xxx: Definir largura de pulso (0 a FFF)";
    strings["4xxx: Set cutoff (0 to FFF)1"].plurals[0] = "4xxx: Definir ponto de corte (0 a FFF)";
    strings["a chip which found its way inside mobile phones in the 2000's.\nas proprietary as it is, it passed away after losing to MP3 in the mobile hardware battle."].plurals[0] = "um chip que encontrou seu lugar dentro de celulares nos anos 2000.\nproprietário como era, ele faleceu após perder para o MP3 na batalha de hardware móvel.";
    strings["<COMPOUND SYSTEM!>"].plurals[0] = "<SISTEMA COMPOSTO!>";
    strings["Sega Genesis Extended Channel 31"].plurals[0] = "Sega Mega Drive com Canal 3 Estendido";
    strings["<COMPOUND SYSTEM!>1"].plurals[0] = "<SISTEMA COMPOSTO!>";
    strings["a square/noise sound chip found on the Sega Master System, ColecoVision, Tandy, TI's own 99/4A and a few other places."].plurals[0] = "um chip de som de onda quadrada e ruído encontrado no Sega Master System, ColecoVision, PCs Tandy, o próprio 99/4A da TI e alguns outros lugares.";
    strings["20xy: Set noise mode (x: preset freq/ch3 freq; y: thin pulse/noise)"].plurals[0] = "20xy: Definir modo de ruído (x: freq. predefinidas/freq. canal 3; y: pulso fino/ruído)";
    strings["<COMPOUND SYSTEM!>2"].plurals[0] = "<SISTEMA COMPOSTO!>";
    strings["the most popular portable game console of the era."].plurals[0] = "o console de games portátil mais popular da sua época.";
    strings["10xx: Set waveform1"].plurals[0] = "10xx: Definir forma de onda";
    strings["11xx: Set noise length (0: long; 1: short)"].plurals[0] = "11xx: Definir comprimento do ruído (0: longo; 1: curto)";
    strings["12xx: Set duty cycle (0 to 3)"].plurals[0] = "12xx: Definir ciclo de trabalho (0 a 3)";
    strings["13xy: Setup sweep (x: time; y: shift)"].plurals[0] = "13xy: Configurar sweep (x: tempo; y: deslocamento)";
    strings["14xx: Set sweep direction (0: up; 1: down)"].plurals[0] = "14xx: Definir direção do sweep (0: para cima; 1: para baixo)";
    strings["15xx: Set waveform (local)"].plurals[0] = "15xx: Definir forma de onda (local)";
    strings["an '80s game console with a wavetable sound chip, popular in Japan."].plurals[0] = "um console de games dos anos 80 com um chip de som wavetable, popular no Japão.";
    strings["10xx: Set waveform2"].plurals[0] = "10xx: Definir forma de onda";
    strings["11xx: Toggle noise mode"].plurals[0] = "11xx: Alternar modo de rúido";
    strings["12xx: Setup LFO (0: disabled; 1: 1x depth; 2: 16x depth; 3: 256x depth)"].plurals[0] = "12xx: Configurar LFO (0: desabilitado; 1: profundidade 1x; 2: profundidade 16x; 3: profundidade 256x)";
    strings["13xx: Set LFO speed"].plurals[0] = "13xx: Definir velocidade do LFO";
    strings["17xx: Toggle PCM mode (LEGACY)1"].plurals[0] = "17xx: Alternar modo PCM (LEGADO)";
    strings["18xx: Set waveform (local)"].plurals[0] = "18xx: Definir forma de onda (local)";
    strings["also known as Famicom in Japan, it's the most well-known game console of the '80s."].plurals[0] = "também conhecido como Famicom no Japão, e também conhecido como Phantom System, Top Game, Turbo Game, Dynavision, Bit System e Polystation no Brasil, é o console de jogos mais conhecido dos anos 80."; // viva os Famiclones!
    strings["11xx: Write to delta modulation counter (0 to 7F)"].plurals[0] = "11xx: Escrever no contador de modulação delta (DAC) (0 a 7F)";
    strings["12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1)"].plurals[0] = "12xx: Definir ciclo de trabalho/modo de ruído (pulso: 0 a 3; ruído: 0 ou 1)";
    strings["13xy: Sweep up (x: time; y: shift)"].plurals[0] = "13xy: Realizar sweep de tom para cima (x: tempo; y: deslocamento)";
    strings["14xy: Sweep down (x: time; y: shift)"].plurals[0] = "14xy: Realizar sweep de tom para baixo (x: tempo; y: deslocamento)";
    strings["15xx: Set envelope mode (0: envelope, 1: length, 2: looping, 3: constant)"].plurals[0] = "15xx: Definir modo de envelope (0: envelope, 1: comprimento, 2: repetir, 3: constante)";
    strings["16xx: Set length counter (refer to manual for a list of values)"].plurals[0] = "16xx: Definir contador de comprimento (veja o manual para uma lista de valores)";
    strings["17xx: Set frame counter mode (0: 4-step, 1: 5-step)"].plurals[0] = "17xx: Definir modo do contador de quadros (0: 4 passos, 1: 5 passos)";
    strings["18xx: Select PCM/DPCM mode (0: PCM; 1: DPCM)"].plurals[0] = "18xx: Selecionar modo PCM/DPCM (0: PCM; 1: DPCM)";
    strings["19xx: Set triangle linear counter (0 to 7F; 80 and higher halt)"].plurals[0] = "19xx: Definir contador linear do canal triângulo (0 a 7F; valores 80 e superiores interrompem)";
    strings["20xx: Set DPCM frequency (0 to F)"].plurals[0] = "20xx: Definir frequência DPCM (0 a F)";
    strings["<COMPOUND SYSTEM!>3"].plurals[0] = "<SISTEMA COMPOSTO!>";
    strings["<COMPOUND SYSTEM!>4"].plurals[0] = "<SISTEMA COMPOSTO!>";
    strings["this computer is powered by the SID chip, which had synthesizer features like a filter and ADSR."].plurals[0] = "este computador possui o chip de som SID, que possui recursos de sintetizador como um filtro e ADSR.";
    strings["this computer is powered by the SID chip, which had synthesizer features like a filter and ADSR.\nthis is the newer revision of the chip."].plurals[0] = "este computador possui o chip de som SID, que possui recursos de sintetizador como um filtro e ADSR.\nessa é uma revisão mais nova do chip.";
    strings["<COMPOUND SYSTEM!>5"].plurals[0] = "<SISTEMA COMPOSTO!>";
    strings["like Neo Geo, but lacking the ADPCM-B channel since they couldn't connect the pins."].plurals[0] = "como o Neo Geo, mas faltando o canal ADPCM-B já que eles não puderam conectar os pinos.";
    strings["Neo Geo CD Extended Channel 2"].plurals[0] = "Neo Geo CD com Canal 2 estendido";
    strings["like Neo Geo, but lacking the ADPCM-B channel since they couldn't connect the pins.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies."].plurals[0] = "como o Neo Geo, mas faltando o canal ADPCM-B já que eles não puderam conectar os pinos.\nesse está no modo de Canal Estendido, que transforma o segundo canal FM em quatro operadores com notas/frequências independentes.";
    strings["this chip is everywhere! ZX Spectrum, MSX, Amstrad CPC, Intellivision, Vectrex...\nthe discovery of envelope bass helped it beat the SN76489 with ease."].plurals[0] = "esse chip está em todo lugar! ZX Spectrum, MSX, Amstrad CPC, Intellivision, Vectrex...\na descoberta do baixo com o envelope ajudou ele a ganhar do SN76489 facilmente.";
    strings["a computer from the '80s with full sampling capabilities, giving it a sound ahead of its time."].plurals[0] = "um computador dos anos 80 com capacidade completa de amostragem (sampling), dando a ele um som à frente do seu tempo.";
    strings["10xx: Toggle filter (0 disables; 1 enables)"].plurals[0] = "10xx: Alternar filtro (0 desabilita; 1 habilita)";
    strings["11xx: Toggle AM with next channel"].plurals[0] = "11xx: Alternar AM com o canal à direita";
    strings["12xx: Toggle period modulation with next channel"].plurals[0] = "12xx: Alternar modulação de período com o canal à direita";
    strings["13xx: Set waveform"].plurals[0] = "13xx: Definir forma de onda";
    strings["14xx: Set waveform (local)"].plurals[0] = "14xx: Definir forma de onda (local)";
    strings["this was Yamaha's first integrated FM chip.\nit was used in several synthesizers, computers and arcade boards."].plurals[0] = "esse foi o primeiro chip FM integrado da Yamaha.\nele foi usado em vários sintetizadores, computadores e placas de fliperama.";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer)."].plurals[0] = "esse chip é mais conhecido por ter sido utilizado no Sega Mega Drive (mas ele também foi usado no computador FM Towns).";
    strings["it's a challenge to make music on this chip which barely has musical capabilities..."].plurals[0] = "é um desafio fazer música nesse chip que mal tem capacidades musicais..."; // zói tu num é dj, duvido cê fazer música no atari... mas desafio é desafio zói, cê num é hardicóri???
    strings["supposedly an upgrade from the AY-3-8910, this was present on the Creative Music System (Game Blaster) and SAM Coupé."].plurals[0] = "supostamente um upgrade do AY-3-8910, esse chip estava presente na placa Creative Music System (Game Blaster) e no computador SAM Coupé.";
    strings["10xy: Set channel mode (x: noise; y: tone)"].plurals[0] = "10xy: Definir modo do canal (x: ruído; y: tom)";
    strings["11xx: Set noise frequency"].plurals[0] = "11xx: Definir frequência do ruído";
    strings["12xx: Setup envelope (refer to docs for more information)"].plurals[0] = "12xx: Configurar envelope (confira o manual para mais informações)";
    strings["an improved version of the AY-3-8910 with a bigger frequency range, duty cycles, configurable noise and per-channel envelopes!"].plurals[0] = "uma versão melhorada do AY-3-8910 com uma faixa de frequências maior, ciclos de trabalho, ruído configurável e envelopes por canal!";
    strings["Commodore's successor to the PET.\nits square wave channels are more than just square..."].plurals[0] = "o sucessor da Commodore para o PET.\nseus canais de onda quadrada são mais do que apenas ondas quadradas...";
    strings["one channel of 1-bit wavetable which is better (and worse) than the PC Speaker."].plurals[0] = "um canal de wavetable 1-bit que é melhor (e pior) que o PC Speaker.";
    strings["FM? nah... samples! Nintendo's answer to Sega."].plurals[0] = "FM? nah... samples! a resposta da Nintendo para a Sega.";
    strings["18xx: Enable echo buffer"].plurals[0] = "18xx: Habilitar buffer de eco";
    strings["19xx: Set echo delay (0 to F)"].plurals[0] = "19xx: Definir atraso de eco (0 a F)";
    strings["1Axx: Set left echo volume"].plurals[0] = "1Axx: Definir volume esquerdo do eco";
    strings["1Bxx: Set right echo volume"].plurals[0] = "1Bxx: Definir volume direito do eco";
    strings["1Cxx: Set echo feedback"].plurals[0] = "1Cxx: Definir retorno do eco";
    strings["1Exx: Set dry output volume (left)"].plurals[0] = "1Exx: Definir volume de saída não-processado (esquerda)";
    strings["1Fxx: Set dry output volume (right)"].plurals[0] = "1Fxx: Definir volume de saída não-processado (direita)";
    strings["30xx: Set echo filter coefficient 0"].plurals[0] = "30xx: Definir coeficiente de filtro do eco 0";
    strings["31xx: Set echo filter coefficient 1"].plurals[0] = "31xx: Definir coeficiente de filtro do eco 1";
    strings["32xx: Set echo filter coefficient 2"].plurals[0] = "32xx: Definir coeficiente de filtro do eco 2";
    strings["33xx: Set echo filter coefficient 3"].plurals[0] = "33xx: Definir coeficiente de filtro do eco 3";
    strings["34xx: Set echo filter coefficient 4"].plurals[0] = "34xx: Definir coeficiente de filtro do eco 4";
    strings["35xx: Set echo filter coefficient 5"].plurals[0] = "35xx: Definir coeficiente de filtro do eco 5";
    strings["36xx: Set echo filter coefficient 6"].plurals[0] = "36xx: Definir coeficiente de filtro do eco 6";
    strings["37xx: Set echo filter coefficient 7"].plurals[0] = "37xx: Definir coeficiente de filtro do eco 7";
    strings["10xx: Set waveform3"].plurals[0] = "10xx: Definir forma de onda";
    strings["11xx: Toggle noise mode1"].plurals[0] = "11xx: Alternar modo de ruído";
    strings["12xx: Toggle echo on this channel"].plurals[0] = "12xx: Alternar eco neste canal";
    strings["13xx: Toggle pitch modulation"].plurals[0] = "13xx: Alternar modulação de tom";
    strings["14xy: Toggle invert (x: left; y: right)"].plurals[0] = "14xy: Alternar inversão de onda (x: esquerda; y: direita)";
    strings["15xx: Set envelope mode (0: ADSR, 1: gain/direct, 2: dec, 3: exp, 4: inc, 5: bent)"].plurals[0] = "15xx: Definir modo de envelope (0: ADSR, 1: ganho/direto, 2: decr., 3: exp., 4: incr., 5: linha torta)";
    strings["16xx: Set gain (00 to 7F if direct; 00 to 1F otherwise)"].plurals[0] = "16xx: Definir ganho (00 a 7F se for direto; 00 a 1F caso contrário)";
    strings["17xx: Set waveform (local)"].plurals[0] = "17xx: Definir forma de onda (local)";
    strings["1Dxx: Set noise frequency (00 to 1F)"].plurals[0] = "1Dxx: Definir frequência do ruído (00 a 1F)";
    strings["20xx: Set attack (0 to F)"].plurals[0] = "20xx: Definir ataque (0 a F)";
    strings["21xx: Set decay (0 to 7)"].plurals[0] = "21xx: Definir decaimento (0 a 7)";
    strings["22xx: Set sustain (0 to 7)"].plurals[0] = "22xx: Definir sustentação (0 a 7)";
    strings["23xx: Set release (00 to 1F)"].plurals[0] = "23xx: Definir repouso (00 a 1F)";
    strings["an expansion chip for the Famicom, featuring a quirky sawtooth channel."].plurals[0] = "um chip de expansão para o Famicom, contendo um canal dente-de-serra peculiar.";
    strings["12xx: Set duty cycle (pulse: 0 to 7)"].plurals[0] = "12xx: Definir ciclo de trabalho (pulso: 0 a 7)";
    strings["17xx: Toggle PCM mode (LEGACY)2"].plurals[0] = "17xx: Alternar modo PCM (LEGADO)";
    strings["cost-reduced version of the OPL with 16 patches and only one of them is user-configurable."].plurals[0] = "versão de custo reduzido do chip OPL com 16 timbres selecionáveis, e apenas um deles é configurável pelo usuário.";
    strings["Famicom Disk System (chip)"].plurals[0] = "Famicom Disk System (chip)";
    strings["a disk drive for the Famicom which also contains one wavetable channel."].plurals[0] = "um drive de disquete para o Famicom que também contém um canal de wavetable.";
    strings["10xx: Set waveform4"].plurals[0] = "10xx: Definir forma de onda";
    strings["11xx: Set modulation depth"].plurals[0] = "11xx: Definir profundidade de modulação";
    strings["12xy: Set modulation speed high byte (x: enable; y: value)"].plurals[0] = "12xy: Definir byte superior da velocidade de modulação (x: habilitar; y: valor)";
    strings["13xx: Set modulation speed low byte"].plurals[0] = "13xx: Definir byte inferior da velocidade de modulação";
    strings["14xx: Set modulator position"].plurals[0] = "14xx: Definir posição do modulador";
    strings["15xx: Set modulator table to waveform"].plurals[0] = "15xx: Definir tabela do modulador para uma forma de onda";
    strings["16xx: Set waveform (local)"].plurals[0] = "16xx: Definir forma de onda (local)";
    strings["an expansion chip for the Famicom, featuring a little-known PCM channel."].plurals[0] = "um chip de expansão para o Famicom, contendo um canal PCM pouco conhecido.";
    strings["12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1)1"].plurals[0] = "12xx: Definir ciclo de trabalho/modo de ruído (pulso: 0 a 3; ruído: 0 ou 1)";
    strings["an expansion chip for the Famicom, with full wavetable."].plurals[0] = "um chip de expansão para o Famicom, com vários canais de wavetable.";
    strings["18xx: Change channel limits (0 to 7, x + 1)"].plurals[0] = "18xx: Mudar limite de canais (0 a 7, x + 1)";
    strings["20xx: Load a waveform into memory"].plurals[0] = "20xx: Carregar uma forma de onda na memória";
    strings["21xx: Set position for wave load"].plurals[0] = "21xx: Definir posição para carregar onda na memória";
    strings["10xx: Select waveform"].plurals[0] = "10xx: Selecionar forma de onda";
    strings["11xx: Set waveform position in RAM"].plurals[0] = "11xx: Definir posição da forma de onda na RAM";
    strings["12xx: Set waveform length in RAM (04 to FC in steps of 4)"].plurals[0] = "12xx: Definir comprimento da forma de onda na RAM (04 a FC em incrementos de 4)";
    strings["15xx: Set waveform load position"].plurals[0] = "15xx: Definir posição de carregamento de forma de onda";
    strings["16xx: Set waveform load length (04 to FC in steps of 4)"].plurals[0] = "16xx: Definir comprimento do carregamento da forma de onda (04 a FC em incrementos de 4)";
    strings["17xx: Select waveform (local)1"].plurals[0] = "17xx: Selecionar forma de onda (local)";
    strings["cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)"].plurals[0] = "versão de custo reduzido do OPM com um leiaute de registradores diferentes e sem estéreo...\n...mas ele tem um AY-3-8910 embutido! (na verdade é um YM2149)";
    strings["Yamaha YM2203 (OPN) Extended Channel 3"].plurals[0] = "Yamaha YM2203 (OPN) com Canal 3 Estendido";
    strings["cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies"].plurals[0] = "versão de custo reduzido do OPM com um leiaute de registradores diferentes e sem estéreo...\n...mas ele tem um AY-3-8910 embutido! (na verdade é um YM2149)\nesse está em modo de Canal Estendido, que transforma o terceiro canal FM em quatro operadores com notas/frequências independentes.";
    strings["cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "versão de custo reduzido do OPM com um leiaute de registradores diferentes e sem estéreo...\n...mas ele tem um AY-3-8910 embutido! (na verdade é um YM2149)\nesse está em modo de Canal Estendido, que transforma o terceiro canal FM em quatro operadores com notas/frequências independentes.\nesse inclui controle do modo CSM para efeitos especiais no Canal 3.";
    strings["OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels."].plurals[0] = "OPN mas com o dobro dos canais FM, o estéreo está de volta e possui canais de bateria e um canal ADPCM.";
    strings["Yamaha YM2608 (OPNA) Extended Channel 3"].plurals[0] = "Yamaha YM2608 (OPNA) com Canal 3 Estendido";
    strings["OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies."].plurals[0] = "OPN mas com o dobro dos canais FM, o estéreo está de volta e possui canais de bateria e um canal ADPCM.\nesse está em modo de Canal Estendido, que transforma o terceiro canal FM em quatro operadores com notas/frequências independentes.";
    strings["Yamaha YM2608 (OPNA) Extended Channel 3 and CSM"].plurals[0] = "Yamaha YM2608 (OPNA) com Canal 3 Estendido e CSM";
    strings["OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "OPN mas com o dobro dos canais FM, o estéreo está de volta e possui canais de bateria e um canal ADPCM.\nesse está em modo de Canal Estendido, que transforma o terceiro canal FM em quatro operadores com notas/frequências independentes.\nesse inclui controle do modo CSM para efeitos especiais no Canal 3.";
    strings["OPN, but what if you only had two operators, no stereo, no detune and a lower ADSR parameter range?"].plurals[0] = "OPN, mas e se você só tivesse dois operadores, não tivesse estéreo, nem desafinação e tivesse um alcance menor nos parâmetros ADSR?"; // mas peraí, o OPN já não tinha estéreo pra começo de conversa!
    strings["OPL, but what if you had more waveforms to choose than the normal sine?"].plurals[0] = "OPL, mas e se você tivesse mais formas de onda pra escolher do que apenas o seno normal?";
    strings["OPL2, but what if you had twice the channels, 4-op mode, stereo and even more waveforms?"].plurals[0] = "OPL2, mas e se você tivesse o dobro de canais, modo de 4 operadores, estéreo e ainda mais formas de onda?";
    strings["how many channels of PCM do you want?\nMultiPCM: yes"].plurals[0] = "quantos canais de PCM você quer?\nMultiPCM: sim";
    strings["PC Speaker"].plurals[0] = "PC Speaker";
    strings["good luck! you get one square and no volume control."].plurals[0] = "boa sorte! você tem uma onda quadrada e nenhum controle de volume.";
    strings["please don't use this chip. it was added as a joke."].plurals[0] = "por favor não use esse chip. ele foi adicionado por causa de uma brincadeira.";
    strings["TIA, but better and more flexible.\nused in the Atari 8-bit family of computers (400/800/XL/XE)."].plurals[0] = "TIA, só que melhor e mais flexível.\nutilizado na família de computadores Atari 8-bit (400/800/XL/XE)."; // e no Atari 5200, né?
    strings["10xx: Set waveform (0 to 7)"].plurals[0] = "10xx: Definir forma de onda (0 a 7)";
    strings["11xx: Set AUDCTL"].plurals[0] = "11xx: Definir AUDCTL";
    strings["12xx: Toggle two-tone mode"].plurals[0] = "12xx: Alternar modo de dois tons";
    strings["13xx: Set raw period"].plurals[0] = "13xx: Definir período (val. registrador)";
    strings["14xx: Set raw period (higher byte; only for 16-bit mode)"].plurals[0] = "14xx: Definir byte superior do período (val. registrador) (somente para o modo 16-bit)";
    strings["this is like SNES' sound chip but without interpolation and the rest of nice bits."].plurals[0] = "esse é como o chip de som do SNES só que sem interpolação e o resto das coisas legais.";
    strings["developed by the makers of the Game Boy and the Virtual Boy..."].plurals[0] = "desenvolvido pelos criadores do Game Boy e do Virtual Boy...";
    strings["10xx: Set waveform5"].plurals[0] = "10xx: Definir forma de onda";
    strings["11xx: Setup noise mode (0: disabled; 1-8: enabled/tap)"].plurals[0] = "11xx: Configurar modo de ruído (0: desabilitado; 1-8: habilitado/tap)";
    strings["12xx: Setup sweep period (0: disabled; 1-20: enabled/period)"].plurals[0] = "12xx: Configurar período de sweep (0: desabilitado; 1-20: habilitado/período)";
    strings["13xx: Set sweep amount"].plurals[0] = "13xx: Definir quantidade de sweep";
    strings["17xx: Toggle PCM mode (LEGACY)3"].plurals[0] = "17xx: Alternar modo PCM (LEGADO)";
    strings["18xx: Set waveform (local)1"].plurals[0] = "18xx: Definir forma de onda (local)";
    strings["like OPM, but with more waveforms, fixed frequency mode and totally... undocumented.\nused in the Yamaha TX81Z and some other synthesizers."].plurals[0] = "como o OPM, mas com mais formas de onda, modo de frequência fixa e completamente... não documentado.\nutilizado no Yamaha TX81Z e alguns outros sintetizadores.";
    strings["2Fxx: Toggle hard envelope reset on new notes"].plurals[0] = "2Fxx: Alternar reinício brusco do envelope em novas notas";
    strings["this one is like PC Speaker but has duty cycles."].plurals[0] = "esse é parecido com o PC Speaker só que tem ciclos de trabalho.";
    strings["used in some Sega arcade boards (like OutRun), and usually paired with a YM2151."].plurals[0] = "utilizado em algumas placas de fliperama da Sega (como OutRun), e geralmente pareado com um YM2151 (OPM).";
    strings["a console which failed to sell well due to its headache-inducing features."].plurals[0] = "um console que foi um desastre de vendas por conta dos seus recursos que causavam dores de cabeça.";
    strings["10xx: Set waveform6"].plurals[0] = "10xx: Definir forma de onda";
    strings["11xx: Set noise length (0 to 7)"].plurals[0] = "11xx: Definir comprimento do ruído (0 a 7)";
    strings["12xy: Setup envelope (x: enabled/loop (1: enable, 3: enable+loop); y: speed/direction (0-7: down, 8-F: up))"].plurals[0] = "12xy: Definir envelope (x: habilitado/repetir (1: habilitado, 3: habilitado+repetir); y: velocidade/direção (0-7: para baixo, 8-F: para cima))";
    strings["13xy: Setup sweep (x: speed; y: shift; channel 5 only)"].plurals[0] = "13xy: Configurar sweep (x: velocidade; y: deslocamento; apenas no canal 5)";
    strings["14xy: Setup modulation (x: enabled/loop (1: enable, 3: enable+loop); y: speed; channel 5 only)"].plurals[0] = "14xy: Configurar modulação (x: habilitada/repetir (1: habilitada, 3: habilitada+repetir); y: velocidade; canal 5 somente)";
    strings["15xx: Set modulation waveform (x: wavetable; channel 5 only)"].plurals[0] = "15xx: Definir forma de onda de modulação (x: wavetable; canal 5 somente)";
    strings["16xx: Set waveform (local)1"].plurals[0] = "16xx: Definir forma de onda (local)";
    strings["like OPLL, but even more cost reductions applied. three less FM channels, and no drums mode..."].plurals[0] = "como o OPLL, mas com ainda mais reduções de custo aplicadas: três canais FM a menos, e sem o modo bateria...";
    strings["so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip."].plurals[0] = "então a Taito pediu à Yamaha se eles poderiam ter os 2 canais FM faltantes de volta, e a Yamaha lhes providenciou de bom grado com este chip.";
    strings["ZX Spectrum Beeper"].plurals[0] = "Beeper do ZX Spectrum";
    strings["the ZX Spectrum only had a basic beeper capable of...\n...a bunch of thin pulses and tons of other interesting stuff!\nFurnace provides a thin pulse system."].plurals[0] = "o ZX Spectrum só tinha um beeper básico capaz de...\n...um monte de pulsos finos e um monte de outras coisas interessantes!\nFurnace provê um sistema de pulsos finos.";
    strings["12xx: Set pulse width"].plurals[0] = "12xx: Definir largura de pulso";
    strings["17xx: Trigger overlay drum"].plurals[0] = "17xx: Disparar tambor sobreposto";
    strings["Yamaha YM2612 (OPN2) Extended Channel 3"].plurals[0] = "Yamaha YM2612 (OPN2) com Canal 3 Estendido";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies."].plurals[0] = "esse chip é mais conhecido por ter sido utilizado no Sega Mega Drive (mas ele também foi usado no computador FM Towns).\nesse está em modo de Canal Estendido, que transforma o terceiro canal FM em quatro operadores com notas/frequências independentes.";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "esse chip é mais conhecido por ter sido utilizado no Sega Mega Drive (mas ele também foi usado no computador FM Towns).\nesse inclui controle do modo CSM para efeitos especiais no Canal 3.";
    strings["a wavetable chip made by Konami for use with the MSX.\nthe last channel shares its wavetable with the previous one though."].plurals[0] = "um chip wavetable feito pela Konami para ser utilizado com o MSX.\no último canal compartilha sua wavetable com o anterior, porém.";
    strings["Yamaha YM3526 (OPL) with drums"].plurals[0] = "Yamaha YM3526 (OPL) em modo bateria";
    strings["the OPL chip but with drums mode enabled."].plurals[0] = "o chip OPL mas com modo bateria habilitado.";
    strings["Yamaha YM3812 (OPL2) with drums"].plurals[0] = "Yamaha YM3812 (OPL2) em modo bateria";
    strings["the OPL2 chip but with drums mode enabled."].plurals[0] = "o chip OPL2 mas com modo bateria habilitado.";
    strings["Yamaha YMF262 (OPL3) with drums"].plurals[0] = "Yamaha YMF262 (OPL3) em modo bateria";
    strings["the OPL3 chip but with drums mode enabled."].plurals[0] = "o chip OPL3 mas com modo bateria habilitado.";
    strings["this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing."].plurals[0] = "esse chip foi usado no Neo Geo, placa de fliperama e console de videogame da SNK.\né como o OPNA mas os canais de bateria são canais de ADPCM e dois canais de FM foram removidos.";
    strings["Yamaha YM2610 (OPNB) Extended Channel 2"].plurals[0] = "Yamaha YM2610 (OPNB) com Canal 2 Estendido";
    strings["this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies."].plurals[0] = "esse chip foi usado no Neo Geo, placa de fliperama e console de videogame da SNK.\né como o OPNA mas os canais de bateria são canais de ADPCM e dois canais de FM foram removidos.\nesse está em modo de Canal Estendido, que transforma o segundo canal FM em quatro operadores com notas/frequências independentes.";
    strings["this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 2."].plurals[0] = "esse chip foi usado no Neo Geo, placa de fliperama e console de videogame da SNK.\né como o OPNA mas os canais de bateria são canais de ADPCM e dois canais de FM foram removidos.\nesse está em modo de Canal Estendido, que transforma o segundo canal FM em quatro operadores com notas/frequências independentes.\nesse inclui controle do modo CSM para efeitos especiais no Canal 2.";
    strings["Yamaha YM2413 (OPLL) with drums"].plurals[0] = "Yamaha YM2413 (OPLL) em modo bateria";
    strings["the OPLL chip but with drums mode turned on."].plurals[0] = "o chip OPLL mas com modo bateria habilitado.";
    strings["3xxx: Load LFSR (0 to FFF)"].plurals[0] = "3xxx: Carregar LFSR (0 a FFF)";
    strings["a portable console made by Atari. it has all of Atari's trademark waveforms."].plurals[0] = "um console portátil feito pela Atari. ele possui todas as formas de onda conhecidíssimas dos consoles Atari.";
    strings["10xx: Set echo feedback level (00 to FF)"].plurals[0] = "10xx: Definir nível de retorno do Eco (00 a FF)";
    strings["11xx: Set channel echo level (00 to FF)"].plurals[0] = "11xx: Definir nível de eco do canal (00 a FF)";
    strings["12xx: Toggle QSound algorithm (0: disabled; 1: enabled)"].plurals[0] = "12xx: Alternar algoritmo QSound (0: desabilitado; 1: habilitado)";
    strings["3xxx: Set echo delay buffer length (000 to AA5)"].plurals[0] = "3xxx: Definir tamanho do buffer de atraso do eco (000 a AA5)";
    strings["used in some of Capcom's arcade boards. surround-like sampled sound with echo."].plurals[0] = "utilizado em algumas das placas de fliperama da Capcom. som amostrado estilo surround com eco.";
    strings["the chip used in a computer design created by The 8-Bit Guy."].plurals[0] = "o chip utilizado em um computador criado pelo The 8-Bit Guy.";
    strings["20xx: Set waveform"].plurals[0] = "20xx: Definir forma de onda";
    strings["22xx: Set duty cycle (0 to 3F)"].plurals[0] = "22xx: Definir ciclo de trabalho (0 a 3F)";
    strings["Yamaha YM2610B (OPNB2) Extended Channel 3"].plurals[0] = "Yamaha YM2610B (OPNB2) com Canal 3 Estendido";
    strings["so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies."].plurals[0] = "então a Taito pediu à Yamaha se eles poderiam ter os 2 canais FM faltantes de volta, e a Yamaha lhes providenciou de bom grado com este chip.\nesse está em modo de Canal Estendido, que transforma o terceiro canal FM em quatro operadores com notas/frequências independentes.";
    strings["so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "então a Taito pediu à Yamaha se eles poderiam ter os 2 canais FM faltantes de volta, e a Yamaha lhes providenciou de bom grado com este chip.\nesse está em modo de Canal Estendido, que transforma o terceiro canal FM em quatro operadores com notas/frequências independentes.\nesse inclui controle do modo CSM para efeitos especiais no Canal 3.";
    strings["SegaPCM (compatible 5-channel mode)"].plurals[0] = "SegaPCM (modo de compatibilidade de 5 canais)";
    strings["this is the same thing as SegaPCM, but only exposes 5 of the channels for compatibility with DefleMask."].plurals[0] = "esse é a mesma coisa que o SegaPCM, mas só expões 5 dos canais para compatibilidade com o DefleMask.";
    strings["a sound chip used in several Seta/Allumer-manufactured arcade boards with too many channels of wavetable sound, which also are capable of sampled sound."].plurals[0] = "um chip de som utilizado em várias placa de fliperama fabricadas pela Seta/Allumer, com muitos canais de wavetable que também são capazes de tocar samples.";
    strings["10xx: Set waveform7"].plurals[0] = "10xx: Definir forma de onda";
    strings["11xx: Set envelope shape"].plurals[0] = "11xx: Definir formato do envelope";
    strings["12xx: Set sample bank slot (0 to 7)"].plurals[0] = "12xx: Definir vaga do banco de samples (0 to 7)";
    strings["17xx: Toggle PCM mode (LEGACY)4"].plurals[0] = "17xx: Alternar modo PCM (LEGADO)";
    strings["18xx: Set waveform (local)2"].plurals[0] = "18xx: Definir forma de onda (local)";
    strings["20xx: Set PCM frequency (1 to FF)"].plurals[0] = "20xx: Definir frequência PCM (1 a FF)";
    strings["22xx: Set envelope mode (bit 0: enable; bit 1: one-shot; bit 2: split shape to L/R; bit 3/5: H.invert right/left; bit 4/6: V.invert right/left)"].plurals[0] = "22xx: Definir modo do envelope (bit 0: habilitar; bit 1: uma vez; bit 2: dividir formato para esquerda/direita; bit 3/5: inverter hor. direita/esquerda; bit 4/6: inverter vert. direita/esquerda)";
    strings["23xx: Set envelope period"].plurals[0] = "23xx: Definir período do envelope";
    strings["25xx: Envelope slide up1"].plurals[0] = "25xx: Slide de envelope para cima";
    strings["26xx: Envelope slide down1"].plurals[0] = "26xx: Slide de envelope para baixo";
    strings["29xy: Set auto-envelope (x: numerator; y: denominator)1"].plurals[0] = "29xy: Definir envelope automático (x: numerador; y: denominador)";
    strings["this is the wavetable part of the Bubble System, which also had two AY-3-8910s."].plurals[0] = "essa é a parte wavetable do Bubble System, que também possuía dois AY-3-8910.";
    strings["like OPL3, but this time it also has a 24-channel version of MultiPCM."].plurals[0] = "como o OPL3, mas dessa vez ele também possui uma versão de 24 canais do MultiPCM.";
    strings["Yamaha YMF278B (OPL4) with drums"].plurals[0] = "Yamaha YMF278B (OPL4) em modo bateria";
    strings["the OPL4 but with drums mode turned on."].plurals[0] = "o chip OPL4 mas com modo bateria habilitado.";
    strings["11xx: Set filter mode (00 to 03)"].plurals[0] = "11xx: Definir modo de filtro (00 to 03)";
    strings["14xx: Set filter coefficient K1 low byte (00 to FF)"].plurals[0] =   "14xx: Definir byte inferior do coeficiente do filtro K1 (00 a FF)";
    strings["15xx: Set filter coefficient K1 high byte (00 to FF)"].plurals[0] =  "15xx: Definir byte superior do coeficiente do filtro K1 (00 a FF)";
    strings["16xx: Set filter coefficient K2 low byte (00 to FF)"].plurals[0] =   "16xx: Definir byte inferior do coeficiente do filtro K2 (00 a FF)";
    strings["17xx: Set filter coefficient K2 high byte (00 to FF)"].plurals[0] =  "17xx: Definir byte superior do coeficiente do filtro K2 (00 a FF)";
    strings["18xx: Set filter coefficient K1 slide up (00 to FF)"].plurals[0] =   "18xx: Definir slide para cima do coeficiente do filtro K1 (00 a FF)";
    strings["19xx: Set filter coefficient K1 slide down (00 to FF)"].plurals[0] = "19xx: Definir slide para baixo do coeficiente do filtro K1 (00 a FF)";
    strings["1Axx: Set filter coefficient K2 slide up (00 to FF)"].plurals[0] =   "1Axx: Definir slide para cima do coeficiente do filtro K2 (00 a FF)";
    strings["1Bxx: Set filter coefficient K2 slide down (00 to FF)"].plurals[0] = "1Bxx: Definir slide para baixo do coeficiente do filtro K2 (00 a FF)";
    strings["22xx: Set envelope left volume ramp (signed) (00 to FF)"].plurals[0] = "22xx: Definir rampa de volume esquerdo do envelope (sinalizado) (00 a FF)";
    strings["23xx: Set envelope right volume ramp (signed) (00 to FF)"].plurals[0] = "23xx: Definir rampa de volume direito do envelope (sinalizado) (00 a FF)";
    strings["24xx: Set envelope filter coefficient k1 ramp (signed) (00 to FF)"].plurals[0] = "24xx: Definir rampa do coeficiente do filtro K1 (sinalizado) (00 a FF)";
    strings["25xx: Set envelope filter coefficient k1 ramp (signed, slower) (00 to FF)"].plurals[0] = "25xx: Definir rampa do coeficiente do filtro K1 (sinalizado, mais lento) (00 a FF)";
    strings["26xx: Set envelope filter coefficient k2 ramp (signed) (00 to FF)"].plurals[0] = "26xx: Definir rampa do coeficiente do filtro K2 (sinalizado) (00 a FF)";
    strings["27xx: Set envelope filter coefficient k2 ramp (signed, slower) (00 to FF)"].plurals[0] = "27xx: Definir rampa do coeficiente do filtro K2 (sinalizado, mais lento) (00 a FF)";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)1"].plurals[0] = "DFxx: Definir direção de reprodução da sample (0: normal; 1: reversa)";
    strings["120x: Set pause (bit 0)"].plurals[0] = "120x: Definir pausa (bit 0)";
    strings["2xxx: Set envelope count (000 to 1FF)"].plurals[0] = "2xxx: Definir contagem do envelope (000 a 1FF)";
    strings["3xxx: Set filter coefficient K1 (000 to FFF)"].plurals[0] = "3xxx: Definir coeficiente do filtro K1 (000 a FFF)";
    strings["4xxx: Set filter coefficient K2 (000 to FFF)"].plurals[0] = "4xxx: Definir coeficiente do filtro K2 (000 a FFF)";
    strings["a sample chip made by Ensoniq, which is the basis for the GF1 chip found in Gravis' Ultrasound cards."].plurals[0] = "um chip de sample feito pela Ensoniq, que é a base para o chip GF1 encontrado nas placas Gravis Ultrasound.";
    strings["like OPL but with an ADPCM channel."].plurals[0] = "como o OPL, mas com um canal ADPCM.";
    strings["Yamaha Y8950 with drums"].plurals[0] = "Yamaha Y8950 em modo bateria";
    strings["the Y8950 chip, in drums mode."].plurals[0] = "o chip Y8950 mas com modo bateria habilitado.";
    strings["this is a variant of Konami's SCC chip with the last channel's wavetable being independent."].plurals[0] = "essa é uma variante do chip Konami SCC com a wavetable do último canal sendo independente.";
    strings["10xx: Set waveform (0 to 7)1"].plurals[0] = "10xx: Definir waveform (0 a 7)";
    strings["12xx: Set pulse width (0 to 7F)"].plurals[0] = "12xx: Definir largura de pulso (0 a 7F)";
    strings["13xx: Set resonance (0 to FF)"].plurals[0] = "13xx: Definir ressonância (0 a FF)";
    strings["14xx: Set filter mode (bit 0: ring mod; bit 1: low pass; bit 2: high pass; bit 3: band pass)"].plurals[0] = "14xx: Definir modo de filtro (bit 0: modulação anel; bit 1: passa baixa; bit 2: passa alta; bit 3: passa banda)";
    strings["15xx: Set frequency sweep period low byte"].plurals[0] = "15xx: Definir byte inferior do período do sweep de frequência";
    strings["16xx: Set frequency sweep period high byte"].plurals[0] = "16xx: Definir byte superior do período de sweep de frequência";
    strings["17xx: Set volume sweep period low byte"].plurals[0] = "17xx: Definir byte inferior do período do sweep de volume";
    strings["18xx: Set volume sweep period high byte"].plurals[0] = "18xx: Definir byte superior do período do sweep de volume";
    strings["19xx: Set cutoff sweep period low byte"].plurals[0] = "19xx: Definir byte inferior do período do sweep de ponto de corte";
    strings["1Axx: Set cutoff sweep period high byte"].plurals[0] = "1Axx: Definir byte superior do período do sweep de ponto de corte";
    strings["1Bxx: Set frequency sweep boundary"].plurals[0] = "1Bxx: Definir limite do sweep de frequência";
    strings["1Cxx: Set volume sweep boundary"].plurals[0] = "1Cxx: Definir limite do sweep de volume";
    strings["1Dxx: Set cutoff sweep boundary"].plurals[0] = "1Dxx: Definir limite do sweep de ponto de corte";
    strings["1Exx: Set phase reset period low byte"].plurals[0] = "1Exx: Definir byte inferior do período de redefinição de fase";
    strings["1Fxx: Set phase reset period high byte"].plurals[0] = "1Fxx: Definir byte superior do período de redefinição de fase";
    strings["20xx: Toggle frequency sweep (bit 0-6: speed; bit 7: direction is up)"].plurals[0] = "20xx: Alternar sweep de frequência (bit 0-6: velocidade; bit 7: direção é para cima)";
    strings["21xx: Toggle volume sweep (bit 0-4: speed; bit 5: direction is up; bit 6: loop; bit 7: alternate)"].plurals[0] = "21xx: Alternar sweep de volume (bit 0-4: velocidade; bit 5: direção é para cima; bit 6: repetir; bit 7: alternar)";
    strings["22xx: Toggle cutoff sweep (bit 0-6: speed; bit 7: direction is up)"].plurals[0] = "22xx: Alternar sweep de ponto de corte (bit 0-6: velocidade; bit 7: direção é para cima)";
    strings["4xxx: Set cutoff (0 to FFF)"].plurals[0] = "4xxx: Definir ponto de corte (0 a FFF)";
    strings["tildearrow's fantasy sound chip. put SID, AY and VERA in a blender, and you get this!"].plurals[0] = "chip de som de fantasia do tildearrow. coloque o SID, AY e VERA num liquidificador, e você obtém isso!";
    strings["an ADPCM sound chip manufactured by OKI and used in many arcade boards."].plurals[0] = "um chip de som ADPCM fabricado pela OKI e utilizado em muitas placas de fliperama.";
    strings["20xx: Set chip output rate (0: clock/132; 1: clock/165)"].plurals[0] = "20xx: Definir taxa de amostragem do chip (0: clock/132; 1: clock/165)";
    strings["an ADPCM sound chip manufactured by OKI and used in the Sharp X68000."].plurals[0] = "um chip de som ADPCM fabricado pela OKI e utilizado no Sharp X68000.";
    strings["20xx: Set frequency divider (0-2)"].plurals[0] = "20xx: Definir divisor de frequência (0-2)";
    strings["21xx: Select clock rate (0: full; 1: half)"].plurals[0] = "21xx: Definir taxa de clock (0: 100%; 1: 50%)";
    strings["used in some arcade boards. Can play back either 4-bit ADPCM, 8-bit PCM or 16-bit PCM."].plurals[0] = "utilizado em algumas placas de fliperama. Pode tocar ADPCM 4-bit, PCM 8-bit ou PCM 16-bit.";
    strings["10xx: Set waveform8"].plurals[0] = "10xx: Definir forma de onda";
    strings["11xx: Select waveform (local)1"].plurals[0] = "11xx: Selecionar forma de onda (local)";
    strings["10xx: Set waveform9"].plurals[0] = "10xx: Definir forma de onda";
    strings["11xx: Toggle noise mode2"].plurals[0] = "11xx: Alternar modo de ruído";
    strings["a wavetable sound chip used in Pac-Man, among other early Namco arcade games."].plurals[0] = "um chip de som wavetable utilizado no fliperama Pac-Man, juntamente com outros dos primeiros fliperamas da Namco.";
    strings["successor of the original Namco WSG chip, used in later Namco arcade games."].plurals[0] = "sucessos do chip Namco WSG original, utilizado em fliperamas Namco posteriores.";
    strings["like Namco C15 but with stereo sound."].plurals[0] = "similar ao Namco C15 mas com som estéreo.";
    strings["a square wave additive synthesis chip made by OKI. used in some arcade machines and instruments."].plurals[0] = "um chip de síntese aditiva de ondas quadradas feito pela OKI. utilizado em algumas máquinas de fliperama e instrumentos..";
    strings["10xy: Set group control (x: sustain; y: part toggle bitmask)"].plurals[0] = "10xy: Definir controle de grupo (x: sustentação; y: máscara de bits para alternar partes)"; // TODO refinar?
    strings["11xx: Set noise mode"].plurals[0] = "11xx: Definir modo de ruído"; 
    strings["12xx: Set group attack (0 to 5)"].plurals[0] = "12xx: Definir ataque do grupo (0 a 5)";
    strings["13xx: Set group decay (0 to 11)"].plurals[0] = "13xx: Definir decaimento do grupo (0 a 11)";
    strings["Yamaha YM2612 (OPN2) with DualPCM"].plurals[0] = "Yamaha YM2612 (OPN2) com DualPCM";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis system uses software mixing to provide two sample channels."].plurals[0] = "esse chip é mais conhecido por ter sido utilizado no Sega Mega Drive (mas ele também foi usado no computador FM Towns).\nesse sistema utiliza mistura de samples em software para prover dois canais de sample.";
    strings["Yamaha YM2612 (OPN2) Extended Channel 3 with DualPCM and CSM"].plurals[0] = "Yamaha YM2612 (OPN2) Extended Channel 3 com DualPCM e CSM";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis system uses software mixing to provide two sample channels.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "esse chip é mais conhecido por ter sido utilizado no Sega Mega Drive (mas ele também foi usado no computador FM Towns).\nesse sistema utiliza mistura de samples em software para prover dois canais de sample.\nesse está em modo de Canal Estendido, que transforma o terceiro canal FM em quatro operadores com notas/frequências independentes.\nesse inclui controle do modo CSM para efeitos especiais no Canal 3.";
    strings["an SN76489 derivative used in Neo Geo Pocket, has independent stereo volume and noise channel frequency."].plurals[0] = "uma derivativa do SN76489 utilizada no Neo Geo Pocket que possui volume estéreo independente e frequência independente para o canal de ruído.";
    strings["20xx: Set noise length (0: short, 1: long)"].plurals[0] = "20xx: Definir comprimento do ruído (0: curto, 1: longo)";
    strings["Generic PCM DAC"].plurals[0] = "DAC PCM Genérico";
    strings["as generic sample playback as it gets."].plurals[0] = "simplesmente reprodução de samples, o mais genérico possível.";
    strings["this PCM chip was widely used at Konami arcade boards in 1986-1990."].plurals[0] = "esse chip PCM foi amplamente utilizado em placas de fliperama da Konami entre 1986 e 1990.";
    strings["yet another PCM chip from Irem. like Amiga, but less pitch resolution and no sample loop."].plurals[0] = "mais um chip PCM da Irem. similar ao Amiga, mas com menos resolução de tom e sem repetição de samples.";
    strings["a SoC with wavetable sound hardware."].plurals[0] = "um SoC com hardware de som wavetable.";
    strings["a game console with 3 channels of square wave. it's what happens after fusing TIA and VIC together."].plurals[0] = "um console de jogo com 3 canais de onda quadrada. é o que acontece quando se funde a TIA e o VIC juntos.";
    strings["10xx: Set ring modulation (0: disable, 1: enable)"].plurals[0] = "10xx: Alternar modulação anel (0: desabilitar, 1: habilitar)";
    strings["11xx: Raw frequency (0-3E)"].plurals[0] = "11xx: Definir frequência (valor do registrador, 0-3E)";
    strings["ZX Spectrum Beeper (QuadTone Engine)"].plurals[0] = "Beeper do ZX Spectrum (Motor QuadTone)";
    strings["another ZX Spectrum beeper system with full PWM pulses and 3-level volume per channel. it also has a pitchable overlay sample channel."].plurals[0] = "outro sistema de beeper do ZX Spectrum, dessa vez com pulsos PWM completos e volume de 3 níveis por canal. ele também possui um canal de sobreposição de sample com tom controlável.";
    strings["12xx: Set pulse width1"].plurals[0] = "12xx: Definir largura de pulso";
    strings["this PCM chip was widely used at Konami arcade boards in 1990-1992."].plurals[0] = "esse chip PCM foi largamente utilizado em placas de fliperama da Konami entre 1990 e 1992.";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)2"].plurals[0] = "DFxx: Definir direção de reprodução da sample (0: normal; 1: reversa)";
    strings["two square waves (one may be turned into noise). used in the Commodore Plus/4, 16 and 116."].plurals[0] = "duas ondas quadradas (uma pode ser transformada em ruído). utilizado no Commodore Plus/4, 16 e 116.";
    strings["Namco's first PCM chip from 1987. it's pretty good for being so."].plurals[0] = "o primeiro chip PCM da Namco de 1987. é muito bom pelo que é.";
    strings["Namco's PCM chip used in their NA-1/2 hardware.\nvery similar to C140, but has noise generator."].plurals[0] = "chip de som PCM da Namco utilizado em suas placas de fliperama NA-1/2.\nmuito similar ao C140, porém contém um gerador de ruído.";
    strings["11xx: Set noise mode1"].plurals[0] = "11xx: Definir modo de ruído";
    strings["12xy: Set invert mode (x: surround; y: invert)"].plurals[0] = "12xy: Definir modo de inversão (x: surround; y: inverter)";
    strings["ESS ES1xxx series (ESFM)"].plurals[0] = "ESS série ES1xxx (ESFM)";
    strings["a unique FM synth featured in PC sound cards.\nbased on the OPL3 design, but with lots of its features extended."].plurals[0] = "um sintetizador FM único encontrado em placas de som de PC.\nbaseado no design do OPL3, mas com muitos de seus recursos estendidos."; // :3
    strings["2Exx: Toggle hard envelope reset on new notes"].plurals[0] = "2Exx: Alternar reinício brusco do envelope em novas notas";
    strings["first Ensoniq chip used in their synths and Apple IIGS computer. Has 32 hard-panned 8-bit wavetable/sample channels, can do oscillator sync (like SID) and amplitude modulation. Can have up to 128 KiB (2 banks of 64 KiB) of memory for wavetables/samples.\nAs Robert Yannes (SID chip creator) said, it's more or less what SID chip could be if he was given enough time for its development."].plurals[0] = "o primeiro chip da Ensoniq utilizado em seus sintetizadores e no computador Apple IIGS. Contém 32 canais de sample/wavetable 8-bit com balanço binário, é capaz de sincronizar osciladores (como o SID) e realizar modulação de amplitude. Pode endereçar até 128 KiB (2 bancos de 64 KiB) de memória para wavetables/samples.\nComo Robert Yannes (criador do chip SID) disse, é mais ou menos o que o chip SID poderia ter sido se ele tivesse tido tempo suficiente para o seu desenvolvimento.";
    strings["11xx: Set number of enabled oscillators (2-1F)"].plurals[0] = "11xx: Definir número de osciladores habilitados (2-1F)";
    strings["12xx: Set oscillator output (0-7, 0=left, 1=right)"].plurals[0] = "12xx: Definir saída do oscilador (0-7, 0=esquerda, 1=direita)";
    strings["13xx: Set wave/sample length (0-7, 0=256, 1=512, 2=1024, etc.)"].plurals[0] = "13xx: Definir tamanho da onda/sample (0-7, 0=256, 1=512, 2=1024, etc.)";
    strings["14xx: Set wave/sample position in memory (xx*256 offset)"].plurals[0] = "14xx: Definir posição na memória da onda/sample (deslocamento em xx*256)";
    strings["15xx: Set oscillator mode (0-3)"].plurals[0] = "15xx: Definir modo do oscilador (0-3)";
    strings["a fantasy sound chip designed by jvsTSX and The Beesh-Spweesh!\nused in the Hexheld fantasy console."].plurals[0] = "um chip de som fantasia desenvolvido por jvsTSX e The Beesh-Spweesh!\nutilizado no console fantasia Hexheld.";
    strings["20xx: Load low byte of noise channel LFSR (00 to FF) or slope channel accumulator (00 to 7F)"].plurals[0] = "20xx: Carregar byte inferior do LFSR do canal de ruído (00 a FF) ou acumulador do canal de rampa (00 a 7F)";
    strings["21xx: Load high byte of noise channel LFSR (00 to FF)"].plurals[0] = "21xx: Carregar byte superior do LFSR do canal de ruído (00 to FF)";
    strings["22xx: Write to I/O port A"].plurals[0] = "22xx: Escrever na porta E/S A";
    strings["23xx: Write to I/O port B"].plurals[0] = "23xx: Escrever na porta E/S B";
    strings["this chip was featured in the Enterprise 128 computer. it is similar to POKEY, but with stereo output, more features and frequency precision and the ability to turn left or right (or both) channel into a 6-bit DAC for sample playback."].plurals[0] = "esse chip foi utilizado no computador Enterprise 128. ele é similar ao POKEY, mas com saída estéreo, mais recursos, mais precisão de frequência e com a possibilidade de transformar o canal esquerdo, direito ou ambos em um DAC 6-bit para reprodução de samples.";
    strings["10xx: Set waveform (0 to 4; 0 to 3 on noise)"].plurals[0] = "10xx: Definir forma de onda (0 a 4; 0 a 3 no canal de ruído)";
    strings["11xx: Set noise frequency source (0: fixed; 1-3: channels 1 to 3)"].plurals[0] = "11xx: Definir fonte da frequência do ruído (0: fixa; 1-3: canais 1 a 3)";
    strings["12xx: Toggle high-pass with next channel"].plurals[0] = "12xx: Alternar passa alta com o próximo canal";
    strings["13xx: Toggle ring modulation with channel+2"].plurals[0] = "13xx: Alternar modulação anel com o canal+2";
    strings["14xx: Toggle swap counters (noise only)"].plurals[0] = "14xx: Alternar trocar contadores (somente ruído)";
    strings["15xx: Toggle low pass (noise only)"].plurals[0] = "15xx: Alternar passa baixa (somente ruído)";
    strings["16xx: Set clock divider (0: /2; 1: /3)"].plurals[0] = "16xx: Definir divisor de clock (0: /2; 1: /3)";
    strings["a fictional sound chip by LTVA. like SID, but with many of its problems fixed. also features extended functionality like more wave mixing modes, tonal noise, filter and volume per channel."].plurals[0] = "um chip de som fictício por LTVA. como o SID, mas com muitos de seus problemas consertados. também possui recursos estendidos como mais modos de mistura de formas de onda, ruído tonal, filtro e volume por canal.";
    strings["a fictional sound chip by Euly. similar to Ricoh 2A03, but all the duty cycles are different, noise has 32 pitches instead of 16 and you have four hard-coded waveforms on triangle channel."].plurals[0] = "um chip de som fictício por Euly. similar ao Ricoh 2A03, mas todos os ciclos de trabalho são diferentes, o ruído tem 32 tons ao invés de 16 e você possui 4 formas de onda predefinidas no lugar do canal de triângulo.";
    strings["12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1, wave: 0 to 3)"].plurals[0] = "12xx: Definir ciclo de trabalho/modo de ruído/onda (pulso: 0 a 3; ruído: 0 ou 1, onda: 0 a 3)";
    strings["19xx: Set wave linear counter (0 to 7F; 80 and higher halt)"].plurals[0] = "19xx: Definir contador linear do canal de onda (0 a 7F; valores 80 e superiores interrompem)";
    strings["additional PCM FIFO channels in Game Boy Advance driven directly by its DMA hardware."].plurals[0] = "canais PCM FIFO adicionais no Game Boy Advance controlados diretamente por seu hardware de DMA.";
    strings["additional PCM FIFO channels in Game Boy Advance driven by software mixing to provide up to sixteen sample channels."].plurals[0] = "canais PCM FIFO adicionais no Game Boy Advance controlados por mixing em software para prover até 16 canais de sample.";
    strings["11xy: Set echo channel (x: left/right source; y: delay (0 disables))"].plurals[0] = "11xy: Definir canal de eco (x: fonte esquerda/direita; y: atraso (0 desabilita))";
    strings["12xy: Toggle invert (x: left; y: right)"].plurals[0] = "12xy: Alternar inversão (x: lado esquerdo; y: lado direito)";
    strings["a handheld video game console with two screens. it uses a stylus."].plurals[0] = "um console de videogame portátil com duas telas. ele usa uma canetinha.";
    strings["12xx: Set duty cycle (pulse: 0 to 7)"].plurals[0] = "12xx: Definir ciclo de trabalho (pulso: 0 a 7)";
    strings["1Fxx: Set global volume (0 to 7F)"].plurals[0] = "1Fxx: Definir volume global (0 a 7F)";
    strings["Dummy System"].plurals[0] = "Sistema Fantoche"; // TODO: Sistema Fictício seria melhor? acho muito literal...
    strings["this is a system designed for testing purposes."].plurals[0] = "este é um sistema desenvolvido para propósito de testes.";
    
    //channel names

    strings["Channel 1"].plurals[0] =  "Canal 1";
    strings["Channel 2"].plurals[0] =  "Canal 2";
    strings["Channel 3"].plurals[0] =  "Canal 3";
    strings["Channel 4"].plurals[0] =  "Canal 4";
    strings["Channel 5"].plurals[0] =  "Canal 5";
    strings["Channel 6"].plurals[0] =  "Canal 6";
    strings["Channel 7"].plurals[0] =  "Canal 7";
    strings["Channel 8"].plurals[0] =  "Canal 8";
    strings["Channel 9"].plurals[0] =  "Canal 9";
    strings["Channel 10"].plurals[0] = "Canal 10";
    strings["Channel 11"].plurals[0] = "Canal 11";
    strings["Channel 12"].plurals[0] = "Canal 12";
    strings["Channel 13"].plurals[0] = "Canal 13";
    strings["Channel 14"].plurals[0] = "Canal 14";
    strings["Channel 15"].plurals[0] = "Canal 15";
    strings["Channel 16"].plurals[0] = "Canal 16";
    strings["Channel 17"].plurals[0] = "Canal 17";
    strings["Channel 18"].plurals[0] = "Canal 18";
    strings["Channel 19"].plurals[0] = "Canal 19";
    strings["Channel 20"].plurals[0] = "Canal 20";
    strings["Channel 21"].plurals[0] = "Canal 21";
    strings["Channel 22"].plurals[0] = "Canal 22";
    strings["Channel 23"].plurals[0] = "Canal 23";
    strings["Channel 24"].plurals[0] = "Canal 24";
    strings["Channel 25"].plurals[0] = "Canal 25";
    strings["Channel 26"].plurals[0] = "Canal 26";
    strings["Channel 27"].plurals[0] = "Canal 27";
    strings["Channel 28"].plurals[0] = "Canal 28";
    strings["Channel 29"].plurals[0] = "Canal 29";
    strings["Channel 30"].plurals[0] = "Canal 30";
    strings["Channel 31"].plurals[0] = "Canal 31";
    strings["Channel 32"].plurals[0] = "Canal 32";

    strings["Square"].plurals[0] = "Quadrado";

    strings["Square 1"].plurals[0] = "Quadrado 1";
    strings["Square 2"].plurals[0] = "Quadrado 2";
    strings["Square 3"].plurals[0] = "Quadrado 3";

    strings["Pulse"].plurals[0] = "Pulso";

    strings["Pulse 1"].plurals[0] = "Pulso 1";
    strings["Pulse 2"].plurals[0] = "Pulso 2";

    strings["Wave"].plurals[0] = "Onda";
    strings["Wavetable"].plurals[0] = "Wavetable";

    strings["Triangle"].plurals[0] = "Triângulo";

    strings["PCM"].plurals[0] = "PCM";

    strings["PCM 1"].plurals[0] =  "PCM 1";
    strings["PCM 2"].plurals[0] =  "PCM 2";
    strings["PCM 3"].plurals[0] =  "PCM 3";
    strings["PCM 4"].plurals[0] =  "PCM 4";
    strings["PCM 5"].plurals[0] =  "PCM 5";
    strings["PCM 6"].plurals[0] =  "PCM 6";
    strings["PCM 7"].plurals[0] =  "PCM 7";
    strings["PCM 8"].plurals[0] =  "PCM 8";
    strings["PCM 9"].plurals[0] =  "PCM 9";
    strings["PCM 10"].plurals[0] = "PCM 10";
    strings["PCM 11"].plurals[0] = "PCM 11";
    strings["PCM 12"].plurals[0] = "PCM 12";
    strings["PCM 13"].plurals[0] = "PCM 13";
    strings["PCM 14"].plurals[0] = "PCM 14";
    strings["PCM 15"].plurals[0] = "PCM 15";
    strings["PCM 16"].plurals[0] = "PCM 16";
    strings["PCM 17"].plurals[0] = "PCM 17";
    strings["PCM 18"].plurals[0] = "PCM 18";
    strings["PCM 19"].plurals[0] = "PCM 19";
    strings["PCM 20"].plurals[0] = "PCM 20";
    strings["PCM 21"].plurals[0] = "PCM 21";
    strings["PCM 22"].plurals[0] = "PCM 22";
    strings["PCM 23"].plurals[0] = "PCM 23";
    strings["PCM 24"].plurals[0] = "PCM 24";

    strings["DPCM"].plurals[0] = "DPCM";

    strings["ADPCM"].plurals[0] = "ADPCM";

    strings["ADPCM 1"].plurals[0] = "ADPCM 1";
    strings["ADPCM 2"].plurals[0] = "ADPCM 2";
    strings["ADPCM 3"].plurals[0] = "ADPCM 3";

    strings["ADPCM-A 1"].plurals[0] = "ADPCM-A 1";
    strings["ADPCM-A 2"].plurals[0] = "ADPCM-A 2";
    strings["ADPCM-A 3"].plurals[0] = "ADPCM-A 3";
    strings["ADPCM-A 4"].plurals[0] = "ADPCM-A 4";
    strings["ADPCM-A 5"].plurals[0] = "ADPCM-A 5";
    strings["ADPCM-A 6"].plurals[0] = "ADPCM-A 6";

    strings["ADPCM-B"].plurals[0] = "ADPCM-B";

    strings["Sample"].plurals[0] = "Sample";

    strings["DAC Left"].plurals[0] = "DAC Esquerdo";
    strings["DAC Right"].plurals[0] = "DAC Direito";

    strings["Noise"].plurals[0] = "Ruído";

    strings["Noise 1"].plurals[0] = "Ruído 1";
    strings["Noise 2"].plurals[0] = "Ruído 2";
    strings["Noise 3"].plurals[0] = "Ruído 3";

    strings["Slope"].plurals[0] = "Rampa";

    strings["FM 6/PCM 1"].plurals[0] = "FM 6/PCM 1";
    strings["CSM Timer"].plurals[0] = "Timer CSM";

    strings["VRC6 Saw"].plurals[0] = "Serra VRC6";

    strings["4OP 1"].plurals[0] = "4OP 1";
    strings["4OP 3"].plurals[0] = "4OP 3";
    strings["4OP 5"].plurals[0] = "4OP 5";
    strings["4OP 7"].plurals[0] = "4OP 7";
    strings["4OP 9"].plurals[0] = "4OP 9";
    strings["4OP 11"].plurals[0] = "4OP 11";

    strings["Kick/FM 7"].plurals[0] = "Bumbo/FM 7";
    strings["Kick/FM 16"].plurals[0] = "Bumbo/FM 16";
    strings["Kick"].plurals[0] = "Bumbo";
    strings["Snare"].plurals[0] = "Caixa";
    strings["Top"].plurals[0] = "Prato";
    strings["HiHat"].plurals[0] = "Chimbal";
    strings["Tom"].plurals[0] = "Surdo";
    strings["Rim"].plurals[0] = "Aro";

    // channel short names

    strings["CH1"].plurals[0] = "CN1";
    strings["CH2"].plurals[0] = "CN2";
    strings["CH3"].plurals[0] = "CN3";
    strings["CH4"].plurals[0] = "CN4";
    strings["CH5"].plurals[0] = "CN5";
    strings["CH6"].plurals[0] = "CN6";
    strings["CH7"].plurals[0] = "CN7";
    strings["CH8"].plurals[0] = "CN8";
    strings["CH9"].plurals[0] = "CN9";

    strings["NO"].plurals[0] = "RU";
    strings["N1"].plurals[0] = "R1";
    strings["N2"].plurals[0] = "R2";
    strings["N3"].plurals[0] = "R3";

    strings["SL"].plurals[0] = "RA";

    strings["S1"].plurals[0] = "Q1";
    strings["S2"].plurals[0] = "Q2";
    strings["S3"].plurals[0] = "Q3";
    strings["S4"].plurals[0] = "Q4";
    strings["S5"].plurals[0] = "Q5";
    strings["S6"].plurals[0] = "Q6";

    strings["P1"].plurals[0] = "S1";
    strings["P2"].plurals[0] = "S2";
    strings["P3"].plurals[0] = "S3";
    strings["P4"].plurals[0] = "S4";
    strings["P5"].plurals[0] = "S5";
    strings["P6"].plurals[0] = "S6";
    strings["P7"].plurals[0] = "S7";
    strings["P8"].plurals[0] = "S8";
    strings["P9"].plurals[0] = "S9";
    strings["P10"].plurals[0] = "S10";
    strings["P11"].plurals[0] = "S11";
    strings["P12"].plurals[0] = "S12";
    strings["P13"].plurals[0] = "S13";
    strings["P14"].plurals[0] = "S14";
    strings["P15"].plurals[0] = "S15";
    strings["P16"].plurals[0] = "S16";
    strings["P17"].plurals[0] = "S17";
    strings["P18"].plurals[0] = "S18";
    strings["P19"].plurals[0] = "S19";
    strings["P20"].plurals[0] = "S20";
    strings["P21"].plurals[0] = "S21";
    strings["P22"].plurals[0] = "S22";
    strings["P23"].plurals[0] = "S23";
    strings["P24"].plurals[0] = "S24";

    strings["BD"].plurals[0] = "BU";
    strings["SD"].plurals[0] = "CX";
    strings["TP"].plurals[0] = "PR";
    strings["HH"].plurals[0] = "CH";
    strings["TM"].plurals[0] = "SU";
    strings["RM"].plurals[0] = "AR";

    strings["P"].plurals[0] = "S";

    strings["VS"].plurals[0] = "VS";

    strings["TR"].plurals[0] = "TR";
    strings["DMC"].plurals[0] = "DMC";

    strings["WA"].plurals[0] = "ON";
}
