...
void DivLocale::addTranslationsPortuguese()
{
    ...
    strings["Pat##sgch"].plurals[0] = "Mat"; // TODO: pensar em uma tradução melhor
    strings["Osc##sgch"].plurals[0] = "Osc";
    strings["Swap##sgch"].plurals[0] = "Trocar";
    strings["Name##sgch"].plurals[0] = "Nome";
    strings["Show in pattern##sgch"].plurals[0] = "Mostrar na matriz"; // TODO: pensar em uma tradução melhor
