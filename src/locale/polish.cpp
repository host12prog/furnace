...
void DivLocale::addTranslationsPolish()
{
    ...
    strings["Follow##sgec0"].plurals[0] = "Podązaj za postępem odtwarzania";
    ...
    strings["Follow##sgec1"].plurals[0] = "Podążaj za postępem odtwarzania";
    ...
    strings["Foll.##sgec"].plurals[0] = "Podążaj";
