...
//   sgcs  src/gui/csPlayer.cpp
    ...
    strings["Load##sgcs"].plurals[0] = "Wczytaj";
    strings["Kill##sgcs"].plurals[0] = "Zniszcz";
    strings["Burn Current Song##sgcs"].plurals[0] = "Wypal obecny utwór";
    ...
    strings["%s: maximum sample rate is %d"].plurals[0] = "%s: maksymalna częstotliwość samplowania to %d";
    strings["%s: minimum sample rate is %d"].plurals[0] = "%s: minimalna częstotliwość samplowania to %d";
    strings["%s: sample rate must be %d"].plurals[0] = "%s: częstotliwość samplowania musi wynosić %d";
    strings["Sample Editor###Sample Editor"].plurals[0] = "Edytor sampli###Sample Editor";
    strings["no sample selected"].plurals[0] = "nie wybrano sampla";
    strings["select one..."].plurals[0] = "wybierz jeden...";
    strings["or##sgsed0"].plurals[0] = "albo";
    strings["Open##sgsed0"].plurals[0] = "Otwórz";
    strings["or##sgsed1"].plurals[0] = "albo";
    strings["Create New"].plurals[0] = "Stwórz nowy";
    strings["Invalid##sgsed0"].plurals[0] = "Niepoprawny.";
    strings["Invalid##sgsed1"].plurals[0] = "Niepoprawny.";
    strings["%d: %s"].plurals[0] = "%d: %s";
    strings["Open##sgsed1"].plurals[0] = "Otwórz";
    strings["import raw..."].plurals[0] = "importj dane surowe...";
    strings["Save"].plurals[0] = "zapisz";
    strings["save raw..."].plurals[0] = "zapisz dane surowe...";
    strings["Name"].plurals[0] = "nazwa";
    strings["SNES: loop start must be a multiple of 16 (try with %d)"].plurals[0] = "SNES: początek pętli musi być wielokrotnością 16 (spróbuj %d)";
    strings["SNES: loop end must be a multiple of 16 (try with %d)"].plurals[0] = "SNES: koniec pętli musi być wielokrotnością 16 (spróbuj %d)";
    strings["SNES: sample length will be padded to multiple of 16"].plurals[0] = "SNES: długość sampla zostanie dostosowana do wielokrotności 16";
    strings["QSound: loop cannot be longer than 32767 samples"].plurals[0] = "QSound: pętla nie może być dłuższa niż 32767 sampli";
    strings["QSound: maximum sample length is 65535"].plurals[0] = "QSound: maksymalna długość sampla: 65535";
	strings["NES: loop start must be a multiple of 512 (try with %d)"].plurals[0] = "NES: początek pętli musi być wielokrotnością 512 (spróbuj %d)";
    strings["NES: loop point ignored on DPCM (may only loop entire sample)"].plurals[0] = "NES: punkt pętli jest ignorowany dla sampli DPCM (tylko cały sampel może być zapętlony)";
    strings["NES: maximum DPCM sample length is 32648"].plurals[0] = "NES: maksymalna długość sampla DPCM wynosi 32648";
    strings["X1-010: samples can't loop"].plurals[0] = "X1-010: zapętlanie sampli niewspierane";
    strings["X1-010: maximum sample length is 131072"].plurals[0] = "X1-010: maksymalna długość sampla wynosi 131072";
    strings["GA20: samples can't loop"].plurals[0] = "GA20: zapętlanie sampli niewspierane";
    strings["YM2608: loop point ignored on ADPCM (may only loop entire sample)"].plurals[0] = "YM2608: punkt pętli jest ignorowany dla ADPCM (tylko cały sampel może być zapętlony)";
    strings["YM2608: sample length will be padded to multiple of 512"].plurals[0] = "YM2608: długość sampla zostanie dostosowana do wielokrotności 512";
    strings["YM2610: ADPCM-A samples can't loop"].plurals[0] = "YM2610: ADPCM-A zapętlanie sampli niewspierane";
    strings["YM2610: loop point ignored on ADPCM-B (may only loop entire sample)"].plurals[0] = "YM2610: punkt pętli jest ignorowany dla ADPCM-B (tylko cały sampel może być zapętlony)";
    strings["YM2610: sample length will be padded to multiple of 512"].plurals[0] = "YM2610: długość sampla zostanie dostosowana do wielokrotności 512";
    strings["YM2610: maximum ADPCM-A sample length is 2097152"].plurals[0] = "YM2610: maksymalna długość sampla ADPCM-A  wynosi 2097152";
    strings["Y8950: loop point ignored on ADPCM (may only loop entire sample)"].plurals[0] = "Y8950: punkt pętli jest ignorowany dla ADPCM (tylko cały sampel może być zapętlony)";
    strings["Y8950: sample length will be padded to multiple of 512"].plurals[0] = "Y8950: długość sampla zostanie dostosowana do wielokrotności 512";
    strings["Amiga: loop start must be a multiple of 2"].plurals[0] = "Amiga: początek pętli musi być wielokrotnością 2";
    strings["Amiga: loop end must be a multiple of 2"].plurals[0] = "Amiga: koniec pętli musi być wielokrotnością 2";
    strings["Amiga: maximum sample length is 131070"].plurals[0] = "Amiga: maksymalna długość sampla wynosi 131070";
    strings["SegaPCM: maximum sample length is 65280"].plurals[0] = "SegaPCM: maksymalna długość sampla wynosi 65280";
    strings["K053260: loop point ignored (may only loop entire sample)"].plurals[0] = "K053260: punkt pętli jest ignorowany (tylko cały sampel może być zapętlony)";
    strings["K053260: maximum sample length is 65535"].plurals[0] = "K053260: maksymalna długość sampla wynosi 65535";
    strings["C140: maximum sample length is 65535"].plurals[0] = "C140: maksymalna długość sampla wynosi 65535";
    strings["C219: loop start must be a multiple of 2"].plurals[0] = "C219: początek pętli musi być wielokrotnością 2";
    strings["C219: loop end must be a multiple of 2"].plurals[0] = "C219: koniec pętli musi być wielokrotnością 2";
    strings["C219: maximum sample length is 131072"].plurals[0] = "C219: maksymalna długość sampla wynosi 131072";
    strings["MSM6295: samples can't loop"].plurals[0] = "MSM6295: zapętlanie sampli niewspierane";
    strings["MSM6295: maximum bankswitched sample length is 129024"].plurals[0] = "MSM6295: maksymalna długość sampla przy zmianie banków wynosi 129024";
    strings["GBA DMA: loop start must be a multiple of 4"].plurals[0] = "GBA DMA: punkt początku pętli musi być wielokrotnością 4";
    strings["GBA DMA: loop length must be a multiple of 16"].plurals[0] = "GBA DMA: dłogość pętli musi być wielokrotnością 16";
    strings["GBA DMA: sample length will be padded to multiple of 16"].plurals[0] = "GBA DMA: długość sampla zostanie przeskalowana do wielokrotności 16";
    strings["ES5506: backward loop mode isn't supported"].plurals[0] = "ES5506: tryb pętli odwrotnej nie jest obsługiwany";
    strings["backward/ping-pong only supported in Generic PCM DAC\nping-pong also on ES5506"].plurals[0] = "Tryb odwrócony jest obsługiwany tylko przez uniwersalny przetwornik C/A, a także przez ES5506.";
    strings["Info"].plurals[0] = "Info";
    strings["Rate##sgsed0"].plurals[0] = "Częstotliwość";
    strings["Compat Rate"].plurals[0] = "Kompat. częstotliwość";
    strings["used in DefleMask-compatible sample mode (17xx), in where samples are mapped to an octave."].plurals[0] = "jest używana podczas odtwarzania w trybie zgodności z DefleMaskiem (17xx), w którym sample odpowiadają oktawie.";
    strings["Loop"].plurals[0] = "Pętla";
    strings["Loop (length: %d)##Loop"].plurals[0] = "Pętla (długość: %d)##Loop";
    strings["changing the loop in a BRR sample may result in glitches!##sgsed0"].plurals[0] = "zmiana pętli sampla BRR może powodować problemy!";
    strings["Chips"].plurals[0] = "Układy";
    strings["Type"].plurals[0] = "Typ";
    strings["BRR emphasis"].plurals[0] = "Przetwarzanie końcowe BRR";
    strings["this is a BRR sample.\nenabling this option will muffle it (only affects non-SNES chips)."].plurals[0] = "jest to sampel BRR.\nwłączenie tej funkcji przytłumi go (na wszystkich układach poza SNES).";
    strings["enable this option to slightly boost high frequencies\nto compensate for the SNES' Gaussian filter's muffle."].plurals[0] = "włącz tę opcję, aby lekko podbić wysokie częstotliwości.\naby skompensować filtrowanie interpolacji gaussowskiej, które powoduje, że sampel jest stłumiony.";
    strings["8-bit dither"].plurals[0] = "8-bitowy dithering";
    strings["dither the sample when used on a chip that only supports 8-bit samples."].plurals[0] = "dithering sampla, gdy jest on używany na układzie obsługującym tylko 8-bitowe sample.";
	strings["Hz"].plurals[0] = "Hz";
	strings["Note"].plurals[0] = "Nuta";
    strings["%s"].plurals[0] = "%s";
    strings["Fine"].plurals[0] = "Rozstrojenie";
    strings["Mode"].plurals[0] = "Tryb";
    strings["Start"].plurals[0] = "Start";
    strings["changing the loop in a BRR sample may result in glitches!##sgsed1"].plurals[0] = "zmiana pętli sampla BRR może powodować problemy!";
    strings["End"].plurals[0] = "Koniec";
    strings["changing the loop in a BRR sample may result in glitches!##sgsed2"].plurals[0] = "zmiana pętli sampla BRR może powodować problemy!";
    ...
    strings["Edit mode: Select"].plurals[0] = "Tryb edycji: zaznaczanie";
    strings["Edit mode: Draw"].plurals[0] = "Tryb edycji: rysowanie";
    strings["Resize##sgsed0"].plurals[0] = "Skaluj";
    strings["Samples##sgsed0"].plurals[0] = "Sample (nowy rozmiar)";
    strings["Resize##sgsed1"].plurals[0] = "Skaluj";
    strings["couldn't resize! make sure your sample is 8 or 16-bit."].plurals[0] = "nie udało się zmienić rozmiaru! upewnij się, że sample są 8 lub 16-bitowe.";
    strings["Resample##sgsed0"].plurals[0] = "Zmień częstotliwość samplowania";
    strings["Rate##sgsed1"].plurals[0] = "Częstotliwość";
    strings["Factor"].plurals[0] = "Współczynnik";
    strings["Filter"].plurals[0] = "Filtr";
    strings["Resample##sgsed1"].plurals[0] = "Zmień częstotliwość samplowania";
    strings["couldn't resample! make sure your sample is 8 or 16-bit."].plurals[0] = "nie udało się zmienić częstotliwości samplowania! upewnij się, że sampel jest 8- lub 16-bitowy.";
    strings["Undo"].plurals[0] = "Cofnij";
    strings["Redo"].plurals[0] = "Ponów";
    strings["Amplify"].plurals[0] = "Wzmocnij";
    strings["Volume"].plurals[0] = "Głośność";
    strings["Apply##sgsed0"].plurals[0] = "Zastosuj";
    strings["Normalize"].plurals[0] = "Normalizuj";
    strings["Fade in"].plurals[0] = "Płynny wzrost";
    strings["Fade out"].plurals[0] = "Płynne tłumienie";
    strings["Insert silence"].plurals[0] = "Wstaw ciszę";
    strings["Samples##sgsed1"].plurals[0] = "Sample";
    strings["Go"].plurals[0] = "Zastosuj";
    strings["couldn't insert! make sure your sample is 8 or 16-bit."].plurals[0] = "nie udało się wstawić! upewnij się że sampel jest 8- lub 16-bitowy.";
    strings["Apply silence"].plurals[0] = "Dodaj ciszę";
    strings["Delete"].plurals[0] = "Usuń";
    strings["Trim"].plurals[0] = "Obetnij";
    strings["Reverse"].plurals[0] = "Odwrotność";
    strings["Invert"].plurals[0] = "Odwróć";
    strings["Signed/unsigned exchange"].plurals[0] = "Ze znakiem <-> Bez znaku";
    strings["Apply filter"].plurals[0] = "Zastosuj filtr";
    strings["Cutoff:"].plurals[0] = "Pukt odcięcia:";
    strings["From"].plurals[0] = "Od";
    strings["To"].plurals[0] = "Do";
    strings["Resonance"].plurals[0] = "Rezonans";
    strings["Power"].plurals[0] = "Moc filtra";
    strings["Low-pass"].plurals[0] = "dolno-przepustowy";
    strings["Band-pass"].plurals[0] = "środkowo-przepustowy";
    strings["High-pass"].plurals[0] = "górno-przepustowy";
    strings["Apply##sgsed1"].plurals[0] = "Zastosuj";
    strings["Crossfade loop points"].plurals[0] = "Punkty zapętlenia crossfade-u";
    strings["Number of samples"].plurals[0] = "Ilość sampli";
    strings["Linear <-> Equal power"].plurals[0] = "Liniowy <-> Ten sam stopień";
    strings["Apply##sgsed2"].plurals[0] = "Zastosuj";
    strings["Crossfade: length would go out of bounds. Aborted..."].plurals[0] = "Crossfade: długość wyjdzie poza granice. Akcja anulowana.";
    strings["Crossfade: length would overflow loopStart. Try a smaller random value."].plurals[0] = "Crossfade: długość wykracza poza początek cyklu. Spróbuj użyć mniejszej wartości losowej.";
    strings["Preview sample"].plurals[0] = "Poglad sampla";
    strings["Stop sample preview"].plurals[0] = "Zatrzymaj podglad sampla";
    strings["Create instrument from sample"].plurals[0] = "Stwórz instrument z sampla";
    strings["Zoom##sgsed0"].plurals[0] = "Powiększ";
    strings["Zoom##sgsed1"].plurals[0] = "Powiększ";
	strings["%dms"].plurals[0] = "%d ms";
    strings["Auto"].plurals[0] = "Automatyczny";
    strings["cut"].plurals[0] = "wytnij";
    strings["copy"].plurals[0] = "kopiuj";
    strings["paste"].plurals[0] = "wklej";
    strings["paste (replace)"].plurals[0] = "wklej i zamień";
    strings["paste (mix)"].plurals[0] = "wstaw ze zmieszaniem";
    strings["select all"].plurals[0] = "wybierz wszystko";
    strings["set loop to selection"].plurals[0] = "ustaw pętlę na zaznaczeniu";
    strings["create wavetable from selection"].plurals[0] = "stwórz tablicę fal z zaznaczenia";
    strings["Draw"].plurals[0] = "Rysuj";
    strings["Select"].plurals[0] = "Wybierz";
    strings["%d samples"].plurals[0] = "%d sampel";
    strings["%d samples"].plurals[1] = "%d sample";
    strings["%d samples"].plurals[2] = "%d sampli";
    strings["%d bytes"].plurals[0] = "%d bajt";
    strings["%d bytes"].plurals[1] = "%d bajty";
    strings["%d bytes"].plurals[2] = "%d bajtów";
    strings[" (%d-%d: %d samples)"].plurals[0] = " (%d-%d: %d sampel)";
    strings[" (%d-%d: %d samples)"].plurals[1] = " (%d-%d: %d sample)";
    strings[" (%d-%d: %d samples)"].plurals[2] = " (%d-%d: %d sampli)";
	strings["%.2fHz"].plurals[0] = "%.2f Hz";
    strings["Non-8/16-bit samples cannot be edited without prior conversion."].plurals[0] = "Sample w formacie innym niż 8-bitowy lub 16-bitowy PCM nie mogą być edytowane bez uprzedniej konwersji do jednego z tych formatów.";
    ...
    strings["Memory Composition##sgse"].plurals[0] = "Zawartość pamięci##sgse";
    ...
    strings["Use software envelope"].plurals[0] = "Używaj obwiedni programowej";
    strings["Initialize envelope on every note"].plurals[0] = "Inicjalizuj obwiednię przy każdej nucie";
    strings["Volume##sgiGB0"].plurals[0] = "Głośność";
    strings["Length"].plurals[0] = "Długość";
    strings["Sound Length##sgiGB0"].plurals[0] = "Dlugość dzwięku";
    strings["Infinity"].plurals[0] = "Nieskończoność";
    strings["Direction"].plurals[0] = "Kierunek";
    strings["Up##sgiGB0"].plurals[0] = "Góra";
    strings["Down##sgiGB0"].plurals[0] = "Dół";
    strings["Hardware Sequence"].plurals[0] = "Sekwencja sprzętowa";
    strings["Tick"].plurals[0] = "Skok";
    strings["Command"].plurals[0] = "Komenda";
    strings["Move/Remove"].plurals[0] = "Przenieś/usuń";
    strings["Volume"].plurals[0] = "Głośność";
    strings["Env Length"].plurals[0] = "Długość obwiedni";
    strings["Sound Length"].plurals[0] = "Długość dzwięku";
    strings["Up"].plurals[0] = "Góra";
    strings["Down"].plurals[0] = "Dół";
    strings["Shift"].plurals[0] = "Jak bardzo";
    strings["Speed"].plurals[0] = "Prędkość";
    strings["Up"].plurals[0] = "Góra";
    strings["Down"].plurals[0] = "Dół";
    strings["Ticks"].plurals[0] = "Kroki";
    strings["Position"].plurals[0] = "Położenie";
    strings["Macros"].plurals[0] = "Makra";
    strings["Volume"].plurals[0] = "Głośność";
    strings["Arpeggio"].plurals[0] = "Arpeggio";
    strings["Pitch"].plurals[0] = "Wysokość";
    strings["Duty/Noise"].plurals[0] = "Szerokość fali prost./tryb szumu";
    strings["Waveform"].plurals[0] = "Fala";
    strings["Panning"].plurals[0] = "Panning";
    strings["Phase Reset"].plurals[0] = "Reset fazy";
...
//           src/engine/cmdStream.cpp
    ...
    strings["20xx: Set channel mode (bit 0: square; bit 1: noise; bit 2: envelope)"].plurals[0] = "20xx: Ustaw tryb kanału (bit 0: fala kwadratowa; bit 1: szum; bit 2: obwiednia)";
    strings["21xx: Set noise frequency (0 to 1F)"].plurals[0] = "21xx: Ustaw częstotliwość szumu (0-1F)";
    strings["22xy: Set envelope mode (x: shape, y: enable for this channel)"].plurals[0] = "22xy: Ustaw tryb obwiedni (x: kształt, y: włącz dla tego kanału)";
    strings["23xx: Set envelope period low byte"].plurals[0] = "23xx: Ustaw niski bajt okresu obwiedni";
    strings["24xx: Set envelope period high byte"].plurals[0] = "24xx: Ustaw wysoki bajt okresu obwiedni";
    strings["25xx: Envelope slide up"].plurals[0] = "25xx: Portamento obwiedni w górę";
    strings["26xx: Envelope slide down"].plurals[0] = "26xx: Portamento obwiedni w dół";
    strings["29xy: Set auto-envelope (x: numerator; y: denominator)"].plurals[0] = "29xy: Ustaw auto-obwiednię (x: licznik; y: mianownik)";
    strings["2Exx: Write to I/O port A"].plurals[0] = "2Exx: Zapisz do portu A I/O";
    strings["2Fxx: Write to I/O port B"].plurals[0] = "2Fxx: Zapisz do portu B I/O";
    strings["12xx: Set duty cycle (0 to 8)"].plurals[0] = "12xx: Ustaw szerokość fali prostokątnej (0-8)";
    strings["16xx: Set raw period higher byte"].plurals[0] = "16xx: Ustaw wysoki bajt absolutnego okresu";
    strings["27xx: Set noise AND mask"].plurals[0] = "27xx: Maska szumu (logiczne OR)";
    strings["28xx: Set noise OR mask"].plurals[0] = "28xx: Maska szumu (logiczne OR)";
    strings["2Dxx: NOT TO BE EMPLOYED BY THE COMPOSER"].plurals[0] = "2Dxx: NIE DO UŻYTKU PRZEZ KOMPOZYTORA";
    strings["30xx: Toggle hard envelope reset on new notes"].plurals[0] = "30xx: Włącz twardy reset obwiedni przy nowej nucie";
    strings["18xx: Toggle extended channel 3 mode"].plurals[0] = "18xx: Włącz rozszerzony kanał 3";
    strings["17xx: Toggle PCM mode (LEGACY)"].plurals[0] = "17xx: Włącz tryb PCM (PRZESTARZAŁE)";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)"].plurals[0] = "DFxx: Set kierunek odtwarzania sampli (0: normalny; 1: odwrotny)";
    strings["18xx: Toggle drums mode (1: enabled; 0: disabled)"].plurals[0] = "18xx: ПWłącz tryb perkusji (1: włączone; 0: wyłączone)";
    strings["11xx: Set feedback (0 to 7)"].plurals[0] = "11xx: Ustaw feedback (0-7)";
    strings["12xx: Set level of operator 1 (0 highest, 7F lowest)"].plurals[0] = "12xx: Ustaw poziom operatora 1 (0 maks., 7F min.)";
    strings["13xx: Set level of operator 2 (0 highest, 7F lowest)"].plurals[0] = "13xx: Ustaw poziom operatora 2 (0 maks., 7F min.)";
    strings["14xx: Set level of operator 3 (0 highest, 7F lowest)"].plurals[0] = "14xx: Ustaw poziom operatora 3 (0 maks., 7F min.)";
    strings["15xx: Set level of operator 4 (0 highest, 7F lowest)"].plurals[0] = "15xx: Ustaw poziom operatora 4 (0 maks., 7F min.)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)"].plurals[0] = "16xy: Ustaw mnożnik częst. operatora (x: operator (1-4); y: mnożnik)";
    strings["19xx: Set attack of all operators (0 to 1F)"].plurals[0] = "19xx: Ustaw atak wszystkich operatorów (0-1F)";
    strings["1Axx: Set attack of operator 1 (0 to 1F)"].plurals[0] = "1Axx: Ustaw atak operatora 1 (0-1F)";
    strings["1Bxx: Set attack of operator 2 (0 to 1F)"].plurals[0] = "1Bxx: Ustaw atak operatora 2 (0-1F)";
    strings["1Cxx: Set attack of operator 3 (0 to 1F)"].plurals[0] = "1Cxx: Ustaw atak operatora 3 (0-1F)";
    strings["1Dxx: Set attack of operator 4 (0 to 1F)"].plurals[0] = "1Dxx: Ustaw atak operatora 4 (0-1F)";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)"].plurals[0] = "50xy: Ustaw AM (x: operator 1-4 (0 dla wszystkich operatorów); y: AM)";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)"].plurals[0] = "51xy: Ustaw poziom podtrzymania (x: operator 1-4 (0 dla wszystkich operatorów); y: poziom)";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)"].plurals[0] = "52xy: Ustaw opadanie (x: operator 1-4 (0 dla wszystkich operatorów); y: opadanie)";
    strings["53xy: Set detune (x: operator from 1 to 4 (0 for all ops); y: detune where 3 is center)"].plurals[0] = "53xy: Ustaw rozstrojenie (x: operator 1-4 (0 dla wszystkich operatorów); y: rozstrojenie (3 - brak rozstrojenia))";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)"].plurals[0] = "54xy:  Ustaw skalowanie obwiedni (x: operator 1-4 (0 dla wszystkich operatorów); y: maks. 0-3)";
    strings["56xx: Set decay of all operators (0 to 1F)"].plurals[0] = "56xx: Ustaw opadanie wszystkich operatorów (0-1F)";
    strings["57xx: Set decay of operator 1 (0 to 1F)"].plurals[0] = "57xx: Ustaw opadanie operatora 1 (0-1F)";
    strings["58xx: Set decay of operator 2 (0 to 1F)"].plurals[0] = "58xx: Ustaw opadanie operatora 2 (0-1F)";
    strings["59xx: Set decay of operator 3 (0 to 1F)"].plurals[0] = "59xx: Ustaw opadanie operatora 3 (0-1F)";
    strings["5Axx: Set decay of operator 4 (0 to 1F)"].plurals[0] = "5Axx: Ustaw opadanie operatora 4 (0-1F)";
    strings["5Bxx: Set decay 2 of all operators (0 to 1F)"].plurals[0] = "5Bxx: Ustaw wtórne opadanie wszystkich operatorów (0-1F)";
    strings["5Cxx: Set decay 2 of operator 1 (0 to 1F)"].plurals[0] = "5Cxx: Ustaw wtórne opadanie operatora 1 (0-1F)";
    strings["5Dxx: Set decay 2 of operator 2 (0 to 1F)"].plurals[0] = "5Dxx: Ustaw wtórne opadanie operatora 2 (0-1F)";
    strings["5Exx: Set decay 2 of operator 3 (0 to 1F)"].plurals[0] = "5Exx: Ustaw wtórne opadanie operatora 3 (0-1F)";
    strings["5Fxx: Set decay 2 of operator 4 (0 to 1F)"].plurals[0] = "5Fxx: Ustaw wtórne opadanie operatora 4 (0-1F)";
    strings["10xx: Set noise frequency (xx: value; 0 disables noise)"].plurals[0] = "10xx: Ustaw częstotliwość szumu (xx: wartość; 0 wyłącza szum)";
    strings["17xx: Set LFO speed"].plurals[0] = "17xx: Ustaw prędkość LFO";
    strings["18xx: Set LFO waveform (0 saw, 1 square, 2 triangle, 3 noise)"].plurals[0] = "18xx: Ustaw kształt fali LFO (0 fala piłokszt., 1 fala kwadratowa, 2 fala trójkątna, 3 szum)";
    strings["1Exx: Set AM depth (0 to 7F)"].plurals[0] = "1Exx: Ustaw głębokość AM (0-7F)";
    strings["1Fxx: Set PM depth (0 to 7F)"].plurals[0] = "1Fxx: Ustaw głębokość PM (0-7F)";
    strings["55xy: Set detune 2 (x: operator from 1 to 4 (0 for all ops); y: detune from 0 to 3)"].plurals[0] = "55xy: Ustaw roztrojenie 2 (x: operator 1-4 (0 dla wszystkich operatorów); y: roztrojenie 0-3)";
    strings["24xx: Set LFO 2 speed"].plurals[0] = "24xx: Ustaw prędkość LFO 2";
    strings["25xx: Set LFO 2 waveform (0 saw, 1 square, 2 triangle, 3 noise)"].plurals[0] = "25xx: Ustaw kształt fali LFO 2 (0 fala piłokszt., 1 fala kwadratowa, 2 fala trójkątna, 3 szum)";
    strings["26xx: Set AM 2 depth (0 to 7F)"].plurals[0] = "26xx: Ustaw głębokość AM 2 (0-7F)";
    strings["27xx: Set PM 2 depth (0 to 7F)"].plurals[0] = "27xx: Ustaw głębokość PM 2 (0-7F)";
    strings["28xy: Set reverb (x: operator from 1 to 4 (0 for all ops); y: reverb from 0 to 7)"].plurals[0] = "28xy: Ustaw reverb (x: operator 1-4 (0 dla wszystkich operatorów); y: reverb 0-7)";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 7)"].plurals[0] = "2Axy: Ustaw kształt fali (x: operator 1-4 (0 dla wszystkich operatorów); y: kształt fali 0-7)";
    strings["2Bxy: Set envelope generator shift (x: operator from 1 to 4 (0 for all ops); y: shift from 0 to 3)"].plurals[0] = "2Bxy: Ustaw przesunięcie generatora obwiedni (x: operator 1-4 (0 dla wszystkich operatorów); y: przesunięcie 0-3)";
    strings["2Cxy: Set fine multiplier (x: operator from 1 to 4 (0 for all ops); y: fine)"].plurals[0] = "2Cxy: Ustaw mnożnik dokładności(x: operator 1-4 (0 dla wszystkich operatorów); y: mnożnik)";
    strings["3xyy: Set fixed frequency of operator 1 (x: octave from 0 to 7; y: frequency)"].plurals[0] = "3xyy: Ustaw stalą częstotliwość operatora 1 (x: oktawa 0-7; y: częstotliwość)";
    strings["3xyy: Set fixed frequency of operator 2 (x: octave from 8 to F; y: frequency)"].plurals[0] = "3xyy: Ustaw stalą częstotliwość operatora operatora 2 (x: oktawa 8-F; y: częstotliwość)";
    strings["4xyy: Set fixed frequency of operator 3 (x: octave from 0 to 7; y: frequency)"].plurals[0] = "4xyy: Ustaw stalą częstotliwość operatora operatora 3 (x: oktawa 0-7; y: częstotliwość)";
    strings["4xyy: Set fixed frequency of operator 4 (x: octave from 8 to F; y: frequency)"].plurals[0] = "4xyy: Ustaw stalą częstotliwość operatora operatora 4 (x: oktawa 8-F; y: częstotliwość)";
    strings["10xy: Setup LFO (x: enable; y: speed)"].plurals[0] = "10xy: Ustaw LFO (x: włączone; y: szybkość)";
    strings["55xy: Set SSG envelope (x: operator from 1 to 4 (0 for all ops); y: 0-7 on, 8 off)"].plurals[0] = "55xy: Ustaw obwiednię SSG (x: operator 1-4 (0 dla wszystkich operatorów); y: 0-7 wł., 8 wył.)";
    strings["1Fxx: Set ADPCM-A global volume (0 to 3F)"].plurals[0] = "1Fxx: Ustaw globalną głośność ADPCM-A (0-3F)";
    strings["11xx: Set feedback (0 to 7)1"].plurals[0] = "11xx: Ustaw feedback (0-7)";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)"].plurals[0] = "12xx: Ustaw poziom operatora 1 (0 maks., 3F min.)";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)"].plurals[0] = "13xx: Ustaw poziom operatora 2 (0 maks., 3F min.)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 2; y: multiplier)"].plurals[0] = "16xy:  Ustaw mnożnik częst. operatora (x: operator 1-2; y: mnożnik)";
    strings["19xx: Set attack of all operators (0 to F)"].plurals[0] = "19xx: Ustaw atak wszystkich operatorów (0-F)";
    strings["1Axx: Set attack of operator 1 (0 to F)"].plurals[0] = "1Axx: Ustaw atak operatora 1 (0-F)";
    strings["1Bxx: Set attack of operator 2 (0 to F)"].plurals[0] = "1Bxx: Ustaw atak operatora 2 (0-F)";
    strings["50xy: Set AM (x: operator from 1 to 2 (0 for all ops); y: AM)"].plurals[0] = "50xy: Włącz AM (x: operator 1-2 (0 dla wszystkich operatorów); y: AM)";
    strings["51xy: Set sustain level (x: operator from 1 to 2 (0 for all ops); y: sustain)"].plurals[0] = "51xy: Ustaw poziom podtrzymania (x: operator 1-2 (0 dla wszystkich operatorów); y: podtrzymanie)";
    strings["52xy: Set release (x: operator from 1 to 2 (0 for all ops); y: release)"].plurals[0] = "52xy: Ustaw zwolnienie (x: operator 1-2 (0 dla wszystkich operatorów); y: zwolnienie)";
    strings["53xy: Set vibrato (x: operator from 1 to 2 (0 for all ops); y: enabled)"].plurals[0] = "53xy: Vibrato (x: operator 1-2 (0 dla wszystkich operatorów); y: wł.)";
    strings["54xy: Set envelope scale (x: operator from 1 to 2 (0 for all ops); y: scale from 0 to 3)"].plurals[0] = "54xy: Ustaw skalowanie obwiedni (x: operator 1-2 (0 dla wszystkich operatorów); y: skala 0-3)";
    strings["55xy: Set envelope sustain (x: operator from 1 to 2 (0 for all ops); y: enabled)"].plurals[0] = "55xy: Ustaw podtrzymanie obwiedni (x: operator 1-2 (0 dla wszystkich operatorów); y: wł.)";
    strings["56xx: Set decay of all operators (0 to F)"].plurals[0] = "56xx: Ustaw opadanie wszystkich operatorów (0-F)";
    strings["57xx: Set decay of operator 1 (0 to F)"].plurals[0] = "57xx: Ustaw opadanie operatora 1 (0-F)";
    strings["58xx: Set decay of operator 2 (0 to F)"].plurals[0] = "58xx: Ustaw opadanie operatora 2 (0-F)";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 2 (0 for all ops); y: enabled)"].plurals[0] = "5Bxy: Ustaw skalowanie obwiedni wg. nuty (x: operator 1-2 (0 dla wszystkich operatorów); y: wł.)";
    strings["10xx: Set global AM depth (0: 1dB, 1: 4.8dB)"].plurals[0] = "10xx: Ustaw globalną głebokość AM (0: 1 dB, 1: 4.8 dB)";
    strings["11xx: Set feedback (0 to 7)2"].plurals[0] = "11xx: Ustaw sprz. zwrotne (0-7)";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)1"].plurals[0] = "12xx: Ustaw poziom operatora 1 (0 maks., 3F min.)";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)1"].plurals[0] = "13xx: Ustaw poziom operatora 2 (0 maks., 3F min.)";
    strings["14xx: Set level of operator 3 (0 highest, 3F lowest)"].plurals[0] = "14xx: Ustaw poziom operatora 3 (0 maks., 3F min.)";
    strings["15xx: Set level of operator 4 (0 highest, 3F lowest)"].plurals[0] = "15xx: Ustaw poziom operatora 4 (0 maks., 3F min.)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)1"].plurals[0] = "16xy:  Ustaw mnożnik częst. operatora (x: operator 1-4; y: mnożnik)";
    strings["17xx: Set global vibrato depth (0: normal, 1: double)"].plurals[0] = "17xx: Ustaw globalną głębokość vibrato (0: normalna, 1: podwójna)";
    strings["19xx: Set attack of all operators (0 to F)1"].plurals[0] = "19xx: Ustaw atak wszystkich operatorów (0-F)";
    strings["1Axx: Set attack of operator 1 (0 to F)1"].plurals[0] = "1Axx: Ustaw atak operatora 1 (0-F)";
    strings["1Bxx: Set attack of operator 2 (0 to F)1"].plurals[0] = "1Bxx: Ustaw atak operatora 2 (0-F)";
    strings["1Cxx: Set attack of operator 3 (0 to F)"].plurals[0] = "1Cxx: Ustaw atak operatora 3 (0-F)";
    strings["1Dxx: Set attack of operator 4 (0 to F)"].plurals[0] = "1Dxx: Ustaw atak operatora 4 (0-F)";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 3 in OPL2 and 0 to 7 in OPL3)"].plurals[0] = "2Axy: Ustaw kształt fali (x: operator 1-4 (0 dla wszystkich operatorów); y: kształt fali 0-3 dla OPL2 i 0-7 dla OPL3)";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)1"].plurals[0] = "50xy: Ustaw AM (x: operator 1-4 (0 dla wszystkich operatorów); y: AM)";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)1"].plurals[0] = "51xy: Ustaw poziom podtrzymania (x: operator 1-4 (0 dla wszystkich operatorów); y: podtrzymanie)";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)1"].plurals[0] = "52xy: Ustaw zwolnienie (x: operator 1-4 (0 dla wszystkich operatorów); y: zwolnienie)";
    strings["53xy: Set vibrato (x: operator from 1 to 4 (0 for all ops); y: enabled)"].plurals[0] = "53xy: Ustaw vibrato (x: operator 1-4 (0 dla wszystkich operatorów); y: wł.)";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)1"].plurals[0] = "54xy: Ustaw skalowanie obwiedni (x: operator 1-4 (0 dla wszystkich operatorów); y: skala 0-3)";
    strings["55xy: Set envelope sustain (x: operator from 1 to 4 (0 for all ops); y: enabled)"].plurals[0] = "55xy: Ustaw podtrzymanie obwiedni (x: operator 1-4 (0 dla wszystkich operatorów); y: wł.)";
    strings["56xx: Set decay of all operators (0 to F)1"].plurals[0] = "56xx: Ustaw opadanie wszystkich operatorów (0-F)";
    strings["57xx: Set decay of operator 1 (0 to F)1"].plurals[0] = "57xx: Ustaw opadanie operatora 1 (0-F)";
    strings["58xx: Set decay of operator 2 (0 to F)1"].plurals[0] = "58xx: Ustaw opadanie operatora 2 (0-F)";
    strings["59xx: Set decay of operator 3 (0 to F)"].plurals[0] = "59xx: Ustaw opadanie operatora 3 (0-F)";
    strings["5Axx: Set decay of operator 4 (0 to F)"].plurals[0] = "5Axx: Ustaw opadanie operatora 4 (0-F)";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 4 (0 for all ops); y: enabled)"].plurals[0] = "5Bxy: Ustaw skalowanie obwiedni wg. nuty (x: operator 1-4 (0 dla wszystkich operatorów); y: wł.)";
    strings["10xx: Set waveform (bit 0: triangle; bit 1: saw; bit 2: pulse; bit 3: noise)"].plurals[0] = "10xx: Ustaw kształt fali (bit 0: trójkątna; bit 1: piłokształtna; bit 2: prostokątna; bit 3: szum)";
    strings["11xx: Set coarse cutoff (not recommended; use 4xxx instead)"].plurals[0] = "11xx: Ustaw przybliżony punkt odcięcia (niezalecane, proszę używać 4xxx)";
    strings["12xx: Set coarse pulse width (not recommended; use 3xxx instead)"].plurals[0] = "12xx: Ustaw przybliżoną szerokość fali prost. (niezalecane, proszę używać 3xxx)";
    strings["13xx: Set resonance (0 to F)"].plurals[0] = "13xx: Ustaw rezonans (0-F)";
    strings["14xx: Set filter mode (bit 0: low pass; bit 1: band pass; bit 2: high pass)"].plurals[0] = "14xx: Ustaw tryb filtra (bit 0: dolno-; bit 1: środkowo-; bit 2: górnoprzepustowy)";
    strings["15xx: Set envelope reset time"].plurals[0] = "15xx: Ustaw czas resetu obwiedni";
    strings["1Axx: Disable envelope reset for this channel (1 disables; 0 enables)"].plurals[0] = "1Axx: Wyłącz reset obwiedni dla tego kanału (1 wył.; 0 wł.)";
    strings["1Bxy: Reset cutoff (x: on new note; y: now)"].plurals[0] = "1Bxy: Zresetuj punkt odcięcia (x: od nowej nuty; y: teraz)";
    strings["1Cxy: Reset pulse width (x: on new note; y: now)"].plurals[0] = "1Cxy: Zresetuj szerokość fali prost. (x: od nowej nuty; y: teraz)";
    strings["1Exy: Change other parameters (LEGACY)"].plurals[0] = "1Exy: Zmień inne parametry (PRZESTARZAŁE)";
    strings["20xy: Set attack/decay (x: attack; y: decay)"].plurals[0] = "20xy: Ustaw atak/opadanie (x: atak; y: opadanie)";
    strings["21xy: Set sustain/release (x: sustain; y: release)"].plurals[0] = "21xy: Ustaw podtrzymanie/zwolnienie (x: podtrzymanie; y: zwolnienie)";
    strings["22xx: Pulse width slide up"].plurals[0] = "22xx: Narastanie szerokości fali prostokątnej";
    strings["23xx: Pulse width slide down"].plurals[0] = "23xx: Opadanie szerokości fali prostokątnej";
    strings["24xx: Cutoff slide up"].plurals[0] = "24xx: Narastanie punktu odcięcia";
    strings["25xx: Cutoff slide down"].plurals[0] = "25xx: Opadanie punktu odcięcia";
    strings["3xxx: Set pulse width (0 to FFF)"].plurals[0] = "3xxx: Ustaw szerokość fali prost. (0-FFF)";
    strings["4xxx: Set cutoff (0 to 7FF)"].plurals[0] = "4xxx: Ustaw punkt odcięcia (0-7FF)";
    strings["10xx: Set waveform"].plurals[0] = "10xx: Ustaw kształt fali";
    strings["13xx: Set waveform (local)"].plurals[0] = "13xx: Ustaw kształt fali (lokalny)";
    strings["11xx: Set raw period (0-1F)"].plurals[0] = "11xx: Ustaw absolutny okres (0-1F)";
    strings["11xx: Set waveform (local)"].plurals[0] = "11xx: Ustaw kształt fali (lokalny)";
    strings["20xx: Set PCM frequency"].plurals[0] = "20xx: Ustaw częstotliwość PCM";
    strings["10xy: Set AM depth (x: operator from 1 to 4 (0 for all ops); y: depth (0: 1dB, 1: 4.8dB))"].plurals[0] = "10xy: Ustaw głębokość AM (x: operator 1-4 (0 dla wszystkich operatorów); y: głębokość (0: 1 dB, 1: 4.8 dB))";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)2"].plurals[0] = "12xx: Ustaw poziom operatora 1 (0 maks., 3F min.)";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)2"].plurals[0] = "13xx: Ustaw poziom operatora 2 (0 maks., 3F min.)";
    strings["14xx: Set level of operator 3 (0 highest, 3F lowest)1"].plurals[0] = "14xx: Ustaw poziom operatora 3 (0 maks., 3F min.)";
    strings["15xx: Set level of operator 4 (0 highest, 3F lowest)1"].plurals[0] = "15xx: Ustaw poziom operatora 4 (0 maks., 3F min.)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)2"].plurals[0] = "16xy: Ustaw mnożnik operatora (x: operator 1-4; y: mnożnik)";
    strings["17xy: Set vibrato depth (x: operator from 1 to 4 (0 for all ops); y: depth (0: normal, 1: double))"].plurals[0] = "17xy: Ustaw głębokość vibrato (x: operator 1-4 (0 dla wszystkich operatorów); y: głębokość (0: normalna, 1: podwójna))";
    strings["19xx: Set attack of all operators (0 to F)"].plurals[0] = "19xx: Ustaw atak wszystkich operatorów (0-F)";
    strings["1Axx: Set attack of operator 1 (0 to F)2"].plurals[0] = "1Axx: Ustaw atak operatora 1 (0-F)";
    strings["1Bxx: Set attack of operator 2 (0 to F)2"].plurals[0] = "1Bxx: Ustaw atak operatora 2 (0-F)";
    strings["1Cxx: Set attack of operator 3 (0 to F)1"].plurals[0] = "1Cxx: Ustaw atak operatora 3 (0-F)";
    strings["1Dxx: Set attack of operator 4 (0 to F)1"].plurals[0] = "1Dxx: Ustaw atak operatora 4 (0-F)";
    strings["20xy: Set panning of operator 1 (x: left; y: right)"].plurals[0] = "20xy: Ustaw panning operatora 1 (x: lewo; y: prawo)";
    strings["21xy: Set panning of operator 2 (x: left; y: right)"].plurals[0] = "21xy: Ustaw panning operatora 2 (x: lewo; y: prawo)";
    strings["22xy: Set panning of operator 3 (x: left; y: right)"].plurals[0] = "22xy: Ustaw panning operatora 3 (x: lewo; y: prawo)";
    strings["23xy: Set panning of operator 4 (x: left; y: right)"].plurals[0] = "23xy: Ustaw panning operatora 4 (x: lewo; y: prawo)";
    strings["24xy: Set output level register (x: operator from 1 to 4 (0 for all ops); y: level from 0 to 7)"].plurals[0] = "24xy: Ustaw rejestr poziomu wyjścia (głośności) (x: operator 1-4 (0 dla wszystkich operatorów); y: poziom 0-7)";
    strings["25xy: Set modulation input level (x: operator from 1 to 4 (0 for all ops); y: level from 0 to 7)"].plurals[0] = "25xy: Ustaw poziom wejścia modulacji (x: operator 1-4 (0 dla wszystkich operatorów); y: poziom 0-7)";
    strings["26xy: Set envelope delay (x: operator from 1 to 4 (0 for all ops); y: delay from 0 to 7)"].plurals[0] = "26xy: Ustaw opóźnienie obwiedni (x: operator 1-4 (0 dla wszystkich operatorów); y: opóźnienie 0-7)";
    strings["27xx: Set noise mode for operator 4 (x: mode from 0 to 3)"].plurals[0] = "27xx: Ustaw tryb szumu operatora 4 (x: tryby 0-3)";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 7)1"].plurals[0] = "2Axy: Ustaw kształt fali (x: operator 1-4 (0 dla wszystkich operatorów); y: kształt fali 0-7)";
    strings["2Fxy: Set fixed frequency block (x: operator from 1 to 4; y: octave from 0 to 7)"].plurals[0] = "2Fxy: Ustaw blok stałej częstotiwości (x: operator 1-4; y: oktawa 0-7)";
    strings["40xx: Set detune of operator 1 (80: center)"].plurals[0] = "40xx: Rozstrojenie operatora 1 (80: brak rozstrojenia)";
    strings["41xx: Set detune of operator 2 (80: center)"].plurals[0] = "41xx: Rozstrojenie operatora 2 (80: brak rozstrojenia)";
    strings["42xx: Set detune of operator 3 (80: center)"].plurals[0] = "42xx: Rozstrojenie operatora 3 (80: brak rozstrojenia)";
    strings["43xx: Set detune of operator 4 (80: center)"].plurals[0] = "43xx: Rozstrojenie operatora 4 (80: brak rozstrojenia)";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)2"].plurals[0] = "50xy: Ustaw AM (x: operator 1-4 (0 dla wszystkich operatorów); y: AM)";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)2"].plurals[0] = "51xy: Ustaw podtrzymanie (x: operator 1-4 (0 dla wszystkich operatorów); y: podtrzymanie)";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)2"].plurals[0] = "52xy: Ustaw zwolnienie (x: operator 1-4 (0 dla wszystkich operatorów); y: zwolnienie)";
    strings["53xy: Set vibrato (x: operator from 1 to 4 (0 for all ops); y: enabled)1"].plurals[0] = "53xy: Ustaw vibrato (x: operator 1-4 (0 dla wszystkich operatorów); y: wł.)";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)2"].plurals[0] = "54xy: Ustaw skalowanie obwiedni (x: operator 1-4 (0 dla wszystkich operatorów); y: skala 0-3)";
    strings["55xy: Set envelope sustain (x: operator from 1 to 4 (0 for all ops); y: enabled)1"].plurals[0] = "55xy: Ustaw podtrzymanie obwiedni (x: operator 1-4 (0 dla wszystkich operatorów); y: wł.)";
    strings["56xx: Set decay of all operators (0 to F)2"].plurals[0] = "56xx: Ustaw opadanie wszystkich operatorów (0-F)";
    strings["57xx: Set decay of operator 1 (0 to F)2"].plurals[0] = "57xx: Ustaw opadanie operatora 1 (0-F)";
    strings["58xx: Set decay of operator 2 (0 to F)2"].plurals[0] = "58xx: Ustaw opadanie operatora 2 (0-F)";
    strings["59xx: Set decay of operator 3 (0 to F)1"].plurals[0] = "59xx: Ustaw opadanie operatora 3 (0-F)";
    strings["5Axx: Set decay of operator 4 (0 to F)1"].plurals[0] = "5Axx: Ustaw opadanie operatora 4 (0-F)";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 4 (0 for all ops); y: enabled)1"].plurals[0] = "5Bxy: Ustaw skalowanie obwiedni wg. nuty (x: operator 1-4 (0 dla wszystkich operatorów); y: wł.)";
    strings["3xyy: Set fixed frequency F-num of operator 1 (x: high 2 bits from 0 to 3; y: low 8 bits of F-num)"].plurals[0] = "3xyy: Ustaw F-Num stałej częstotliwości dla operatora 1 (x: dwa wysokie bity 0-3; y: 8 niskich bitów F-num)";
    strings["3xyy: Set fixed frequency F-num of operator 2 (x: high 2 bits from 4 to 7; y: low 8 bits of F-num)"].plurals[0] = "3xyy: Ustaw F-Num stałej częstotliwości dla operatora 2 (x: dwa wysokie bity 4-7; y: 8 niskich bitów F-num)";
    strings["3xyy: Set fixed frequency F-num of operator 3 (x: high 2 bits from 8 to B; y: low 8 bits of F-num)"].plurals[0] = "3xyy: Ustaw F-Num stałej częstotliwości dla operatora 3 (x: dwa wysokie bity 8-B; y: 8 niskich bitów F-num)";
    strings["3xyy: Set fixed frequency F-num of operator 4 (x: high 2 bits from C to F; y: low 8 bits of F-num)"].plurals[0] = "3xyy: Ustaw F-Num stałej częstotliwości dla operatora 4 (x:dwa wysokie bity C-F; y: 8 niskich bitów F-num)";
    strings["10xx: Set waveform (bit 0: triangle; bit 1: saw; bit 2: pulse; bit 3: noise)1"].plurals[0] = "10xx: Ustaw kształt fali (bit 0: trójkątna.; bit 1: piłokształtna; bit 2: prostokątna.; bit 3: szum)";
    strings["11xx: Set resonance (0 to FF)"].plurals[0] = "11xx: Ustaw rezonans (0-FF)";
    strings["12xx: Set filter mode (bit 0: low pass; bit 1: band pass; bit 2: high pass)"].plurals[0] = "12xx: Ustaw tryb filtra (bit 0: dolno-; bit 1: środkowo-; bit 2: górnoprzepustowy)";
    strings["13xx: Disable envelope reset for this channel (1 disables; 0 enables)"].plurals[0] = "13xx: Wyłącz reset obwiedni dla tego kanału (1 wył.; 0 wł.)";
    strings["14xy: Reset cutoff (x: on new note; y: now)"].plurals[0] = "14xy: Resetuj punkt odcięcia (x: od nowej nuty; y: teraz)";
    strings["15xy: Reset pulse width (x: on new note; y: now)"].plurals[0] = "15xy: Resetuj szerokość fali prost. (x: od nowej nuty; y: teraz)";
    strings["16xy: Change other parameters"].plurals[0] = "16xy: Zmień inne parametry";
    strings["17xx: Pulse width slide up"].plurals[0] = "17xx: Narastanie szerokości fali prostokątnej";
    strings["18xx: Pulse width slide down"].plurals[0] = "18xx: Opadanie szerokości fali prostokątnej";
    strings["19xx: Cutoff slide up"].plurals[0] = "19xx: Narastanie punktu odcięcia";
    strings["1Axx: Cutoff slide down"].plurals[0] = "1Axx: Opadanie punktu odcięcia";
    strings["3xxx: Set pulse width (0 to FFF)1"].plurals[0] = "3xxx: Ustaw szerokość fali prostokątnej (0-FFF)";
    strings["4xxx: Set cutoff (0 to FFF)1"].plurals[0] = "4xxx: Ustaw punkt odcięcia (0-FFF)";
    strings["a chip which found its way inside mobile phones in the 2000's.\nas proprietary as it is, it passed away after losing to MP3 in the mobile hardware battle."].plurals[0] = "układ, który zaczął pojawiać się w telefonach komórkowych w 2000 r.\n jako iż wykorzystwał zastreżony format, przegrał z formatem MP3 podczas rywalizacji między różnymi typami sprzętu mobilnego.";
    strings["<COMPOUND SYSTEM!>"].plurals[0] = "<SYSTEM ZŁOŻONY!>";
    strings["<COMPOUND SYSTEM!>1"].plurals[0] = "<SYSTEM ZŁOŻONY!>";
    strings["a square/noise sound chip found on the Sega Master System, ColecoVision, Tandy, TI's own 99/4A and a few other places."].plurals[0] = "układ generujący falę prostokątną i szum, który został zastosowany w Sega Master System, ColecoVision, Tandy, własnym urządzeniu 99/4A firmy TI i kilku innych urządzeniach";
    strings["20xy: Set noise mode (x: preset freq/ch3 freq; y: thin pulse/noise)"].plurals[0] = "20xy: Ustaw tryb szumu (x: stała częst/częst. 3-go kanału; y: \"wąska\" fala prostokątna/szum)";
    strings["<COMPOUND SYSTEM!>2"].plurals[0] = "<SYSTEM ZŁOŻONY!>";
    strings["the most popular portable game console of the era."].plurals[0] = "najbardziej popularna przenośna konsola tamtych czasów.";
    strings["10xx: Set waveform1"].plurals[0] = "10xx: Ustaw kształt fali";
    strings["11xx: Set noise length (0: long; 1: short)"].plurals[0] = "11xx: Ustaw długość szumu (0: długi; 1: krótki)";
    strings["12xx: Set duty cycle (0 to 3)"].plurals[0] = "12xx: Ustaw szerokość fali prost. (0-3)";
    strings["13xy: Setup sweep (x: time; y: shift)"].plurals[0] = "13xy: Skonfiguruj sprzętowe portamento (x: okres trwania; y: przesunięcie)";
    strings["14xx: Set sweep direction (0: up; 1: down)"].plurals[0] = "14xx: Ustaw kierunek sprzętowego portamento (0: w górę; 1: w dół)";
    strings["15xx: Set waveform (local)"].plurals[0] = "15xx: Ustaw kształt fali (lokalny)";
    strings["an '80s game console with a wavetable sound chip, popular in Japan."].plurals[0] = "konsola do gier z lat 80. z układem syntezy tablicowej. była popularna w Japonii.";
    strings["10xx: Set waveform2"].plurals[0] = "10xx: Ustaw kształt fali";
    strings["11xx: Toggle noise mode"].plurals[0] = "11xx: Włącz tryb szumu";
    strings["12xx: Setup LFO (0: disabled; 1: 1x depth; 2: 16x depth; 3: 256x depth)"].plurals[0] = "12xx: Ustaw LFO (0: wł.; 1: głębokość 1x; 2: głębokość 16x; 3: głębokość 256x)";
    strings["13xx: Set LFO speed"].plurals[0] = "13xx: Ustaw szybkość LFO";
    strings["17xx: Toggle PCM mode (LEGACY)1"].plurals[0] = "17xx: Włącz tryb PCM (PRZESTARZAŁY)";
    strings["18xx: Set waveform (local)"].plurals[0] = "18xx: Ustaw kształt fali (lokalny)";
    strings["also known as Famicom in Japan, it's the most well-known game console of the '80s."].plurals[0] = "także znana w Japonii jako Famicom. to najbardziej znana konsola lat 80-tych.";
    strings["11xx: Write to delta modulation counter (0 to 7F)"].plurals[0] = "11xx: Zapisz do licznika modulacji delta (0-7F)";
    strings["12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1)"].plurals[0] = "12xx: Ustaw szerokość fali prost./tryb szumu (fala prost.: 0-3; szum: 0 lub 1)";
    strings["13xy: Sweep up (x: time; y: shift)"].plurals[0] = "13xy: Sprzętowe portamento w górę (x: czas; y: przesunięcie)";
    strings["14xy: Sweep down (x: time; y: shift)"].plurals[0] = "14xy: Sprzętowe portamento w dół (x: czas; y: przesunięcie)";
    strings["15xx: Set envelope mode (0: envelope, 1: length, 2: looping, 3: constant)"].plurals[0] = "15xx: Ustaw tryb obwiedni (0: obwiednia, 1: długość, 2: zapętla, 3: stały)";
    strings["16xx: Set length counter (refer to manual for a list of values)"].plurals[0] = "16xx: Ustaw długość licznika (lista wartości w instrukcji)";
    strings["17xx: Set frame counter mode (0: 4-step, 1: 5-step)"].plurals[0] = "17xx: Tryb licznika klatek (0: 4 kroki, 1: 5 kroków)";
    strings["18xx: Select PCM/DPCM mode (0: PCM; 1: DPCM)"].plurals[0] = "18xx: Wybierz tryb PCM/DPCM (0: PCM; 1: DPCM)";
    strings["19xx: Set triangle linear counter (0 to 7F; 80 and higher halt)"].plurals[0] = "19xx: Ustaw liniowy licznik kanały fali trójk. (0-7F; 80 w wyżej zatrzymują falę";
    strings["20xx: Set DPCM frequency (0 to F)"].plurals[0] = "20xx: Ustaw częstotliwość DPCM (0-F)";
    strings["<COMPOUND SYSTEM!>3"].plurals[0] = "<SYSTEM ZŁOŻONY!>";
    strings["<COMPOUND SYSTEM!>4"].plurals[0] = "<SYSTEM ZŁOŻONY!>";
    strings["this computer is powered by the SID chip, which had synthesizer features like a filter and ADSR."].plurals[0] = "ten komputer ma układ SID, który ma zaawansowane funkcje typowe dla syntezatorów, takie jak filtr i obwiednia ADSR.";
    strings["this computer is powered by the SID chip, which had synthesizer features like a filter and ADSR.\nthis is the newer revision of the chip."].plurals[0] = "ten komputer ma układ SID, który ma zaawansowane funkcje typowe dla syntezatorów, takie jak filtr i obwiednia ADSR.\nto nowsza wersja układu.";
    strings["<COMPOUND SYSTEM!>5"].plurals[0] = "<SYSTEM ZŁOŻONY!>";
    strings["like Neo Geo, but lacking the ADPCM-B channel since they couldn't connect the pins."].plurals[0] = "to samo co Neo Geo, ale bez kanału ADPCM-B, ponieważ podłączenie pinów ich przerosło.";
    strings["like Neo Geo, but lacking the ADPCM-B channel since they couldn't connect the pins.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies."].plurals[0] = "to samo co Neo Geo, ale bez kanału ADPCM-B, ponieważ podłaczenie pinów ich przerosło.\njest to układ w trybie rozszerzonego kanału, który zamienia drugi kanał FM w cztery operatory z niezależnymi nutami/częstotliwościami.";
    strings["this chip is everywhere! ZX Spectrum, MSX, Amstrad CPC, Intellivision, Vectrex...\nthe discovery of envelope bass helped it beat the SN76489 with ease."].plurals[0] = "ten układ był wszędzie! ZX Spectrum, MSX, Amstrad CPC, Intellivision, Vectrex...\nodkrycie metody wykorzystania obwiedni dla basów z łatwością pozwoliło temu układowi pokonać SN76489.";
    strings["a computer from the '80s with full sampling capabilities, giving it a sound ahead of its time."].plurals[0] = "komputer z lat 80-tych z pełnymi możliwościami samplingu, nadający mu brzmienie wyprzedzające swoją epokę.";
    strings["10xx: Toggle filter (0 disables; 1 enables)"].plurals[0] = "10xx: Włącz filtr (0 wył.; 1 wł.)";
    strings["11xx: Toggle AM with next channel"].plurals[0] = "11xx: Włącz AM z następnym kanałem";
    strings["12xx: Toggle period modulation with next channel"].plurals[0] = "12xx: Włącz modulację okresu z następnym kanałem";
    strings["13xx: Set waveform"].plurals[0] = "13xx: Ustaw kształt fali";
     strings["14xx: Set waveform (local)"].plurals[0] = "14xx: Ustaw kształt fali (lokalny)";
    strings["this was Yamaha's first integrated FM chip.\nit was used in several synthesizers, computers and arcade boards."].plurals[0] = "układ ten był pierwszym jednoukładowym syntezatorem FM Yamahy\nbył używany w kilku syntezatorach, komputerach i automatach do gier.";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer)."].plurals[0] = "układ ten znany jest głównie z tego, że znajduje się w Sega Mega Drive (ale był również używany w komputerze FM Towns).";
    strings["it's a challenge to make music on this chip which barely has musical capabilities..."].plurals[0] = "jest to pewne wyzwanie tworzyć komozycje pod układ który praktycznie nie posiada możliwości muzycznych...";
    strings["supposedly an upgrade from the AY-3-8910, this was present on the Creative Music System (Game Blaster) and SAM Coupé."].plurals[0] = "ten układ, rzekomo ulepszona wersja AY-3-8910, był używany w Creative Music System (Game Blaster) i SAM Coupé.";
    strings["10xy: Set channel mode (x: noise; y: tone)"].plurals[0] = "10xy: Ustaw tryb kanału (x: szum; y: ton)";
    strings["11xx: Set noise frequency"].plurals[0] = "11xx: Częstotliwość szumu";
    strings["12xx: Setup envelope (refer to docs for more information)"].plurals[0] = "12xx: Ustaw obwiednię (patrz: instrukcja)";
    strings["an improved version of the AY-3-8910 with a bigger frequency range, duty cycles, configurable noise and per-channel envelopes!"].plurals[0] = "ulepszona wersja AY-3-8910 z większym zakresem częstotliwości, regulowaną szerokościa fali prostokątnej, regulowanym szumem i osobną obwiednią na każdy kanał!";
    strings["Commodore's successor to the PET.\nits square wave channels are more than just square..."].plurals[0] = "komputer Commodore, który ukazał się po PET.\njego kanały fal prostokątnych mogą odtwarzać więcej niż tylko fale prostokątne...";
    strings["one channel of 1-bit wavetable which is better (and worse) than the PC Speaker."].plurals[0] = "1-kanałowy 1-bitow syntezator tablicowy, która jest lepsza (lub gorsza) niż PC Speaker (brzęczyk).";
    strings["FM? nah... samples! Nintendo's answer to Sega."].plurals[0] = "FM? nieee, sample! Odpowiedź Nintendo na sukces Segi.";
    strings["18xx: Enable echo buffer"].plurals[0] = "18xx: Włącz bufor echo";
    strings["19xx: Set echo delay (0 to F)"].plurals[0] = "19xx: Ustaw opóźnienie echo (0-F)";
    strings["1Axx: Set left echo volume"].plurals[0] = "1Axx: Ustaw głośność echo na lewym kanale";
    strings["1Bxx: Set right echo volume"].plurals[0] = "1Bxx: Ustaw głośność echo na prawym kanale";
    strings["1Cxx: Set echo feedback"].plurals[0] = "1Cxx: Ustaw feedback echo";
    strings["1Exx: Set dry output volume (left)"].plurals[0] = "1Exx: Ustaw głośność kanału (lewo)";
    strings["1Fxx: Set dry output volume (right)"].plurals[0] = "1Fxx: Ustaw głośność kanału (prawo)";
    strings["30xx: Set echo filter coefficient 0"].plurals[0] = "30xx: Ustaw współczynnik 0 filtra echo";
    strings["31xx: Set echo filter coefficient 1"].plurals[0] = "31xx: Ustaw współczynnik 1 filtra echo";
    strings["32xx: Set echo filter coefficient 2"].plurals[0] = "32xx: Ustaw współczynnik 2 filtra echo";
    strings["33xx: Set echo filter coefficient 3"].plurals[0] = "33xx: Ustaw współczynnik 3 filtra echo";
    strings["34xx: Set echo filter coefficient 4"].plurals[0] = "34xx: Ustaw współczynnik 4 filtra echo";
    strings["35xx: Set echo filter coefficient 5"].plurals[0] = "35xx: Ustaw współczynnik 5 filtra echo";
    strings["36xx: Set echo filter coefficient 6"].plurals[0] = "36xx: Ustaw współczynnik 6 filtra echo";
    strings["37xx: Set echo filter coefficient 7"].plurals[0] = "37xx: Ustaw współczynnik 7 filtra echo";
    strings["10xx: Set waveform3"].plurals[0] = "10xx: Ustaw kształt fali";
    strings["11xx: Toggle noise mode1"].plurals[0] = "11xx: Włącz tryb szumu";
    strings["12xx: Toggle echo on this channel"].plurals[0] = "12xx: Włącz echo na tym kanale";
    strings["13xx: Toggle pitch modulation"].plurals[0] = "13xx: Włącz modulację wysokości dźwięku";
    strings["14xy: Toggle invert (x: left; y: right)"].plurals[0] = "14xy: Włacz odwrócenie sygnału (x: lewo; y: prawo)";
    strings["15xx: Set envelope mode (0: ADSR, 1: gain/direct, 2: dec, 3: exp, 4: inc, 5: bent)"].plurals[0] = "15xx: Tryb obwiedni (0: ADSR, 1: wzmocnienie/bezpośredni, 2: opadający 3: wykładniczy, 4: wzrastający 5: zakrzywiony)";
    strings["16xx: Set gain (00 to 7F if direct; 00 to 1F otherwise)"].plurals[0] = "16xx: Ustaw wzmocnienie (00-7F w bezpośrednim trrybie; inaczej 00-1F)";
    strings["17xx: Set waveform (local)"].plurals[0] = "17xx: Ustaw kształt fali (lokalny)";
    strings["1Dxx: Set noise frequency (00 to 1F)"].plurals[0] = "1Dxx: Ustaw częstotliwość szumu (00-1F)";
    strings["20xx: Set attack (0 to F)"].plurals[0] = "20xx: Ustaw atak (0-F)";
    strings["21xx: Set decay (0 to 7)"].plurals[0] = "21xx: Ustaw opadanie (0-7)";
    strings["22xx: Set sustain (0 to 7)"].plurals[0] = "22xx: Ustaw podtrzymanie (0-7)";
    strings["23xx: Set release (00 to 1F)"].plurals[0] = "23xx: Ustaw zwolnienie (00-1F)";
    strings["an expansion chip for the Famicom, featuring a quirky sawtooth channel."].plurals[0] = "układ rozszerzający dla Famicoma, zawierający bardzo nietypowy kanał fali piłokształtnej.";
    strings["12xx: Set duty cycle (pulse: 0 to 7)"].plurals[0] = "12xx: Ustaw szerokość fali prost. (puls: 0-7)";
    strings["17xx: Toggle PCM mode (LEGACY)2"].plurals[0] = "17xx: włącz tryb PCM (PRZESTARZAŁY)";
    strings["cost-reduced version of the OPL with 16 patches and only one of them is user-configurable."].plurals[0] = "tańsza wersja OPL z 16 wbudowanymi instrumentami, z których tylko jeden jest dostępny do dostosowania przez użytkownika.";
    strings["a disk drive for the Famicom which also contains one wavetable channel."].plurals[0] = "stacja dyskietek dla Famicoma, która przy okazji dostarcza jeden kanał syntezy tablicowej";
    strings["10xx: Set waveform4"].plurals[0] = "10xx: Ustaw kształt fali";
    strings["11xx: Set modulation depth"].plurals[0] = "11xx: Ustaw głębokość modulacji";
    strings["12xy: Set modulation speed high byte (x: enable; y: value)"].plurals[0] = "12xy: Ustaw wysoki bajt szybkości modulacji (x: wł.; y: wartość)";
    strings["13xx: Set modulation speed low byte"].plurals[0] = "13xx: Ustaw niski bajt szybkości modulacji";
    strings["14xx: Set modulator position"].plurals[0] = "14xx: Położenie modulatora";
    strings["15xx: Set modulator table to waveform"].plurals[0] = "15xx: Ustaw tablicę modulacji na dany kształt fali";
    strings["16xx: Set waveform (local)"].plurals[0] = "16xx: Ustaw kształt fali (lokalny)";
    strings["an expansion chip for the Famicom, featuring a little-known PCM channel."].plurals[0] = "układ rozszerzający dla Famicoma,, posiadający mało znany kanał PCM";
    strings["12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1)1"].plurals[0] = "12xx: Ustaw szerokość fali prost./tryb szumu (fala prostokątna: 0-3; szum: 0 lub 1)";
    strings["an expansion chip for the Famicom, with full wavetable."].plurals[0] = "układ rozszerzający dla Famicoma, który jest pełnoprawnym syntezatorem tablicowym.";
    strings["18xx: Change channel limits (0 to 7, x + 1)"].plurals[0] = "18xx: Zmień ilość kanałów (0-7, x + 1)";
    strings["20xx: Load a waveform into memory"].plurals[0] = "20xx: Wczytaj falę do pamięci";
    strings["21xx: Set position for wave load"].plurals[0] = "21xx: Ustaw początkowe przesunięcie załadowania fali";
    strings["10xx: Select waveform"].plurals[0] = "10xx: Wybierz kształt fali";
    strings["11xx: Set waveform position in RAM"].plurals[0] = "11xx: Ustaw pozycję fali w RAM-ie";
    strings["12xx: Set waveform length in RAM (04 to FC in steps of 4)"].plurals[0] = "12xx: Ustaw długość fali w RAM-ie (04-FC w odstępach 4)";
    strings["15xx: Set waveform load position"].plurals[0] = "15xx: Ustaw pozycję ładowania fali";
    strings["16xx: Set waveform load length (04 to FC in steps of 4)"].plurals[0] = "16xx: Ustaw długość fali do wczytania(04-FC w odstępach 4)";
    strings["17xx: Select waveform (local)1"].plurals[0] = "17xx: Ustaw kształt fali (lokalny)";
    strings["cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)"].plurals[0] = "tańsza wersja OPM z innym układem rejestrów i bez stereo...\n...ale za to z wbudowanym AY-3-8910! (tak naprawdę YM2149)";
    strings["cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies"].plurals[0] = "tańsza wersja OPM z innym układem rejestrów i bez stereo...\n...ale za to z wbudowanym AY-3-8910! (tak naprawdę YM2149)\njest to układ w trybie rozszerzonego kanału, która zamienia trzeci kanał FM w cztery operatory z niezależnymi nutami/częstotliwościami";
    strings["cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "tańsza wersja OPM z innym układem rejestrów i bez stereo...\n...ale za to z wbudowanym AY-3-8910! (tak naprawdę YM2149)\njest to układ w trybie rozszerzonego kanału, która zamienia trzeci kanał FM w cztery operatory z niezależnymi nutami/częstotliwościami\nten układ posiada kontrolę trybu CSM dla efektów specjalnych na trzecim kanale.";
    strings["OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels."].plurals[0] = "OPN, ale z dwa razy większą ilością kanałów FM, stereo powraca, są też kanały perkusji i ADPCM.";
    strings["OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies"].plurals[0] = "OPN, ale z dwa razy większą ilością kanałów FM, stereo powrca, są też kanały perkusji i ADPCM.\njest to układ w trybie rozszerzonego kanału, która zamienia trzeci kanał FM w cztery operatory z niezależnymi nutami/częstotliwościami.";
    strings["OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "OPN, ale z dwa razy większą ilością kanałów FM, stereo powrca, są też kanały perkusji i ADPCM.\nЭjest to układ w trybie rozszerzonego kanału, która zamienia trzeci kanał FM w cztery operatory z niezależnymi nutami/częstotliwościami.\nten układ posiada kontrolę trybu CSM dla efektów specjalnych na trzecim kanale.";
    strings["OPN, but what if you only had two operators, no stereo, no detune and a lower ADSR parameter range?"].plurals[0] = "OPN, ale co jeśli są tylko dwa operatory na kanał, nie ma stereo, nie ma rozstrajania operatorów, a zakres regulacji parametrów ADSR jest mniejszy?";
    strings["OPL, but what if you had more waveforms to choose than the normal sine?"].plurals[0] = "OPL, ale co jeśli oferuje inne kształty fal oprócz sinusoidy?";
    strings["OPL2, but what if you had twice the channels, 4-op mode, stereo and even more waveforms?"].plurals[0] = "OPL2, ale co jeśli ma dwa razy więcej kanałów, tryb 4-op, stereo i jeszcze więcej kształtów fal do wyboru?";
    strings["how many channels of PCM do you want?\nMultiPCM: yes"].plurals[0] = "ile kanałów PCM chcesz?\nMultiPCM: tak";
    strings["good luck! you get one square and no volume control."].plurals[0] = "powodzenia! masz jeden kanał fali kwadratowej i zero regulacji głośności.";
    strings["please don't use this chip. it was added as a joke."].plurals[0] = "nie używaj tego układu. został dodany jako żart.";
    strings["TIA, but better and more flexible.\nused in the Atari 8-bit family of computers (400/800/XL/XE)."].plurals[0] = "TIA, ale lepsze i prostsze w obsłudze\nbył używany w rodzinie 8-bitowych komputerów Atari (400/800/XL/XE).";
    strings["10xx: Set waveform (0 to 7)"].plurals[0] = "10xx: Ustaw kształt fali (0-7)";
    strings["11xx: Set AUDCTL"].plurals[0] = "11xx: Ustaw AUDCTL";
    strings["12xx: Toggle two-tone mode"].plurals[0] = "12xx: Włącz tryb dwóch głosów";
    strings["13xx: Set raw period"].plurals[0] = "13xx: Ustaw absolutny okres";
    strings["14xx: Set raw period (higher byte; only for 16-bit mode)"].plurals[0] = "14xx: Ustaw absolutny okres (wysoki bajt; tylko w trybie 16-bitowym)";
    strings["this is like SNES' sound chip but without interpolation and the rest of nice bits."].plurals[0] = "podobny do układu dźwiękowego SNES, ale bez interpolacji i innych fajnych ficzerów";
    strings["developed by the makers of the Game Boy and the Virtual Boy..."].plurals[0] = "zaprojektowany przez twórców Game Boy'a i Virtual Boy'a...";
    strings["10xx: Set waveform5"].plurals[0] = "10xx: Ustaw kształt fali";
    strings["11xx: Setup noise mode (0: disabled; 1-8: enabled/tap)"].plurals[0] = "11xx: Skonfiguruj tryb szumu (0: wył.; 1-8: wł./przełączniki)";
    strings["12xx: Setup sweep period (0: disabled; 1-20: enabled/period)"].plurals[0] = "12xx: Włącz okres sprętowego portamento (0: wył.; 1-20: wł./okres)";
    strings["13xx: Set sweep amount"].plurals[0] = "13xx: Ustaw wielkość sprzętowego portamento";
    strings["17xx: Toggle PCM mode (LEGACY)3"].plurals[0] = "17xx: Włącz tryb PCM (PRZESTARZAŁY)";
    strings["18xx: Set waveform (local)1"].plurals[0] = "18xx: Ustaw kształt fali (lokalny)";
    strings["like OPM, but with more waveforms, fixed frequency mode and totally... undocumented.\nused in the Yamaha TX81Z and some other synthesizers."].plurals[0] = "jak OPM, ale z większą liczbą fal, trybem stałej częstotliwości i całkowitym... brakiem informacji o jego konstrukcji.\nużywany w Yamaha TX81Z i niektórych innych syntezatorach.";
    strings["2Fxx: Toggle hard envelope reset on new notes"].plurals[0] = "2Fxx: Włącz twardy reset obwiedni przy nowych nutach";
    strings["this one is like PC Speaker but has duty cycles."].plurals[0] = "ten układ jest podobny do PC Speakera, ale ma zmienną szerokość fali prostokątnej";
    strings["used in some Sega arcade boards (like OutRun), and usually paired with a YM2151."].plurals[0] = "był używany w niektórych automatach do gier Segi (np. OutRun) i był zwykle używany w połączeniu z YM2151.";
    strings["a console which failed to sell well due to its headache-inducing features."].plurals[0] = "konsola, która się nie sprzedawałą, ponieważ jej funkcje przyprawiały graczy o ból głowy.";
    strings["10xx: Set waveform6"].plurals[0] = "10xx: Ustaw kształt fali";
    strings["11xx: Set noise length (0 to 7)"].plurals[0] = "11xx: Ustaw długość szumu (0-7)";
    strings["12xy: Setup envelope (x: enabled/loop (1: enable, 3: enable+loop); y: speed/direction (0-7: down, 8-F: up))"].plurals[0] = "12xy: Skonfiguruj obwiednię (x: wł./zapętla (1: wł., 3: wł.i zapętla); y: prędkość/kierunek (0-7: w dół, 8-F: w górę))";
    strings["13xy: Setup sweep (x: speed; y: shift; channel 5 only)"].plurals[0] = "13xy: Skonfiguruj sprzętowe portamento (x: szybkość; y: zakres; tylko kanał 5)";
    strings["14xy: Setup modulation (x: enabled/loop (1: enable, 3: enable+loop); y: speed; channel 5 only)"].plurals[0] = "14xy: Skonfiguruj modulację (x: wł./zapętla (1: wł, 3: wł.i zapętla); y: szybkość; tylko kanał 5)";
    strings["15xx: Set modulation waveform (x: wavetable; channel 5 only)"].plurals[0] = "15xx: Ustaw kształt fali modulatora (x: tablica fal; tylko kanał 5)";
    strings["16xx: Set waveform (local)1"].plurals[0] = "16xx: Ustaw kształt fali (lokalny)";
    strings["like OPLL, but even more cost reductions applied. three less FM channels, and no drums mode..."].plurals[0] = "jak OPLL, ale jeszcze bardziej wykastrowany. trzy kanały mniej, brak trybu perkusyjnego...";
    strings["so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip."].plurals[0] = "a więc Taito poprosiło Yamahę o dodanie do YM2610 dwóch brakujących kanałów FM, a Yamaha z przyjemnością dostarczyła ów układ.";
    strings["the ZX Spectrum only had a basic beeper capable of...\n...a bunch of thin pulses and tons of other interesting stuff!\nFurnace provides a thin pulse system."].plurals[0] = "ZX Spectrum miał tylko prosty brzęczyk zdolny do generowania\n...kilku \"wąskich\" fal prostokątnych i wielu innych ciekawych dźwięków!\nFurnace dostarcza silnik z \"wąskimi\" falami prostokątnymi.";
    strings["12xx: Set pulse width"].plurals[0] = "12xx: Ustaw szerokość fali prost.";
    strings["17xx: Trigger overlay drum"].plurals[0] = "17xx: Uruchom nakładkę perkusyjną";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies."].plurals[0] = "układ ten znany jest głównie z tego, że znajduje się w Sega Mega Drive (ale był również używany w komputerze FM Towns).\njest to układ w trybie rozszerzonego kanału, która zamienia trzeci kanał FM w cztery operatory z niezależnymi nutami/częstotliwościami.";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "układ ten znany jest głównie z tego, że znajduje się w Sega Mega Drive (ale był również używany w komputerze FM Towns).\nten układ posiada kontrolę trybu CSM dla efektów specjalnych na trzecim kanale.";
    strings["a wavetable chip made by Konami for use with the MSX.\nthe last channel shares its wavetable with the previous one though."].plurals[0] = "syntezator tablicowy wyprodukowany przez Konami do użytku z MSX.\nostatni i przedostatni kanał korzystają z tej samej tablicy fal.";
    strings["the OPL chip but with drums mode enabled."].plurals[0] = "układ OPL z włączonym trybem perkusji.";
    strings["the OPL2 chip but with drums mode enabled."].plurals[0] = "układ OPL2 z włączonym trybem perkusji.";
    strings["the OPL3 chip but with drums mode enabled."].plurals[0] = "układ OPL3 z włączonym trybem perkusji.";
    strings["this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing."].plurals[0] = "układ ten był używany w automatach i konsolach do gier Neo Geo firmy SNK.\njest podobny do OPNA, ale kanały perkusyjne są teraz kanałami ADPCM i brakuje dwóch kanałów FM.";
    strings["this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies."].plurals[0] = "układ ten był używany w automatach i konsolach do gier Neo Geo firmy SNK.\njest podobny do OPNA, ale kanały perkusyjne są teraz kanałami ADPCM i brakuje dwóch kanałów FM.\njest to układ w trybie rozszerzonego kanału, która zamienia drugi kanał FM w cztery operatory z niezależnymi nutami/częstotliwościami.";
    strings["this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 2."].plurals[0] = "układ ten był używany w automatach i konsolach do gier Neo Geo firmy SNK.\njest podobny do OPNA, ale kanały perkusyjne są teraz kanałami ADPCM i brakuje dwóch kanałów FM.\njest to układ w trybie rozszerzonego kanału, która zamienia drugi kanał FM w cztery operatory z niezależnymi nutami/częstotliwościami.\nten układ posiada kontrolę trybu CSM dla efektów specjalnych na trzecim kanale.";
    strings["the OPLL chip but with drums mode turned on."].plurals[0] = "układ OPLL z włączonym trybem perkusji.";
    strings["3xxx: Load LFSR (0 to FFF)"].plurals[0] = "3xxx: Załaduj LFSR (0-FFF)";
    strings["a portable console made by Atari. it has all of Atari's trademark waveforms."].plurals[0] = "przenośna konsola do gier od Atari. posiada wszystkie charakterystyczne dla Atari kształty fal";
    strings["10xx: Set echo feedback level (00 to FF)"].plurals[0] = "10xx: Ustaw poziom sprzężenia zwrotnego echa (00-FF)";
    strings["11xx: Set channel echo level (00 to FF)"].plurals[0] = "11xx: Ustaw poziom echa kanału (00-FF)";
    strings["12xx: Toggle QSound algorithm (0: disabled; 1: enabled)"].plurals[0] = "12xx: Włącz algorytm QSound (0: wył.; 1: wł.)";
    strings["3xxx: Set echo delay buffer length (000 to AA5)"].plurals[0] = "3xxx: Ustaw długość bufora opóźnienia echo (000-AA5)";
    strings["used in some of Capcom's arcade boards. surround-like sampled sound with echo."].plurals[0] = "używany w niektórych automatach do gier Capcomu. samplowany dźwięk z echem i efektami dźwięku przestrzennego.";
    strings["the chip used in a computer design created by The 8-Bit Guy."].plurals[0] = "układ używany w projekcie komputera opracowanym przez 8-Bit Guy'a.";
    strings["20xx: Set waveform"].plurals[0] = "20xx: Ustaw kształt fali";
    strings["22xx: Set duty cycle (0 to 3F)"].plurals[0] = "22xx: Ustaw szerokość fali prost. (0-3F)";
    strings["so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies."].plurals[0] = "a więc Taito poprosiło Yamahę o dodanie do YM2610 dwóch brakujących kanałów FM, a Yamaha z przyjemnością dostarczyła ów układ.\njest to układ w trybie rozszerzonego kanału, która zamienia trzeci kanał FM w cztery operatory z niezależnymi nutami/częstotliwościami.";
    strings["so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "a więc Taito poprosiło Yamahę o dodanie do YM2610 dwóch brakujących kanałów FM, a Yamaha z przyjemnością dostarczyła ów układ.\njest to układ w trybie rozszerzonego kanału, która zamienia trzeci kanał FM w cztery operatory z niezależnymi nutami/częstotliwościami.\nten układ posiada kontrolę trybu CSM dla efektów specjalnych na trzecim kanale.";
    strings["this is the same thing as SegaPCM, but only exposes 5 of the channels for compatibility with DefleMask."].plurals[0] = "jest to to samo co SegaPCM, ale tylko pięć kanałów jest dostępnych dla kompatybilności z DefleMaskiem.";
    strings["a sound chip used in several Seta/Allumer-manufactured arcade boards with too many channels of wavetable sound, which also are capable of sampled sound."].plurals[0] = "układ dźwiękowy używany w kilku automatach go gier firmy Seta/Allumer. posiada stanowczo za dużo kanałów syntezy tablicowej, zdolny również do odtwarzania sampli.";
    strings["10xx: Set waveform7"].plurals[0] = "10xx: Ustaw kształt fali";
    strings["11xx: Set envelope shape"].plurals[0] = "11xx: Ustaw kształt obwiedni";
    strings["12xx: Set sample bank slot (0 to 7)"].plurals[0] = "12xx: Ustaw slot banków sampli (0-7)";
    strings["17xx: Toggle PCM mode (LEGACY)4"].plurals[0] = "17xx: Włącz tryb PCM (PRZESTARZAŁY)";
    strings["18xx: Set waveform (local)2"].plurals[0] = "18xx: Ustaw kształt fali (lokalny)";
    strings["20xx: Set PCM frequency (1 to FF)"].plurals[0] = "20xx: Ustaw częstotliwość PCM (1-FF)";
    strings["22xx: Set envelope mode (bit 0: enable; bit 1: one-shot; bit 2: split shape to L/R; bit 3/5: H.invert right/left; bit 4/6: V.invert right/left)"].plurals[0] = "22xx: Ustaw tryb obwiedni (bit 0: wł.; bit 1: jednokrotny.; bit 2: rozdziel kształt fali na lewo/prawo; bity 3/5: odwróć pionowo na prawo/lewo; bity 4/6: odwróć poziomo na prawo/lewo)";
    strings["23xx: Set envelope period"].plurals[0] = "23xx: Ustaw okres obwiedni";
    strings["25xx: Envelope slide up1"].plurals[0] = "25xx: Portamento obwiedni w górę";
    strings["26xx: Envelope slide down1"].plurals[0] = "26xx: Portamento obwiedni w dół";
    strings["29xy: Set auto-envelope (x: numerator; y: denominator)1"].plurals[0] = "29xy: Auto-obwiednia (x: licznik; y: mianownik)";
    strings["this is the wavetable part of the Bubble System, which also had two AY-3-8910s."].plurals[0] = "jest syntezatorową częścią Bubble Systemu, który również posiadał dwa AY-3-8910.";
    strings["like OPL3, but this time it also has a 24-channel version of MultiPCM."].plurals[0] = "to samo co OPL3, ale z 24 kanałami PCM na bazie układu MultiPCM.";
    strings["the OPL4 but with drums mode turned on."].plurals[0] = "OPL4 z włączonym trybem perkusji.";
    strings["11xx: Set filter mode (00 to 03)"].plurals[0] = "11xx: Ustaw tryb filtra (00-03)";
    strings["14xx: Set filter coefficient K1 low byte (00 to FF)"].plurals[0] = "14xx: Ustaw niski bit współczynnika filtra K1 (00-FF)";
    strings["15xx: Set filter coefficient K1 high byte (00 to FF)"].plurals[0] = "15xx: Ustaw wysoki bit współczynnika filtra K1 (00-FF)";
    strings["16xx: Set filter coefficient K2 low byte (00 to FF)"].plurals[0] = "16xx: Ustaw niski bit współczynnika filtra K2 (00-FF)";
    strings["17xx: Set filter coefficient K2 high byte (00 to FF)"].plurals[0] = "17xx: Ustaw wysoki bit współczynnika filtra K2 (00-FF)";
    strings["18xx: Set filter coefficient K1 slide up (00 to FF)"].plurals[0] = "18xx: Ustaw zjazd spółczynnika filtra K1 w górę (00-FF)";
    strings["19xx: Set filter coefficient K1 slide down (00 to FF)"].plurals[0] = "19xx: Ustaw zjazd spółczynnika filtra K1 w dół (00-FF)";
    strings["1Axx: Set filter coefficient K2 slide up (00 to FF)"].plurals[0] = "1Axx: Ustaw zjazd spółczynnika filtra K2 w górę (00-FF)";
    strings["1Bxx: Set filter coefficient K2 slide down (00 to FF)"].plurals[0] = "1Bxx: Ustaw zjazd spółczynnika filtra K1 w dół (00 to FF)";
    strings["22xx: Set envelope left volume ramp (signed) (00 to FF)"].plurals[0] = "22xx: Ustaw narastanie obwiedni głośności lewej strony (ze znakiem) (00-FF)";
    strings["23xx: Set envelope right volume ramp (signed) (00 to FF)"].plurals[0] = "23xx: Ustaw narastanie obwiedni głośności prawej strony (ze znakiem) (00-FF)";
    strings["24xx: Set envelope filter coefficient k1 ramp (signed) (00 to FF)"].plurals[0] = "24xx:  Ustaw narastanie obwiedni wspólczynnika filtra K1 (ze znakiem) (00-FF)";
    strings["25xx: Set envelope filter coefficient k1 ramp (signed, slower) (00 to FF)"].plurals[0] = "25xx: Ustaw narastanie obwiedni wspólczynnika filtra K1 (ze znakiem, wolniej) (00-FF)";
    strings["26xx: Set envelope filter coefficient k2 ramp (signed) (00 to FF)"].plurals[0] = "26xx: Ustaw narastanie obwiedni wspólczynnika filtra K2 (ze znakiem) (00-FF)";
    strings["27xx: Set envelope filter coefficient k2 ramp (signed, slower) (00 to FF)"].plurals[0] = "27xx: 25xx: Ustaw narastanie obwiedni wspólczynnika filtra K2 (ze znakiem, wolniej) (00-FF)";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)1"].plurals[0] = "DFxx: Ustaw kieruynek odtwarzania sampla (0: normalny; 1: odwrotny)";
    strings["120x: Set pause (bit 0)"].plurals[0] = "120x: Ustaw pauzę (bit 0)";
    strings["2xxx: Set envelope count (000 to 1FF)"].plurals[0] = "2xxx: Ustaw długość obwiedni (000-1FF)";
    strings["3xxx: Set filter coefficient K1 (000 to FFF)"].plurals[0] = "3xxx: Współczynnik filtra K1 (000-FFF)";
    strings["4xxx: Set filter coefficient K2 (000 to FFF)"].plurals[0] = "4xxx: Współczynnik filtra K2 (000-FFF)";
    strings["a sample chip made by Ensoniq, which is the basis for the GF1 chip found in Gravis' Ultrasound cards."].plurals[0] = "sampler Ensoniqa, który był podstawą układu GF1 używanego w kartach dźwiękowych Gravis Ultrasound.";
    strings["like OPL but with an ADPCM channel."].plurals[0] = "OPL, ale z dodatkowym kanałem ADPCM.";
    strings["the Y8950 chip, in drums mode."].plurals[0] = "układ Y8950 w trybie perkusji.";
    strings["this is a variant of Konami's SCC chip with the last channel's wavetable being independent."].plurals[0] = "wariant układu SCC firmy Konami z niezależną tablicą fal ostatniego kanału.";
    strings["10xx: Set waveform (0 to 7)1"].plurals[0] = "10xx: Ustaw kształt fali (0-7)";
    strings["12xx: Set pulse width (0 to 7F)"].plurals[0] = "12xx: Ustaw szerokość fali prost. (0-7F)";
    strings["13xx: Set resonance (0 to FF)"].plurals[0] = "13xx: Ustaw rezonans (0-FF)";
    strings["14xx: Set filter mode (bit 0: ring mod; bit 1: low pass; bit 2: high pass; bit 3: band pass)"].plurals[0] = "14xx: Ustaw tryb filtra (bit 0: modulacja kołowa; bit 1: dolno-; bit 2: środkowo-; bit 3: górnoprzepustowy)";
    strings["15xx: Set frequency sweep period low byte"].plurals[0] = "15xx: Ustaw wysoki bajt okresu sprzętowego portamento";
    strings["16xx: Set frequency sweep period high byte"].plurals[0] = "16xx: Ustaw niski bajt okresu sprzętowego portamento";
    strings["17xx: Set volume sweep period low byte"].plurals[0] = "17xx: Ustaw wysoki bajt okresu sprzętowej zmiany głośniości";
    strings["18xx: Set volume sweep period high byte"].plurals[0] = "18xx: Ustaw niski bajt okresu sprzętowej zmiany głośniości";
    strings["19xx: Set cutoff sweep period low byte"].plurals[0] = "19xx: Ustaw wysoki bajt okresu sprzętowej zmiany punktu odcięcia filtra";
    strings["1Axx: Set cutoff sweep period high byte"].plurals[0] = "1Axx: Ustaw niski bajt okresu sprzętowej zmiany punktu odcięcia filtra";
    strings["1Bxx: Set frequency sweep boundary"].plurals[0] = "1Bxx: Ustaw granicę sprzętowego poprtamento";
    strings["1Cxx: Set volume sweep boundary"].plurals[0] = "1Cxx: Ustaw granicę sprzętowej zmiany głośniości";
    strings["1Dxx: Set cutoff sweep boundary"].plurals[0] = "1Dxx: Granica sprzętowej zmiany punktu odcięcia filtra";
    strings["1Exx: Set phase reset period low byte"].plurals[0] = "1Exx: Ustaw niski bajt okresu resetu fazy";
    strings["1Fxx: Set phase reset period high byte"].plurals[0] = "1Fxx: Ustaw wysoki bajt okresu resetu fazy";
    strings["20xx: Toggle frequency sweep (bit 0-6: speed; bit 7: direction is up)"].plurals[0] = "20xx: Ustaw sprzętowe portamento (bity 0-6: szybkość; bit 7: kierunek w górę)";
    strings["21xx: Toggle volume sweep (bit 0-4: speed; bit 5: direction is up; bit 6: loop; bit 7: alternate)"].plurals[0] = "21xx: Włącz sprzętową zmianę głośności (bity 0-4: szybkość; bit 5: kierunek w górę; bit 6: zapętl; bit 7: naprzemiennie góra-dół)";
    strings["22xx: Toggle cutoff sweep (bit 0-6: speed; bit 7: direction is up)"].plurals[0] = "22xx: Włącz sprzętową zmianę punktu odcięcia filtra (bit 0-6: szybkość; bit 7: kierunek w górę)";
    strings["4xxx: Set cutoff (0 to FFF)"].plurals[0] = "4xxx: Ustaw punkt odcięcia (0-FFF)";
    strings["tildearrow's fantasy sound chip. put SID, AY and VERA in a blender, and you get this!"].plurals[0] = "fikcyjny układ dźwiękowy tildearrowa. wsadź SIDa, AY i VERA do blendera i otrzymasz ten układ!";
    strings["an ADPCM sound chip manufactured by OKI and used in many arcade boards."].plurals[0] = "układ dźwiękowy ADPCM wyprodukowany przez firmę OKI. używany był w wielu maszynach arcade.";
    strings["20xx: Set chip output rate (0: clock/132; 1: clock/165)"].plurals[0] = "20xx: Częstotliwość samplowania układu (0: Taktowanie zegara/132; 1: Taktowanie zegara/165)";
    strings["an ADPCM sound chip manufactured by OKI and used in the Sharp X68000."].plurals[0] = "układ dźwiękowy ADPCM firmy OKI, używany w Sharpie X68000.";
    strings["20xx: Set frequency divider (0-2)"].plurals[0] = "20xx: Ustaw dzielnik częstotliwości (0-2)";
    strings["21xx: Select clock rate (0: full; 1: half)"].plurals[0] = "21xx: Taktowanie zegara (0: pełne; 1: połowiczne)";
    strings["used in some arcade boards. Can play back either 4-bit ADPCM, 8-bit PCM or 16-bit PCM."].plurals[0] = "używany w niektórych automatach do gier. może odtwarzać 4-bitowe próbki ADPCM, a także 8-bitowe i 16-bitowe próbki PCM";
    strings["10xx: Set waveform8"].plurals[0] = "10xx: Ustaw kształt fali";
    strings["11xx: Select waveform (local)1"].plurals[0] = "11xx: Ustaw kształt fali (lokalny)";
    strings["10xx: Set waveform9"].plurals[0] = "10xx: Ustaw kształt fali";
    strings["11xx: Toggle noise mode2"].plurals[0] = "11xx: Włącz tryb szumu";
    strings["a wavetable sound chip used in Pac-Man, among other early Namco arcade games."].plurals[0] = "prosty syntezator tablicowy używany w automacie Pac-Mana i innych wczesnych grach Namco.";
    strings["successor of the original Namco WSG chip, used in later Namco arcade games."].plurals[0] = "kolejny model po Namco WSG, używany w późniejszych automatach do gier Namco.";
    strings["like Namco C15 but with stereo sound."].plurals[0] = "to samo co Namco C15, ale z dźwiękiem stereo.";
    strings["a square wave additive synthesis chip made by OKI. used in some arcade machines and instruments."].plurals[0] = "układ syntezy addytywnej firmy OKI. używany w niektórych automatach do gier i instrumentach muzycznych.";
    strings["10xy: Set group control (x: sustain; y: part toggle bitmask)"].plurals[0] = "10xy: Ustaw kontrolę grupy (x: podtrzymanie; y: maska bitowa części)";
    strings["11xx: Set noise mode"].plurals[0] = "11xx: Ustaw tryb szumu";
    strings["12xx: Set group attack (0 to 5)"].plurals[0] = "12xx: Ustaw atak grupy (0-5)";
    strings["13xx: Set group decay (0 to 11)"].plurals[0] = "13xx: Ustaw opadanie grupy (0-11)";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis system uses software mixing to provide two sample channels."].plurals[0] = "układ ten znany jest głównie z tego, że znajduje się w Sega Mega Drive (ale był również używany w komputerze FM Towns).\nw ta wersja wykorzystuje programowe miksowanie sampli, dzięki czemu można odtwarzać dwa kanały sampli na raz.";
    ...
    strings["an SN76489 derivative used in Neo Geo Pocket, has independent stereo volume and noise channel frequency."].plurals[0] = "wariant SN76489 używany w Neo Geo Pocket. Posiada niezależną kontrolę głośności kanału stereo i częstotliwości kanału szumów.";
    strings["20xx: Set noise length (0: short, 1: long)"].plurals[0] = "20xx: Ustaw długość szumu (0: krótki, 1: długi)";
    strings["as generic sample playback as it gets."].plurals[0] = "proste do bólu urządzenie do odtwarzania sampli.";
    strings["this PCM chip was widely used at Konami arcade boards in 1986-1990."].plurals[0] = "ten układ PCM był szeroko stosowany w automatach do gier Konami w latach 1986-1990.";
    strings["yet another PCM chip from Irem. like Amiga, but less pitch resolution and no sample loop."].plurals[0] = "kolejny układ PCM od firmy Irem. podobny do tego z Amigi, ale z mniejszą rozdzielczością kontroli częstotliwości i bez zapętlania sampli.";
    strings["a SoC with wavetable sound hardware."].plurals[0] = "CPU z syntezatorem tablicowym.";
    strings["a game console with 3 channels of square wave. it's what happens after fusing TIA and VIC together."].plurals[0] = "konsola do gier z trzema kanałami fali kwadratowej. oto, co otrzymujesz po skrzyżowaniu TIA i VIC.";
    strings["10xx: Set ring modulation (0: disable, 1: enable)"].plurals[0] = "10xx: Ustaw modulację kołową (0: wył., 1: wł.)";
    strings["11xx: Raw frequency (0-3E)"].plurals[0] = "11xx: Absulutna częstotliwość (0-3E)";
    strings["another ZX Spectrum beeper system with full PWM pulses and 3-level volume per channel. it also has a pitchable overlay sample channel."].plurals[0] = "kolejny system brzęczyka ZX Spectrum, tym razem zawierający pełnoprawne fale prostokątne z regulowaną szerokością i trzema poziomami głośności dla każdego kanału. ma również nakładający się ma inne kanały kanał sampli z kontrolą częstotliwości.";
    strings["12xx: Set pulse width1"].plurals[0] = "12xx: Ustaw szerokość fali prost.";
    strings["this PCM chip was widely used at Konami arcade boards in 1990-1992."].plurals[0] = "ten układ PCM był szeroko stosowany w automatach do gier Konami w latach 1990-1992.";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)2"].plurals[0] = "DFxx: Ustaw kierunek odtwarzania sampli (0: normalny; 1: odwrotny)";
    strings["two square waves (one may be turned into noise). used in the Commodore Plus/4, 16 and 116."].plurals[0] = "dwa kanały fali kwadratowej (jeden z nich może odtwarzać szum). używany w Commodore Plus/4, 16 i 116.";
    strings["Namco's first PCM chip from 1987. it's pretty good for being so."].plurals[0] = "pierwszy układ PCM Namco z 1987r. Całkiem przyzwoity jak na swoje czasy.";
    strings["Namco's PCM chip used in their NA-1/2 hardware.\nvery similar to C140, but has noise generator."].plurals[0] = "Układ PCM firmy Namco używany w urządzeniach NA-1/2.\nbardzo podobny do C140, ale ma generator szumu.";
    strings["11xx: Set noise mode1"].plurals[0] = "11xx: Ustaw tryb szumu";
    strings["12xy: Set invert mode (x: surround; y: invert)"].plurals[0] = "12xy: Ustwa tryb odwrotny (x: dźwięk przestrzenny; y: odwrotny.)";
    strings["a unique FM synth featured in PC sound cards.\nbased on the OPL3 design, but with lots of its features extended."].plurals[0] = "unikalny układ syntezy FM stosowany w kartach dźwiękowych dla komputerów PC.\nopiera się na OPL3, ale ma znacznie rozszerzone możliwości syntezy.";
    strings["2Exx: Toggle hard envelope reset on new notes"].plurals[0] = "2Exx: Włącz twardy reset obwiedni przy nowej nucie";
    strings["first Ensoniq chip used in their synths and Apple IIGS computer. Has 32 hard-panned 8-bit wavetable/sample channels, can do oscillator sync (like SID) and amplitude modulation. Can have up to 128 KiB (2 banks of 64 KiB) of memory for wavetables/samples.\nAs Robert Yannes (SID chip creator) said, it's more or less what SID chip could be if he was given enough time for its development."].plurals[0] = "pierwszy układ scalony firmy Ensoniq, wykorzystywany w syntezatorach i komputerze Apple IIGS. Posiada 32 kanały syntezy tablicowej / sampli z twardym panningiem, synchronizacją oscylatorów (tak jak SID) i modulacją amplitudy. Może mieć do 128 KiB (2 banki po 64 KiB każdy) pamięci na tablice fal/sample.\nJak powiedział Robert Yannes (twórca układu SID), ES5503 jest mniej więcej tym, czym mógłby być układ SID, gdyby miał wystarczająco dużo czasu na jego opracowanie.";
    strings["11xx: Set number of enabled oscillators (2-1F)"].plurals[0] = "11xx: Ustaw ilość włączonych oscylatorów (2-1F)";
    strings["12xx: Set oscillator output (0-7, 0=left, 1=right)"].plurals[0] = "12xx: Ustaw wyjście sygnału oscylatora (0-7, 0=lewo, 1=prawo)";
    strings["13xx: Set wave/sample length (0-7, 0=256, 1=512, 2=1024, etc.)"].plurals[0] = "13xx: Ustaw długości fali/sampla (0-7, 0=256, 1=512, 2=1024 i.t.d.)";
    strings["14xx: Set wave/sample position in memory (xx*256 offset)"].plurals[0] = "14xx: Ustaw położenie fali/sampla w pamięci (przesunięcie xx*256)";
    strings["15xx: Set oscillator mode (0-3)"].plurals[0] = "15xx: Ustaw tryb oscylatora (0-3)";
    strings["a fantasy sound chip designed by jvsTSX and The Beesh-Spweesh!\nused in the Hexheld fantasy console."].plurals[0] = "fikcyjny układ dźwiękowy opracowany przez jvsTSX i The Beesh-Spweesh!\nużywany w fikcyjnej konsoli do gier Hexheld.";
    strings["20xx: Load low byte of noise channel LFSR (00 to FF) or slope channel accumulator (00 to 7F)"].plurals[0] = "20xx: Załaduj najmniej znaczący bajt do LFSRa kanału szumu (00-FF) lub akumulatora kanału spadka (00-7F)";
    strings["21xx: Load high byte of noise channel LFSR (00 to FF)"].plurals[0] = "21xx: Załaduj wysokiego bajtu do LFSR kanału szumu (00-FF)";
    strings["22xx: Write to I/O port A"].plurals[0] = "22xx: Zapisz do prtu I/O A";
    strings["23xx: Write to I/O port B"].plurals[0] = "23xx: Zapisz do portu I/O B";
    strings["this chip was featured in the Enterprise 128 computer. it is similar to POKEY, but with stereo output, more features and frequency precision and the ability to turn left or right (or both) channel into a 6-bit DAC for sample playback."].plurals[0] = "Układ ten znajdował się w komputerze Enterprise 128. Jest podobny do POKEY, ale ma dźwięk stereo, więcej funkcji, dokładniejsze dostrajanie częstotliwości i możliwość zamiany lewego lub prawego (lub obu) kanału w 6-bitowy przetwornik cyfrowo-analogowy do odtwarzania sampli.";
    strings["10xx: Set waveform (0 to 4; 0 to 3 on noise)"].plurals[0] = "10xx: Ustaw kształt fali (0-4; 0-3 na kanale szumu)";
    strings["11xx: Set noise frequency source (0: fixed; 1-3: channels 1 to 3)"].plurals[0] = "11xx: Ustaw źródło częstotliwości szumu(0: stały, 1-3: kanały 1-3)";
    strings["12xx: Toggle high-pass with next channel"].plurals[0] = "12xx: Włącz filtr gornoprzep. na następnym kanale";
    strings["13xx: Toggle ring modulation with channel+2"].plurals[0] = "13xx: Włącz modulację kołową na kanale +2";
    strings["14xx: Toggle swap counters (noise only)"].plurals[0] = "14xx: Włącz zamianę liczników (tylko szum)";
    strings["15xx: Toggle low pass (noise only)"].plurals[0] = "15xx: Włącz filtr dolnoprzep. (tylko szum)";
    strings["16xx: Set clock divider (0: /2; 1: /3)"].plurals[0] = "16xx: Ustaw dzielnik zegara (0: /2; 1: /3)";
    strings["a fictional sound chip by LTVA. like SID, but with many of its problems fixed. also features extended functionality like more wave mixing modes, tonal noise, filter and volume per channel."].plurals[0] = "fikcyjny układ dźwiękowy stworzony przez LTVA. podobny do SID, ale z wieloma naprawionymi problemami. ten układ ma również dodatkowe funkcje, takie jak nowe metody miksowania fal, melodyjny szum, oddzielna regulacja głośności i filtr na każdym kanale.";
    strings["a fictional sound chip by Euly. similar to Ricoh 2A03, but all the duty cycles are different, noise has 32 pitches instead of 16 and you have four hard-coded waveforms on triangle channel."].plurals[0] = "fikcyjny układ dźwiękowy stworzony przez Euly. podobny do Ricoh 2A03, ale wszytskie szerokości fali prostokątnej są inne, szum ma 32 możliwe częstotliwości do wyboru (zamiast 16), masz też również 4 pre-definiowany kształty fal na kanale 3.";
    strings["12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1, wave: 0 to 3)"].plurals[0] = "12xx: Ustaw szerokość fali prostokątnej/tryb szumu (fala prost.: 0-3; szum: 0 lub 1; fala: 0-3)";
    strings["19xx: Set wave linear counter (0 to 7F; 80 and higher halt)"].plurals[0] = "19xx: Ustaw liniowy licznik fali (0-7F; 80 i wyższe zatrzymują)";
    strings["additional PCM FIFO channels in Game Boy Advance driven directly by its DMA hardware."].plurals[0] = "dodatkowe kanały PCM typu FIFO znajdujące się w Game Boy'u Advance sterowane bezpośrednio przez własne, sprzętowe DMA";
    strings["additional PCM FIFO channels in Game Boy Advance driven by software mixing to provide up to sixteen sample channels."].plurals[0] = "dodatkowe kanały PCM typu FIFO znajdujące się w Game Boy'u Advance sterowane przez główny procesor, aby uzyskać 16 kanałów PCM.";
    strings["11xy: Set echo channel (x: left/right source; y: delay (0 disables))"].plurals[0] = "11xy: Ustaw kanał echo (x: lewe/prawe źródło; y: opóźnienie (0 wyłącza))";
    strings["12xy: Toggle invert (x: left; y: right)"].plurals[0] = "12xy: Włącz odwrócenie sygnału (x: lewo; y: prawo)";
    strings["a handheld video game console with two screens. it uses a stylus."].plurals[0] = "przenośna konsola do gier z dwoma ekranami. w zestawie był rysik";
    strings["12xx: Set duty cycle (pulse: 0 to 7)"].plurals[0] = "12xx: Ustaw szerokość fali prostokątnej (zakres: 0-7)";
    strings["1Fxx: Set global volume (0 to 7F)"].plurals[0] = "1Fxx: Ustaw globalną głośność (0-7F)";
	strings["FZT sound source"].plurals[0] = "Źródło dźwięku FZT";
    strings["a software synth core by LTVA used in Flizzer Tracker (Flipper Zero chiptune tracker)."].plurals[0] = " syntezator dźwięku autorstwa LTVA używany w Flizzer Trackerze (tracker dla Flippera Zero).";
    strings["10xx: Set wave (bits: 0: noise, 1: pulse, 2: triangle, 3: sawtooth, 4: metallic noise, 5: sine)"].plurals[0] = "10xx: Ustaw kształt fali (bity: 0: szum, 1: fala prost., 2: fala trójk., 3: piłokształtna, 4: \"metaliczny\" szum, 5: sinusoida)";
    strings["11xy: PWM (pulsolo) with speed x and depth y"].plurals[0] = "11xy: PWM (pulsolo) z szybkością (x) i głębokością (y)";
    strings["12xx: Set pulse width"].plurals[0] = "12xx: Ustaw szerokość fali prost.";
    strings["13xx: Pulse width up"].plurals[0] = "13xx: Szerokość fali prostokątnej w górę";
    strings["14xx: Pulse width down"].plurals[0] = "14xx: Szerokość fali prostokątnej w dół";
    strings["15xx: Set filter cutoff"].plurals[0] = "15xx: Ustaw punkt odcięcia filtra";
    strings["16xx: Set volume"].plurals[0] = "16xx: Ustaw głośność";
    strings["17xx: Toggle filter"].plurals[0] = "17xx: Wł./wył filtr";
    strings["18xx: Set filter mode"].plurals[0] = "18xx: Ustaw tryb filtra";
    strings["19xx: Phase reset"].plurals[0] = "19xx: Reset fazy";
    strings["1Axx: Filter cutoff up"].plurals[0] = "1Axx: Punkt odcięcia filtra w górę";
    strings["1Bxx: Filter cutoff down"].plurals[0] = "1Bxx: unkt odcięcia filtra w dół";
    strings["1Cxx: Set filter resonance"].plurals[0] = "1Cxx: Ustaw rezonans filtra";
    strings["1Dxx: Filter resonance up"].plurals[0] = "1Dxx: Rezonans w górę";
    strings["1Exx: Filter resonance down"].plurals[0] = "1Exx: Rezonans w górę";
    strings["1Fxx: Ring mod source (FF = self)"].plurals[0] = "1Fxx: Ustaw sygnał źródłowy modulacji kołowej (FF = automodulacja)";
    strings["20xx: Hard sync source (FF = self)"].plurals[0] = "20xx: Ustaw źródło synchronizacji oscylatora (FF = automodulacja)";
    strings["21xx: Set attack speed"].plurals[0] = "21xx: Ustaw atak";
    strings["22xx: Set decay speed"].plurals[0] = "22xx: Ustaw opadanie";
    strings["23xx: Set sustain level"].plurals[0] = "23xx: Ustaw podtrzymanie";
    strings["24xx: Set release rate"].plurals[0] = "24xx: Ustaw zwolnienie";
    strings["25xx: Restart instrument program"].plurals[0] = "25xx: Zrestartuj parametry instrumentu";
    strings["26xx: Portamento up (semitones)"].plurals[0] = "26xx: Portamento w górę (w półtonach)";
    strings["27xx: Portamento down (semitones)"].plurals[0] = "27xx: Portamento w dół (w półtonach)";
    strings["28xx: Absolute arpeggio note"].plurals[0] = "28xx: Absolutna nuta arpeggio";
    strings["29xx: Trigger envelope release"].plurals[0] = "29xx: Wywołaj zwolnienie obwiedni";
    strings["a fantasy sound chip using logistic map iterations to generate sound."].plurals[0] = "fikcyjny układ audio wykorzystujący ciąg iteracji odwzorowania logistycznego do synteszy dźwięku ";
    strings["10xx: Load low byte of channel sample state"].plurals[0] = "10xx: Załaduj niski bajt stanu samplowania kanału";
    strings["11xx: Load high byte of channel sample state"].plurals[0] = "11xx: Załaduj wysoki bajt stanu samplowania kanału";
    strings["12xx: Set low byte of channel parameter"].plurals[0] = "12xx: Ustaw niski bajt parametru kanału";
    strings["13xx: Set high byte of channel parameter"].plurals[0] = "13xx: Ustaw wysoki bajt parametru kanału";
    strings["this is a system designed for testing purposes."].plurals[0] = "ten system jest przeznaczony do testowania.";

    strings["help! what's going on!"].plurals[0] = "pomocy! co się dzieje?";
    strings["Sunsoft 5B standalone"].plurals[0] = "Sunsoft 5B oddzielnie";
    strings["Sunsoft 5B standalone (PAL)"].plurals[0] = "Sunsoft 5B oddzielnie (PAL)";
    strings["Overclocked Sunsoft 5B"].plurals[0] = "Podkręcony Sunsoft 5B";
    strings["Sega Genesis Extended Channel 3"].plurals[0] = "Sega Mega Drive z rozszerzonym kanałem 3";
    strings["NTSC-J Sega Master System + drums"].plurals[0] = "NTSC-J Sega Master System + perkusja";
    strings["MSX-MUSIC + drums"].plurals[0] = "MSX-MUSIC + perkusja";
    strings["Commodore 64 with dual 6581"].plurals[0] = "Commodore 64 z dwoma 6581";
    strings["Commodore 64 with dual 8580"].plurals[0] = "Commodore 64 z dwoma 8580";
    strings["YM2151 + SegaPCM Arcade (compatibility)"].plurals[0] = "YM2151 + SegaPCM Arcade (kompatybilny)";
    strings["YM2151 + SegaPCM Arcade"].plurals[0] = "YM2151 + SegaPCM Arcade";
    strings["Game Boy with AY expansion"].plurals[0] = "Game Boy z rozszerzeniem AY";
    strings["multi-system"].plurals[0] = "muti-system";
    strings["Unknown"].plurals[0] = "Nieznany";
    strings["15xx: Set raw period"].plurals[0] = "15xx: Ustaw absolutny okres";
    strings["16xx: Set raw period higher nybble (0-F)"].plurals[0] = "16xx: Ustaw wyższy półbajt absolutnego okresu (0-F)";
    strings["Sega Genesis Extended Channel 31"].plurals[0] = "Sega Mega Drive z rozszerzonym kanałem 3";
    strings["Neo Geo CD Extended Channel 2"].plurals[0] = "Neo Geo CD z rozszerzonym kanałem 2";
    strings["Famicom Disk System (chip)"].plurals[0] = "Famicom Disk System (sam chip)";
    strings["Yamaha YM2203 (OPN) Extended Channel 3"].plurals[0] = "Yamaha YM2203 (OPN) z rozszerzonym kanałem 3";
    strings["Yamaha YM2608 (OPNA) Extended Channel 3"].plurals[0] = "Yamaha YM2608 (OPNA) z rozszerzonym kanałem 3";
    strings["Yamaha YM2608 (OPNA) Extended Channel 3 and CSM"].plurals[0] = "Yamaha YM2608 (OPNA) z rozszerzonym kanałem 3 i CSM";
    strings["PC Speaker"].plurals[0] = "PC Speaker (brzęczyk)";
    strings["ZX Spectrum Beeper"].plurals[0] = "Brzęczyk ZX Spectrum";
    strings["Yamaha YM2612 (OPN2) Extended Channel 3"].plurals[0] = "Yamaha YM2612 (OPN2) z rozszerzonym kanałem 3";
    strings["Yamaha YM3526 (OPL) with drums"].plurals[0] = "Yamaha YM3526 (OPL) (tryb perkusji)";
    strings["Yamaha YM3812 (OPL2) with drums"].plurals[0] = "Yamaha YM3812 (OPL2) (tryb perkusji)";
    strings["Yamaha YMF262 (OPL3) with drums"].plurals[0] = "Yamaha YMF262 (OPL3) (tryb perkusji)";
    strings["Yamaha YM2610 (OPNB) Extended Channel 2"].plurals[0] = "Yamaha YM2610 (OPNB) z rozszerzonym kanałem 2";
    strings["Yamaha YM2413 (OPLL) with drums"].plurals[0] = "=Yamaha YM2413 (OPLL) (tryb perkusji)";
    strings["Yamaha YM2610B (OPNB2) Extended Channel 3"].plurals[0] = "Yamaha YM2610B (OPNB2) z rozszerzonym kanałem 3";
    strings["SegaPCM (compatible 5-channel mode)"].plurals[0] = "SegaPCM (kompatybilny tryb 5-kanałowy)";
    strings["Yamaha YMF278B (OPL4) with drums"].plurals[0] = "Yamaha YMF278B (OPL4) (tryb perkusji)";
    strings["Yamaha Y8950 with drums"].plurals[0] = "Yamaha Y8950 (tryb perkusji)";
    strings["Yamaha YM2612 (OPN2) with DualPCM"].plurals[0] = "Yamaha YM2612 (OPN2) z DualPCM";
    strings["Yamaha YM2612 (OPN2) Extended Channel 3 with DualPCM and CSM"].plurals[0] = "Yamaha YM2612 (OPN2) z rozszerzonym kanałem 3, DualPCM i CSM";
    strings["Generic PCM DAC"].plurals[0] = "Typowy przetwornik C/A";
    strings["ZX Spectrum Beeper (QuadTone Engine)"].plurals[0] = "Brzęczyk ZX Spectrum (silnik QuadTone)";
    strings["ESS ES1xxx series (ESFM)"].plurals[0] = "ESS serii ES1xxx (ESFM)";
    strings["Dummy System"].plurals[0] = "System-wydmuszka";

     //channel names

    strings["Channel 1"].plurals[0] = "Kanał 1";
    strings["Channel 2"].plurals[0] = "Kanał 2";
    strings["Channel 3"].plurals[0] = "Kanał 3";
    strings["Channel 4"].plurals[0] = "Kanał 4";
    strings["Channel 5"].plurals[0] = "Kanał 5";
    strings["Channel 6"].plurals[0] = "Kanał 6";
    strings["Channel 7"].plurals[0] = "Kanał 7";
    strings["Channel 8"].plurals[0] = "Kanał 8";
    strings["Channel 9"].plurals[0] = "Kanał 9";
    strings["Channel 10"].plurals[0] = "Kanał 10";
    strings["Channel 11"].plurals[0] = "Kanał 11";
    strings["Channel 12"].plurals[0] = "Kanał 12";
    strings["Channel 13"].plurals[0] = "Kanał 13";
    strings["Channel 14"].plurals[0] = "Kanał 14";
    strings["Channel 15"].plurals[0] = "Kanał 15";
    strings["Channel 16"].plurals[0] = "Kanał 16";
    strings["Channel 17"].plurals[0] = "Kanał 17";
    strings["Channel 18"].plurals[0] = "Kanał 18";
    strings["Channel 19"].plurals[0] = "Kanał 19";
    strings["Channel 20"].plurals[0] = "Kanał 20";
    strings["Channel 21"].plurals[0] = "Kanał 21";
    strings["Channel 22"].plurals[0] = "Kanał 22";
    strings["Channel 23"].plurals[0] = "Kanał 23";
    strings["Channel 24"].plurals[0] = "Kanał 24";
    strings["Channel 25"].plurals[0] = "Kanał 25";
    strings["Channel 26"].plurals[0] = "Kanał 26";
    strings["Channel 27"].plurals[0] = "Kanał 27";
    strings["Channel 28"].plurals[0] = "Kanał 28";
    strings["Channel 29"].plurals[0] = "Kanał 29";
    strings["Channel 30"].plurals[0] = "Kanał 30";
    strings["Channel 31"].plurals[0] = "Kanał 31";
    strings["Channel 32"].plurals[0] = "Kanał 32";

    strings["Square"].plurals[0] = "Kwadrat";

    strings["Square 1"].plurals[0] = "Kwadrat 1";
    strings["Square 2"].plurals[0] = "Kwadrat 2";
    strings["Square 3"].plurals[0] = "Kwadrat 3";

    strings["Pulse"].plurals[0] = "Prostokąt";

    strings["Pulse 1"].plurals[0] = "Prostokąt 1";
    strings["Pulse 2"].plurals[0] = "Prostokąt 2";

    strings["Wave"].plurals[0] = "Fala";
    strings["Wavetable"].plurals[0] = "Tabl. fali";

    strings["Triangle"].plurals[0] = "Trójkąt";
    ...
    strings["DAC Left"].plurals[0] = "DAC Lewy";
    strings["DAC Right"].plurals[0] = "DAC Prawy";

    strings["Noise"].plurals[0] = "Szum";

    strings["Noise 1"].plurals[0] = "Szum 1";
    strings["Noise 2"].plurals[0] = "Szum 2";
    strings["Noise 3"].plurals[0] = "Szum 3";

    strings["Slope"].plurals[0] = "Spadek";

    strings["FM 6/PCM 1"].plurals[0] = "FM 6/PCM 1";
    strings["CSM Timer"].plurals[0] = "Timer CSM";

    strings["VRC6 Saw"].plurals[0] = "Piła VRC6";
    ...
    strings["Kick/FM 7"].plurals[0] = "Stopa/FM7";
    strings["Kick/FM 16"].plurals[0] = "Stopa/FM16";
    strings["Kick"].plurals[0] = "Stopa";
    strings["Snare"].plurals[0] = "Werbel";
    strings["Top"].plurals[0] = "Talerz";
    strings["HiHat"].plurals[0] = "Hi-hat";
    strings["Tom"].plurals[0] = "Tom-tom";
    strings["Rim"].plurals[0] = "Rimshot";

    // channel short names

    strings["CH1"].plurals[0] = "KN1";
    strings["CH2"].plurals[0] = "KN2";
    strings["CH3"].plurals[0] = "KN3";
    strings["CH4"].plurals[0] = "KN4";
    strings["CH5"].plurals[0] = "KN5";
    strings["CH6"].plurals[0] = "KN6";
    strings["CH7"].plurals[0] = "KN7";
    strings["CH8"].plurals[0] = "KN8";
    strings["CH9"].plurals[0] = "KN9";

    strings["NO"].plurals[0] = "SZ";
    strings["N1"].plurals[0] = "SZ1";
    strings["N2"].plurals[0] = "SZ2";
    strings["N3"].plurals[0] = "SZ3";

    strings["SL"].plurals[0] = "SP";

    strings["S1"].plurals[0] = "P1";
    strings["S2"].plurals[0] = "P2";
    strings["S3"].plurals[0] = "P3";
    strings["S4"].plurals[0] = "P4";
    strings["S5"].plurals[0] = "P5";
    strings["S6"].plurals[0] = "P6";

    strings["P1"].plurals[0] = "SA1";
    strings["P2"].plurals[0] = "SA2";
    strings["P3"].plurals[0] = "SA3";
    strings["P4"].plurals[0] = "SA4";
    strings["P5"].plurals[0] = "SA5";
    strings["P6"].plurals[0] = "SA6";
    strings["P7"].plurals[0] = "SA7";
    strings["P8"].plurals[0] = "SA8";
    strings["P9"].plurals[0] = "SA9";
    strings["P10"].plurals[0] = "SA10";
    strings["P11"].plurals[0] = "SA11";
    strings["P12"].plurals[0] = "SA12";
    strings["P13"].plurals[0] = "SA13";
    strings["P14"].plurals[0] = "SA14";
    strings["P15"].plurals[0] = "SA15";
    strings["P16"].plurals[0] = "SA16";
    strings["P17"].plurals[0] = "SA17";
    strings["P18"].plurals[0] = "SA18";
    strings["P19"].plurals[0] = "SA19";
    strings["P20"].plurals[0] = "SA20";
    strings["P21"].plurals[0] = "SA21";
    strings["P22"].plurals[0] = "SA22";
    strings["P23"].plurals[0] = "SA23";
    strings["P24"].plurals[0] = "SA24";

    strings["BD"].plurals[0] = "BB";
    strings["SD"].plurals[0] = "WB";
    strings["TP"].plurals[0] = "TL";
