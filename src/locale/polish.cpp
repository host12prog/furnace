...
void DivLocale::addTranslationsPolish()
{
    ...
    strings["could not save sample! open Log Viewer for more information.##sggu1"].plurals[0] = "nie udało się zapisać sampla! otwoórz podląd logów aby uzyskać więcej informacji.";
    ...
    strings["20xx: Set channel mode (bit 0: square; bit 1: noise; bit 2: envelope)##sesd"].plurals[0] = "20xx: Режим канала (бит 0: меандр; бит 1: szum; бит 2: огибающая)";
    ...
    strings["10xx: Set waveform##sesd1"].plurals[0] = "10xx: Ustaw falę";
    ...
    strings["TIA, but better and more flexible.\nused in the Atari 8-bit family of computers (400/800/XL/XE).##sesd"].plurals[0] = "TIA, ale lepsze i prossze w obsłudze\nbył używany w rodzinie 8-bitowych komputerów Atari (400/800/XL/XE).";
    ...
    strings["this is like SNES' sound chip but without interpolation and the rest of nice bits.##sesd"].plurals[0] = "odobny do układu dźwiękowego SNES, ale bez interpolacji i innych fajnych ficzerów";
    ...
    strings["10xx: Set waveform##sesd5"].plurals[0] = "10xx: Ustaw falę";
    ...
    strings["a portable console made by Atari. it has all of Atari's trademark waveforms.##sesd"].plurals[0] = "przenośna konsola do gier od Atari. posiada wszystkie charakterystyczne dla Atari fale";
    ...
    strings["the chip used in a computer design created by The 8-Bit Guy.##sesd"].plurals[0] = "układ używany w projekcie komputera opracowanym przez 8-Bit Guy.";
    ...
    strings["10xx: Set waveform##sesd8"].plurals[0] = "10xx: Ustaw falę";
    strings["10xx: Set waveform##sesd9"].plurals[0] = "10xx: Ustaw  falę";
    ...
    strings["like Namco C15 but with stereo sound.##sesd"].plurals[0] = "to samo co Namco C15, aloe z dźwiękiem stereo.";
    ...
    strings["10xx: Set waveform (0 to 4; 0 to 3 on noise)##sesd"].plurals[0] = "10xx: Ustaw falę (0-4; 0-3 na kanale szumu)";
