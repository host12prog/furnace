...
void DivLocale::addTranslationsPolish()
{
    ...
    strings["F5xx: Disable macro (see manual)##seen"].plurals[0] = "F5xx: Отключить макрос (patrz: instrukcja)";
    strings["F6xx: Enable macro (see manual)##seen"].plurals[0] = "F6xx: włącz makro (patrz: instrukcja)";
    strings["F7xx: Restart macro (see manual)##seen"].plurals[0] = "F7xx: Перезапустить макрос (patrz: instrukcja)";
