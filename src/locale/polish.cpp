...
void DivLocale::addTranslationsPolish()
{
    ...
    strings["Ignore DAC mode change outside of intended channel in ExtCh mode##sgcf"].plurals[0] = "Ignoruj przełączanie trybu DAC, poza odpowiednim kanałem odpowiednim kanale, w trybie rozszerzonego kanału 3";
    ...
    strings["None##sgcf"].plurals[0] = "Brak (прямая работа с частотой)";
    ...
    strings["Normal##sgcf"].plurals[0] = "Normalny";
    ...
    strings["WaveTools##sgwe"].plurals[0] = "Narzędzia tablic";
    strings["Scale X##sgwe"].plurals[0] = "Skaluj oś X";
    strings["wavetable longer than 256 samples!##sgwe"].plurals[0] = "tablioca fal powyżej 256 sampli!";
    ...
    strings["Half##sgwe"].plurals[0] = "Zmniejsz 2х";
    strings["Double##sgwe"].plurals[0] = "Powiększ 2х";
    ...
    strings["Closest to Tick Rate##sgse"].plurals[0] = "Najbliżsy częstotliwości silnika trackera";
    ...
    strings["Regular##CHFont0"].plurals[0] = "Zwykłas#CHFont0";
    ...
    strings["Channel type##CHC1"].plurals[0] = "Zgodnie z typem kanału##CHC1";
    strings["Instrument type##CHC2"].plurals[0] = "Zgodnie z typem instrumentu##CHC2";
    ...
    strings["Log level: Trace/Verbose##CC_GUI_COLOR_LOGLEVEL_TRACE"].plurals[0] = "Уровень лога: Diagnostyka/Szczegóły##CC_GUI_COLOR_LOGLEVEL_TRACE";
    ...
    strings["10xx: Set waveform (bit 0: triangle; bit 1: saw; bit 2: pulse; bit 3: noise)##sesd1"].plurals[0] = "10xx: Ustaw kształt fali (bit 0: fala trójkątna.; bit 1: fala piłokształtna; bit 2: fala prostokątna.; bit 3: szum)";
