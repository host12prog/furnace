...
//   sgcs  src/gui/csPlayer.cpp
    ...
    strings["pattern visualizer##sggu"].plurals[0] = "wizualizator wzorca";
    ...
    strings["song##sggu"].plurals[0] = "utwór";
    strings["visualizers##sggu"].plurals[0] = "wizualizator";
    strings["tempo##sggu"].plurals[0] = "tempo";
    strings["debug##sggu"].plurals[0] = "debugowanie";
    ...
    strings["%s: maximum sample rate is %d##sgsed"].plurals[0] = "%s: maksymalna częstotliwość samplowania to %d";
    strings["%s: minimum sample rate is %d##sgsed"].plurals[0] = "%s: minimalna częstotliwość samplowania to %d";
    strings["%s: sample rate must be %d##sgsed"].plurals[0] = "%s: częstotliwość samplowania musi wynosić %d";
    strings["Sample Editor###Sample Editor"].plurals[0] = "Edytor sampli###Sample Editor";
    strings["no sample selected##sgsed"].plurals[0] = "nie wybrano sampla";
    strings["select one...##sgsed"].plurals[0] = "wybierz jeden...";
    strings["or##sgsed0"].plurals[0] = "albo";
    strings["Open##sgsed0"].plurals[0] = "Otwórz";
    strings["or##sgsed1"].plurals[0] = "albo";
    strings["Create New##sgsed"].plurals[0] = "Stwórz nowy";
    ...
    strings["import raw...##sgsed"].plurals[0] = "importj dane surowe...";
    strings["Save##sgsed"].plurals[0] = "zapisz";
    strings["save raw...##sgsed"].plurals[0] = "zapisz dane surowe...";
    strings["Name##sgsed"].plurals[0] = "nazwa";
    strings["SNES: loop start must be a multiple of 16 (try with %d)##sgsed"].plurals[0] = "SNES: początek pętli musi być wielokrotnością 16 (spróbuj %d)";
    strings["SNES: loop end must be a multiple of 16 (try with %d)##sgsed"].plurals[0] = "SNES: koniec pętli musi być wielokrotnością 16 (spróbuj %d)";
    ...
    strings["X1-010: maximum sample length is 131072##sgsed"].plurals[0] = "X1-010: maksymalna długość sampla wynosi 131072";
    strings["GA20: samples can't loop##sgsed"].plurals[0] = "GA20: zapętlanie sampli niewspierane";
    strings["YM2608: loop point ignored on ADPCM (may only loop entire sample)##sgsed"].plurals[0] = "YM2608: punkt pętli jest ignorowany dla ADPCM (tylko cały sampel może być zapętlony)";
    strings["YM2608: sample length will be padded to multiple of 512##sgsed"].plurals[0] = "YM2608: długość sampla zostanie dostosowana do wielokrotności 512";
    strings["YM2610: ADPCM-A samples can't loop##sgsed"].plurals[0] = "YM2610: ADPCM-A zapętlanie sampli niewspierane";
    strings["YM2610: loop point ignored on ADPCM-B (may only loop entire sample)##sgsed"].plurals[0] = "YM2610: punkt pętli jest ignorowany dla ADPCM-B (tylko cały sampel może być zapętlony)";
    strings["YM2610: sample length will be padded to multiple of 512##sgsed"].plurals[0] = "YM2610: długość sampla zostanie dostosowana do wielokrotności 512";
    strings["YM2610: maximum ADPCM-A sample length is 2097152##sgsed"].plurals[0] = "YM2610: maksymalna długość sampla ADPCM-A  wynosi 2097152";
    strings["Y8950: loop point ignored on ADPCM (may only loop entire sample)##sgsed"].plurals[0] = "Y8950: punkt pętli jest ignorowany dla ADPCM (tylko cały sampel może być zapętlony)";
    strings["Y8950: sample length will be padded to multiple of 512##sgsed"].plurals[0] = "Y8950: długość sampla zostanie dostosowana do wielokrotności 512";
    strings["Amiga: loop start must be a multiple of 2##sgsed"].plurals[0] = "Amiga: początek pętli musi być wielokrotnością 2";
    strings["Amiga: loop end must be a multiple of 2##sgsed"].plurals[0] = "Amiga: koniec pętli musi być wielokrotnością 2";
    strings["Amiga: maximum sample length is 131070##sgsed"].plurals[0] = "Amiga: maksymalna długość sampla wynosi 131070";
    strings["SegaPCM: maximum sample length is 65280##sgsed"].plurals[0] = "SegaPCM: maksymalna długość sampla wynosi 65280";
    strings["K053260: loop point ignored (may only loop entire sample)##sgsed"].plurals[0] = "K053260: punkt pętli jest ignorowany (tylko cały sampel może być zapętlony)";
    strings["K053260: maximum sample length is 65535##sgsed"].plurals[0] = "K053260: maksymalna długość sampla wynosi 65535";
    strings["C140: maximum sample length is 65535##sgsed"].plurals[0] = "C140: maksymalna długość sampla wynosi 65535";
    strings["C219: loop start must be a multiple of 2##sgsed"].plurals[0] = "C219: początek pętli musi być wielokrotnością 2";
    strings["C219: loop end must be a multiple of 2##sgsed"].plurals[0] = "C219: koniec pętli musi być wielokrotnością 2";
    strings["C219: maximum sample length is 131072##sgsed"].plurals[0] = "C219: maksymalna długość sampla wynosi 131072";
    strings["MSM6295: samples can't loop##sgsed"].plurals[0] = "MSM6295: zapętlanie sampli niewspierane";
    strings["MSM6295: maximum bankswitched sample length is 129024##sgsed"].plurals[0] = "MSM6295: maksymalna długość sampla przy zmianie banków wynosi 129024";
    strings["GBA DMA: loop start must be a multiple of 4##sgsed"].plurals[0] = "GBA DMA: punkt początku pętli musi być wielokrotnością 4";
    strings["GBA DMA: loop length must be a multiple of 16##sgsed"].plurals[0] = "GBA DMA: dłogość pętli musi być wielokrotnością 16";
    strings["GBA DMA: sample length will be padded to multiple of 16##sgsed"].plurals[0] = "GBA DMA: długość sampla zostanie przeskalowana do wielokrotności 16";
    strings["ES5506: backward loop mode isn't supported##sgsed"].plurals[0] = "ES5506: tryb pętli odwrotnej nie jest obsługiwany";
    strings["backward/ping-pong only supported in Generic PCM DAC\nping-pong also on ES5506##sgsed"].plurals[0] = "Tryb odwrócony jest obsługiwany tylko przez uniwersalny przetwornik C/A, a także przez ES5506.";
    strings["Info##sgsed"].plurals[0] = "Info";
    strings["Rate##sgsed0"].plurals[0] = "Częstotliwość";
    strings["Compat Rate##sgsed"].plurals[0] = "Kompat. częstotliwość";
    strings["used in DefleMask-compatible sample mode (17xx), in where samples are mapped to an octave.##sgsed"].plurals[0] = "jest używana podczas odtwarzania w trybie zgodności z DefleMaskiem (17xx), w którym sample odpowiadają oktawie.";
    strings["Loop##sgsed"].plurals[0] = "Pętla";
    ...
    strings["Chips##sgsed"].plurals[0] = "Układy";
    strings["Type##sgsed"].plurals[0] = "Typ";
    strings["BRR emphasis##sgsed"].plurals[0] = "Przetwarzanie końcowe BRR";
    strings["this is a BRR sample.\nenabling this option will muffle it (only affects non-SNES chips).##sgsed"].plurals[0] = "jest to sampel BRR.\nwłączenie tej funkcji przytłumi go (na wszystkich układach poza SNES).";
    ...
    strings["End##sgsed"].plurals[0] = "Koniec";
    ...
    strings["Edit mode: Select##sgsed"].plurals[0] = "Tryb edycji: zaznaczanie";
    strings["Edit mode: Draw##sgsed"].plurals[0] = "Tryb edycji: rysowanie";
    ...
    strings["couldn't resize! make sure your sample is 8 or 16-bit.##sgsed"].plurals[0] = "nie udało się zmienić rozmiaru! upewnij się, że sample są 8 lub 16-bitowe.";
    strings["Resample##sgsed0"].plurals[0] = "Zmień częstotliwość samplowania";
    strings["Rate##sgsed1"].plurals[0] = "Częstotliwość";
    strings["Factor##sgsed"].plurals[0] = "Współczynnik";
    strings["Filter##sgsed"].plurals[0] = "Filtr";
    strings["Resample##sgsed1"].plurals[0] = "Zmień częstotliwość samplowania";
    strings["couldn't resample! make sure your sample is 8 or 16-bit.##sgsed"].plurals[0] = "nie udało się zmienić częstotliwości samplowania! upewnij się, że sampel jest 8- lub 16-bitowy.";
    strings["Undo##sgsed"].plurals[0] = "Cofnij";
    strings["Redo##sgsed"].plurals[0] = "Ponów";
    strings["Amplify##sgsed"].plurals[0] = "Wzmocnij";
    strings["Volume##sgsed"].plurals[0] = "Głośność";
    strings["Apply##sgsed0"].plurals[0] = "Zastosuj";
    strings["Normalize##sgsed"].plurals[0] = "Normalizuj";
    strings["Fade in##sgsed"].plurals[0] = "Płynny wzrost";
    strings["Fade out##sgsed"].plurals[0] = "Płynne tłumienie";
    strings["Insert silence##sgsed"].plurals[0] = "Wstaw ciszę";
    strings["Samples##sgsed1"].plurals[0] = "Sample";
    strings["Go##sgsed"].plurals[0] = "Zastosuj";
    strings["couldn't insert! make sure your sample is 8 or 16-bit.##sgsed"].plurals[0] = "nie udało się wstawić! upewnij się że sampel jest 8- lub 16-bitowy.";
    strings["Apply silence##sgsed"].plurals[0] = "Dodaj ciszę";
    strings["Delete##sgsed"].plurals[0] = "Usuń";
    strings["Trim##sgsed"].plurals[0] = "Obetnij";
    strings["Reverse##sgsed"].plurals[0] = "Odwrotność";
    strings["Invert##sgsed"].plurals[0] = "Odwróć";
    strings["Signed/unsigned exchange##sgsed"].plurals[0] = "Ze znakiem <-> Bez znaku";
    strings["Apply filter##sgsed"].plurals[0] = "Zastosuj filtr";
    strings["Cutoff:##sgsed"].plurals[0] = "Pukt odcięcia:";
    strings["From##sgsed"].plurals[0] = "Od";
    strings["To##sgsed"].plurals[0] = "Do";
    strings["Resonance##sgsed"].plurals[0] = "Rezonans";
    strings["Power##sgsed"].plurals[0] = "Moc filtra";
    strings["Low-pass##sgsed"].plurals[0] = "dolno-przepustowy";
    strings["Band-pass##sgsed"].plurals[0] = "środkowo-przepustowy";
    strings["High-pass##sgsed"].plurals[0] = "górno-przepustowy";
    strings["Apply##sgsed1"].plurals[0] = "Zastosuj";
    strings["Crossfade loop points##sgsed"].plurals[0] = "Punkty zapętlenia crossfade-u";
    strings["Number of samples##sgsed"].plurals[0] = "Ilość sampli";
    strings["Linear <-> Equal power##sgsed"].plurals[0] = "Liniowy <-> Ten sam stopień";
    strings["Apply##sgsed2"].plurals[0] = "Zastosuj";
    strings["Crossfade: length would go out of bounds. Aborted...##sgsed"].plurals[0] = "Crossfade: długość wyjdzie poza granice. Akcja anulowana.";
    strings["Crossfade: length would overflow loopStart. Try a smaller random value.##sgsed"].plurals[0] = "Crossfade: długość wykracza poza początek cyklu. Spróbuj użyć mniejszej wartości losowej.";
    strings["Preview sample##sgsed"].plurals[0] = "Poglad sampla";
    strings["Stop sample preview##sgsed"].plurals[0] = "Zatrzymaj podglad sampla";
    ...
    strings["paste##sgsed"].plurals[0] = "wklej";
    strings["paste (replace)##sgsed"].plurals[0] = "wklej i zamień";
    strings["paste (mix)##sgsed"].plurals[0] = "wstaw ze zmieszaniem";
    strings["select all##sgsed"].plurals[0] = "wybierz wszystko";
    strings["set loop to selection##sgsed"].plurals[0] = "ustaw pętlę na zaznaczeniu";
    strings["create wavetable from selection##sgsed"].plurals[0] = "stwórz tablicę fal z zaznaczenia";
    strings["Draw##sgsed"].plurals[0] = "Rysuj";
    strings["Select##sgsed"].plurals[0] = "Wybierz";
    strings["%d samples##sgsed"].plurals[0] = "%d sampel";
    strings["%d samples##sgsed"].plurals[1] = "%d sample";
    strings["%d samples##sgsed"].plurals[2] = "%d sampli";
    strings["%d bytes##sgsed"].plurals[0] = "%d bajt";
    strings["%d bytes##sgsed"].plurals[1] = "%d bajty";
    strings["%d bytes##sgsed"].plurals[2] = "%d bajtów";
