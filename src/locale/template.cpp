...
//progress on sifting through files alphabetically
    ...
    strings["the song is over!##sggu0"].plurals[0] = "=the song is over!##sggu0";
    strings["the song is over!##sggu1"].plurals[0] = "=the song is over!##sggu1";
    strings["Open File##sggu"].plurals[0] = "=Open File##sggu";
    strings["compatible files##sggu0"].plurals[0] = "=compatible files##sggu0";
    strings["all files##sggu0"].plurals[0] = "=all files##sggu0";
    strings["no backups made yet!##sggu"].plurals[0] = "=no backups made yet!##sggu";
    strings["Restore Backup##sggu"].plurals[0] = "=Restore Backup##sggu";
    strings["Furnace song##sggu0"].plurals[0] = "=Furnace song##sggu0";
    strings["Save File##sggu"].plurals[0] = "=Save File##sggu";
    strings["Furnace song##sggu1"].plurals[0] = "=Furnace song##sggu1";
    strings["Load Instrument##sggu"].plurals[0] = "=Load Instrument##sggu";
    strings["all compatible files##sggu1"].plurals[0] = "=all compatible files##sggu1";
    strings["Furnace instrument##sggu0"].plurals[0] = "=Furnace instrument##sggu0";
    strings["DefleMask preset##sggu0"].plurals[0] = "=DefleMask preset##sggu0";
    strings["TFM Music Maker instrument##sggu"].plurals[0] = "=TFM Music Maker instrument##sggu";
    strings["VGM Music Maker instrument##sggu"].plurals[0] = "=VGM Music Maker instrument##sggu";
    strings["Scream Tracker 3 instrument##sggu"].plurals[0] = "=Scream Tracker 3 instrument##sggu";
    strings["SoundBlaster instrument##sggu"].plurals[0] = "=SoundBlaster instrument##sggu";
    strings["Wohlstand OPL instrument##sggu"].plurals[0] = "=Wohlstand OPL instrument##sggu";
    strings["Wohlstand OPN instrument##sggu"].plurals[0] = "=Wohlstand OPN instrument##sggu";
    strings["Gens KMod patch dump##sggu"].plurals[0] = "=Gens KMod patch dump##sggu";
    strings["BNK file (AdLib)##sggu"].plurals[0] = "=BNK file (AdLib)##sggu";
    strings["FF preset bank##sggu"].plurals[0] = "=FF preset bank##sggu";
    strings["2612edit GYB preset bank##sggu"].plurals[0] = "=2612edit GYB preset bank##sggu";
    strings["VOPM preset bank##sggu"].plurals[0] = "=VOPM preset bank##sggu";
    strings["Wohlstand WOPL bank##sggu"].plurals[0] = "=Wohlstand WOPL bank##sggu";
    strings["Wohlstand WOPN bank##sggu"].plurals[0] = "=Wohlstand WOPN bank##sggu";
    strings["all files##sggu1"].plurals[0] = "=all files##sggu1";
    strings["Save Instrument##sggu0"].plurals[0] = "=Save Instrument##sggu0";
    strings["Furnace instrument##sggu1"].plurals[0] = "=Furnace instrument##sggu1";
    strings["Save Instrument##sggu1"].plurals[0] = "=Save Instrument##sggu1";
    strings["DefleMask preset##sggu1"].plurals[0] = "=DefleMask preset##sggu1";
    strings["Load Wavetable##sggu"].plurals[0] = "=Load Wavetable##sggu";
    strings["compatible files##sggu2"].plurals[0] = "=compatible files##sggu2";
    strings["all files##sggu2"].plurals[0] = "=all files##sggu2";
    strings["Save Wavetable##sggu0"].plurals[0] = "=Save Wavetable##sggu0";
    strings["Furnace wavetable##sggu"].plurals[0] = "=Furnace wavetable##sggu";
    strings["Save Wavetable##sggu1"].plurals[0] = "=Save Wavetable##sggu1";
    strings["DefleMask wavetable##sggu"].plurals[0] = "=DefleMask wavetable##sggu";
    strings["Save Wavetable##sggu2"].plurals[0] = "=Save Wavetable##sggu2";
    strings["raw data##sggu"].plurals[0] = "=raw data##sggu";
    strings["Load Sample##sggu"].plurals[0] = "=Load Sample##sggu";
    strings["compatible files##sggu3"].plurals[0] = "=compatible files##sggu3";
    strings["all files##sggu3"].plurals[0] = "=all files##sggu3";
    strings["Load Raw Sample##sggu"].plurals[0] = "=Load Raw Sample##sggu";
    strings["all files##sggu4"].plurals[0] = "=all files##sggu4";
    strings["Save Sample##sggu"].plurals[0] = "=Save Sample##sggu";
    strings["Wave file##sggu0"].plurals[0] = "=Wave file##sggu0";
    strings["Save Raw Sample##sggu"].plurals[0] = "=Save Raw Sample##sggu";
    strings["all files##sggu5"].plurals[0] = "=all files##sggu5";
    strings["Export Audio##sggu0"].plurals[0] = "=Export Audio##sggu0";
    strings["Wave file##sggu1"].plurals[0] = "=Wave file##sggu1";
    strings["Export Audio##sggu1"].plurals[0] = "=Export Audio##sggu1";
    strings["Wave file##sggu2"].plurals[0] = "=Wave file##sggu2";
    strings["Export Audio##sggu2"].plurals[0] = "=Export Audio##sggu2";
    strings["Wave file##sggu3"].plurals[0] = "=Wave file##sggu3";
    strings["Export VGM##sggu"].plurals[0] = "=Export VGM##sggu";
    strings["VGM file##sggu"].plurals[0] = "=VGM file##sggu";
    strings["Export ZSM##sggu"].plurals[0] = "=Export ZSM##sggu";
    strings["ZSM file##sggu"].plurals[0] = "=ZSM file##sggu";
    strings["Export Command Stream##sggu0"].plurals[0] = "=Export Command Stream##sggu0";
    strings["text file##sggu0"].plurals[0] = "=text file##sggu0";
    strings["Export Command Stream##sggu1"].plurals[0] = "=Export Command Stream##sggu1";
    strings["text file##sggu1"].plurals[0] = "=text file##sggu1";
    strings["Export Command Stream##sggu2"].plurals[0] = "=Export Command Stream##sggu2";
    strings["binary file##sggu"].plurals[0] = "=binary file##sggu";
    strings["Coming soon!##sggu"].plurals[0] = "=Coming soon!##sggu";
    strings["Select Font##sggu0"].plurals[0] = "=Select Font##sggu0";
    strings["compatible files##sggu4"].plurals[0] = "=compatible files##sggu4";
    strings["Select Font##sggu1"].plurals[0] = "=Select Font##sggu1";
    strings["compatible files##sggu5"].plurals[0] = "=compatible files##sggu5";
    strings["Select Font##sggu2"].plurals[0] = "=Select Font##sggu2";
    strings["compatible files##sggu6"].plurals[0] = "=compatible files##sggu6";
    strings["Select Color File##sggu"].plurals[0] = "=Select Color File##sggu";
    strings["configuration files##sggu0"].plurals[0] = "=configuration files##sggu0";
    strings["Select Keybind File##sggu"].plurals[0] = "=Select Keybind File##sggu";
    strings["configuration files##sggu1"].plurals[0] = "=configuration files##sggu1";
    strings["Select Layout File##sggu"].plurals[0] = "=Select Layout File##sggu";
    strings[".ini files##sggu0"].plurals[0] = "=.ini files##sggu0";
    strings["Export Colors##sggu"].plurals[0] = "=Export Colors##sggu";
    strings["configuration files##sggu2"].plurals[0] = "=configuration files##sggu2";
    strings["Export Keybinds##sggu"].plurals[0] = "=Export Keybinds##sggu";
    strings["configuration files##sggu3"].plurals[0] = "=configuration files##sggu3";
    strings["Export Layout##sggu"].plurals[0] = "=Export Layout##sggu";
    strings[".ini files##sggu1"].plurals[0] = "=.ini files##sggu1";
    strings["Load ROM##sggu"].plurals[0] = "=Load ROM##sggu";
    strings["compatible files##sggu7"].plurals[0] = "=compatible files##sggu7";
    strings["all files##sggu6"].plurals[0] = "=all files##sggu6";
    strings["Play Command Stream##sggu"].plurals[0] = "=Play Command Stream##sggu";
    strings["command stream##sggu"].plurals[0] = "=command stream##sggu";
    strings["all files##sggu7"].plurals[0] = "=all files##sggu7";
    strings["Open Test##sggu"].plurals[0] = "=Open Test##sggu";
    strings["compatible files##sggu8"].plurals[0] = "=compatible files##sggu8";
    strings["another option##sggu0"].plurals[0] = "=another option##sggu0";
    strings["all files##sggu8"].plurals[0] = "=all files##sggu8";
    strings["Open Test (Multi)##sggu"].plurals[0] = "=Open Test (Multi)##sggu";
    strings["compatible files##sggu9"].plurals[0] = "=compatible files##sggu9";
    strings["another option##sggu1"].plurals[0] = "=another option##sggu1";
    strings["all files##sggu9"].plurals[0] = "=all files##sggu9";
    strings["Save Test##sggu"].plurals[0] = "=Save Test##sggu";
    strings["Furnace song##sggu"].plurals[0] = "=Furnace song##sggu";
    strings["DefleMask module##sggu"].plurals[0] = "=DefleMask module##sggu";
    strings["you have loaded a backup!\nif you need to, please save it somewhere.\n\nDO NOT RELY ON THE BACKUP SYSTEM FOR AUTO-SAVE!\nFurnace will not save backups of backups.##sggu"].plurals[0] = "=you have loaded a backup!\nif you need to, please save it somewhere.\n\nDO NOT RELY ON THE BACKUP SYSTEM FOR AUTO-SAVE!\nFurnace will not save backups of backups.##sggu";
    strings["cut##sggu"].plurals[0] = "=cut##sggu";
    strings["copy##sggu"].plurals[0] = "=copy##sggu";
    strings["paste##sggu0"].plurals[0] = "=paste##sggu0";
    strings["paste special...##sggu"].plurals[0] = "=paste special...##sggu";
    strings["paste mix##sggu"].plurals[0] = "=paste mix##sggu";
    strings["paste mix (background)##sggu"].plurals[0] = "=paste mix (background)##sggu";
    strings["paste with ins (foreground)##sggu"].plurals[0] = "=paste with ins (foreground)##sggu";
    strings["no instruments available##sggu0"].plurals[0] = "=no instruments available##sggu0";
    strings["paste with ins (background)##sggu"].plurals[0] = "=paste with ins (background)##sggu";
    strings["no instruments available##sggu1"].plurals[0] = "=no instruments available##sggu1";
    strings["paste flood##sggu"].plurals[0] = "=paste flood##sggu";
    strings["paste overflow##sggu"].plurals[0] = "=paste overflow##sggu";
    strings["delete##sggu0"].plurals[0] = "=delete##sggu0";
    strings["select all##sggu"].plurals[0] = "=select all##sggu";
    strings["operation mask...##sggu"].plurals[0] = "=operation mask...##sggu";
    strings["delete##sggu1"].plurals[0] = "=delete##sggu1";
    strings["pull delete##sggu"].plurals[0] = "=pull delete##sggu";
    strings["insert##sggu"].plurals[0] = "=insert##sggu";
    strings["paste##sggu1"].plurals[0] = "=paste##sggu1";
    strings["transpose (note)##sggu"].plurals[0] = "=transpose (note)##sggu";
    strings["transpose (value)##sggu"].plurals[0] = "=transpose (value)##sggu";
    strings["interpolate##sggu0"].plurals[0] = "=interpolate##sggu0";
    strings["fade##sggu"].plurals[0] = "=fade##sggu";
    strings["invert values##sggu0"].plurals[0] = "=invert values##sggu0";
    strings["scale##sggu"].plurals[0] = "=scale##sggu";
    strings["randomize##sggu"].plurals[0] = "=randomize##sggu";
    strings["flip##sggu"].plurals[0] = "=flip##sggu";
    strings["collapse/expand##sggu"].plurals[0] = "=collapse/expand##sggu";
    strings["input latch##sggu"].plurals[0] = "=input latch##sggu";
    strings["&&: selected instrument\n..: no instrument##sggu"].plurals[0] = "=&&: selected instrument\n..: no instrument##sggu";
    strings["Set##sggu"].plurals[0] = "=Set##sggu";
    strings["Reset##sggu"].plurals[0] = "=Reset##sggu";
    strings["note up##sggu"].plurals[0] = "=note up##sggu";
    strings["note down##sggu"].plurals[0] = "=note down##sggu";
    strings["octave up##sggu"].plurals[0] = "=octave up##sggu";
    strings["octave down##sggu"].plurals[0] = "=octave down##sggu";
    strings["values up##sggu"].plurals[0] = "=values up##sggu";
    strings["values down##sggu"].plurals[0] = "=values down##sggu";
    strings["values up (+16)##sggu"].plurals[0] = "=values up (+16)##sggu";
    strings["values down (-16)##sggu"].plurals[0] = "=values down (-16)##sggu";
    strings["transpose##sggu"].plurals[0] = "=transpose##sggu";
    strings["Notes##sggu"].plurals[0] = "=Notes##sggu";
    strings["Values##sggu"].plurals[0] = "=Values##sggu";
    strings["interpolate##sggu1"].plurals[0] = "=interpolate##sggu1";
    strings["change instrument...##sggu"].plurals[0] = "=change instrument...##sggu";
    strings["no instruments available##sggu"].plurals[0] = "=no instruments available##sggu";
    strings["gradient/fade...##sggu"].plurals[0] = "=gradient/fade...##sggu";
    strings["Start##sggu"].plurals[0] = "=Start##sggu";
    strings["End##sggu"].plurals[0] = "=End##sggu";
    strings["Nibble mode##sggu0"].plurals[0] = "=Nibble mode##sggu0";
    strings["Go ahead##sggu"].plurals[0] = "=Go ahead##sggu";
    strings["scale...##sggu"].plurals[0] = "=scale...##sggu";
    strings["Scale##sggu"].plurals[0] = "=Scale##sggu";
    strings["randomize...##sggu"].plurals[0] = "=randomize...##sggu";
    strings["Minimum##sggu"].plurals[0] = "=Minimum##sggu";
    strings["Maximum##sggu"].plurals[0] = "=Maximum##sggu";
    strings["Nibble mode##sggu1"].plurals[0] = "=Nibble mode##sggu1";
    strings["Randomize##sggu"].plurals[0] = "=Randomize##sggu";
    strings["invert values##sggu1"].plurals[0] = "=invert values##sggu1";
    strings["flip selection##sggu"].plurals[0] = "=flip selection##sggu";
    strings["collapse/expand amount##CollapseAmount"].plurals[0] = "=collapse/expand amount##CollapseAmount";
    strings["collapse##sggu"].plurals[0] = "=collapse##sggu";
    strings["expand##sggu"].plurals[0] = "=expand##sggu";
    strings["collapse pattern##sggu"].plurals[0] = "=collapse pattern##sggu";
    strings["expand pattern##sggu"].plurals[0] = "=expand pattern##sggu";
    strings["collapse song##sggu"].plurals[0] = "=collapse song##sggu";
    strings["expand song##sggu"].plurals[0] = "=expand song##sggu";
    strings["find/replace##sggu"].plurals[0] = "=find/replace##sggu";
    ...
    strings["Unsaved changes! Save changes before opening file?##sggu0"].plurals[0] = "=Unsaved changes! Save changes before opening file?##sggu0";
    strings["Error while loading file! (%s)##sggu0"].plurals[0] = "=Error while loading file! (%s)##sggu0";
    strings["Unsaved changes! Save changes before quitting?##sggu"].plurals[0] = "=Unsaved changes! Save changes before quitting?##sggu";
    strings["error while loading fonts! please check your settings.##sggu0"].plurals[0] = "=error while loading fonts! please check your settings.##sggu0";
    strings["File##menubar"].plurals[0] = "=File##menubar";
    strings["file##menubar"].plurals[0] = "=file##menubar";
    strings["new...##sggu"].plurals[0] = "=new...##sggu";
    strings["Unsaved changes! Save changes before creating a new song?##sggu"].plurals[0] = "=Unsaved changes! Save changes before creating a new song?##sggu";
    strings["open...##sggu"].plurals[0] = "=open...##sggu";
    strings["Unsaved changes! Save changes before opening another file?##sggu"].plurals[0] = "=Unsaved changes! Save changes before opening another file?##sggu";
    strings["open recent##sggu"].plurals[0] = "=open recent##sggu";
    strings["Unsaved changes! Save changes before opening file?##sggu1"].plurals[0] = "=Unsaved changes! Save changes before opening file?##sggu1";
    strings["Error while loading file! (%s)##sggu1"].plurals[0] = "=Error while loading file! (%s)##sggu1";
    strings["nothing here yet##sggu"].plurals[0] = "=nothing here yet##sggu";
    strings["clear history##sggu"].plurals[0] = "=clear history##sggu";
    strings["Are you sure you want to clear the recent file list?##sggu"].plurals[0] = "=Are you sure you want to clear the recent file list?##sggu";
    strings["save##sggu"].plurals[0] = "=save##sggu";
    strings["Error while saving file! (%s)##sggu0"].plurals[0] = "=Error while saving file! (%s)##sggu0";
    strings["save as...##sggu"].plurals[0] = "=save as...##sggu";
    strings["export audio...##sggu0"].plurals[0] = "=export audio...##sggu0";
    strings["export VGM...##sggu0"].plurals[0] = "=export VGM...##sggu0";
    strings["export ZSM...##sggu0"].plurals[0] = "=export ZSM...##sggu0";
    strings["export Amiga validation data...##sggu0"].plurals[0] = "=export Amiga validation data...##sggu0";
    strings["export text...##sggu0"].plurals[0] = "=export text...##sggu0";
    strings["export command stream...##sggu0"].plurals[0] = "=export command stream...##sggu0";
    strings["export audio...##sggu1"].plurals[0] = "=export audio...##sggu1";
    strings["export VGM...##sggu1"].plurals[0] = "=export VGM...##sggu1";
    strings["export ZSM...##sggu1"].plurals[0] = "=export ZSM...##sggu1";
    strings["export Amiga validation data...##sggu1"].plurals[0] = "=export Amiga validation data...##sggu1";
    strings["export text...##sggu1"].plurals[0] = "=export text...##sggu1";
    strings["export command stream...##sggu1"].plurals[0] = "=export command stream...##sggu1";
    strings["export...##sggu"].plurals[0] = "=export...##sggu";
    strings["manage chips##sggu"].plurals[0] = "=manage chips##sggu";
    strings["add chip...##sggu"].plurals[0] = "=add chip...##sggu";
    strings["cannot add chip! (##sggu"].plurals[0] = "=cannot add chip! (##sggu";
    strings["configure chip...##sggu"].plurals[0] = "=configure chip...##sggu";
    strings["change chip...##sggu"].plurals[0] = "=change chip...##sggu";
    strings["Preserve channel positions##sggu0"].plurals[0] = "=Preserve channel positions##sggu0";
    strings["remove chip...##sggu"].plurals[0] = "=remove chip...##sggu";
    strings["Preserve channel positions##sggu1"].plurals[0] = "=Preserve channel positions##sggu1";
    strings["cannot remove chip! (##sggu"].plurals[0] = "=cannot remove chip! (##sggu";
    strings["restore backup##sggu"].plurals[0] = "=restore backup##sggu";
    strings["exit##sggu"].plurals[0] = "=exit##sggu";
    strings["Unsaved changes! Save before quitting?##sggu"].plurals[0] = "=Unsaved changes! Save before quitting?##sggu";
    strings["Edit##menubar"].plurals[0] = "=Edit##menubar";
    strings["edit##menubar"].plurals[0] = "=edit##menubar";
    strings["undo##sggu"].plurals[0] = "=undo##sggu";
    strings["redo##sggu"].plurals[0] = "=redo##sggu";
    strings["clear...##sggu"].plurals[0] = "=clear...##sggu";
    strings["Settings##menubar"].plurals[0] = "=Settings##menubar";
    strings["settings##menubar"].plurals[0] = "=settings##menubar";
    strings["full screen##sggu"].plurals[0] = "=full screen##sggu";
    strings["lock layout##sggu"].plurals[0] = "=lock layout##sggu";
    strings["visualizer##sggu"].plurals[0] = "=visualizer##sggu";
    strings["reset layout##sggu"].plurals[0] = "=reset layout##sggu";
    strings["Are you sure you want to reset the workspace layout?##sggu"].plurals[0] = "=Are you sure you want to reset the workspace layout?##sggu";
    strings["switch to mobile view##sggu"].plurals[0] = "=switch to mobile view##sggu";
    strings["settings...##sggu"].plurals[0] = "=settings...##sggu";
    strings["Window##menubar"].plurals[0] = "=Window##menubar";
    strings["window##menubar"].plurals[0] = "=window##menubar";
    strings["song information##sggu"].plurals[0] = "=song information##sggu";
    strings["subsongs##sggu"].plurals[0] = "=subsongs##sggu";
    strings["speed##sggu"].plurals[0] = "=speed##sggu";
    strings["assets##sggu"].plurals[0] = "=assets##sggu";
    strings["instruments##sggu"].plurals[0] = "=instruments##sggu";
    strings["wavetables##sggu"].plurals[0] = "=wavetables##sggu";
    strings["samples##sggu"].plurals[0] = "=samples##sggu";
    strings["orders##sggu"].plurals[0] = "=orders##sggu";
    strings["pattern##sggu"].plurals[0] = "=pattern##sggu";
    strings["mixer##sggu"].plurals[0] = "=mixer##sggu";
    strings["grooves##sggu"].plurals[0] = "=grooves##sggu";
    strings["channels##sggu"].plurals[0] = "=channels##sggu";
    strings["pattern manager##sggu"].plurals[0] = "=pattern manager##sggu";
    strings["chip manager##sggu"].plurals[0] = "=chip manager##sggu";
    strings["compatibility flags##sggu"].plurals[0] = "=compatibility flags##sggu";
    strings["song comments##sggu"].plurals[0] = "=song comments##sggu";
    strings["instrument editor##sggu"].plurals[0] = "=instrument editor##sggu";
    strings["wavetable editor##sggu"].plurals[0] = "=wavetable editor##sggu";
    strings["sample editor##sggu"].plurals[0] = "=sample editor##sggu";
    strings["play/edit controls##sggu"].plurals[0] = "=play/edit controls##sggu";
    strings["piano/input pad##sggu"].plurals[0] = "=piano/input pad##sggu";
    strings["oscilloscope (master)##sggu"].plurals[0] = "=oscilloscope (master)##sggu";
    strings["oscilloscope (per-channel)##sggu"].plurals[0] = "=oscilloscope (per-channel)##sggu";
    strings["oscilloscope (X-Y)##sggu"].plurals[0] = "=oscilloscope (X-Y)##sggu";
    strings["volume meter##sggu"].plurals[0] = "=volume meter##sggu";
    strings["clock##sggu"].plurals[0] = "=clock##sggu";
    strings["register view##sggu"].plurals[0] = "=register view##sggu";
    strings["log viewer##sggu"].plurals[0] = "=log viewer##sggu";
    strings["statistics##sggu"].plurals[0] = "=statistics##sggu";
    strings["spoiler##sggu"].plurals[0] = "=spoiler##sggu";
    strings["Help##menubar"].plurals[0] = "=Help##menubar";
    strings["help##menubar"].plurals[0] = "=help##menubar";
    strings["effect list##sggu"].plurals[0] = "=effect list##sggu";
    strings["debug menu##sggu"].plurals[0] = "=debug menu##sggu";
    strings["inspector##sggu"].plurals[0] = "=inspector##sggu";
    strings["panic##sggu"].plurals[0] = "=panic##sggu";
    strings["about...##sggu"].plurals[0] = "=about...##sggu";
    strings["| Speed %d:%d##sggu"].plurals[0] = "=| Speed %d:%d##sggu";
    strings["| Speed %d##sggu"].plurals[0] = "=| Speed %d##sggu";
    strings["| Groove##sggu"].plurals[0] = "=| Groove##sggu";
    strings[" @ %gHz (%g BPM) ##sggu"].plurals[0] = "= @ %gHz (%g BPM) ##sggu";
    strings["| Order %.2X/%.2X ##sggu"].plurals[0] = "=| Order %.2X/%.2X ##sggu";
    strings["| Order %d/%d ##sggu"].plurals[0] = "=| Order %d/%d ##sggu";
    strings["| Row %.2X/%.2X ##sggu"].plurals[0] = "=| Row %.2X/%.2X ##sggu";
    strings["| Row %d/%d ##sggu"].plurals[0] = "=| Row %d/%d ##sggu";
    strings["Don't you have anything better to do?##sggu"].plurals[0] = "=Don't you have anything better to do?##sggu";
    strings["%d years ##sggu"].plurals[0] = "=%d years ##sggu";
    strings["%d year ##sggu"].plurals[0] = "=%d year ##sggu";
    strings["%d months ##sggu"].plurals[0] = "=%d months ##sggu";
    strings["%d month ##sggu"].plurals[0] = "=%d month ##sggu";
    strings["%d days ##sggu"].plurals[0] = "=%d days ##sggu";
    strings["%d day ##sggu"].plurals[0] = "=%d day ##sggu";
    strings["Note off (cut)##sggu"].plurals[0] = "=Note off (cut)##sggu";
    strings["Note off (release)##sggu"].plurals[0] = "=Note off (release)##sggu";
    strings["Macro release only##sggu"].plurals[0] = "=Macro release only##sggu";
    strings["Note on: %s##sggu"].plurals[0] = "=Note on: %s##sggu";
    strings["Ins %d: <invalid>##sggu"].plurals[0] = "=Ins %d: <invalid>##sggu";
    strings["Ins %d: %s##sggu"].plurals[0] = "=Ins %d: %s##sggu";
    strings["Set volume: %d (%.2X, INVALID!)##sggu"].plurals[0] = "=Set volume: %d (%.2X, INVALID!)##sggu";
    strings["Set volume: %d (%.2X, %d%%)##sggu"].plurals[0] = "=Set volume: %d (%.2X, %d%%)##sggu";
    strings["| modified##sggu"].plurals[0] = "=| modified##sggu";
    ...
    strings["can't do anything without Storage permissions!##sggu"].plurals[0] = "=can't do anything without Storage permissions!##sggu";
    ...
    strings["Error while loading file! (%s)##sggu2"].plurals[0] = "=Error while loading file! (%s)##sggu2";
    strings["Error while saving file! (%s)##sggu1"].plurals[0] = "=Error while saving file! (%s)##sggu1";
    strings["Error while loading file! (%s)##sggu3"].plurals[0] = "=Error while loading file! (%s)##sggu3";
    strings["error while saving instrument! make sure your instrument is compatible.##sggu"].plurals[0] = "=error while saving instrument! make sure your instrument is compatible.##sggu";
    strings["...but you haven't selected a sample!##sggu0"].plurals[0] = "=...but you haven't selected a sample!##sggu0";
    strings["could not save sample! open Log Viewer for more information.##sggu0"].plurals[0] = "=could not save sample! open Log Viewer for more information.##sggu0";
    strings["could not save sample! open Log Viewer for more information.##sggu1"].plurals[0] = "=could not save sample! open Log Viewer for more information.##sggu1";
    strings["cannot load instrument! (##sggu"].plurals[0] = "=cannot load instrument! (##sggu";
    ...
    strings["...but you haven't selected an instrument!##sggu0"].plurals[0] = "=...but you haven't selected an instrument!##sggu0";
    strings["Rendering...###Rendering..."].plurals[0] = "=Rendering...###Rendering...";
    strings["Please wait...##sggu"].plurals[0] = "=Please wait...##sggu";
    strings["Abort##sggu"].plurals[0] = "=Abort##sggu";
    ...
    strings["OK##sggu0"].plurals[0] = "=OK##sggu0";
    strings["Warning###Warning"].plurals[0] = "=Warning###Warning";
    strings["Yes##sggu0"].plurals[0] = "=Yes##sggu0";
    strings["No##sggu0"].plurals[0] = "=No##sggu0";
    strings["Yes##sggu1"].plurals[0] = "=Yes##sggu1";
    strings["No##sggu1"].plurals[0] = "=No##sggu1";
    strings["Yes##sggu2"].plurals[0] = "=Yes##sggu2";
    strings["No##sggu2"].plurals[0] = "=No##sggu2";
    strings["Yes##sggu3"].plurals[0] = "=Yes##sggu3";
    strings["No##sggu3"].plurals[0] = "=No##sggu3";
    strings["Cancel##sggu0"].plurals[0] = "=Cancel##sggu0";
    strings["Erasing##sggu"].plurals[0] = "=Erasing##sggu";
    strings["All subsongs##sggu"].plurals[0] = "=All subsongs##sggu";
    strings["Current subsong##sggu"].plurals[0] = "=Current subsong##sggu";
    strings["Orders##sggu"].plurals[0] = "=Orders##sggu";
    strings["Pattern##sggu"].plurals[0] = "=Pattern##sggu";
    strings["Instruments##sggu"].plurals[0] = "=Instruments##sggu";
    strings["Wavetables##sggu"].plurals[0] = "=Wavetables##sggu";
    strings["Samples##sggu"].plurals[0] = "=Samples##sggu";
    strings["Optimization##sggu"].plurals[0] = "=Optimization##sggu";
    strings["De-duplicate patterns##sggu"].plurals[0] = "=De-duplicate patterns##sggu";
    strings["Remove unused instruments##sggu"].plurals[0] = "=Remove unused instruments##sggu";
    strings["Remove unused samples##sggu"].plurals[0] = "=Remove unused samples##sggu";
    strings["Never mind! Cancel##sggu1"].plurals[0] = "=Never mind! Cancel##sggu1";
    strings["Yes##sggu4"].plurals[0] = "=Yes##sggu4";
    strings["No##sggu4"].plurals[0] = "=No##sggu4";
    strings["Yes##sggu5"].plurals[0] = "=Yes##sggu5";
    strings["No##sggu5"].plurals[0] = "=No##sggu5";
    strings["Yes##sggu6"].plurals[0] = "=Yes##sggu6";
    strings["No##sggu6"].plurals[0] = "=No##sggu6";
    strings["OK##sggu1"].plurals[0] = "=OK##sggu1";
    strings["too many instruments!##sggu"].plurals[0] = "=too many instruments!##sggu";
    strings["too many wavetables!##sggu"].plurals[0] = "=too many wavetables!##sggu";
    strings["Select Instrument###Select Instrument"].plurals[0] = "=Select Instrument###Select Instrument";
    strings["this is an instrument bank! select which one to use:##sggu"].plurals[0] = "=this is an instrument bank! select which one to use:##sggu";
    strings["this is an instrument bank! select which ones to load:##sggu"].plurals[0] = "=this is an instrument bank! select which ones to load:##sggu";
    strings["All##sggu"].plurals[0] = "=All##sggu";
    strings["None##sggu"].plurals[0] = "=None##sggu";
    strings["OK##sggu2"].plurals[0] = "=OK##sggu2";
    strings["Cancel##sggu2"].plurals[0] = "=Cancel##sggu2";
    strings["...but you haven't selected an instrument!##sggu1"].plurals[0] = "=...but you haven't selected an instrument!##sggu1";
    strings["Import Raw Sample###Import Raw Sample"].plurals[0] = "=Import Raw Sample###Import Raw Sample";
    strings["Data type:##sggu"].plurals[0] = "=Data type:##sggu";
    strings["Sample rate##sggu"].plurals[0] = "=Sample rate##sggu";
    strings["Channels##sggu"].plurals[0] = "=Channels##sggu";
    strings["(will be mixed down to mono)##sggu"].plurals[0] = "=(will be mixed down to mono)##sggu";
    strings["Unsigned##sggu"].plurals[0] = "=Unsigned##sggu";
    strings["Big endian##sggu"].plurals[0] = "=Big endian##sggu";
    strings["Swap nibbles##sggu"].plurals[0] = "=Swap nibbles##sggu";
    strings["Swap words##sggu"].plurals[0] = "=Swap words##sggu";
    strings["Encoding:##sggu"].plurals[0] = "=Encoding:##sggu";
    strings["Reverse bit order##sggu"].plurals[0] = "=Reverse bit order##sggu";
    strings["OK##sggu3"].plurals[0] = "=OK##sggu3";
    strings["...but you haven't selected a sample!##sggu1"].plurals[0] = "=...but you haven't selected a sample!##sggu1";
    strings["Cancel##sggu3"].plurals[0] = "=Cancel##sggu3";
    strings["Error! No string provided!##sggu"].plurals[0] = "=Error! No string provided!##sggu";
    strings["OK##sggu4"].plurals[0] = "=OK##sggu4";
    strings["error while loading fonts! please check your settings.##sggu1"].plurals[0] = "=error while loading fonts! please check your settings.##sggu1";
    strings["it appears I couldn't load these fonts. any setting you can check?##sggu"].plurals[0] = "=it appears I couldn't load these fonts. any setting you can check?##sggu";
    strings["\r\nthe render driver has been set to a safe value. please restart Furnace.##sggu"].plurals[0] = "=\r\nthe render driver has been set to a safe value. please restart Furnace.##sggu";
    strings["error while loading fonts! please check your settings.##sggu2"].plurals[0] = "=error while loading fonts! please check your settings.##sggu2";
