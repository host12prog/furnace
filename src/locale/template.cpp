...
*/
    ...
    strings["00xy: Arpeggio##seen"].plurals[0] = "00xy: =Arpeggio##seen";
    strings["01xx: Pitch slide up##seen"].plurals[0] = "01xx: =Pitch slide up##seen";
    strings["02xx: Pitch slide down##seen"].plurals[0] = "02xx: =Pitch slide down##seen";
    strings["03xx: Portamento##seen"].plurals[0] = "03xx: =Portamento##seen";
    strings["04xy: Vibrato (x: speed; y: depth)##seen"].plurals[0] = "04xy: =Vibrato (x: speed; y: depth)##seen";
    strings["05xy: Volume slide + vibrato (compatibility only!)##seen"].plurals[0] = "05xy: =Volume slide + vibrato (compatibility only!)##seen";
    strings["06xy: Volume slide + portamento (compatibility only!)##seen"].plurals[0] = "06xy: =Volume slide + portamento (compatibility only!)##seen";
    strings["07xy: Tremolo (x: speed; y: depth)##seen"].plurals[0] = "07xy: =Tremolo (x: speed; y: depth)##seen";
    strings["08xy: Set panning (x: left; y: right)##seen"].plurals[0] = "08xy: =Set panning (x: left; y: right)##seen";
    strings["09xx: Set groove pattern (speed 1 if no grooves exist)##seen"].plurals[0] = "09xx: =Set groove pattern (speed 1 if no grooves exist)##seen";
    strings["0Axy: Volume slide (0y: down; x0: up)##seen"].plurals[0] = "0Axy: =Volume slide (0y: down; x0: up)##seen";
    strings["0Bxx: Jump to pattern##seen"].plurals[0] = "0Bxx: =Jump to pattern##seen";
    strings["0Cxx: Retrigger##seen"].plurals[0] = "0Cxx: =Retrigger##seen";
    strings["0Dxx: Jump to next pattern##seen"].plurals[0] = "0Dxx: =Jump to next pattern##seen";
    strings["0Fxx: Set speed (speed 2 if no grooves exist)##seen"].plurals[0] = "0Fxx: =Set speed (speed 2 if no grooves exist)##seen";
    strings["80xx: Set panning (00: left; 80: center; FF: right)##seen"].plurals[0] = "80xx: =Set panning (00: left; 80: center; FF: right)##seen";
    strings["81xx: Set panning (left channel)##seen"].plurals[0] = "81xx: =Set panning (left channel)##seen";
    strings["82xx: Set panning (right channel)##seen"].plurals[0] = "82xx: =Set panning (right channel)##seen";
    strings["88xy: Set panning (rear channels; x: left; y: right)##seen"].plurals[0] = "88xy: =Set panning (rear channels; x: left; y: right)##seen";
    strings["89xx: Set panning (rear left channel)##seen"].plurals[0] = "89xx: =Set panning (rear left channel)##seen";
    strings["8Axx: Set panning (rear right channel)##seen"].plurals[0] = "8Axx: =Set panning (rear right channel)##seen";
    strings["Cxxx: Set tick rate (hz)##seen"].plurals[0] = "Cxxx: =Set tick rate (hz)##seen";
    strings["E0xx: Set arp speed##seen"].plurals[0] = "E0xx: =Set arp speed##seen";
    strings["E1xy: Note slide up (x: speed; y: semitones)##seen"].plurals[0] = "E1xy: =Note slide up (x: speed; y: semitones)##seen";
    strings["E2xy: Note slide down (x: speed; y: semitones)##seen"].plurals[0] = "E2xy: =Note slide down (x: speed; y: semitones)##seen";
    strings["E3xx: Set vibrato shape (0: up/down; 1: up only; 2: down only)##seen"].plurals[0] = "E3xx: =Set vibrato shape (0: up/down; 1: up only; 2: down only)##seen";
    strings["E4xx: Set vibrato range##seen"].plurals[0] = "E4xx: =Set vibrato range##seen";
    strings["E5xx: Set pitch (80: center)##seen"].plurals[0] = "E5xx: =Set pitch (80: center)##seen";
    strings["EAxx: Legato##seen"].plurals[0] = "EAxx: =Legato##seen";
    strings["EBxx: Set LEGACY sample mode bank##seen"].plurals[0] = "EBxx: =Set LEGACY sample mode bank##seen";
    strings["ECxx: Note cut##seen"].plurals[0] = "ECxx: =Note cut##seen";
    strings["EDxx: Note delay##seen"].plurals[0] = "EDxx: =Note delay##seen";
    strings["EExx: Send external command##seen"].plurals[0] = "EExx: =Send external command##seen";
    strings["F0xx: Set tick rate (bpm)##seen"].plurals[0] = "F0xx: =Set tick rate (bpm)##seen";
    strings["F1xx: Single tick note slide up##seen"].plurals[0] = "F1xx: =Single tick note slide up##seen";
    strings["F2xx: Single tick note slide down##seen"].plurals[0] = "F2xx: =Single tick note slide down##seen";
    strings["F3xx: Fine volume slide up##seen"].plurals[0] = "F3xx: =Fine volume slide up##seen";
    strings["F4xx: Fine volume slide down##seen"].plurals[0] = "F4xx: =Fine volume slide down##seen";
    strings["F5xx: Disable macro (see manual)##seen"].plurals[0] = "F5xx: =Disable macro (see manual)##seen";
    strings["F6xx: Enable macro (see manual)##seen"].plurals[0] = "F6xx: =Enable macro (see manual)##seen";
    strings["F7xx: Restart macro (see manual)##seen"].plurals[0] = "F7xx: =Restart macro (see manual)##seen";
    strings["F8xx: Single tick volume slide up##seen"].plurals[0] = "F8xx: =Single tick volume slide up##seen";
    strings["F9xx: Single tick volume slide down##seen"].plurals[0] = "F9xx: =Single tick volume slide down##seen";
    strings["FAxx: Fast volume slide (0y: down; x0: up)##seen"].plurals[0] = "FAxx: =Fast volume slide (0y: down; x0: up)##seen";
    strings["FFxx: Stop song##seen"].plurals[0] = "FFxx: =Stop song##seen";
    strings["9xxx: Set sample offset*256##seen"].plurals[0] = "9xxx: =Set sample offset*256##seen";

    //   sesd    src/engine/sysDef.cpp

    strings["20xx: Set channel mode (bit 0: square; bit 1: noise; bit 2: envelope)##sesd"].plurals[0] = "20xx: =Set channel mode (bit 0: square; bit 1: noise; bit 2: envelope)##sesd";
    strings["21xx: Set noise frequency (0 to 1F)##sesd"].plurals[0] = "21xx: =Set noise frequency (0 to 1F)##sesd";
    strings["22xy: Set envelope mode (x: shape, y: enable for this channel)##sesd"].plurals[0] = "22xy: =Set envelope mode (x: shape, y: enable for this channel)##sesd";
    strings["23xx: Set envelope period low byte##sesd"].plurals[0] = "23xx: =Set envelope period low byte##sesd";
    strings["24xx: Set envelope period high byte##sesd"].plurals[0] = "24xx: =Set envelope period high byte##sesd";
    strings["25xx: Envelope slide up##sesd0"].plurals[0] = "25xx: =Envelope slide up##sesd0";
    strings["26xx: Envelope slide down##sesd0"].plurals[0] = "26xx: =Envelope slide down##sesd0";
    strings["29xy: Set auto-envelope (x: numerator; y: denominator)##sesd0"].plurals[0] = "29xy: =Set auto-envelope (x: numerator; y: denominator)##sesd0";
    strings["2Exx: Write to I/O port A##sesd"].plurals[0] = "2Exx: =Write to I/O port A##sesd";
    strings["2Fxx: Write to I/O port B##sesd"].plurals[0] = "2Fxx: =Write to I/O port B##sesd";
    strings["12xx: Set duty cycle (0 to 8)##sesd"].plurals[0] = "12xx: =Set duty cycle (0 to 8)##sesd";
    strings["27xx: Set noise AND mask##sesd"].plurals[0] = "27xx: =Set noise AND mask##sesd";
    strings["28xx: Set noise OR mask##sesd"].plurals[0] = "28xx: =Set noise OR mask##sesd";
    strings["2Dxx: NOT TO BE EMPLOYED BY THE COMPOSER##sesd"].plurals[0] = "2Dxx: =NOT TO BE EMPLOYED BY THE COMPOSER##sesd";
    strings["30xx: Toggle hard envelope reset on new notes##sesd"].plurals[0] = "30xx: =Toggle hard envelope reset on new notes##sesd";
    strings["18xx: Toggle extended channel 3 mode##sesd"].plurals[0] = "18xx: =Toggle extended channel 3 mode##sesd";
    strings["17xx: Toggle PCM mode (LEGACY)##sesd0"].plurals[0] = "17xx: =Toggle PCM mode (LEGACY)##sesd0";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)##sesd0"].plurals[0] = "DFxx: =Set sample playback direction (0: normal; 1: reverse)##sesd0";
    strings["18xx: Toggle drums mode (1: enabled; 0: disabled)##sesd"].plurals[0] = "18xx: =Toggle drums mode (1: enabled; 0: disabled)##sesd";
    strings["11xx: Set feedback (0 to 7)##sesd0"].plurals[0] = "11xx: =Set feedback (0 to 7)##sesd0";
    strings["12xx: Set level of operator 1 (0 highest, 7F lowest)##sesd"].plurals[0] = "12xx: =Set level of operator 1 (0 highest, 7F lowest)##sesd";
    strings["13xx: Set level of operator 2 (0 highest, 7F lowest)##sesd"].plurals[0] = "13xx: =Set level of operator 2 (0 highest, 7F lowest)##sesd";
    strings["14xx: Set level of operator 3 (0 highest, 7F lowest)##sesd"].plurals[0] = "14xx: =Set level of operator 3 (0 highest, 7F lowest)##sesd";
    strings["15xx: Set level of operator 4 (0 highest, 7F lowest)##sesd"].plurals[0] = "15xx: =Set level of operator 4 (0 highest, 7F lowest)##sesd";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)##sesd0"].plurals[0] = "16xy: =Set operator multiplier (x: operator from 1 to 4; y: multiplier)##sesd0";
    strings["19xx: Set attack of all operators (0 to 1F)##sesd"].plurals[0] = "19xx: =Set attack of all operators (0 to 1F)##sesd";
    strings["1Axx: Set attack of operator 1 (0 to 1F)##sesd"].plurals[0] = "1Axx: =Set attack of operator 1 (0 to 1F)##sesd";
    strings["1Bxx: Set attack of operator 2 (0 to 1F)##sesd"].plurals[0] = "1Bxx: =Set attack of operator 2 (0 to 1F)##sesd";
    strings["1Cxx: Set attack of operator 3 (0 to 1F)##sesd"].plurals[0] = "1Cxx: =Set attack of operator 3 (0 to 1F)##sesd";
    strings["1Dxx: Set attack of operator 4 (0 to 1F)##sesd"].plurals[0] = "1Dxx: =Set attack of operator 4 (0 to 1F)##sesd";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)##sesd0"].plurals[0] = "50xy: =Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)##sesd0";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)##sesd0"].plurals[0] = "51xy: =Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)##sesd0";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)##sesd0"].plurals[0] = "52xy: =Set release (x: operator from 1 to 4 (0 for all ops); y: release)##sesd0";
    strings["53xy: Set detune (x: operator from 1 to 4 (0 for all ops); y: detune where 3 is center)##sesd"].plurals[0] = "53xy: =Set detune (x: operator from 1 to 4 (0 for all ops); y: detune where 3 is center)##sesd";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)##sesd0"].plurals[0] = "54xy: =Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)##sesd0";
    strings["56xx: Set decay of all operators (0 to 1F)##sesd"].plurals[0] = "56xx: =Set decay of all operators (0 to 1F)##sesd";
    strings["57xx: Set decay of operator 1 (0 to 1F)##sesd"].plurals[0] = "57xx: =Set decay of operator 1 (0 to 1F)##sesd";
    strings["58xx: Set decay of operator 2 (0 to 1F)##sesd"].plurals[0] = "58xx: =Set decay of operator 2 (0 to 1F)##sesd";
    strings["59xx: Set decay of operator 3 (0 to 1F)##sesd"].plurals[0] = "59xx: =Set decay of operator 3 (0 to 1F)##sesd";
    strings["5Axx: Set decay of operator 4 (0 to 1F)##sesd"].plurals[0] = "5Axx: =Set decay of operator 4 (0 to 1F)##sesd";
    strings["5Bxx: Set decay 2 of all operators (0 to 1F)##sesd"].plurals[0] = "5Bxx: =Set decay 2 of all operators (0 to 1F)##sesd";
    strings["5Cxx: Set decay 2 of operator 1 (0 to 1F)##sesd"].plurals[0] = "5Cxx: =Set decay 2 of operator 1 (0 to 1F)##sesd";
    strings["5Dxx: Set decay 2 of operator 2 (0 to 1F)##sesd"].plurals[0] = "5Dxx: =Set decay 2 of operator 2 (0 to 1F)##sesd";
    strings["5Exx: Set decay 2 of operator 3 (0 to 1F)##sesd"].plurals[0] = "5Exx: =Set decay 2 of operator 3 (0 to 1F)##sesd";
    strings["5Fxx: Set decay 2 of operator 4 (0 to 1F)##sesd"].plurals[0] = "5Fxx: =Set decay 2 of operator 4 (0 to 1F)##sesd";
    strings["10xx: Set noise frequency (xx: value; 0 disables noise)##sesd"].plurals[0] = "10xx: =Set noise frequency (xx: value; 0 disables noise)##sesd";
    strings["17xx: Set LFO speed##sesd"].plurals[0] = "17xx: =Set LFO speed##sesd";
    strings["18xx: Set LFO waveform (0 saw, 1 square, 2 triangle, 3 noise)##sesd"].plurals[0] = "18xx: =Set LFO waveform (0 saw, 1 square, 2 triangle, 3 noise)##sesd";
    strings["1Exx: Set AM depth (0 to 7F)##sesd"].plurals[0] = "1Exx: =Set AM depth (0 to 7F)##sesd";
    strings["1Fxx: Set PM depth (0 to 7F)##sesd"].plurals[0] = "1Fxx: =Set PM depth (0 to 7F)##sesd";
    strings["55xy: Set detune 2 (x: operator from 1 to 4 (0 for all ops); y: detune from 0 to 3)##sesd"].plurals[0] = "55xy: =Set detune 2 (x: operator from 1 to 4 (0 for all ops); y: detune from 0 to 3)##sesd";
    strings["24xx: Set LFO 2 speed##sesd"].plurals[0] = "24xx: =Set LFO 2 speed##sesd";
    strings["25xx: Set LFO 2 waveform (0 saw, 1 square, 2 triangle, 3 noise)##sesd"].plurals[0] = "25xx: =Set LFO 2 waveform (0 saw, 1 square, 2 triangle, 3 noise)##sesd";
    strings["26xx: Set AM 2 depth (0 to 7F)##sesd"].plurals[0] = "26xx: =Set AM 2 depth (0 to 7F)##sesd";
    strings["27xx: Set PM 2 depth (0 to 7F)##sesd"].plurals[0] = "27xx: =Set PM 2 depth (0 to 7F)##sesd";
    strings["28xy: Set reverb (x: operator from 1 to 4 (0 for all ops); y: reverb from 0 to 7)##sesd"].plurals[0] = "28xy: =Set reverb (x: operator from 1 to 4 (0 for all ops); y: reverb from 0 to 7)##sesd";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 7)##sesd0"].plurals[0] = "2Axy: =Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 7)##sesd0";
    strings["2Bxy: Set envelope generator shift (x: operator from 1 to 4 (0 for all ops); y: shift from 0 to 3)##sesd"].plurals[0] = "2Bxy: =Set envelope generator shift (x: operator from 1 to 4 (0 for all ops); y: shift from 0 to 3)##sesd";
    strings["2Cxy: Set fine multiplier (x: operator from 1 to 4 (0 for all ops); y: fine)##sesd"].plurals[0] = "2Cxy: =Set fine multiplier (x: operator from 1 to 4 (0 for all ops); y: fine)##sesd";
    strings["3xyy: Set fixed frequency of operator 1 (x: octave from 0 to 7; y: frequency)##sesd"].plurals[0] = "3xyy: =Set fixed frequency of operator 1 (x: octave from 0 to 7; y: frequency)##sesd";
    strings["3xyy: Set fixed frequency of operator 2 (x: octave from 8 to F; y: frequency)##sesd"].plurals[0] = "3xyy: =Set fixed frequency of operator 2 (x: octave from 8 to F; y: frequency)##sesd";
    strings["4xyy: Set fixed frequency of operator 3 (x: octave from 0 to 7; y: frequency)##sesd"].plurals[0] = "4xyy: =Set fixed frequency of operator 3 (x: octave from 0 to 7; y: frequency)##sesd";
    strings["4xyy: Set fixed frequency of operator 4 (x: octave from 8 to F; y: frequency)##sesd"].plurals[0] = "4xyy: =Set fixed frequency of operator 4 (x: octave from 8 to F; y: frequency)##sesd";
    strings["10xy: Setup LFO (x: enable; y: speed)##sesd"].plurals[0] = "10xy: =Setup LFO (x: enable; y: speed)##sesd";
    strings["55xy: Set SSG envelope (x: operator from 1 to 4 (0 for all ops); y: 0-7 on, 8 off)##sesd"].plurals[0] = "55xy: =Set SSG envelope (x: operator from 1 to 4 (0 for all ops); y: 0-7 on, 8 off)##sesd";
    strings["1Fxx: Set ADPCM-A global volume (0 to 3F)##sesd"].plurals[0] = "1Fxx: =Set ADPCM-A global volume (0 to 3F)##sesd";
    strings["11xx: Set feedback (0 to 7)##sesd1"].plurals[0] = "11xx: =Set feedback (0 to 7)##sesd1";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)##sesd0"].plurals[0] = "12xx: =Set level of operator 1 (0 highest, 3F lowest)##sesd0";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)##sesd0"].plurals[0] = "13xx: =Set level of operator 2 (0 highest, 3F lowest)##sesd0";
    strings["16xy: Set operator multiplier (x: operator from 1 to 2; y: multiplier)##sesd"].plurals[0] = "16xy: =Set operator multiplier (x: operator from 1 to 2; y: multiplier)##sesd";
    strings["19xx: Set attack of all operators (0 to F)##sesd0"].plurals[0] = "19xx: =Set attack of all operators (0 to F)##sesd0";
    strings["1Axx: Set attack of operator 1 (0 to F)##sesd0"].plurals[0] = "1Axx: =Set attack of operator 1 (0 to F)##sesd0";
    strings["1Bxx: Set attack of operator 2 (0 to F)##sesd0"].plurals[0] = "1Bxx: =Set attack of operator 2 (0 to F)##sesd0";
    strings["50xy: Set AM (x: operator from 1 to 2 (0 for all ops); y: AM)##sesd"].plurals[0] = "50xy: =Set AM (x: operator from 1 to 2 (0 for all ops); y: AM)##sesd";
    strings["51xy: Set sustain level (x: operator from 1 to 2 (0 for all ops); y: sustain)##sesd"].plurals[0] = "51xy: =Set sustain level (x: operator from 1 to 2 (0 for all ops); y: sustain)##sesd";
    strings["52xy: Set release (x: operator from 1 to 2 (0 for all ops); y: release)##sesd"].plurals[0] = "52xy: =Set release (x: operator from 1 to 2 (0 for all ops); y: release)##sesd";
    strings["53xy: Set vibrato (x: operator from 1 to 2 (0 for all ops); y: enabled)##sesd"].plurals[0] = "53xy: =Set vibrato (x: operator from 1 to 2 (0 for all ops); y: enabled)##sesd";
    strings["54xy: Set envelope scale (x: operator from 1 to 2 (0 for all ops); y: scale from 0 to 3)##sesd"].plurals[0] = "54xy: =Set envelope scale (x: operator from 1 to 2 (0 for all ops); y: scale from 0 to 3)##sesd";
    strings["55xy: Set envelope sustain (x: operator from 1 to 2 (0 for all ops); y: enabled)##sesd"].plurals[0] = "55xy: =Set envelope sustain (x: operator from 1 to 2 (0 for all ops); y: enabled)##sesd";
    strings["56xx: Set decay of all operators (0 to F)##sesd0"].plurals[0] = "56xx: =Set decay of all operators (0 to F)##sesd0";
    strings["57xx: Set decay of operator 1 (0 to F)##sesd0"].plurals[0] = "57xx: =Set decay of operator 1 (0 to F)##sesd0";
    strings["58xx: Set decay of operator 2 (0 to F)##sesd0"].plurals[0] = "58xx: =Set decay of operator 2 (0 to F)##sesd0";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 2 (0 for all ops); y: enabled)##sesd"].plurals[0] = "5Bxy: =Set whether key will scale envelope (x: operator from 1 to 2 (0 for all ops); y: enabled)##sesd";
    strings["10xx: Set global AM depth (0: 1dB, 1: 4.8dB)##sesd"].plurals[0] = "10xx: =Set global AM depth (0: 1dB, 1: 4.8dB)##sesd";
    strings["11xx: Set feedback (0 to 7)##sesd2"].plurals[0] = "11xx: =Set feedback (0 to 7)##sesd2";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)##sesd1"].plurals[0] = "12xx: =Set level of operator 1 (0 highest, 3F lowest)##sesd1";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)##sesd1"].plurals[0] = "13xx: =Set level of operator 2 (0 highest, 3F lowest)##sesd1";
    strings["14xx: Set level of operator 3 (0 highest, 3F lowest)##sesd0"].plurals[0] = "14xx: =Set level of operator 3 (0 highest, 3F lowest)##sesd0";
    strings["15xx: Set level of operator 4 (0 highest, 3F lowest)##sesd0"].plurals[0] = "15xx: =Set level of operator 4 (0 highest, 3F lowest)##sesd0";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)##sesd1"].plurals[0] = "16xy: =Set operator multiplier (x: operator from 1 to 4; y: multiplier)##sesd1";
    strings["17xx: Set global vibrato depth (0: normal, 1: double)##sesd"].plurals[0] = "17xx: =Set global vibrato depth (0: normal, 1: double)##sesd";
    strings["19xx: Set attack of all operators (0 to F)##sesd1"].plurals[0] = "19xx: =Set attack of all operators (0 to F)##sesd1";
    strings["1Axx: Set attack of operator 1 (0 to F)##sesd1"].plurals[0] = "1Axx: =Set attack of operator 1 (0 to F)##sesd1";
    strings["1Bxx: Set attack of operator 2 (0 to F)##sesd1"].plurals[0] = "1Bxx: =Set attack of operator 2 (0 to F)##sesd1";
    strings["1Cxx: Set attack of operator 3 (0 to F)##sesd0"].plurals[0] = "1Cxx: =Set attack of operator 3 (0 to F)##sesd0";
    strings["1Dxx: Set attack of operator 4 (0 to F)##sesd0"].plurals[0] = "1Dxx: =Set attack of operator 4 (0 to F)##sesd0";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 3 in OPL2 and 0 to 7 in OPL3)##sesd"].plurals[0] = "2Axy: =Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 3 in OPL2 and 0 to 7 in OPL3)##sesd";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)##sesd1"].plurals[0] = "50xy: =Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)##sesd1";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)##sesd1"].plurals[0] = "51xy: =Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)##sesd1";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)##sesd1"].plurals[0] = "52xy: =Set release (x: operator from 1 to 4 (0 for all ops); y: release)##sesd1";
    strings["53xy: Set vibrato (x: operator from 1 to 4 (0 for all ops); y: enabled)##sesd0"].plurals[0] = "53xy: =Set vibrato (x: operator from 1 to 4 (0 for all ops); y: enabled)##sesd0";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)##sesd1"].plurals[0] = "54xy: =Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)##sesd1";
    strings["55xy: Set envelope sustain (x: operator from 1 to 4 (0 for all ops); y: enabled)##sesd0"].plurals[0] = "55xy: =Set envelope sustain (x: operator from 1 to 4 (0 for all ops); y: enabled)##sesd0";
    strings["56xx: Set decay of all operators (0 to F)##sesd1"].plurals[0] = "56xx: =Set decay of all operators (0 to F)##sesd1";
    strings["57xx: Set decay of operator 1 (0 to F)##sesd1"].plurals[0] = "57xx: =Set decay of operator 1 (0 to F)##sesd1";
    strings["58xx: Set decay of operator 2 (0 to F)##sesd1"].plurals[0] = "58xx: =Set decay of operator 2 (0 to F)##sesd1";
    strings["59xx: Set decay of operator 3 (0 to F)##sesd0"].plurals[0] = "59xx: =Set decay of operator 3 (0 to F)##sesd0";
    strings["5Axx: Set decay of operator 4 (0 to F)##sesd0"].plurals[0] = "5Axx: =Set decay of operator 4 (0 to F)##sesd0";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 4 (0 for all ops); y: enabled)##sesd0"].plurals[0] = "5Bxy: =Set whether key will scale envelope (x: operator from 1 to 4 (0 for all ops); y: enabled)##sesd0";
    strings["10xx: Set waveform (bit 0: triangle; bit 1: saw; bit 2: pulse; bit 3: noise)##sesd"].plurals[0] = "10xx: =Set waveform (bit 0: triangle; bit 1: saw; bit 2: pulse; bit 3: noise)##sesd";
    strings["11xx: Set coarse cutoff (not recommended; use 4xxx instead)##sesd"].plurals[0] = "11xx: =Set coarse cutoff (not recommended; use 4xxx instead)##sesd";
    strings["12xx: Set coarse pulse width (not recommended; use 3xxx instead)##sesd"].plurals[0] = "12xx: =Set coarse pulse width (not recommended; use 3xxx instead)##sesd";
    strings["13xx: Set resonance (0 to F)##sesd"].plurals[0] = "13xx: =Set resonance (0 to F)##sesd";
    strings["14xx: Set filter mode (bit 0: low pass; bit 1: band pass; bit 2: high pass)##sesd"].plurals[0] = "14xx: =Set filter mode (bit 0: low pass; bit 1: band pass; bit 2: high pass)##sesd";
    strings["15xx: Set envelope reset time##sesd"].plurals[0] = "15xx: =Set envelope reset time##sesd";
    strings["1Axx: Disable envelope reset for this channel (1 disables; 0 enables)##sesd"].plurals[0] = "1Axx: =Disable envelope reset for this channel (1 disables; 0 enables)##sesd";
    strings["1Bxy: Reset cutoff (x: on new note; y: now)##sesd"].plurals[0] = "1Bxy: =Reset cutoff (x: on new note; y: now)##sesd";
    strings["1Cxy: Reset pulse width (x: on new note; y: now)##sesd"].plurals[0] = "1Cxy: =Reset pulse width (x: on new note; y: now)##sesd";
    strings["1Exy: Change other parameters (LEGACY)##sesd"].plurals[0] = "1Exy: =Change other parameters (LEGACY)##sesd";
    strings["20xy: Set attack/decay (x: attack; y: decay)##sesd"].plurals[0] = "20xy: =Set attack/decay (x: attack; y: decay)##sesd";
    strings["21xy: Set sustain/release (x: sustain; y: release)##sesd"].plurals[0] = "21xy: =Set sustain/release (x: sustain; y: release)##sesd";
    strings["3xxx: Set pulse width (0 to FFF)##sesd"].plurals[0] = "3xxx: =Set pulse width (0 to FFF)##sesd";
    strings["4xxx: Set cutoff (0 to 7FF)##sesd"].plurals[0] = "4xxx: =Set cutoff (0 to 7FF)##sesd";
    strings["10xx: Set waveform##sesd0"].plurals[0] = "10xx: =Set waveform##sesd0";
    strings["20xx: Set PCM frequency##sesd"].plurals[0] = "20xx: =Set PCM frequency##sesd";
    strings["10xy: Set AM depth (x: operator from 1 to 4 (0 for all ops); y: depth (0: 1dB, 1: 4.8dB))##sesd"].plurals[0] = "10xy: =Set AM depth (x: operator from 1 to 4 (0 for all ops); y: depth (0: 1dB, 1: 4.8dB))##sesd";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)##sesd2"].plurals[0] = "12xx: =Set level of operator 1 (0 highest, 3F lowest)##sesd2";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)##sesd2"].plurals[0] = "13xx: =Set level of operator 2 (0 highest, 3F lowest)##sesd2";
    strings["14xx: Set level of operator 3 (0 highest, 3F lowest)##sesd1"].plurals[0] = "14xx: =Set level of operator 3 (0 highest, 3F lowest)##sesd1";
    strings["15xx: Set level of operator 4 (0 highest, 3F lowest)##sesd1"].plurals[0] = "15xx: =Set level of operator 4 (0 highest, 3F lowest)##sesd1";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)##sesd2"].plurals[0] = "16xy: =Set operator multiplier (x: operator from 1 to 4; y: multiplier)##sesd2";
    strings["17xy: Set vibrato depth (x: operator from 1 to 4 (0 for all ops); y: depth (0: normal, 1: double))##sesd"].plurals[0] = "17xy: =Set vibrato depth (x: operator from 1 to 4 (0 for all ops); y: depth (0: normal, 1: double))##sesd";
    strings["19xx: Set attack of all operators (0 to F)##sesd"].plurals[0] = "19xx: =Set attack of all operators (0 to F)##sesd";
    strings["1Axx: Set attack of operator 1 (0 to F)##sesd2"].plurals[0] = "1Axx: =Set attack of operator 1 (0 to F)##sesd2";
    strings["1Bxx: Set attack of operator 2 (0 to F)##sesd2"].plurals[0] = "1Bxx: =Set attack of operator 2 (0 to F)##sesd2";
    strings["1Cxx: Set attack of operator 3 (0 to F)##sesd1"].plurals[0] = "1Cxx: =Set attack of operator 3 (0 to F)##sesd1";
    strings["1Dxx: Set attack of operator 4 (0 to F)##sesd1"].plurals[0] = "1Dxx: =Set attack of operator 4 (0 to F)##sesd1";
    strings["20xy: Set panning of operator 1 (x: left; y: right)##sesd"].plurals[0] = "20xy: =Set panning of operator 1 (x: left; y: right)##sesd";
    strings["21xy: Set panning of operator 2 (x: left; y: right)##sesd"].plurals[0] = "21xy: =Set panning of operator 2 (x: left; y: right)##sesd";
    strings["22xy: Set panning of operator 3 (x: left; y: right)##sesd"].plurals[0] = "22xy: =Set panning of operator 3 (x: left; y: right)##sesd";
    strings["23xy: Set panning of operator 4 (x: left; y: right)##sesd"].plurals[0] = "23xy: =Set panning of operator 4 (x: left; y: right)##sesd";
    strings["24xy: Set output level register (x: operator from 1 to 4 (0 for all ops); y: level from 0 to 7)##sesd"].plurals[0] = "24xy: =Set output level register (x: operator from 1 to 4 (0 for all ops); y: level from 0 to 7)##sesd";
    strings["25xy: Set modulation input level (x: operator from 1 to 4 (0 for all ops); y: level from 0 to 7)##sesd"].plurals[0] = "25xy: =Set modulation input level (x: operator from 1 to 4 (0 for all ops); y: level from 0 to 7)##sesd";
    strings["26xy: Set envelope delay (x: operator from 1 to 4 (0 for all ops); y: delay from 0 to 7)##sesd"].plurals[0] = "26xy: =Set envelope delay (x: operator from 1 to 4 (0 for all ops); y: delay from 0 to 7)##sesd";
    strings["27xx: Set noise mode for operator 4 (x: mode from 0 to 3)##sesd"].plurals[0] = "27xx: =Set noise mode for operator 4 (x: mode from 0 to 3)##sesd";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 7)##sesd1"].plurals[0] = "2Axy: =Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 7)##sesd1";
    strings["2Fxy: Set fixed frequency block (x: operator from 1 to 4; y: octave from 0 to 7)##sesd"].plurals[0] = "2Fxy: =Set fixed frequency block (x: operator from 1 to 4; y: octave from 0 to 7)##sesd";
    strings["40xx: Set detune of operator 1 (80: center)##sesd"].plurals[0] = "40xx: =Set detune of operator 1 (80: center)##sesd";
    strings["41xx: Set detune of operator 2 (80: center)##sesd"].plurals[0] = "41xx: =Set detune of operator 2 (80: center)##sesd";
    strings["42xx: Set detune of operator 3 (80: center)##sesd"].plurals[0] = "42xx: =Set detune of operator 3 (80: center)##sesd";
    strings["43xx: Set detune of operator 4 (80: center)##sesd"].plurals[0] = "43xx: =Set detune of operator 4 (80: center)##sesd";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)##sesd2"].plurals[0] = "50xy: =Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)##sesd2";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)##sesd2"].plurals[0] = "51xy: =Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)##sesd2";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)##sesd2"].plurals[0] = "52xy: =Set release (x: operator from 1 to 4 (0 for all ops); y: release)##sesd2";
    strings["53xy: Set vibrato (x: operator from 1 to 4 (0 for all ops); y: enabled)##sesd1"].plurals[0] = "53xy: =Set vibrato (x: operator from 1 to 4 (0 for all ops); y: enabled)##sesd1";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)##sesd2"].plurals[0] = "54xy: =Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)##sesd2";
    strings["55xy: Set envelope sustain (x: operator from 1 to 4 (0 for all ops); y: enabled)##sesd1"].plurals[0] = "55xy: =Set envelope sustain (x: operator from 1 to 4 (0 for all ops); y: enabled)##sesd1";
    strings["56xx: Set decay of all operators (0 to F)##sesd2"].plurals[0] = "56xx: =Set decay of all operators (0 to F)##sesd2";
    strings["57xx: Set decay of operator 1 (0 to F)##sesd2"].plurals[0] = "57xx: =Set decay of operator 1 (0 to F)##sesd2";
    strings["58xx: Set decay of operator 2 (0 to F)##sesd2"].plurals[0] = "58xx: =Set decay of operator 2 (0 to F)##sesd2";
    strings["59xx: Set decay of operator 3 (0 to F)##sesd1"].plurals[0] = "59xx: =Set decay of operator 3 (0 to F)##sesd1";
    strings["5Axx: Set decay of operator 4 (0 to F)##sesd1"].plurals[0] = "5Axx: =Set decay of operator 4 (0 to F)##sesd1";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 4 (0 for all ops); y: enabled)##sesd1"].plurals[0] = "5Bxy: =Set whether key will scale envelope (x: operator from 1 to 4 (0 for all ops); y: enabled)##sesd1";
    strings["3xyy: Set fixed frequency F-num of operator 1 (x: high 2 bits from 0 to 3; y: low 8 bits of F-num)##sesd"].plurals[0] = "3xyy: =Set fixed frequency F-num of operator 1 (x: high 2 bits from 0 to 3; y: low 8 bits of F-num)##sesd";
    strings["3xyy: Set fixed frequency F-num of operator 2 (x: high 2 bits from 4 to 7; y: low 8 bits of F-num)##sesd"].plurals[0] = "3xyy: =Set fixed frequency F-num of operator 2 (x: high 2 bits from 4 to 7; y: low 8 bits of F-num)##sesd";
    strings["3xyy: Set fixed frequency F-num of operator 3 (x: high 2 bits from 8 to B; y: low 8 bits of F-num)##sesd"].plurals[0] = "3xyy: =Set fixed frequency F-num of operator 3 (x: high 2 bits from 8 to B; y: low 8 bits of F-num)##sesd";
    strings["3xyy: Set fixed frequency F-num of operator 4 (x: high 2 bits from C to F; y: low 8 bits of F-num)##sesd"].plurals[0] = "3xyy: =Set fixed frequency F-num of operator 4 (x: high 2 bits from C to F; y: low 8 bits of F-num)##sesd";
    ...
    strings["<COMPOUND SYSTEM!>##sesd0"].plurals[0] = "=<COMPOUND SYSTEM!>##sesd0";
    strings["<COMPOUND SYSTEM!>##sesd1"].plurals[0] = "=<COMPOUND SYSTEM!>##sesd1";
    strings["a square/noise sound chip found on the Sega Master System, ColecoVision, Tandy, TI's own 99/4A and a few other places.##sesd"].plurals[0] = "=a square/noise sound chip found on the Sega Master System, ColecoVision, Tandy, TI's own 99/4A and a few other places.##sesd";
    strings["20xy: Set noise mode (x: preset freq/ch3 freq; y: thin pulse/noise)##sesd"].plurals[0] = "20xy: =Set noise mode (x: preset freq/ch3 freq; y: thin pulse/noise)##sesd";
    strings["<COMPOUND SYSTEM!>##sesd2"].plurals[0] = "=<COMPOUND SYSTEM!>##sesd2";
    strings["the most popular portable game console of the era.##sesd"].plurals[0] = "=the most popular portable game console of the era.##sesd";
    strings["10xx: Set waveform##sesd1"].plurals[0] = "10xx: =Set waveform##sesd1";
    strings["11xx: Set noise length (0: long; 1: short)##sesd"].plurals[0] = "11xx: =Set noise length (0: long; 1: short)##sesd";
    strings["12xx: Set duty cycle (0 to 3)##sesd"].plurals[0] = "12xx: =Set duty cycle (0 to 3)##sesd";
    strings["13xy: Setup sweep (x: time; y: shift)##sesd"].plurals[0] = "13xy: =Setup sweep (x: time; y: shift)##sesd";
    strings["14xx: Set sweep direction (0: up; 1: down)##sesd"].plurals[0] = "14xx: =Set sweep direction (0: up; 1: down)##sesd";
    strings["an '80s game console with a wavetable sound chip, popular in Japan.##sesd"].plurals[0] = "=an '80s game console with a wavetable sound chip, popular in Japan.##sesd";
    strings["10xx: Set waveform##sesd2"].plurals[0] = "10xx: =Set waveform##sesd2";
    strings["11xx: Toggle noise mode##sesd0"].plurals[0] = "11xx: =Toggle noise mode##sesd0";
    strings["12xx: Setup LFO (0: disabled; 1: 1x depth; 2: 16x depth; 3: 256x depth)##sesd"].plurals[0] = "12xx: =Setup LFO (0: disabled; 1: 1x depth; 2: 16x depth; 3: 256x depth)##sesd";
    strings["13xx: Set LFO speed##sesd"].plurals[0] = "13xx: =Set LFO speed##sesd";
    strings["17xx: Toggle PCM mode (LEGACY)##sesd1"].plurals[0] = "17xx: =Toggle PCM mode (LEGACY)##sesd1";
    strings["also known as Famicom in Japan, it's the most well-known game console of the '80s.##sesd"].plurals[0] = "=also known as Famicom in Japan, it's the most well-known game console of the '80s.##sesd";
    strings["11xx: Write to delta modulation counter (0 to 7F)##sesd"].plurals[0] = "11xx: =Write to delta modulation counter (0 to 7F)##sesd";
    strings["12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1)##sesd0"].plurals[0] = "12xx: =Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1)##sesd0";
    strings["13xy: Sweep up (x: time; y: shift)##sesd"].plurals[0] = "13xy: =Sweep up (x: time; y: shift)##sesd";
    strings["14xy: Sweep down (x: time; y: shift)##sesd"].plurals[0] = "14xy: =Sweep down (x: time; y: shift)##sesd";
    strings["15xx: Set envelope mode (0: envelope, 1: length, 2: looping, 3: constant)##sesd"].plurals[0] = "15xx: =Set envelope mode (0: envelope, 1: length, 2: looping, 3: constant)##sesd";
    strings["16xx: Set length counter (refer to manual for a list of values)##sesd"].plurals[0] = "16xx: =Set length counter (refer to manual for a list of values)##sesd";
    strings["17xx: Set frame counter mode (0: 4-step, 1: 5-step)##sesd"].plurals[0] = "17xx: =Set frame counter mode (0: 4-step, 1: 5-step)##sesd";
    strings["18xx: Select PCM/DPCM mode (0: PCM; 1: DPCM)##sesd"].plurals[0] = "18xx: =Select PCM/DPCM mode (0: PCM; 1: DPCM)##sesd";
    strings["19xx: Set triangle linear counter (0 to 7F; 80 and higher halt)##sesd"].plurals[0] = "19xx: =Set triangle linear counter (0 to 7F; 80 and higher halt)##sesd";
    strings["20xx: Set DPCM frequency (0 to F)##sesd"].plurals[0] = "20xx: =Set DPCM frequency (0 to F)##sesd";
    strings["<COMPOUND SYSTEM!>##sesd3"].plurals[0] = "=<COMPOUND SYSTEM!>##sesd3";
    strings["<COMPOUND SYSTEM!>##sesd4"].plurals[0] = "=<COMPOUND SYSTEM!>##sesd4";
    strings["this computer is powered by the SID chip, which had synthesizer features like a filter and ADSR.##sesd"].plurals[0] = "=this computer is powered by the SID chip, which had synthesizer features like a filter and ADSR.##sesd";
    ...
    strings["<COMPOUND SYSTEM!>##sesd5"].plurals[0] = "=<COMPOUND SYSTEM!>##sesd5";
    strings["like Neo Geo, but lacking the ADPCM-B channel since they couldn't connect the pins.##sesd"].plurals[0] = "=like Neo Geo, but lacking the ADPCM-B channel since they couldn't connect the pins.##sesd";
    ...
    strings["a computer from the '80s with full sampling capabilities, giving it a sound ahead of its time.##sesd"].plurals[0] = "=a computer from the '80s with full sampling capabilities, giving it a sound ahead of its time.##sesd";
    strings["10xx: Toggle filter (0 disables; 1 enables)##sesd"].plurals[0] = "10xx: =Toggle filter (0 disables; 1 enables)##sesd";
    strings["11xx: Toggle AM with next channel##sesd"].plurals[0] = "11xx: =Toggle AM with next channel##sesd";
    strings["12xx: Toggle period modulation with next channel##sesd"].plurals[0] = "12xx: =Toggle period modulation with next channel##sesd";
    strings["13xx: Set waveform##sesd"].plurals[0] = "13xx: =Set waveform##sesd";
    ...
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).##sesd"].plurals[0] = "=this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).##sesd";
    strings["it's a challenge to make music on this chip which barely has musical capabilities...##sesd"].plurals[0] = "=it's a challenge to make music on this chip which barely has musical capabilities...##sesd";
    strings["supposedly an upgrade from the AY-3-8910, this was present on the Creative Music System (Game Blaster) and SAM Coupé.##sesd"].plurals[0] = "=supposedly an upgrade from the AY-3-8910, this was present on the Creative Music System (Game Blaster) and SAM Coupé.##sesd";
    strings["10xy: Set channel mode (x: noise; y: tone)##sesd"].plurals[0] = "10xy: =Set channel mode (x: noise; y: tone)##sesd";
    strings["11xx: Set noise frequency##sesd"].plurals[0] = "11xx: =Set noise frequency##sesd";
    strings["12xx: Setup envelope (refer to docs for more information)##sesd"].plurals[0] = "12xx: =Setup envelope (refer to docs for more information)##sesd";
    strings["an improved version of the AY-3-8910 with a bigger frequency range, duty cycles, configurable noise and per-channel envelopes!##sesd"].plurals[0] = "=an improved version of the AY-3-8910 with a bigger frequency range, duty cycles, configurable noise and per-channel envelopes!##sesd";
    ...
    strings["one channel of 1-bit wavetable which is better (and worse) than the PC Speaker.##sesd"].plurals[0] = "=one channel of 1-bit wavetable which is better (and worse) than the PC Speaker.##sesd";
    strings["FM? nah... samples! Nintendo's answer to Sega.##sesd"].plurals[0] = "=FM? nah... samples! Nintendo's answer to Sega.##sesd";
    strings["18xx: Enable echo buffer##sesd"].plurals[0] = "18xx: =Enable echo buffer##sesd";
    strings["19xx: Set echo delay (0 to F)##sesd"].plurals[0] = "19xx: =Set echo delay (0 to F)##sesd";
    strings["1Axx: Set left echo volume##sesd"].plurals[0] = "1Axx: =Set left echo volume##sesd";
    strings["1Bxx: Set right echo volume##sesd"].plurals[0] = "1Bxx: =Set right echo volume##sesd";
    strings["1Cxx: Set echo feedback##sesd"].plurals[0] = "1Cxx: =Set echo feedback##sesd";
    strings["1Exx: Set dry output volume (left)##sesd"].plurals[0] = "1Exx: =Set dry output volume (left)##sesd";
    strings["1Fxx: Set dry output volume (right)##sesd"].plurals[0] = "1Fxx: =Set dry output volume (right)##sesd";
    strings["30xx: Set echo filter coefficient 0##sesd"].plurals[0] = "30xx: =Set echo filter coefficient 0##sesd";
    strings["31xx: Set echo filter coefficient 1##sesd"].plurals[0] = "31xx: =Set echo filter coefficient 1##sesd";
    strings["32xx: Set echo filter coefficient 2##sesd"].plurals[0] = "32xx: =Set echo filter coefficient 2##sesd";
    strings["33xx: Set echo filter coefficient 3##sesd"].plurals[0] = "33xx: =Set echo filter coefficient 3##sesd";
    strings["34xx: Set echo filter coefficient 4##sesd"].plurals[0] = "34xx: =Set echo filter coefficient 4##sesd";
    strings["35xx: Set echo filter coefficient 5##sesd"].plurals[0] = "35xx: =Set echo filter coefficient 5##sesd";
    strings["36xx: Set echo filter coefficient 6##sesd"].plurals[0] = "36xx: =Set echo filter coefficient 6##sesd";
    strings["37xx: Set echo filter coefficient 7##sesd"].plurals[0] = "37xx: =Set echo filter coefficient 7##sesd";
    strings["10xx: Set waveform##sesd3"].plurals[0] = "10xx: =Set waveform##sesd3";
    strings["11xx: Toggle noise mode##sesd1"].plurals[0] = "11xx: =Toggle noise mode##sesd1";
    strings["12xx: Toggle echo on this channel##sesd"].plurals[0] = "12xx: =Toggle echo on this channel##sesd";
    strings["13xx: Toggle pitch modulation##sesd"].plurals[0] = "13xx: =Toggle pitch modulation##sesd";
    strings["14xy: Toggle invert (x: left; y: right)##sesd"].plurals[0] = "14xy: =Toggle invert (x: left; y: right)##sesd";
    strings["15xx: Set envelope mode (0: ADSR, 1: gain/direct, 2: dec, 3: exp, 4: inc, 5: bent)##sesd"].plurals[0] = "15xx: =Set envelope mode (0: ADSR, 1: gain/direct, 2: dec, 3: exp, 4: inc, 5: bent)##sesd";
    strings["16xx: Set gain (00 to 7F if direct; 00 to 1F otherwise)##sesd"].plurals[0] = "16xx: =Set gain (00 to 7F if direct; 00 to 1F otherwise)##sesd";
    strings["1Dxx: Set noise frequency (00 to 1F)##sesd"].plurals[0] = "1Dxx: =Set noise frequency (00 to 1F)##sesd";
    strings["20xx: Set attack (0 to F)##sesd"].plurals[0] = "20xx: =Set attack (0 to F)##sesd";
    strings["21xx: Set decay (0 to 7)##sesd"].plurals[0] = "21xx: =Set decay (0 to 7)##sesd";
    strings["22xx: Set sustain (0 to 7)##sesd"].plurals[0] = "22xx: =Set sustain (0 to 7)##sesd";
    strings["23xx: Set release (00 to 1F)##sesd"].plurals[0] = "23xx: =Set release (00 to 1F)##sesd";
    strings["an expansion chip for the Famicom, featuring a quirky sawtooth channel.##sesd"].plurals[0] = "=an expansion chip for the Famicom, featuring a quirky sawtooth channel.##sesd";
    strings["12xx: Set duty cycle (pulse: 0 to 7)##sesd"].plurals[0] = "12xx: =Set duty cycle (pulse: 0 to 7)##sesd";
    strings["17xx: Toggle PCM mode (LEGACY)##sesd2"].plurals[0] = "17xx: =Toggle PCM mode (LEGACY)##sesd2";
    strings["cost-reduced version of the OPL with 16 patches and only one of them is user-configurable.##sesd"].plurals[0] = "=cost-reduced version of the OPL with 16 patches and only one of them is user-configurable.##sesd";
    strings["a disk drive for the Famicom which also contains one wavetable channel.##sesd"].plurals[0] = "=a disk drive for the Famicom which also contains one wavetable channel.##sesd";
    strings["10xx: Set waveform##sesd4"].plurals[0] = "10xx: =Set waveform##sesd4";
    strings["11xx: Set modulation depth##sesd"].plurals[0] = "11xx: =Set modulation depth##sesd";
    strings["12xy: Set modulation speed high byte (x: enable; y: value)##sesd"].plurals[0] = "12xy: =Set modulation speed high byte (x: enable; y: value)##sesd";
    strings["13xx: Set modulation speed low byte##sesd"].plurals[0] = "13xx: =Set modulation speed low byte##sesd";
    strings["14xx: Set modulator position##sesd"].plurals[0] = "14xx: =Set modulator position##sesd";
    strings["15xx: Set modulator table to waveform##sesd"].plurals[0] = "15xx: =Set modulator table to waveform##sesd";
    strings["an expansion chip for the Famicom, featuring a little-known PCM channel.##sesd"].plurals[0] = "=an expansion chip for the Famicom, featuring a little-known PCM channel.##sesd";
    strings["12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1)##sesd1"].plurals[0] = "12xx: =Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1)##sesd1";
    strings["an expansion chip for the Famicom, with full wavetable.##sesd"].plurals[0] = "=an expansion chip for the Famicom, with full wavetable.##sesd";
    strings["18xx: Change channel limits (0 to 7, x + 1)##sesd"].plurals[0] = "18xx: =Change channel limits (0 to 7, x + 1)##sesd";
    strings["20xx: Load a waveform into memory##sesd"].plurals[0] = "20xx: =Load a waveform into memory##sesd";
    strings["21xx: Set position for wave load##sesd"].plurals[0] = "21xx: =Set position for wave load##sesd";
    strings["10xx: Select waveform##sesd"].plurals[0] = "10xx: =Select waveform##sesd";
    strings["11xx: Set waveform position in RAM##sesd"].plurals[0] = "11xx: =Set waveform position in RAM##sesd";
    strings["12xx: Set waveform length in RAM (04 to FC in steps of 4)##sesd"].plurals[0] = "12xx: =Set waveform length in RAM (04 to FC in steps of 4)##sesd";
    strings["15xx: Set waveform load position##sesd"].plurals[0] = "15xx: =Set waveform load position##sesd";
    strings["16xx: Set waveform load length (04 to FC in steps of 4)##sesd"].plurals[0] = "16xx: =Set waveform load length (04 to FC in steps of 4)##sesd";
    ...
    strings["OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels.##sesd"].plurals[0] = "=OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels.##sesd";
    ...
    strings["OPN, but what if you only had two operators, no stereo, no detune and a lower ADSR parameter range?##sesd"].plurals[0] = "=OPN, but what if you only had two operators, no stereo, no detune and a lower ADSR parameter range?##sesd";
    strings["OPL, but what if you had more waveforms to choose than the normal sine?##sesd"].plurals[0] = "=OPL, but what if you had more waveforms to choose than the normal sine?##sesd";
    strings["OPL2, but what if you had twice the channels, 4-op mode, stereo and even more waveforms?##sesd"].plurals[0] = "=OPL2, but what if you had twice the channels, 4-op mode, stereo and even more waveforms?##sesd";
    strings["how many channels of PCM do you want?\nMultiPCM: yes##sesd"].plurals[0] = "=how many channels of PCM do you want?\nMultiPCM: yes##sesd";
    strings["good luck! you get one square and no volume control.##sesd"].plurals[0] = "=good luck! you get one square and no volume control.##sesd";
    strings["please don't use this chip. it was added as a joke.##sesd"].plurals[0] = "=please don't use this chip. it was added as a joke.##sesd";
    ...
    strings["10xx: Set waveform (0 to 7)##sesd0"].plurals[0] = "10xx: =Set waveform (0 to 7)##sesd0";
    strings["11xx: Set AUDCTL##sesd"].plurals[0] = "11xx: =Set AUDCTL##sesd";
    strings["12xx: Toggle two-tone mode##sesd"].plurals[0] = "12xx: =Toggle two-tone mode##sesd";
    strings["this is like SNES' sound chip but without interpolation and the rest of nice bits.##sesd"].plurals[0] = "=this is like SNES' sound chip but without interpolation and the rest of nice bits.##sesd";
    strings["developed by the makers of the Game Boy and the Virtual Boy...##sesd"].plurals[0] = "=developed by the makers of the Game Boy and the Virtual Boy...##sesd";
    strings["10xx: Set waveform##sesd5"].plurals[0] = "10xx: =Set waveform##sesd5";
    strings["11xx: Setup noise mode (0: disabled; 1-8: enabled/tap)##sesd"].plurals[0] = "11xx: =Setup noise mode (0: disabled; 1-8: enabled/tap)##sesd";
    strings["12xx: Setup sweep period (0: disabled; 1-20: enabled/period)##sesd"].plurals[0] = "12xx: =Setup sweep period (0: disabled; 1-20: enabled/period)##sesd";
    strings["13xx: Set sweep amount##sesd"].plurals[0] = "13xx: =Set sweep amount##sesd";
    strings["17xx: Toggle PCM mode (LEGACY)##sesd3"].plurals[0] = "17xx: =Toggle PCM mode (LEGACY)##sesd3";
    ...
    strings["2Fxx: Toggle hard envelope reset on new notes##sesd"].plurals[0] = "2Fxx: =Toggle hard envelope reset on new notes##sesd";
    strings["this one is like PC Speaker but has duty cycles.##sesd"].plurals[0] = "=this one is like PC Speaker but has duty cycles.##sesd";
    strings["used in some Sega arcade boards (like OutRun), and usually paired with a YM2151.##sesd"].plurals[0] = "=used in some Sega arcade boards (like OutRun), and usually paired with a YM2151.##sesd";
    strings["a console which failed to sell well due to its headache-inducing features.##sesd"].plurals[0] = "=a console which failed to sell well due to its headache-inducing features.##sesd";
    strings["10xx: Set waveform##sesd6"].plurals[0] = "10xx: =Set waveform##sesd6";
    strings["11xx: Set noise length (0 to 7)##sesd"].plurals[0] = "11xx: =Set noise length (0 to 7)##sesd";
    strings["12xy: Setup envelope (x: enabled/loop (1: enable, 3: enable+loop); y: speed/direction (0-7: down, 8-F: up))##sesd"].plurals[0] = "12xy: =Setup envelope (x: enabled/loop (1: enable, 3: enable+loop); y: speed/direction (0-7: down, 8-F: up))##sesd";
    strings["13xy: Setup sweep (x: speed; y: shift; channel 5 only)##sesd"].plurals[0] = "13xy: =Setup sweep (x: speed; y: shift; channel 5 only)##sesd";
    strings["14xy: Setup modulation (x: enabled/loop (1: enable, 3: enable+loop); y: speed; channel 5 only)##sesd"].plurals[0] = "14xy: =Setup modulation (x: enabled/loop (1: enable, 3: enable+loop); y: speed; channel 5 only)##sesd";
    strings["15xx: Set modulation waveform (x: wavetable; channel 5 only)##sesd"].plurals[0] = "15xx: =Set modulation waveform (x: wavetable; channel 5 only)##sesd";
    strings["like OPLL, but even more cost reductions applied. three less FM channels, and no drums mode...##sesd"].plurals[0] = "=like OPLL, but even more cost reductions applied. three less FM channels, and no drums mode...##sesd";
    strings["so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip.##sesd"].plurals[0] = "=so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip.##sesd";
    ...
    strings["12xx: Set pulse width##sesd0"].plurals[0] = "12xx: =Set pulse width##sesd0";
    strings["17xx: Trigger overlay drum##sesd"].plurals[0] = "17xx: =Trigger overlay drum##sesd";
    ...
    strings["the OPL chip but with drums mode enabled.##sesd"].plurals[0] = "=the OPL chip but with drums mode enabled.##sesd";
    strings["the OPL2 chip but with drums mode enabled.##sesd"].plurals[0] = "=the OPL2 chip but with drums mode enabled.##sesd";
    strings["the OPL3 chip but with drums mode enabled.##sesd"].plurals[0] = "=the OPL3 chip but with drums mode enabled.##sesd";
    ...
    strings["the OPLL chips but with drums mode turned on.##sesd"].plurals[0] = "=the OPLL chips but with drums mode turned on.##sesd";
    strings["3xxx: Load LFSR (0 to FFF)##sesd"].plurals[0] = "3xxx: =Load LFSR (0 to FFF)##sesd";
    strings["a portable console made by Atari. it has all of Atari's trademark waveforms.##sesd"].plurals[0] = "=a portable console made by Atari. it has all of Atari's trademark waveforms.##sesd";
    strings["10xx: Set echo feedback level (00 to FF)##sesd"].plurals[0] = "10xx: =Set echo feedback level (00 to FF)##sesd";
    strings["11xx: Set channel echo level (00 to FF)##sesd"].plurals[0] = "11xx: =Set channel echo level (00 to FF)##sesd";
    strings["12xx: Toggle QSound algorithm (0: disabled; 1: enabled)##sesd"].plurals[0] = "12xx: =Toggle QSound algorithm (0: disabled; 1: enabled)##sesd";
    strings["3xxx: Set echo delay buffer length (000 to AA5)##sesd"].plurals[0] = "3xxx: =Set echo delay buffer length (000 to AA5)##sesd";
    strings["used in some of Capcom's arcade boards. surround-like sampled sound with echo.##sesd"].plurals[0] = "=used in some of Capcom's arcade boards. surround-like sampled sound with echo.##sesd";
    strings["the chip used in a computer design created by The 8-Bit Guy.##sesd"].plurals[0] = "=the chip used in a computer design created by The 8-Bit Guy.##sesd";
    strings["20xx: Set waveform##sesd"].plurals[0] = "20xx: =Set waveform##sesd";
    strings["22xx: Set duty cycle (0 to 3F)##sesd"].plurals[0] = "22xx: =Set duty cycle (0 to 3F)##sesd";
    ...
    strings["this is the same thing as SegaPCM, but only exposes 5 of the channels for compatibility with DefleMask.##sesd"].plurals[0] = "=this is the same thing as SegaPCM, but only exposes 5 of the channels for compatibility with DefleMask.##sesd";
    strings["a sound chip used in several Seta/Allumer-manufactured arcade boards with too many channels of wavetable sound, which also are capable of sampled sound.##sesd"].plurals[0] = "=a sound chip used in several Seta/Allumer-manufactured arcade boards with too many channels of wavetable sound, which also are capable of sampled sound.##sesd";
    strings["10xx: Set waveform##sesd7"].plurals[0] = "10xx: =Set waveform##sesd7";
    strings["11xx: Set envelope shape##sesd"].plurals[0] = "11xx: =Set envelope shape##sesd";
    strings["12xx: Set sample bank slot (0 to 7)##sesd"].plurals[0] = "12xx: =Set sample bank slot (0 to 7)##sesd";
    strings["17xx: Toggle PCM mode (LEGACY)##sesd4"].plurals[0] = "17xx: =Toggle PCM mode (LEGACY)##sesd4";
    strings["20xx: Set PCM frequency (1 to FF)##sesd"].plurals[0] = "20xx: =Set PCM frequency (1 to FF)##sesd";
    strings["22xx: Set envelope mode (bit 0: enable; bit 1: one-shot; bit 2: split shape to L/R; bit 3/5: H.invert right/left; bit 4/6: V.invert right/left)##sesd"].plurals[0] = "22xx: =Set envelope mode (bit 0: enable; bit 1: one-shot; bit 2: split shape to L/R; bit 3/5: H.invert right/left; bit 4/6: V.invert right/left)##sesd";
    strings["23xx: Set envelope period##sesd"].plurals[0] = "23xx: =Set envelope period##sesd";
    strings["25xx: Envelope slide up##sesd1"].plurals[0] = "25xx: =Envelope slide up##sesd1";
    strings["26xx: Envelope slide down##sesd1"].plurals[0] = "26xx: =Envelope slide down##sesd1";
    strings["29xy: Set auto-envelope (x: numerator; y: denominator)##sesd1"].plurals[0] = "29xy: =Set auto-envelope (x: numerator; y: denominator)##sesd1";
    strings["this is the wavetable part of the Bubble System, which also had two AY-3-8910s.##sesd"].plurals[0] = "=this is the wavetable part of the Bubble System, which also had two AY-3-8910s.##sesd";
    strings["like OPL3, but this time it also has a 24-channel version of MultiPCM.##sesd"].plurals[0] = "=like OPL3, but this time it also has a 24-channel version of MultiPCM.##sesd";
    strings["the OPL4 but with drums mode turned on.##sesd"].plurals[0] = "=the OPL4 but with drums mode turned on.##sesd";
    strings["11xx: Set filter mode (00 to 03)##sesd"].plurals[0] = "11xx: =Set filter mode (00 to 03)##sesd";
    strings["14xx: Set filter coefficient K1 low byte (00 to FF)##sesd"].plurals[0] = "14xx: =Set filter coefficient K1 low byte (00 to FF)##sesd";
    strings["15xx: Set filter coefficient K1 high byte (00 to FF)##sesd"].plurals[0] = "15xx: =Set filter coefficient K1 high byte (00 to FF)##sesd";
    strings["16xx: Set filter coefficient K2 low byte (00 to FF)##sesd"].plurals[0] = "16xx: =Set filter coefficient K2 low byte (00 to FF)##sesd";
    strings["17xx: Set filter coefficient K2 high byte (00 to FF)##sesd"].plurals[0] = "17xx: =Set filter coefficient K2 high byte (00 to FF)##sesd";
    strings["18xx: Set filter coefficient K1 slide up (00 to FF)##sesd"].plurals[0] = "18xx: =Set filter coefficient K1 slide up (00 to FF)##sesd";
    strings["19xx: Set filter coefficient K1 slide down (00 to FF)##sesd"].plurals[0] = "19xx: =Set filter coefficient K1 slide down (00 to FF)##sesd";
    strings["1Axx: Set filter coefficient K2 slide up (00 to FF)##sesd"].plurals[0] = "1Axx: =Set filter coefficient K2 slide up (00 to FF)##sesd";
    strings["1Bxx: Set filter coefficient K2 slide down (00 to FF)##sesd"].plurals[0] = "1Bxx: =Set filter coefficient K2 slide down (00 to FF)##sesd";
    strings["22xx: Set envelope left volume ramp (signed) (00 to FF)##sesd"].plurals[0] = "22xx: =Set envelope left volume ramp (signed) (00 to FF)##sesd";
    strings["23xx: Set envelope right volume ramp (signed) (00 to FF)##sesd"].plurals[0] = "23xx: =Set envelope right volume ramp (signed) (00 to FF)##sesd";
    strings["24xx: Set envelope filter coefficient k1 ramp (signed) (00 to FF)##sesd"].plurals[0] = "24xx: =Set envelope filter coefficient k1 ramp (signed) (00 to FF)##sesd";
    strings["25xx: Set envelope filter coefficient k1 ramp (signed, slower) (00 to FF)##sesd"].plurals[0] = "25xx: =Set envelope filter coefficient k1 ramp (signed, slower) (00 to FF)##sesd";
    strings["26xx: Set envelope filter coefficient k2 ramp (signed) (00 to FF)##sesd"].plurals[0] = "26xx: =Set envelope filter coefficient k2 ramp (signed) (00 to FF)##sesd";
    strings["27xx: Set envelope filter coefficient k2 ramp (signed, slower) (00 to FF)##sesd"].plurals[0] = "27xx: =Set envelope filter coefficient k2 ramp (signed, slower) (00 to FF)##sesd";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)##sesd1"].plurals[0] = "DFxx: =Set sample playback direction (0: normal; 1: reverse)##sesd1";
    strings["120x: Set pause (bit 0)##sesd"].plurals[0] = "120x: =Set pause (bit 0)##sesd";
    strings["2xxx: Set envelope count (000 to 1FF)##sesd"].plurals[0] = "2xxx: =Set envelope count (000 to 1FF)##sesd";
    strings["3xxx: Set filter coefficient K1 (000 to FFF)##sesd"].plurals[0] = "3xxx: =Set filter coefficient K1 (000 to FFF)##sesd";
    strings["4xxx: Set filter coefficient K2 (000 to FFF)##sesd"].plurals[0] = "4xxx: =Set filter coefficient K2 (000 to FFF)##sesd";
    strings["a sample chip made by Ensoniq, which is the basis for the GF1 chip found in Gravis' Ultrasound cards.##sesd"].plurals[0] = "=a sample chip made by Ensoniq, which is the basis for the GF1 chip found in Gravis' Ultrasound cards.##sesd";
    strings["like OPL but with an ADPCM channel.##sesd"].plurals[0] = "=like OPL but with an ADPCM channel.##sesd";
    strings["the Y8950 chip, in drums mode.##sesd"].plurals[0] = "=the Y8950 chip, in drums mode.##sesd";
    strings["this is a variant of Konami's SCC chip with the last channel's wavetable being independent.##sesd"].plurals[0] = "=this is a variant of Konami's SCC chip with the last channel's wavetable being independent.##sesd";
    strings["10xx: Set waveform (0 to 7)##sesd1"].plurals[0] = "10xx: =Set waveform (0 to 7)##sesd1";
    strings["12xx: Set pulse width (0 to 7F)##sesd"].plurals[0] = "12xx: =Set pulse width (0 to 7F)##sesd";
    strings["13xx: Set resonance (0 to FF)##sesd"].plurals[0] = "13xx: =Set resonance (0 to FF)##sesd";
    strings["14xx: Set filter mode (bit 0: ring mod; bit 1: low pass; bit 2: high pass; bit 3: band pass)##sesd"].plurals[0] = "14xx: =Set filter mode (bit 0: ring mod; bit 1: low pass; bit 2: high pass; bit 3: band pass)##sesd";
    strings["15xx: Set frequency sweep period low byte##sesd"].plurals[0] = "15xx: =Set frequency sweep period low byte##sesd";
    strings["16xx: Set frequency sweep period high byte##sesd"].plurals[0] = "16xx: =Set frequency sweep period high byte##sesd";
    strings["17xx: Set volume sweep period low byte##sesd"].plurals[0] = "17xx: =Set volume sweep period low byte##sesd";
    strings["18xx: Set volume sweep period high byte##sesd"].plurals[0] = "18xx: =Set volume sweep period high byte##sesd";
    strings["19xx: Set cutoff sweep period low byte##sesd"].plurals[0] = "19xx: =Set cutoff sweep period low byte##sesd";
    strings["1Axx: Set cutoff sweep period high byte##sesd"].plurals[0] = "1Axx: =Set cutoff sweep period high byte##sesd";
    strings["1Bxx: Set frequency sweep boundary##sesd"].plurals[0] = "1Bxx: =Set frequency sweep boundary##sesd";
    strings["1Cxx: Set volume sweep boundary##sesd"].plurals[0] = "1Cxx: =Set volume sweep boundary##sesd";
    strings["1Dxx: Set cutoff sweep boundary##sesd"].plurals[0] = "1Dxx: =Set cutoff sweep boundary##sesd";
    strings["1Exx: Set phase reset period low byte##sesd"].plurals[0] = "1Exx: =Set phase reset period low byte##sesd";
    strings["1Fxx: Set phase reset period high byte##sesd"].plurals[0] = "1Fxx: =Set phase reset period high byte##sesd";
    strings["20xx: Toggle frequency sweep (bit 0-6: speed; bit 7: direction is up)##sesd"].plurals[0] = "20xx: =Toggle frequency sweep (bit 0-6: speed; bit 7: direction is up)##sesd";
    strings["21xx: Toggle volume sweep (bit 0-4: speed; bit 5: direction is up; bit 6: loop; bit 7: alternate)##sesd"].plurals[0] = "21xx: =Toggle volume sweep (bit 0-4: speed; bit 5: direction is up; bit 6: loop; bit 7: alternate)##sesd";
    strings["22xx: Toggle cutoff sweep (bit 0-6: speed; bit 7: direction is up)##sesd"].plurals[0] = "22xx: =Toggle cutoff sweep (bit 0-6: speed; bit 7: direction is up)##sesd";
    strings["4xxx: Set cutoff (0 to FFF)##sesd"].plurals[0] = "4xxx: =Set cutoff (0 to FFF)##sesd";
    strings["tildearrow's fantasy sound chip. put SID, AY and VERA in a blender, and you get this!##sesd"].plurals[0] = "=tildearrow's fantasy sound chip. put SID, AY and VERA in a blender, and you get this!##sesd";
    strings["an ADPCM sound chip manufactured by OKI and used in many arcade boards.##sesd"].plurals[0] = "=an ADPCM sound chip manufactured by OKI and used in many arcade boards.##sesd";
    strings["20xx: Set chip output rate (0: clock/132; 1: clock/165)##sesd"].plurals[0] = "20xx: =Set chip output rate (0: clock/132; 1: clock/165)##sesd";
    strings["an ADPCM sound chip manufactured by OKI and used in the Sharp X68000.##sesd"].plurals[0] = "=an ADPCM sound chip manufactured by OKI and used in the Sharp X68000.##sesd";
    strings["20xx: Set frequency divider (0-2)##sesd"].plurals[0] = "20xx: =Set frequency divider (0-2)##sesd";
    strings["21xx: Select clock rate (0: full; 1: half)##sesd"].plurals[0] = "21xx: =Select clock rate (0: full; 1: half)##sesd";
    strings["used in some arcade boards. Can play back either 4-bit ADPCM, 8-bit PCM or 16-bit PCM.##sesd"].plurals[0] = "=used in some arcade boards. Can play back either 4-bit ADPCM, 8-bit PCM or 16-bit PCM.##sesd";
    strings["10xx: Set waveform##sesd8"].plurals[0] = "10xx: =Set waveform##sesd8";
    strings["10xx: Set waveform##sesd9"].plurals[0] = "10xx: =Set waveform##sesd9";
    strings["11xx: Toggle noise mode##sesd2"].plurals[0] = "11xx: =Toggle noise mode##sesd2";
    strings["a wavetable sound chip used in Pac-Man, among other early Namco arcade games.##sesd"].plurals[0] = "=a wavetable sound chip used in Pac-Man, among other early Namco arcade games.##sesd";
    strings["successor of the original Namco WSG chip, used in later Namco arcade games.##sesd"].plurals[0] = "=successor of the original Namco WSG chip, used in later Namco arcade games.##sesd";
    strings["like Namco C15 but with stereo sound.##sesd"].plurals[0] = "=like Namco C15 but with stereo sound.##sesd";
    strings["a square wave additive synthesis chip made by OKI. used in some arcade machines and instruments.##sesd"].plurals[0] = "=a square wave additive synthesis chip made by OKI. used in some arcade machines and instruments.##sesd";
    strings["10xy: Set group control (x: sustain; y: part toggle bitmask)##sesd"].plurals[0] = "10xy: =Set group control (x: sustain; y: part toggle bitmask)##sesd";
    strings["11xx: Set noise mode##sesd0"].plurals[0] = "11xx: =Set noise mode##sesd0";
    strings["12xx: Set group attack (0 to 5)##sesd"].plurals[0] = "12xx: =Set group attack (0 to 5)##sesd";
    strings["13xx: Set group decay (0 to 11)##sesd"].plurals[0] = "13xx: =Set group decay (0 to 11)##sesd";
    ...
    strings["an SN76489 derivative used in Neo Geo Pocket, has independent stereo volume and noise channel frequency.##sesd"].plurals[0] = "=an SN76489 derivative used in Neo Geo Pocket, has independent stereo volume and noise channel frequency.##sesd";
    strings["20xx: Set noise length (0: short, 1: long)##sesd"].plurals[0] = "20xx: =Set noise length (0: short, 1: long)##sesd";
    strings["as generic sample playback as it gets.##sesd"].plurals[0] = "=as generic sample playback as it gets.##sesd";
    strings["this PCM chip was widely used at Konami arcade boards in 1986-1990.##sesd"].plurals[0] = "=this PCM chip was widely used at Konami arcade boards in 1986-1990.##sesd";
    strings["yet another PCM chip from Irem. like Amiga, but less pitch resolution and no sample loop.##sesd"].plurals[0] = "=yet another PCM chip from Irem. like Amiga, but less pitch resolution and no sample loop.##sesd";
    strings["a SoC with wavetable sound hardware.##sesd"].plurals[0] = "=a SoC with wavetable sound hardware.##sesd";
    strings["a game console with 3 channels of square wave. it's what happens after fusing TIA and VIC together.##sesd"].plurals[0] = "=a game console with 3 channels of square wave. it's what happens after fusing TIA and VIC together.##sesd";
    strings["10xx: Set ring modulation (0: disable, 1: enable)##sesd"].plurals[0] = "10xx: =Set ring modulation (0: disable, 1: enable)##sesd";
    strings["another ZX Spectrum beeper system with full PWM pulses and 3-level volume per channel. it also has a pitchable overlay sample channel.##sesd"].plurals[0] = "=another ZX Spectrum beeper system with full PWM pulses and 3-level volume per channel. it also has a pitchable overlay sample channel.##sesd";
    strings["12xx: Set pulse width##sesd1"].plurals[0] = "12xx: =Set pulse width##sesd1";
    strings["this PCM chip was widely used at Konami arcade boards in 1990-1992.##sesd"].plurals[0] = "=this PCM chip was widely used at Konami arcade boards in 1990-1992.##sesd";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)##sesd2"].plurals[0] = "DFxx: =Set sample playback direction (0: normal; 1: reverse)##sesd2";
    strings["two square waves (one may be turned into noise). used in the Commodore Plus/4, 16 and 116.##sesd"].plurals[0] = "=two square waves (one may be turned into noise). used in the Commodore Plus/4, 16 and 116.##sesd";
    strings["Namco's first PCM chip from 1987. it's pretty good for being so.##sesd"].plurals[0] = "=Namco's first PCM chip from 1987. it's pretty good for being so.##sesd";
    ...
    strings["11xx: Set noise mode##sesd1"].plurals[0] = "11xx: =Set noise mode##sesd1";
    strings["12xy: Set invert mode (x: surround; y: invert)##sesd"].plurals[0] = "12xy: =Set invert mode (x: surround; y: invert)##sesd";
    ...
    strings["2Exx: Toggle hard envelope reset on new notes##sesd"].plurals[0] = "2Exx: =Toggle hard envelope reset on new notes##sesd";
    strings["first Ensoniq chip used in their synths and Apple IIGS\ncomputer. Has 32 hard-panned 8-bit wavetable/sample channels,\ncan do oscillator sync (like SID) and amplitude modulation.\nCan have up to 128 KiB (2 banks of 64 KiB) of memory\nfor wavetables/samples.\nAs Robert Yannes (SID chip creator)\nsaid, it's more or less what SID chip could be\nif he was given enough time for its development.##sesd"].plurals[0] = "=first Ensoniq chip used in their synths and Apple IIGS\ncomputer. Has 32 hard-panned 8-bit wavetable/sample channels,\ncan do oscillator sync (like SID) and amplitude modulation.\nCan have up to 128 KiB (2 banks of 64 KiB) of memory\nfor wavetables/samples.\nAs Robert Yannes (SID chip creator)\nsaid, it's more or less what SID chip could be\nif he was given enough time for its development.##sesd";
    strings["11xx: Set number of enabled oscillators (2-1F)##sesd"].plurals[0] = "11xx: =Set number of enabled oscillators (2-1F)##sesd";
    strings["12xx: Set oscillator output (0-7, 0=left, 1=right)##sesd"].plurals[0] = "12xx: =Set oscillator output (0-7, 0=left, 1=right)##sesd";
    strings["13xx: Set wave/sample length (0-7, 0=256, 1=512 etc.)##sesd"].plurals[0] = "13xx: =Set wave/sample length (0-7, 0=256, 1=512 etc.)##sesd";
    strings["14xx: Set wave/sample position in memory (xx*256 offset)##sesd"].plurals[0] = "14xx: =Set wave/sample position in memory (xx*256 offset)##sesd";
    strings["15xx: Set oscillator mode (0-3)##sesd"].plurals[0] = "15xx: =Set oscillator mode (0-3)##sesd";
    ...
    strings["20xx: Load low byte of noise channel LFSR (00 to FF) or slope channel accumulator (00 to 7F)##sesd"].plurals[0] = "20xx: =Load low byte of noise channel LFSR (00 to FF) or slope channel accumulator (00 to 7F)##sesd";
    strings["21xx: Load high byte of noise channel LFSR (00 to FF)##sesd"].plurals[0] = "21xx: =Load high byte of noise channel LFSR (00 to FF)##sesd";
    strings["22xx: Write to I/O port A##sesd"].plurals[0] = "22xx: =Write to I/O port A##sesd";
    strings["23xx: Write to I/O port B##sesd"].plurals[0] = "23xx: =Write to I/O port B##sesd";
    strings["this is a system designed for testing purposes.##sesd"].plurals[0] = "=this is a system designed for testing purposes.##sesd";
