...
*/
    ...
    strings["Increase values (-16)##sggc"].plurals[0] = "=Increase values (-16)";
    strings["Select all##sggc"].plurals[0] = "=Select all";
    strings["Cut##sggc"].plurals[0] = "=Cut";
    strings["Copy##sggc"].plurals[0] = "=Copy";
    strings["Paste##sggc"].plurals[0] = "=Paste";
    ...
    strings["Save (.dmp)##sggc"].plurals[0] = "=Save (.dmp)";
