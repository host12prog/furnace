...
void DivLocale::addTranslationsTemplate()
{
    ...
    strings["Search..."].plurals[0] = "=Search...";
    strings["Search recent files..."].plurals[0] = "=Search recent files...";
    strings["Search instruments..."].plurals[0] = "=Search instruments...";
    strings["Search samples..."].plurals[0] = "=Search samples...";
    strings["Search instruments (to change to)..."].plurals[0] = "=Search instruments (to change to)...";
    strings["Search chip (to add)..."].plurals[0] = "=Search chip (to add)...";
    strings["Cancel"].plurals[0] = "=Cancel";
    strings["cannot add chip! ("].plurals[0] = "=cannot add chip! (";
    ...
    strings["export (.dmp)"].plurals[0] = "=export (.dmp)";
    ...
    strings["make me a drum kit"].plurals[0] = "=make me a drum kit";
    ...
    strings["the song is over!0"].plurals[0] = "=the song is over!";
    strings["the song is over!1"].plurals[0] = "=the song is over!";
    strings["Open File"].plurals[0] = "=Open File";
    strings["compatible files0"].plurals[0] = "=compatible files";
    strings["all files0"].plurals[0] = "=all files";
    strings["no backups made yet!"].plurals[0] = "=no backups made yet!";
    strings["Restore Backup"].plurals[0] = "=Restore Backup";
    strings["Furnace or Furnace-B song"].plurals[0] = "=Furnace or Furnace-B song";
    strings["Furnace song0"].plurals[0] = "=Furnace song";
    strings["Save File0"].plurals[0] = "=Save File";
    strings["DefleMask 1.1.3 module"].plurals[0] = "=DefleMask 1.1.3 module";
    strings["Save File1"].plurals[0] = "=Save File";
    strings["DefleMask 1.0/legacy module"].plurals[0] = "=DefleMask 1.0/legacy module";
    strings["Save File2"].plurals[0] = "=Save File";
    strings["Furnace-B song"].plurals[0] = "=Furnace-B song";
    strings["Load Instrument"].plurals[0] = "=Load Instrument";
    strings["all compatible files1"].plurals[0] = "=all compatible files";
    strings["Furnace instrument0"].plurals[0] = "=Furnace instrument";
    strings["DefleMask preset0"].plurals[0] = "=DefleMask preset";
    strings["TFM Music Maker instrument"].plurals[0] = "=TFM Music Maker instrument";
    strings["VGM Music Maker instrument"].plurals[0] = "=VGM Music Maker instrument";
    strings["Scream Tracker 3 instrument"].plurals[0] = "=Scream Tracker 3 instrument";
    strings["SoundBlaster instrument"].plurals[0] = "=SoundBlaster instrument";
    strings["Wohlstand OPL instrument"].plurals[0] = "=Wohlstand OPL instrument";
    strings["Wohlstand OPN instrument"].plurals[0] = "=Wohlstand OPN instrument";
    strings["Gens KMod patch dump"].plurals[0] = "=Gens KMod patch dump";
    strings["BNK file (AdLib)"].plurals[0] = "=BNK file (AdLib)";
    strings["FF preset bank"].plurals[0] = "=FF preset bank";
    strings["2612edit GYB preset bank"].plurals[0] = "=2612edit GYB preset bank";
    strings["VOPM preset bank"].plurals[0] = "=VOPM preset bank";
    strings["Wohlstand WOPL bank"].plurals[0] = "=Wohlstand WOPL bank";
    strings["Wohlstand WOPN bank"].plurals[0] = "=Wohlstand WOPN bank";
    strings["all files1"].plurals[0] = "=all files";
    strings["Save Instrument0"].plurals[0] = "=Save Instrument";
    strings["Furnace instrument1"].plurals[0] = "=Furnace instrument";
    strings["Save Instrument1"].plurals[0] = "=Save Instrument";
    strings["DefleMask preset1"].plurals[0] = "=DefleMask preset";
    strings["Load Wavetable"].plurals[0] = "=Load Wavetable";
    strings["compatible files2"].plurals[0] = "=compatible files";
    strings["all files2"].plurals[0] = "=all files";
    strings["Save Wavetable0"].plurals[0] = "=Save Wavetable";
    strings["Furnace wavetable"].plurals[0] = "=Furnace wavetable";
    strings["Save Wavetable1"].plurals[0] = "=Save Wavetable";
    strings["DefleMask wavetable"].plurals[0] = "=DefleMask wavetable";
    strings["Save Wavetable2"].plurals[0] = "=Save Wavetable";
    strings["raw data"].plurals[0] = "=raw data";
    strings["Load Sample"].plurals[0] = "=Load Sample";
    strings["compatible files3"].plurals[0] = "=compatible files";
    strings["all files3"].plurals[0] = "=all files";
    strings["NES DPCM data"].plurals[0] = "=NES DPCM data";
    strings["SNES Bit Rate Reduction"].plurals[0] = "=SNES Bit Rate Reduction";
    strings["Load Raw Sample"].plurals[0] = "=Load Raw Sample";
    strings["all files4"].plurals[0] = "=all files";
    strings["Save Sample"].plurals[0] = "=Save Sample";
    strings["Wave file0"].plurals[0] = "=Wave file";
    strings["Save Raw Sample"].plurals[0] = "=Save Raw Sample";
    strings["all files5"].plurals[0] = "=all files";
    strings["Export Audio0"].plurals[0] = "=Export Audio";
    strings["Wave file1"].plurals[0] = "=Wave file";
    strings["Export Audio1"].plurals[0] = "=Export Audio";
    strings["Wave file2"].plurals[0] = "=Wave file";
    strings["Export Audio2"].plurals[0] = "=Export Audio";
    strings["Wave file3"].plurals[0] = "=Wave file";
    strings["Export VGM"].plurals[0] = "=Export VGM";
    strings["VGM file"].plurals[0] = "=VGM file";
    strings["Export ZSM"].plurals[0] = "=Export ZSM";
    strings["ZSM file"].plurals[0] = "=ZSM file";
    strings["Export Command Stream0"].plurals[0] = "=Export Command Stream";
    strings["text file0"].plurals[0] = "=text file";
    strings["Export Command Stream1"].plurals[0] = "=Export Command Stream";
    strings["text file1"].plurals[0] = "=text file";
    strings["Export Command Stream2"].plurals[0] = "=Export Command Stream";
    strings["Export FZT module"].plurals[0] = "=Export FZT module";
    strings["FZT module"].plurals[0] = "=FZT module";
    strings["binary file"].plurals[0] = "=binary file";
    strings["Export Furnace song"].plurals[0] = "=Export Furnace song";
    strings["Furnace song2"].plurals[0] = "=Furnace song";
    strings["Coming soon!"].plurals[0] = "=Coming soon!";
    strings["Select Font0"].plurals[0] = "=Select Font";
    strings["compatible files4"].plurals[0] = "=compatible files";
    strings["Select Font1"].plurals[0] = "=Select Font";
    strings["compatible files5"].plurals[0] = "=compatible files";
    strings["Select Font2"].plurals[0] = "=Select Font";
    strings["compatible files6"].plurals[0] = "=compatible files";
    strings["Select Color File"].plurals[0] = "=Select Color File";
    strings["configuration files0"].plurals[0] = "=configuration files";
    strings["Select Keybind File"].plurals[0] = "=Select Keybind File";
    strings["configuration files1"].plurals[0] = "=configuration files";
    strings["Select Layout File"].plurals[0] = "=Select Layout File";
    strings[".ini files0"].plurals[0] = "=.ini files";
    strings["Select User Presets File"].plurals[0] = "=Select User Presets File";
    strings["configuration files4"].plurals[0] = "=configuration files";
    strings["Select Settings File"].plurals[0] = "=Select Settings File";
    strings["configuration files5"].plurals[0] = "=configuration files";
    strings["Export Colors"].plurals[0] = "=Export Colors";
    strings["configuration files2"].plurals[0] = "=configuration files";
    strings["Export Keybinds"].plurals[0] = "=Export Keybinds";
    strings["configuration files3"].plurals[0] = "=configuration files";
    strings["Export Layout"].plurals[0] = "=Export Layout";
    strings["Export User Presets"].plurals[0] = "=Export User Presets";
    strings["configuration files6"].plurals[0] = "=configuration files";
    strings["Export Settings"].plurals[0] = "=Export Settings";
    strings["configuration files7"].plurals[0] = "=configuration files";
    strings[".ini files1"].plurals[0] = "=.ini files";
    strings["Load ROM"].plurals[0] = "=Load ROM";
    strings["compatible files7"].plurals[0] = "=compatible files";
    strings["all files6"].plurals[0] = "=all files";
    strings["Play Command Stream"].plurals[0] = "=Play Command Stream";
    strings["command stream"].plurals[0] = "=command stream";
    strings["all files7"].plurals[0] = "=all files";
    strings["Open Test"].plurals[0] = "=Open Test";
    strings["compatible files8"].plurals[0] = "=compatible files";
    strings["another option0"].plurals[0] = "=another option";
    strings["all files8"].plurals[0] = "=all files";
    strings["Open Test (Multi)"].plurals[0] = "=Open Test (Multi)";
    strings["compatible files9"].plurals[0] = "=compatible files";
    strings["another option1"].plurals[0] = "=another option";
    strings["all files9"].plurals[0] = "=all files";
    strings["Save Test"].plurals[0] = "=Save Test";
    strings["Furnace song"].plurals[0] = "=Furnace song";
    strings["DefleMask module"].plurals[0] = "=DefleMask module";
    strings["you have loaded a backup!\nif you need to, please save it somewhere.\n\nDO NOT RELY ON THE BACKUP SYSTEM FOR AUTO-SAVE!\nFurnace will not save backups of backups."].plurals[0] = "=you have loaded a backup!\nif you need to, please save it somewhere.\n\nDO NOT RELY ON THE BACKUP SYSTEM FOR AUTO-SAVE!\nFurnace will not save backups of backups.";
    strings["cut"].plurals[0] = "=cut";
    strings["copy"].plurals[0] = "=copy";
    strings["paste0"].plurals[0] = "=paste";
    strings["paste special..."].plurals[0] = "=paste special...";
    strings["paste mix"].plurals[0] = "=paste mix";
    strings["paste mix (background)"].plurals[0] = "=paste mix (background)";
    strings["paste with ins (foreground)"].plurals[0] = "=paste with ins (foreground)";
    strings["no instruments available0"].plurals[0] = "=no instruments available";
    strings["paste with ins (background)"].plurals[0] = "=paste with ins (background)";
    strings["no instruments available1"].plurals[0] = "=no instruments available";
    strings["paste flood"].plurals[0] = "=paste flood";
    strings["paste overflow"].plurals[0] = "=paste overflow";
    strings["delete0"].plurals[0] = "=delete";
    strings["select all"].plurals[0] = "=select all";
    strings["operation mask..."].plurals[0] = "=operation mask...";
    strings["delete1"].plurals[0] = "=delete";
    strings["pull delete"].plurals[0] = "=pull delete";
    strings["insert"].plurals[0] = "=insert";
    strings["paste1"].plurals[0] = "=paste";
    strings["transpose (note)"].plurals[0] = "=transpose (note)";
    strings["transpose (value)"].plurals[0] = "=transpose (value)";
    strings["interpolate0"].plurals[0] = "=interpolate";
    strings["fade"].plurals[0] = "=fade";
    strings["invert values0"].plurals[0] = "=invert values";
    strings["scale"].plurals[0] = "=scale";
    strings["randomize"].plurals[0] = "=randomize";
    strings["flip"].plurals[0] = "=flip";
    strings["collapse/expand"].plurals[0] = "=collapse/expand";
    strings["input latch"].plurals[0] = "=input latch";
    strings["&&: selected instrument\n..: no instrument"].plurals[0] = "=&&: selected instrument\n..: no instrument";
    strings["Set"].plurals[0] = "=Set";
    strings["Reset"].plurals[0] = "=Reset";
    strings["note up"].plurals[0] = "=note up";
    strings["note down"].plurals[0] = "=note down";
    strings["octave up"].plurals[0] = "=octave up";
    strings["octave down"].plurals[0] = "=octave down";
    strings["values up"].plurals[0] = "=values up";
    strings["values down"].plurals[0] = "=values down";
    strings["values up (+16)"].plurals[0] = "=values up (+16)";
    strings["values down (-16)"].plurals[0] = "=values down (-16)";
    strings["transpose"].plurals[0] = "=transpose";
    strings["Notes"].plurals[0] = "=Notes";
    strings["Values"].plurals[0] = "=Values";
    strings["interpolate1"].plurals[0] = "=interpolate";
    strings["change instrument..."].plurals[0] = "=change instrument...";
    strings["no instruments available"].plurals[0] = "=no instruments available";
    strings["gradient/fade..."].plurals[0] = "=gradient/fade...";
    strings["Start"].plurals[0] = "=Start";
    strings["End"].plurals[0] = "=End";
    strings["Nibble mode0"].plurals[0] = "=Nibble mode";
    strings["Go ahead"].plurals[0] = "=Go ahead";
    strings["scale..."].plurals[0] = "=scale...";
    strings["Scale"].plurals[0] = "=Scale";
    strings["randomize..."].plurals[0] = "=randomize...";
    strings["Minimum"].plurals[0] = "=Minimum";
    strings["Maximum"].plurals[0] = "=Maximum";
    strings["Nibble mode1"].plurals[0] = "=Nibble mode";
    strings["Randomize"].plurals[0] = "=Randomize";
    strings["invert values1"].plurals[0] = "=invert values";
    ...
    strings["collapse"].plurals[0] = "=collapse";
    strings["expand"].plurals[0] = "=expand";
    ...
    strings["clone pattern"].plurals[0] = "=clone pattern";
    strings["Furnace has been started in Safe Mode.\nthis means that:\n\n- software rendering is being used\n- audio output may not work\n- font loading is disabled\n\ncheck any settings which may have made Furnace start up in this mode.\nfont loading is one of these."].plurals[0] = "=Furnace has been started in Safe Mode.\nthis means that:\n\n- software rendering is being used\n- audio output may not work\n- font loading is disabled\n\ncheck any settings which may have made Furnace start up in this mode.\nfont loading is one of these.";
    strings["Unsaved changes! Save changes before opening file?0"].plurals[0] = "=Unsaved changes! Save changes before opening file?";
    strings["Unsaved changes! Save changes before opening file?2"].plurals[0] = "=Unsaved changes! Save changes before opening file?";
    strings["Error while loading file! (%s)0"].plurals[0] = "=Error while loading file! (%s)";
    strings["Unsaved changes! Save changes before quitting?"].plurals[0] = "=Unsaved changes! Save changes before quitting?";
    strings["error while loading fonts! please check your settings.0"].plurals[0] = "=error while loading fonts! please check your settings.";
    strings["File##menubar"].plurals[0] = "=File##menubar";
    strings["file##menubar"].plurals[0] = "=file##menubar";
    strings["new..."].plurals[0] = "=new...";
    strings["Unsaved changes! Save changes before creating a new song?"].plurals[0] = "=Unsaved changes! Save changes before creating a new song?";
    strings["open..."].plurals[0] = "=open...";
    strings["Unsaved changes! Save changes before opening another file?"].plurals[0] = "=Unsaved changes! Save changes before opening another file?";
    strings["open recent"].plurals[0] = "=open recent";
    strings["Unsaved changes! Save changes before opening file?1"].plurals[0] = "=Unsaved changes! Save changes before opening file?";
    strings["nothing here yet"].plurals[0] = "=nothing here yet";
    strings["clear history"].plurals[0] = "=clear history";
    strings["Are you sure you want to clear the recent file list?"].plurals[0] = "=Are you sure you want to clear the recent file list?";
    strings["save"].plurals[0] = "=save";
    strings["Error while saving file! (%s)0"].plurals[0] = "=Error while saving file! (%s)";
    strings["save as..."].plurals[0] = "=save as...";
    strings["export audio...0"].plurals[0] = "=export audio...";
    strings["export VGM...0"].plurals[0] = "=export VGM...";
    strings["export .dmf (1.1.3+)...0"].plurals[0] = "=export .dmf (1.1.3+)...";
    strings["export .dmf (1.0/legacy)...0"].plurals[0] = "=export .dmf (1.0/legacy)...";
    strings["export ZSM...0"].plurals[0] = "=export ZSM...";
    strings["export Amiga validation data...0"].plurals[0] = "=export Amiga validation data...";
    strings["export text...0"].plurals[0] = "=export text...";
    strings["export command stream...0"].plurals[0] = "=export command stream...";
    strings["export FZT module..."].plurals[0] = "=export FZT module...";
    strings["export FZT module...1"].plurals[0] = "=export FZT module...";
    strings["export Furnace module..."].plurals[0] = "=export Furnace module...";
    strings["export audio...1"].plurals[0] = "=export audio...";
    strings["export VGM...1"].plurals[0] = "=export VGM...";
    strings["export .dmf (1.1.3+)...1"].plurals[0] = "=export .dmf (1.1.3+)...";
    strings["export .dmf (1.0/legacy)...1"].plurals[0] = "=export .dmf (1.0/legacy)...";
    strings["export ZSM...1"].plurals[0] = "=export ZSM...";
    strings["export Amiga validation data...1"].plurals[0] = "=export Amiga validation data...";
    strings["export text...1"].plurals[0] = "=export text...";
    strings["export command stream...1"].plurals[0] = "=export command stream...";
    strings["export..."].plurals[0] = "=export...";
    strings["manage chips"].plurals[0] = "=manage chips";
    strings["add chip..."].plurals[0] = "=add chip...";
    strings["cannot add chip! ("].plurals[0] = "=cannot add chip! (";
    strings["configure chip..."].plurals[0] = "=configure chip...";
    strings["change chip..."].plurals[0] = "=change chip...";
    strings["Preserve channel positions0"].plurals[0] = "=Preserve channel positions";
    strings["remove chip..."].plurals[0] = "=remove chip...";
    strings["Preserve channel positions1"].plurals[0] = "=Preserve channel positions";
    strings["cannot remove chip! ("].plurals[0] = "=cannot remove chip! (";
    strings["cannot change chip! ("].plurals[0] = "=cannot change chip! (";
    strings["open built-in assets directory"].plurals[0] = "=open built-in assets directory";
    strings["restore backup"].plurals[0] = "=restore backup";
    strings["exit..."].plurals[0] = "=exit...";
    strings["Unsaved changes! Save before quitting?"].plurals[0] = "=Unsaved changes! Save before quitting?";
    strings["Edit##menubar"].plurals[0] = "=Edit##menubar";
    strings["edit##menubar"].plurals[0] = "=edit##menubar";
    strings["undo"].plurals[0] = "=undo";
    strings["redo"].plurals[0] = "=redo";
    strings["clear..."].plurals[0] = "=clear...";
    strings["Settings##menubar"].plurals[0] = "=Settings##menubar";
    strings["settings##menubar"].plurals[0] = "=settings##menubar";
    strings["full screen"].plurals[0] = "=full screen";
    strings["lock layout"].plurals[0] = "=lock layout";
    strings["pattern visualizer"].plurals[0] = "=pattern visualizer";
    strings["reset layout"].plurals[0] = "=reset layout";
    ...
    strings["switch to mobile view"].plurals[0] = "=switch to mobile view";
    strings["user systems..."].plurals[0] = "=user systems...";
    ...
    strings["song"].plurals[0] = "=song";
    strings["visualizers"].plurals[0] = "=visualizers";
    strings["tempo"].plurals[0] = "=tempo";
    strings["debug"].plurals[0] = "=debug";
    ...
    strings["play/edit controls"].plurals[0] = "=play/edit controls";
    strings["piano/input pad"].plurals[0] = "=piano/input pad";
    ...
    strings["memory composition"].plurals[0] = "=memory composition";
    ...
    strings["inspector"].plurals[0] = "=inspector";
    strings["panic"].plurals[0] = "=panic";
    strings["about..."].plurals[0] = "=about...";
    strings["| Speed %d:%d"].plurals[0] = "=| Speed %d:%d";
    strings["| Speed %d"].plurals[0] = "=| Speed %d";
    strings["| Groove"].plurals[0] = "=| Groove";
    strings[" @ %gHz (%g BPM) "].plurals[0] = "= @ %gHz (%g BPM) ";
    strings["| Order %.2X/%.2X "].plurals[0] = "=| Order %.2X/%.2X ";
    strings["| Order %d/%d "].plurals[0] = "=| Order %d/%d ";
    strings["| Row %.2X/%.2X "].plurals[0] = "=| Row %.2X/%.2X ";
    strings["| Row %d/%d "].plurals[0] = "=| Row %d/%d ";
    strings["Don't you have anything better to do?"].plurals[0] = "=Don't you have anything better to do?";
    strings["%d years "].plurals[0] = "=%d year ";
    strings["%d years "].plurals[1] = "=%d years ";
    strings["%d months "].plurals[0] = "=%d month ";
    strings["%d months "].plurals[1] = "=%d months ";
    strings["%d days "].plurals[0] = "=%d day ";
    strings["%d days "].plurals[1] = "=%d days ";
    strings["Note off (cut)"].plurals[0] = "=Note off (cut)";
    strings["Note off (release)"].plurals[0] = "=Note off (release)";
    strings["Macro release only"].plurals[0] = "=Macro release only";
    strings["Note on: %s"].plurals[0] = "=Note on: %s";
    strings["Ins %d: <invalid>"].plurals[0] = "=Ins %d: <invalid>";
    strings["Ins %d: %s"].plurals[0] = "=Ins %d: %s";
    strings["Set volume: %d (%.2X, INVALID!)"].plurals[0] = "=Set volume: %d (%.2X, INVALID!)";
    strings["Set volume: %d (%.2X, %d%%)"].plurals[0] = "=Set volume: %d (%.2X, %d%%)";
    strings["| modified"].plurals[0] = "=| modified";
    strings["there was an error in the file dialog! you may want to report this issue to:\nhttps://github.com/tildearrow/furnace/issues\ncheck the Log Viewer (window > log viewer) for more information.\n\nfor now please disable the system file picker in Settings > General."].plurals[0] = "=there was an error in the file dialog! you may want to report this issue to:\nhttps://github.com/tildearrow/furnace/issues\ncheck the Log Viewer (window > log viewer) for more information.\n\nfor now please disable the system file picker in Settings > General.";
    strings["can't do anything without Storage permissions!"].plurals[0] = "=can't do anything without Storage permissions!";
    strings["Zenity/KDialog not available!\nplease install one of these, or disable the system file picker in Settings > General."].plurals[0] = "=Zenity/KDialog not available!\nplease install one of these, or disable the system file picker in Settings > General.";
    strings["Error while loading file! (%s)2"].plurals[0] = "=Error while loading file! (%s)";
    strings["Error while saving file! (%s)1"].plurals[0] = "=Error while saving file! (%s)";
    strings["Error while loading file! (%s)3"].plurals[0] = "=Error while loading file! (%s)";
    strings["Error while saving file! (%s)2"].plurals[0] = "=Error while saving file! (%s)";
    strings["Error while saving file! (%s)3"].plurals[0] = "=Error while saving file! (%s)";
    strings["error while saving instrument! only the following instrument types are supported:\n- FM (OPN)\n- SN76489/Sega PSG\n- Game Boy\n- PC Engine\n- NES\n- C64\n- FM (OPLL)\n- FDS"].plurals[0] = "=error while saving instrument! only the following instrument types are supported:\n- FM (OPN)\n- SN76489/Sega PSG\n- Game Boy\n- PC Engine\n- NES\n- C64\n- FM (OPLL)\n- FDS";
    strings["there were some errors while loading samples:\n#sggu"].plurals[0] = "=there were some errors while loading samples:\n";
    strings["...but you haven't selected a sample!0"].plurals[0] = "=...but you haven't selected a sample!";
    strings["could not save sample! open Log Viewer for more information.0"].plurals[0] = "=could not save sample! open Log Viewer for more information.";
    strings["could not save sample! open Log Viewer for more information.1"].plurals[0] = "=could not save sample! open Log Viewer for more information.";
    ...
    strings["...but you haven't selected an instrument!0"].plurals[0] = "=...but you haven't selected an instrument!";
    strings["cannot load instrument! ("].plurals[0] = "=cannot load instrument! (";
    strings["congratulations! you managed to load nothing.\nyou are entitled to a bug report."].plurals[0] = "=congratulations! you managed to load nothing.\nyou are entitled to a bug report.";
    strings["there were some errors while loading wavetables:\n"].plurals[0] = "=there were some errors while loading wavetables:\n";
    strings["cannot load wavetable! ("].plurals[0] = "=cannot load wavetable! (";
    strings["...but you haven't selected a wavetable!"].plurals[0] = "=...but you haven't selected a wavetable!";
    strings["could not open file!"].plurals[0] = "=could not open file!";
    strings["could not write FZT module!"].plurals[0] = "=could not write FZT module!";
    strings["could not import user presets!"].plurals[0] = "=could not import user presets!";
    strings["could not import user presets! (%s)"].plurals[0] = "=could not import user presets! (%s)";
    strings["Could not write ZSM! (%s)"].plurals[0] = "=Could not write ZSM! (%s)";
    strings["could not write text! (%s)"].plurals[0] = "=could not write text! (%s)";
    strings["could not write command stream! (%s)"].plurals[0] = "=could not write command stream! (%s)";
    strings["could not write tildearrow version Furnace module! (%s)"].plurals[0] = "=could not write tildearrow version Furnace module! (%s)";
    strings["Error while loading file! (%s)4"].plurals[0] = "=Error while loading file! (%s)";
    strings["You opened: %s"].plurals[0] = "=You opened: %s";
    strings["You opened:"].plurals[0] = "=You opened:";
    strings["You saved: %s"].plurals[0] = "=You saved: %s";
    strings["Rendering...###Rendering..."].plurals[0] = "=Rendering...###Rendering...";
    strings["Please wait..."].plurals[0] = "=Please wait...";
    strings["Abort"].plurals[0] = "=Abort";
    ...
    strings["Yes0"].plurals[0] = "=Yes";
    strings["No0"].plurals[0] = "=No";
    strings["Yes1"].plurals[0] = "=Yes";
    strings["No1"].plurals[0] = "=No";
    strings["Yes2"].plurals[0] = "=Yes";
    strings["No2"].plurals[0] = "=No";
    strings["Yes3"].plurals[0] = "=Yes";
    strings["No3"].plurals[0] = "=No";
    strings["Yes7"].plurals[0] = "=Yes";
    strings["Yes8"].plurals[0] = "=Yes";
    strings["Yes9"].plurals[0] = "=Yes";
    strings["Yes10"].plurals[0] = "=Yes";
    strings["Yes11"].plurals[0] = "=Yes";
    strings["No8"].plurals[0] = "=No";
    strings["No9"].plurals[0] = "=No";
    strings["No10"].plurals[0] = "=No";
    strings["No11"].plurals[0] = "=No";
    strings["No12"].plurals[0] = "=No";
    strings["Cancel4"].plurals[0] = "=Cancel";
    strings["Cancel5"].plurals[0] = "=Cancel";
    strings["Cancel6"].plurals[0] = "=Cancel";
    strings["Cancel7"].plurals[0] = "=Cancel";
    strings["Cancel8"].plurals[0] = "=Cancel";
    strings["Cancel0"].plurals[0] = "=Cancel";
    strings["Erasing"].plurals[0] = "=Erasing";
    strings["All subsongs"].plurals[0] = "=All subsongs";
    strings["Current subsong"].plurals[0] = "=Current subsong";
    strings["Orders"].plurals[0] = "=Orders";
    strings["Pattern"].plurals[0] = "=Pattern";
    strings["Instruments"].plurals[0] = "=Instruments";
    strings["Wavetables"].plurals[0] = "=Wavetables";
    strings["Samples"].plurals[0] = "=Samples";
    strings["Optimization"].plurals[0] = "=Optimization";
    strings["De-duplicate patterns"].plurals[0] = "=De-duplicate patterns";
    strings["Remove unused instruments"].plurals[0] = "=Remove unused instruments";
    strings["Remove unused samples"].plurals[0] = "=Remove unused samples";
    strings["Never mind! Cancel1"].plurals[0] = "=Never mind! Cancel";
    strings["Yes4"].plurals[0] = "=Yes";
    strings["No4"].plurals[0] = "=No";
    strings["Yes5"].plurals[0] = "=Yes";
    strings["No5"].plurals[0] = "=No";
    strings["Yes6"].plurals[0] = "=Yes";
    strings["No6"].plurals[0] = "=No";
    strings["OK1"].plurals[0] = "=OK";
    strings["Drum kit mode:"].plurals[0] = "=Drum kit mode:";
    strings["Normal"].plurals[0] = "=Normal";
    strings["12 samples per octave"].plurals[0] = "=12 samples per octave";
    strings["Starting octave"].plurals[0] = "=Starting octave";
    strings["too many instruments!"].plurals[0] = "=too many instruments!";
    ...
    strings["this is an instrument bank! select which one to use:"].plurals[0] = "=this is an instrument bank! select which one to use:";
    strings["this is an instrument bank! select which ones to load:"].plurals[0] = "=this is an instrument bank! select which ones to load:";
    strings["All"].plurals[0] = "=All";
    strings["Search..."].plurals[0] = "=Search...";
    strings["None"].plurals[0] = "=None";
    strings["OK2"].plurals[0] = "=OK";
    strings["Cancel2"].plurals[0] = "=Cancel";
    strings["...but you haven't selected an instrument!1"].plurals[0] = "=...but you haven't selected an instrument!";
    strings["Import Raw Sample###Import Raw Sample"].plurals[0] = "=Import Raw Sample###Import Raw Sample";
    strings["Data type:"].plurals[0] = "=Data type:";
    strings["Sample rate"].plurals[0] = "=Sample rate";
    strings["Channels"].plurals[0] = "=Channels";
    strings["(will be mixed down to mono)"].plurals[0] = "=(will be mixed down to mono)";
    strings["Unsigned"].plurals[0] = "=Unsigned";
    strings["Big endian"].plurals[0] = "=Big endian";
    strings["Swap nibbles"].plurals[0] = "=Swap nibbles";
    strings["Swap words"].plurals[0] = "=Swap words";
    strings["Encoding:"].plurals[0] = "=Encoding:";
    strings["Reverse bit order"].plurals[0] = "=Reverse bit order";
    strings["OK3"].plurals[0] = "=OK";
    strings["...but you haven't selected a sample!1"].plurals[0] = "=...but you haven't selected a sample!";
    strings["Cancel3"].plurals[0] = "=Cancel";
    strings["Error! No string provided!"].plurals[0] = "=Error! No string provided!";
    strings["OK4"].plurals[0] = "=OK";
    strings["%.0fµs"].plurals[0] = "=%.0fµs";
    strings["error while loading fonts! please check your settings.1"].plurals[0] = "=error while loading fonts! please check your settings.";
    strings["it appears I couldn't load these fonts. any setting you can check?"].plurals[0] = "=it appears I couldn't load these fonts. any setting you can check?";
    strings["could not init renderer!\r\nfalling back to software renderer. please restart Furnace."].plurals[0] = "=could not init renderer!\r\nfalling back to software renderer. please restart Furnace.";
    strings["could not init renderer! %s\r\nfalling back to software renderer. please restart Furnace."].plurals[0] = "=could not init renderer! %s\r\nfalling back to software renderer. please restart Furnace.";
    strings["\r\nfalling back to software renderer. please restart Furnace."].plurals[0] = "\r\n=falling back to software renderer. please restart Furnace.";
    strings["could not init renderer! %s"].plurals[0] = "=could not init renderer! %s";
    ...
    strings["could not open window! %s"].plurals[0] = "=could not open window! %s";
    strings["error while loading fonts! please check your settings.2"].plurals[0] = "=error while loading fonts! please check your settings.";
    strings["could NOT save layout! %s"].plurals[0] = "=could NOT save layout! %s";
    ...
    strings["Advanced##sgpr"].plurals[0] = "=Advanced";
    ...
    strings["%s: maximum sample rate is %d"].plurals[0] = "=%s: maximum sample rate is %d";
    strings["%s: minimum sample rate is %d"].plurals[0] = "=%s: minimum sample rate is %d";
    strings["%s: sample rate must be %d"].plurals[0] = "=%s: sample rate must be %d";
    strings["Sample Editor###Sample Editor"].plurals[0] = "=Sample Editor###Sample Editor";
    strings["no sample selected"].plurals[0] = "=no sample selected";
    strings["select one..."].plurals[0] = "=select one...";
    strings["or##sgsed0"].plurals[0] = "=or";
    strings["Open##sgsed0"].plurals[0] = "=Open";
    strings["or##sgsed1"].plurals[0] = "=or";
    strings["Create New"].plurals[0] = "=Create New";
    strings["Invalid##sgsed0"].plurals[0] = "=Invalid";
    strings["Invalid##sgsed1"].plurals[0] = "=Invalid";
    strings["%d: %s"].plurals[0] = "=%d: %s";
    strings["Open##sgsed1"].plurals[0] = "=Open";
    strings["import raw..."].plurals[0] = "=import raw...";
    strings["Save"].plurals[0] = "=Save";
    strings["save raw..."].plurals[0] = "=save raw...";
    strings["Name"].plurals[0] = "=Name";
    strings["SNES: loop start must be a multiple of 16 (try with %d)"].plurals[0] = "=SNES: loop start must be a multiple of 16 (try with %d)";
    strings["SNES: loop end must be a multiple of 16 (try with %d)"].plurals[0] = "=SNES: loop end must be a multiple of 16 (try with %d)";
    strings["SNES: sample length will be padded to multiple of 16"].plurals[0] = "=SNES: sample length will be padded to multiple of 16";
    strings["QSound: loop cannot be longer than 32767 samples"].plurals[0] = "=QSound: loop cannot be longer than 32767 samples";
    strings["QSound: maximum sample length is 65535"].plurals[0] = "=QSound: maximum sample length is 65535";
    strings["NES: loop start must be a multiple of 512 (try with %d)"].plurals[0] = "=NES: loop start must be a multiple of 512 (try with %d)";
    strings["NES: loop end must be a multiple of 128 (try with %d)"].plurals[0] = "=NES: loop end must be a multiple of 128 (try with %d)";
    strings["NES: maximum DPCM sample length is 32648"].plurals[0] = "=NES: maximum DPCM sample length is 32648";
    strings["X1-010: samples can't loop"].plurals[0] = "=X1-010: samples can't loop";
    strings["X1-010: maximum sample length is 131072"].plurals[0] = "=X1-010: maximum sample length is 131072";
    strings["GA20: samples can't loop"].plurals[0] = "=GA20: samples can't loop";
    strings["YM2608: loop point ignored on ADPCM (may only loop entire sample)"].plurals[0] = "=YM2608: loop point ignored on ADPCM (may only loop entire sample)";
    strings["YM2608: sample length will be padded to multiple of 512"].plurals[0] = "=YM2608: sample length will be padded to multiple of 512";
    strings["YM2610: ADPCM-A samples can't loop"].plurals[0] = "=YM2610: ADPCM-A samples can't loop";
    strings["YM2610: loop point ignored on ADPCM-B (may only loop entire sample)"].plurals[0] = "=YM2610: loop point ignored on ADPCM-B (may only loop entire sample)";
    strings["YM2610: sample length will be padded to multiple of 512"].plurals[0] = "=YM2610: sample length will be padded to multiple of 512";
    strings["YM2610: maximum ADPCM-A sample length is 2097152"].plurals[0] = "=YM2610: maximum ADPCM-A sample length is 2097152";
    strings["Y8950: loop point ignored on ADPCM (may only loop entire sample)"].plurals[0] = "=Y8950: loop point ignored on ADPCM (may only loop entire sample)";
    strings["Y8950: sample length will be padded to multiple of 512"].plurals[0] = "=Y8950: sample length will be padded to multiple of 512";
    strings["Amiga: loop start must be a multiple of 2"].plurals[0] = "=Amiga: loop start must be a multiple of 2";
    strings["Amiga: loop end must be a multiple of 2"].plurals[0] = "=Amiga: loop end must be a multiple of 2";
    strings["Amiga: maximum sample length is 131070"].plurals[0] = "=Amiga: maximum sample length is 131070";
    strings["SegaPCM: maximum sample length is 65280"].plurals[0] = "=SegaPCM: maximum sample length is 65280";
    strings["K053260: loop point ignored (may only loop entire sample)"].plurals[0] = "=K053260: loop point ignored (may only loop entire sample)";
    strings["K053260: maximum sample length is 65535"].plurals[0] = "=K053260: maximum sample length is 65535";
    strings["C140: maximum sample length is 65535"].plurals[0] = "=C140: maximum sample length is 65535";
    strings["C219: loop start must be a multiple of 2"].plurals[0] = "=C219: loop start must be a multiple of 2";
    strings["C219: loop end must be a multiple of 2"].plurals[0] = "=C219: loop end must be a multiple of 2";
    strings["C219: maximum sample length is 131072"].plurals[0] = "=C219: maximum sample length is 131072";
    strings["MSM6295: samples can't loop"].plurals[0] = "=MSM6295: samples can't loop";
    strings["MSM6295: maximum bankswitched sample length is 129024"].plurals[0] = "=MSM6295: maximum bankswitched sample length is 129024";
    strings["GBA DMA: loop start must be a multiple of 4"].plurals[0] = "=GBA DMA: loop start must be a multiple of 4";
    strings["GBA DMA: loop length must be a multiple of 16"].plurals[0] = "=GBA DMA: loop length must be a multiple of 16";
    strings["GBA DMA: sample length will be padded to multiple of 16"].plurals[0] = "=GBA DMA: sample length will be padded to multiple of 16";
    strings["ES5506: backward loop mode isn't supported"].plurals[0] = "=ES5506: backward loop mode isn't supported";
    strings["backward/ping-pong only supported in Generic PCM DAC\nping-pong also on ES5506"].plurals[0] = "=backward/ping-pong only supported in Generic PCM DAC\nping-pong also on ES5506";
    strings["Info"].plurals[0] = "=Info";
    strings["Rate##sgsed0"].plurals[0] = "=Rate";
    strings["Compat Rate"].plurals[0] = "=Compat Rate";
    strings["used in DefleMask-compatible sample mode (17xx), in where samples are mapped to an octave."].plurals[0] = "=used in DefleMask-compatible sample mode (17xx), in where samples are mapped to an octave.";
    strings["Loop (length: %d)##Loop"].plurals[0] = "=Loop (length: %d)";
    strings["Loop"].plurals[0] = "=Loop";
    strings["changing the loop in a BRR sample may result in glitches!##sgsed0"].plurals[0] = "=changing the loop in a BRR sample may result in glitches!";
    strings["Chips"].plurals[0] = "=Chips";
    strings["Type"].plurals[0] = "=Type";
    strings["BRR emphasis"].plurals[0] = "=BRR emphasis";
    strings["this is a BRR sample.\nenabling this option will muffle it (only affects non-SNES chips)."].plurals[0] = "=this is a BRR sample.\nenabling this option will muffle it (only affects non-SNES chips).";
    strings["enable this option to slightly boost high frequencies\nto compensate for the SNES' Gaussian filter's muffle."].plurals[0] = "=enable this option to slightly boost high frequencies\nto compensate for the SNES' Gaussian filter's muffle.";
    strings["8-bit dither"].plurals[0] = "=8-bit dither";
    strings["dither the sample when used on a chip that only supports 8-bit samples."].plurals[0] = "=dither the sample when used on a chip that only supports 8-bit samples.";
    strings["Hz"].plurals[0] = "=Hz";
    strings["Note"].plurals[0] = "=Note";
    strings["%s"].plurals[0] = "=%s";
    strings["Fine"].plurals[0] = "=Fine";
    strings["Mode"].plurals[0] = "=Mode";
    strings["Start"].plurals[0] = "=Start";
    strings["changing the loop in a BRR sample may result in glitches!##sgsed1"].plurals[0] = "=changing the loop in a BRR sample may result in glitches!";
    strings["End"].plurals[0] = "=End";
    strings["changing the loop in a BRR sample may result in glitches!##sgsed2"].plurals[0] = "=changing the loop in a BRR sample may result in glitches!";
    ...
    strings["Resize##sgsed0"].plurals[0] = "=Resize";
    strings["Samples##sgsed0"].plurals[0] = "=Samples";
    strings["Resize##sgsed1"].plurals[0] = "=Resize";
    strings["couldn't resize! make sure your sample is 8 or 16-bit."].plurals[0] = "=couldn't resize! make sure your sample is 8 or 16-bit.";
    strings["Resample##sgsed0"].plurals[0] = "=Resample";
    strings["Rate##sgsed1"].plurals[0] = "=Rate";
    strings["Factor"].plurals[0] = "=Factor";
    strings["Filter"].plurals[0] = "=Filter";
    strings["Resample##sgsed1"].plurals[0] = "=Resample";
    strings["couldn't resample! make sure your sample is 8 or 16-bit."].plurals[0] = "=couldn't resample! make sure your sample is 8 or 16-bit.";
    strings["Undo"].plurals[0] = "=Undo";
    strings["Redo"].plurals[0] = "=Redo";
    strings["Amplify"].plurals[0] = "=Amplify";
    strings["Volume"].plurals[0] = "=Volume";
    strings["Apply##sgsed0"].plurals[0] = "=Apply";
    ...
    strings["Samples##sgsed1"].plurals[0] = "=Samples";
    strings["Go"].plurals[0] = "=Go";
    strings["couldn't insert! make sure your sample is 8 or 16-bit."].plurals[0] = "=couldn't insert! make sure your sample is 8 or 16-bit.";
    ...
    strings["Cutoff:"].plurals[0] = "=Cutoff:";
    strings["From"].plurals[0] = "=From";
    strings["To"].plurals[0] = "=To";
    strings["Resonance"].plurals[0] = "=Resonance";
    strings["Power"].plurals[0] = "=Power";
    strings["Low-pass"].plurals[0] = "=Low-pass";
    strings["Band-pass"].plurals[0] = "=Band-pass";
    strings["High-pass"].plurals[0] = "=High-pass";
    strings["Apply##sgsed1"].plurals[0] = "=Apply";
    strings["Crossfade loop points"].plurals[0] = "=Crossfade loop points";
    strings["Number of samples"].plurals[0] = "=Number of samples";
    strings["Linear <-> Equal power"].plurals[0] = "=Linear <-> Equal power";
    strings["Apply##sgsed2"].plurals[0] = "=Apply";
    strings["Crossfade: length would go out of bounds. Aborted..."].plurals[0] = "=Crossfade: length would go out of bounds. Aborted...";
    strings["Crossfade: length would overflow loopStart. Try a smaller random value."].plurals[0] = "=Crossfade: length would overflow loopStart. Try a smaller random value.";
    ...
    strings["%.2fHz"].plurals[0] = "=%.2fHz";
    strings["Non-8/16-bit samples cannot be edited without prior conversion."].plurals[0] = "=Non-8/16-bit samples cannot be edited without prior conversion.";
    ...
    strings["Auto-fill file name when saving"].plurals[0] = "=Auto-fill file name when saving";
    strings["fill the file name field with an appropriate file name when saving or exporting."].plurals[0] = "=fill the file name field with an appropriate file name when saving or exporting.";
    ...
    strings["Base note"].plurals[0] = "=Base note";
    strings["Finetune"].plurals[0] = "=Finetune";
    strings["Slide speed"].plurals[0] = "=Slide speed";
    strings["Set PW"].plurals[0] = "=Set PW";
    strings["Set pulse width on keydown"].plurals[0] = "=Set pulse width on keydown";
    strings["Initial pulse width"].plurals[0] = "=Initial pulse width";
    strings["Set cutoff"].plurals[0] = "=Set cutoff";
    strings["Set filter cutoff on keydown"].plurals[0] = "=Set filter cutoff on keydown";
    strings["Waveform"].plurals[0] = "=Waveform";
    strings["noise"].plurals[0] = "=noise";
    strings["pulse"].plurals[0] = "=pulse";
    strings["triangle"].plurals[0] = "=triangle";
    strings["saw"].plurals[0] = "=saw";
    strings["metal"].plurals[0] = "=metal";
    strings["sine"].plurals[0] = "=sine";
    strings["Enable filter"].plurals[0] = "=Enable filter";
    strings["Cutoff"].plurals[0] = "=Cutoff";
    strings["Resonance"].plurals[0] = "=Resonance";
    strings["Type"].plurals[0] = "=Type";
    strings["Enable ring modulation"].plurals[0] = "=Enable ring modulation";
    strings["Ring mod source"].plurals[0] = "=Ring mod source";
    strings["FF = self-modulation"].plurals[0] = "=FF = self-modulation";
    strings["Enable hard sync"].plurals[0] = "=Enable hard sync";
    strings["Hard sync source"].plurals[0] = "=Hard sync source";
    strings["FF = self-sync"].plurals[0] = "=FF = self-sync";
    strings["Retrigger on slide"].plurals[0] = "=Retrigger on slide";
    strings["Restart instrument and envelope even if slide command (03xx) is placed with the note."].plurals[0] = "=Restart instrument and envelope even if slide command (03xx) is placed with the note.";
    strings["Sync osc. on keydown"].plurals[0] = "=Sync osc. on keydown";
    strings["Reset phase of oscillator each time new note is played.\nDoes not happen when slide (03xx) or legato command is placed."].plurals[0] = "=Reset phase of oscillator each time new note is played.\nDoes not happen when slide (03xx) or legato command is placed.";
    strings["Vibrato"].plurals[0] = "=Vibrato";
    strings["Speed0"].plurals[0] = "=Speed0";
    strings["Depth0"].plurals[0] = "=Depth0";
    strings["Delay0"].plurals[0] = "=Delay0";
    strings["PWM"].plurals[0] = "=PWM";
    strings["Speed1"].plurals[0] = "=Speed1";
    strings["Depth1"].plurals[0] = "=Depth1";
    strings["Delay1"].plurals[0] = "=Delay1";
    strings["A"].plurals[0] = "=A";
    strings["D"].plurals[0] = "=D";
    strings["S"].plurals[0] = "=S";
    strings["R"].plurals[0] = "=R";
    strings["VOL"].plurals[0] = "=VOL";
    strings["Envelope"].plurals[0] = "=Envelope";
    strings["Instrument program"].plurals[0] = "=Instrument program";
    strings["Program period22"].plurals[0] = "=Program period";
    strings["Do not restart instrument program on keydown"].plurals[0] = "=Do not restart instrument program on keydown";
    strings["Tick"].plurals[0] = "=Tick";
    strings["Command"].plurals[0] = "=Command";
    strings["Move/Remove"].plurals[0] = "=Move/Remove";
    strings["Unite"].plurals[0] = "=Unite";
    strings["Value"].plurals[0] = "=Value";
    strings["Semitones"].plurals[0] = "=Semitones";
    strings["First external arpeggio note"].plurals[0] = "=First external arpeggio note";
    strings["Second external arpeggio note1"].plurals[0] = "=Second external arpeggio note";
    strings["Speed2"].plurals[0] = "=Speed";
    strings["Depth11"].plurals[0] = "=Depth";
    strings["Value"].plurals[0] = "=Value";
    strings["Up2"].plurals[0] = "=Up";
    strings["Down11"].plurals[0] = "=Down";
    strings["Source channel"].plurals[0] = "=Source channel";
    strings["Source is self"].plurals[0] = "=Source is self";
    strings["Loops"].plurals[0] = "=Loops";
    strings["Step to jump to"].plurals[0] = "=Step to jump to";
    strings["No operation"].plurals[0] = "=No operation";
    strings["Program end"].plurals[0] = "=Program end";
    strings["Execute next command at the same tick"].plurals[0] = "=Execute next command at the same tick";
    strings["Macros"].plurals[0] = "=Macros";
    strings["Warning! Macros are NOT supported by FZT file format! Do not use them if you want to export .fzt file!"].plurals[0] = "=Warning! Macros are NOT supported by FZT file format! Do not use them if you want to export .fzt file!";
    strings["Volume"].plurals[0] = "=Volume";
    strings["Arpeggio"].plurals[0] = "=Arpeggio";
    strings["Pitch"].plurals[0] = "=Pitch";
    strings["Duty"].plurals[0] = "=Duty";
    strings["Waveform"].plurals[0] = "=Waveform";
    strings["Cutoff"].plurals[0] = "=Cutoff";
    strings["Filter Mode"].plurals[0] = "=Filter Mode";
    strings["Filter Toggle"].plurals[0] = "=Filter Toggle";
    strings["Resonance"].plurals[0] = "=Resonance";
    strings["Phase Reset"].plurals[0] = "=Phase Reset";
    strings["Envelope Reset/Key Control"].plurals[0] = "=Envelope Reset/Key Control";
    strings["Ring mod toggle"].plurals[0] = "=Ring mod toggle";
    strings["Ring mod source"].plurals[0] = "=Ring mod source";
    strings["Hard sync toggle"].plurals[0] = "=Hard sync toggle";
    strings["Hard sync source"].plurals[0] = "=Hard sync source";
    strings["Attack"].plurals[0] = "=Attack";
    strings["Decay"].plurals[0] = "=Decay";
    strings["Sustain"].plurals[0] = "=Sustain";
    strings["Release"].plurals[0] = "=Release";
    ...
    strings["Use software envelope"].plurals[0] = "=Use software envelope";
    strings["Initialize envelope on every note"].plurals[0] = "=Initialize envelope on every note";
    strings["Volume##sgiGB0"].plurals[0] = "=Volume";
    strings["Length"].plurals[0] = "=Length";
    strings["Sound Length##sgiGB0"].plurals[0] = "=Sound Length";
    strings["Infinity"].plurals[0] = "=Infinity";
    strings["Direction"].plurals[0] = "=Direction";
    strings["Up##sgiGB0"].plurals[0] = "=Up";
    strings["Down##sgiGB0"].plurals[0] = "=Down";
    strings["Hardware Sequence"].plurals[0] = "=Hardware Sequence";
    strings["Tick"].plurals[0] = "=Tick";
    strings["Command"].plurals[0] = "=Command";
    strings["Move/Remove"].plurals[0] = "=Move/Remove";
    strings["Volume"].plurals[0] = "=Volume";
    strings["Env Length"].plurals[0] = "=Env Length";
    strings["Sound Length"].plurals[0] = "=Sound Length";
    strings["Up"].plurals[0] = "=Up";
    strings["Down"].plurals[0] = "=Down";
    strings["Shift"].plurals[0] = "=Shift";
    strings["Speed"].plurals[0] = "=Speed";
    strings["Up"].plurals[0] = "=Up";
    strings["Down"].plurals[0] = "=Down";
    strings["Ticks"].plurals[0] = "=Ticks";
    strings["Position"].plurals[0] = "=Position";
    strings["Macros"].plurals[0] = "=Macros";
    strings["Volume"].plurals[0] = "=Volume";
    strings["Arpeggio"].plurals[0] = "=Arpeggio";
    strings["Pitch"].plurals[0] = "=Pitch";
    strings["Duty/Noise"].plurals[0] = "=Duty/Noise";
    strings["Waveform"].plurals[0] = "=Waveform";
    ...
    strings["Sunsoft 5B standalone"].plurals[0] = "=Sunsoft 5B standalone";
    strings["Sunsoft 5B standalone (PAL)"].plurals[0] = "=Sunsoft 5B standalone (PAL)";
    strings["Overclocked Sunsoft 5B"].plurals[0] = "=Overclocked Sunsoft 5B";
    strings["Sega Genesis Extended Channel 3"].plurals[0] = "=Sega Genesis Extended Channel 3";
    strings["NTSC-J Sega Master System + drums"].plurals[0] = "=NTSC-J Sega Master System + drums";
    strings["MSX-MUSIC + drums"].plurals[0] = "=MSX-MUSIC + drums";
    strings["Commodore 64 with dual 6581"].plurals[0] = "=Commodore 64 with dual 6581";
    strings["Commodore 64 with dual 8580"].plurals[0] = "=Commodore 64 with dual 8580";
    strings["YM2151 + SegaPCM Arcade (compatibility)"].plurals[0] = "=YM2151 + SegaPCM Arcade (compatibility)";
    strings["YM2151 + SegaPCM Arcade"].plurals[0] = "=YM2151 + SegaPCM Arcade";
    strings["Game Boy with AY expansion"].plurals[0] = "=Game Boy with AY expansion";
    strings["multi-system"].plurals[0] = "=multi-system";
    strings["Unknown"].plurals[0] = "=Unknown";
    strings["15xx: Set raw period"].plurals[0] = "=15xx: Set raw period";
    strings["16xx: Set raw period higher nybble (0-F)"].plurals[0] = "=16xx: Set raw period higher nybble (0-F)";
    strings["20xx: Set channel mode (bit 0: square; bit 1: noise; bit 2: envelope)"].plurals[0] = "=20xx: Set channel mode (bit 0: square; bit 1: noise; bit 2: envelope)";
    strings["21xx: Set noise frequency (0 to 1F)"].plurals[0] = "=21xx: Set noise frequency (0 to 1F)";
    strings["22xy: Set envelope mode (x: shape, y: enable for this channel)"].plurals[0] = "=22xy: Set envelope mode (x: shape, y: enable for this channel)";
    strings["23xx: Set envelope period low byte"].plurals[0] = "=23xx: Set envelope period low byte";
    strings["24xx: Set envelope period high byte"].plurals[0] = "=24xx: Set envelope period high byte";
    strings["25xx: Envelope slide up"].plurals[0] = "=25xx: Envelope slide up";
    strings["26xx: Envelope slide down"].plurals[0] = "=26xx: Envelope slide down";
    strings["29xy: Set auto-envelope (x: numerator; y: denominator)"].plurals[0] = "=29xy: Set auto-envelope (x: numerator; y: denominator)";
    strings["2Exx: Write to I/O port A"].plurals[0] = "=2Exx: Write to I/O port A";
    strings["2Fxx: Write to I/O port B"].plurals[0] = "=2Fxx: Write to I/O port B";
    strings["12xx: Set duty cycle (0 to 8)"].plurals[0] = "=12xx: Set duty cycle (0 to 8)";
    strings["16xx: Set raw period higher byte"].plurals[0] = "=16xx: Set raw period higher byte";
    strings["27xx: Set noise AND mask"].plurals[0] = "=27xx: Set noise AND mask";
    strings["28xx: Set noise OR mask"].plurals[0] = "=28xx: Set noise OR mask";
    strings["2Cxy: Automatic noise frequency (auto-PWM) (x: mode (0: disable, 1: freq, 2: freq + OR mask); y: offset"].plurals[0] = "=2Cxy: Automatic noise frequency (auto-PWM) (x: mode (0: disable, 1: freq, 2: freq + OR mask); y: offset";
    strings["2Dxx: NOT TO BE EMPLOYED BY THE COMPOSER"].plurals[0] = "=2Dxx: NOT TO BE EMPLOYED BY THE COMPOSER";
    strings["30xx: Toggle hard envelope reset on new notes"].plurals[0] = "=30xx: Toggle hard envelope reset on new notes";
    strings["18xx: Toggle extended channel 3 mode"].plurals[0] = "=18xx: Toggle extended channel 3 mode";
    strings["17xx: Toggle PCM mode (LEGACY)"].plurals[0] = "=17xx: Toggle PCM mode (LEGACY)";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)"].plurals[0] = "=DFxx: Set sample playback direction (0: normal; 1: reverse)";
    strings["18xx: Toggle drums mode (1: enabled; 0: disabled)"].plurals[0] = "=18xx: Toggle drums mode (1: enabled; 0: disabled)";
    strings["11xx: Set feedback (0 to 7)"].plurals[0] = "=11xx: Set feedback (0 to 7)";
    strings["12xx: Set level of operator 1 (0 highest, 7F lowest)"].plurals[0] = "=12xx: Set level of operator 1 (0 highest, 7F lowest)";
    strings["13xx: Set level of operator 2 (0 highest, 7F lowest)"].plurals[0] = "=13xx: Set level of operator 2 (0 highest, 7F lowest)";
    strings["14xx: Set level of operator 3 (0 highest, 7F lowest)"].plurals[0] = "=14xx: Set level of operator 3 (0 highest, 7F lowest)";
    strings["15xx: Set level of operator 4 (0 highest, 7F lowest)"].plurals[0] = "=15xx: Set level of operator 4 (0 highest, 7F lowest)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)"].plurals[0] = "=16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)";
    strings["19xx: Set attack of all operators (0 to 1F)"].plurals[0] = "=19xx: Set attack of all operators (0 to 1F)";
    strings["1Axx: Set attack of operator 1 (0 to 1F)"].plurals[0] = "=1Axx: Set attack of operator 1 (0 to 1F)";
    strings["1Bxx: Set attack of operator 2 (0 to 1F)"].plurals[0] = "=1Bxx: Set attack of operator 2 (0 to 1F)";
    strings["1Cxx: Set attack of operator 3 (0 to 1F)"].plurals[0] = "=1Cxx: Set attack of operator 3 (0 to 1F)";
    strings["1Dxx: Set attack of operator 4 (0 to 1F)"].plurals[0] = "=1Dxx: Set attack of operator 4 (0 to 1F)";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)"].plurals[0] = "=50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)"].plurals[0] = "=51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)"].plurals[0] = "=52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)";
    strings["53xy: Set detune (x: operator from 1 to 4 (0 for all ops); y: detune where 3 is center)"].plurals[0] = "=53xy: Set detune (x: operator from 1 to 4 (0 for all ops); y: detune where 3 is center)";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)"].plurals[0] = "=54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)";
    strings["56xx: Set decay of all operators (0 to 1F)"].plurals[0] = "=56xx: Set decay of all operators (0 to 1F)";
    strings["57xx: Set decay of operator 1 (0 to 1F)"].plurals[0] = "=57xx: Set decay of operator 1 (0 to 1F)";
    strings["58xx: Set decay of operator 2 (0 to 1F)"].plurals[0] = "=58xx: Set decay of operator 2 (0 to 1F)";
    strings["59xx: Set decay of operator 3 (0 to 1F)"].plurals[0] = "=59xx: Set decay of operator 3 (0 to 1F)";
    strings["5Axx: Set decay of operator 4 (0 to 1F)"].plurals[0] = "=5Axx: Set decay of operator 4 (0 to 1F)";
    strings["5Bxx: Set decay 2 of all operators (0 to 1F)"].plurals[0] = "=5Bxx: Set decay 2 of all operators (0 to 1F)";
    strings["5Cxx: Set decay 2 of operator 1 (0 to 1F)"].plurals[0] = "=5Cxx: Set decay 2 of operator 1 (0 to 1F)";
    strings["5Dxx: Set decay 2 of operator 2 (0 to 1F)"].plurals[0] = "=5Dxx: Set decay 2 of operator 2 (0 to 1F)";
    strings["5Exx: Set decay 2 of operator 3 (0 to 1F)"].plurals[0] = "=5Exx: Set decay 2 of operator 3 (0 to 1F)";
    strings["5Fxx: Set decay 2 of operator 4 (0 to 1F)"].plurals[0] = "=5Fxx: Set decay 2 of operator 4 (0 to 1F)";
    strings["10xx: Set noise frequency (xx: value; 0 disables noise)"].plurals[0] = "=10xx: Set noise frequency (xx: value; 0 disables noise)";
    strings["17xx: Set LFO speed"].plurals[0] = "=17xx: Set LFO speed";
    strings["18xx: Set LFO waveform (0 saw, 1 square, 2 triangle, 3 noise)"].plurals[0] = "=18xx: Set LFO waveform (0 saw, 1 square, 2 triangle, 3 noise)";
    strings["1Exx: Set AM depth (0 to 7F)"].plurals[0] = "=1Exx: Set AM depth (0 to 7F)";
    strings["1Fxx: Set PM depth (0 to 7F)"].plurals[0] = "=1Fxx: Set PM depth (0 to 7F)";
    strings["55xy: Set detune 2 (x: operator from 1 to 4 (0 for all ops); y: detune from 0 to 3)"].plurals[0] = "=55xy: Set detune 2 (x: operator from 1 to 4 (0 for all ops); y: detune from 0 to 3)";
    strings["24xx: Set LFO 2 speed"].plurals[0] = "=24xx: Set LFO 2 speed";
    strings["25xx: Set LFO 2 waveform (0 saw, 1 square, 2 triangle, 3 noise)"].plurals[0] = "=25xx: Set LFO 2 waveform (0 saw, 1 square, 2 triangle, 3 noise)";
    strings["26xx: Set AM 2 depth (0 to 7F)"].plurals[0] = "=26xx: Set AM 2 depth (0 to 7F)";
    strings["27xx: Set PM 2 depth (0 to 7F)"].plurals[0] = "=27xx: Set PM 2 depth (0 to 7F)";
    strings["28xy: Set reverb (x: operator from 1 to 4 (0 for all ops); y: reverb from 0 to 7)"].plurals[0] = "=28xy: Set reverb (x: operator from 1 to 4 (0 for all ops); y: reverb from 0 to 7)";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 7)"].plurals[0] = "=2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 7)";
    strings["2Bxy: Set envelope generator shift (x: operator from 1 to 4 (0 for all ops); y: shift from 0 to 3)"].plurals[0] = "=2Bxy: Set envelope generator shift (x: operator from 1 to 4 (0 for all ops); y: shift from 0 to 3)";
    strings["2Cxy: Set fine multiplier (x: operator from 1 to 4 (0 for all ops); y: fine)"].plurals[0] = "=2Cxy: Set fine multiplier (x: operator from 1 to 4 (0 for all ops); y: fine)";
    strings["3xyy: Set fixed frequency of operator 1 (x: octave from 0 to 7; y: frequency)"].plurals[0] = "=3xyy: Set fixed frequency of operator 1 (x: octave from 0 to 7; y: frequency)";
    strings["3xyy: Set fixed frequency of operator 2 (x: octave from 8 to F; y: frequency)"].plurals[0] = "=3xyy: Set fixed frequency of operator 2 (x: octave from 8 to F; y: frequency)";
    strings["4xyy: Set fixed frequency of operator 3 (x: octave from 0 to 7; y: frequency)"].plurals[0] = "=4xyy: Set fixed frequency of operator 3 (x: octave from 0 to 7; y: frequency)";
    strings["4xyy: Set fixed frequency of operator 4 (x: octave from 8 to F; y: frequency)"].plurals[0] = "=4xyy: Set fixed frequency of operator 4 (x: octave from 8 to F; y: frequency)";
    strings["10xy: Setup LFO (x: enable; y: speed)"].plurals[0] = "=10xy: Setup LFO (x: enable; y: speed)";
    strings["55xy: Set SSG envelope (x: operator from 1 to 4 (0 for all ops); y: 0-7 on, 8 off)"].plurals[0] = "=55xy: Set SSG envelope (x: operator from 1 to 4 (0 for all ops); y: 0-7 on, 8 off)";
    strings["1Fxx: Set ADPCM-A global volume (0 to 3F)"].plurals[0] = "=1Fxx: Set ADPCM-A global volume (0 to 3F)";
    strings["11xx: Set feedback (0 to 7)1"].plurals[0] = "=11xx: Set feedback (0 to 7)";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)"].plurals[0] = "=12xx: Set level of operator 1 (0 highest, 3F lowest)";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)"].plurals[0] = "=13xx: Set level of operator 2 (0 highest, 3F lowest)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 2; y: multiplier)"].plurals[0] = "=16xy: Set operator multiplier (x: operator from 1 to 2; y: multiplier)";
    strings["19xx: Set attack of all operators (0 to F)"].plurals[0] = "=19xx: Set attack of all operators (0 to F)";
    strings["1Axx: Set attack of operator 1 (0 to F)"].plurals[0] = "=1Axx: Set attack of operator 1 (0 to F)";
    strings["1Bxx: Set attack of operator 2 (0 to F)"].plurals[0] = "=1Bxx: Set attack of operator 2 (0 to F)";
    strings["10xx: Set patch (0 to F)"].plurals[0] = "=10xx: Set patch (0 to F)";
    strings["50xy: Set AM (x: operator from 1 to 2 (0 for all ops); y: AM)"].plurals[0] = "=50xy: Set AM (x: operator from 1 to 2 (0 for all ops); y: AM)";
    strings["51xy: Set sustain level (x: operator from 1 to 2 (0 for all ops); y: sustain)"].plurals[0] = "=51xy: Set sustain level (x: operator from 1 to 2 (0 for all ops); y: sustain)";
    strings["52xy: Set release (x: operator from 1 to 2 (0 for all ops); y: release)"].plurals[0] = "=52xy: Set release (x: operator from 1 to 2 (0 for all ops); y: release)";
    strings["53xy: Set vibrato (x: operator from 1 to 2 (0 for all ops); y: enabled)"].plurals[0] = "=53xy: Set vibrato (x: operator from 1 to 2 (0 for all ops); y: enabled)";
    strings["54xy: Set envelope scale (x: operator from 1 to 2 (0 for all ops); y: scale from 0 to 3)"].plurals[0] = "=54xy: Set envelope scale (x: operator from 1 to 2 (0 for all ops); y: scale from 0 to 3)";
    strings["55xy: Set envelope sustain (x: operator from 1 to 2 (0 for all ops); y: enabled)"].plurals[0] = "=55xy: Set envelope sustain (x: operator from 1 to 2 (0 for all ops); y: enabled)";
    strings["56xx: Set decay of all operators (0 to F)"].plurals[0] = "=56xx: Set decay of all operators (0 to F)";
    strings["57xx: Set decay of operator 1 (0 to F)"].plurals[0] = "=57xx: Set decay of operator 1 (0 to F)";
    strings["58xx: Set decay of operator 2 (0 to F)"].plurals[0] = "=58xx: Set decay of operator 2 (0 to F)";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 2 (0 for all ops); y: enabled)"].plurals[0] = "=5Bxy: Set whether key will scale envelope (x: operator from 1 to 2 (0 for all ops); y: enabled)";
    strings["10xx: Set global AM depth (0: 1dB, 1: 4.8dB)"].plurals[0] = "=10xx: Set global AM depth (0: 1dB, 1: 4.8dB)";
    strings["11xx: Set feedback (0 to 7)2"].plurals[0] = "=11xx: Set feedback (0 to 7)";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)1"].plurals[0] = "=12xx: Set level of operator 1 (0 highest, 3F lowest)";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)1"].plurals[0] = "=13xx: Set level of operator 2 (0 highest, 3F lowest)";
    strings["14xx: Set level of operator 3 (0 highest, 3F lowest)"].plurals[0] = "=14xx: Set level of operator 3 (0 highest, 3F lowest)";
    strings["15xx: Set level of operator 4 (0 highest, 3F lowest)"].plurals[0] = "=15xx: Set level of operator 4 (0 highest, 3F lowest)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)1"].plurals[0] = "=16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)";
    strings["17xx: Set global vibrato depth (0: normal, 1: double)"].plurals[0] = "=17xx: Set global vibrato depth (0: normal, 1: double)";
    strings["19xx: Set attack of all operators (0 to F)1"].plurals[0] = "=19xx: Set attack of all operators (0 to F)";
    strings["1Axx: Set attack of operator 1 (0 to F)1"].plurals[0] = "=1Axx: Set attack of operator 1 (0 to F)";
    strings["1Bxx: Set attack of operator 2 (0 to F)1"].plurals[0] = "=1Bxx: Set attack of operator 2 (0 to F)";
    strings["1Cxx: Set attack of operator 3 (0 to F)"].plurals[0] = "=1Cxx: Set attack of operator 3 (0 to F)";
    strings["1Dxx: Set attack of operator 4 (0 to F)"].plurals[0] = "=1Dxx: Set attack of operator 4 (0 to F)";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 3 in OPL2 and 0 to 7 in OPL3)"].plurals[0] = "=2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 3 in OPL2 and 0 to 7 in OPL3)";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)1"].plurals[0] = "=50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)1"].plurals[0] = "=51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)1"].plurals[0] = "=52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)";
    strings["53xy: Set vibrato (x: operator from 1 to 4 (0 for all ops); y: enabled)"].plurals[0] = "=53xy: Set vibrato (x: operator from 1 to 4 (0 for all ops); y: enabled)";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)1"].plurals[0] = "=54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)";
    strings["55xy: Set envelope sustain (x: operator from 1 to 4 (0 for all ops); y: enabled)"].plurals[0] = "=55xy: Set envelope sustain (x: operator from 1 to 4 (0 for all ops); y: enabled)";
    strings["56xx: Set decay of all operators (0 to F)1"].plurals[0] = "=56xx: Set decay of all operators (0 to F)";
    strings["57xx: Set decay of operator 1 (0 to F)1"].plurals[0] = "=57xx: Set decay of operator 1 (0 to F)";
    strings["58xx: Set decay of operator 2 (0 to F)1"].plurals[0] = "=58xx: Set decay of operator 2 (0 to F)";
    strings["59xx: Set decay of operator 3 (0 to F)"].plurals[0] = "=59xx: Set decay of operator 3 (0 to F)";
    strings["5Axx: Set decay of operator 4 (0 to F)"].plurals[0] = "=5Axx: Set decay of operator 4 (0 to F)";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 4 (0 for all ops); y: enabled)"].plurals[0] = "=5Bxy: Set whether key will scale envelope (x: operator from 1 to 4 (0 for all ops); y: enabled)";
    strings["10xx: Set waveform (bit 0: triangle; bit 1: saw; bit 2: pulse; bit 3: noise)"].plurals[0] = "=10xx: Set waveform (bit 0: triangle; bit 1: saw; bit 2: pulse; bit 3: noise)";
    strings["11xx: Set coarse cutoff (not recommended; use 4xxx instead)"].plurals[0] = "=11xx: Set coarse cutoff (not recommended; use 4xxx instead)";
    strings["12xx: Set coarse pulse width (not recommended; use 3xxx instead)"].plurals[0] = "=12xx: Set coarse pulse width (not recommended; use 3xxx instead)";
    strings["13xx: Set resonance (0 to F)"].plurals[0] = "=13xx: Set resonance (0 to F)";
    strings["14xx: Set filter mode (bit 0: low pass; bit 1: band pass; bit 2: high pass)"].plurals[0] = "=14xx: Set filter mode (bit 0: low pass; bit 1: band pass; bit 2: high pass)";
    strings["15xx: Set envelope reset time"].plurals[0] = "=15xx: Set envelope reset time";
    strings["1Axx: Disable envelope reset for this channel (1 disables; 0 enables)"].plurals[0] = "=1Axx: Disable envelope reset for this channel (1 disables; 0 enables)";
    strings["1Bxy: Reset cutoff (x: on new note; y: now)"].plurals[0] = "=1Bxy: Reset cutoff (x: on new note; y: now)";
    strings["1Cxy: Reset pulse width (x: on new note; y: now)"].plurals[0] = "=1Cxy: Reset pulse width (x: on new note; y: now)";
    strings["1Exy: Change other parameters (LEGACY)"].plurals[0] = "=1Exy: Change other parameters (LEGACY)";
    strings["20xy: Set attack/decay (x: attack; y: decay)"].plurals[0] = "=20xy: Set attack/decay (x: attack; y: decay)";
    strings["21xy: Set sustain/release (x: sustain; y: release)"].plurals[0] = "=21xy: Set sustain/release (x: sustain; y: release)";
    strings["22xx: Pulse width slide up"].plurals[0] = "=22xx: Pulse width slide up";
    strings["23xx: Pulse width slide down"].plurals[0] = "=23xx: Pulse width slide down";
    strings["24xx: Cutoff slide up"].plurals[0] = "=24xx: Cutoff slide up";
    strings["25xx: Cutoff slide down"].plurals[0] = "=25xx: Cutoff slide down";
    strings["3xxx: Set pulse width (0 to FFF)"].plurals[0] = "=3xxx: Set pulse width (0 to FFF)";
    strings["4xxx: Set cutoff (0 to 7FF)"].plurals[0] = "=4xxx: Set cutoff (0 to 7FF)";
    strings["10xx: Set waveform"].plurals[0] = "=10xx: Set waveform";
    strings["13xx: Set waveform (local)"].plurals[0] = "13xx: =Set waveform (local)";
    strings["11xx: Set raw period"].plurals[0] = "=11xx: Set raw period (0-1F)";
    strings["11xx: Set waveform (local)"].plurals[0] = "=11xx: Set waveform (local)";
    strings["20xx: Set PCM frequency"].plurals[0] = "=20xx: Set PCM frequency";
    strings["10xy: Set AM depth (x: operator from 1 to 4 (0 for all ops); y: depth (0: 1dB, 1: 4.8dB))"].plurals[0] = "=10xy: Set AM depth (x: operator from 1 to 4 (0 for all ops); y: depth (0: 1dB, 1: 4.8dB))";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)2"].plurals[0] = "=12xx: Set level of operator 1 (0 highest, 3F lowest)";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)2"].plurals[0] = "=13xx: Set level of operator 2 (0 highest, 3F lowest)";
    strings["14xx: Set level of operator 3 (0 highest, 3F lowest)1"].plurals[0] = "=14xx: Set level of operator 3 (0 highest, 3F lowest)";
    strings["15xx: Set level of operator 4 (0 highest, 3F lowest)1"].plurals[0] = "=15xx: Set level of operator 4 (0 highest, 3F lowest)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)2"].plurals[0] = "=16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)";
    strings["17xy: Set vibrato depth (x: operator from 1 to 4 (0 for all ops); y: depth (0: normal, 1: double))"].plurals[0] = "=17xy: Set vibrato depth (x: operator from 1 to 4 (0 for all ops); y: depth (0: normal, 1: double))";
    strings["19xx: Set attack of all operators (0 to F)"].plurals[0] = "=19xx: Set attack of all operators (0 to F)";
    strings["1Axx: Set attack of operator 1 (0 to F)2"].plurals[0] = "=1Axx: Set attack of operator 1 (0 to F)";
    strings["1Bxx: Set attack of operator 2 (0 to F)2"].plurals[0] = "=1Bxx: Set attack of operator 2 (0 to F)";
    strings["1Cxx: Set attack of operator 3 (0 to F)1"].plurals[0] = "=1Cxx: Set attack of operator 3 (0 to F)";
    strings["1Dxx: Set attack of operator 4 (0 to F)1"].plurals[0] = "=1Dxx: Set attack of operator 4 (0 to F)";
    strings["20xy: Set panning of operator 1 (x: left; y: right)"].plurals[0] = "=20xy: Set panning of operator 1 (x: left; y: right)";
    strings["21xy: Set panning of operator 2 (x: left; y: right)"].plurals[0] = "=21xy: Set panning of operator 2 (x: left; y: right)";
    strings["22xy: Set panning of operator 3 (x: left; y: right)"].plurals[0] = "=22xy: Set panning of operator 3 (x: left; y: right)";
    strings["23xy: Set panning of operator 4 (x: left; y: right)"].plurals[0] = "=23xy: Set panning of operator 4 (x: left; y: right)";
    strings["24xy: Set output level register (x: operator from 1 to 4 (0 for all ops); y: level from 0 to 7)"].plurals[0] = "=24xy: Set output level register (x: operator from 1 to 4 (0 for all ops); y: level from 0 to 7)";
    strings["25xy: Set modulation input level (x: operator from 1 to 4 (0 for all ops); y: level from 0 to 7)"].plurals[0] = "=25xy: Set modulation input level (x: operator from 1 to 4 (0 for all ops); y: level from 0 to 7)";
    strings["26xy: Set envelope delay (x: operator from 1 to 4 (0 for all ops); y: delay from 0 to 7)"].plurals[0] = "=26xy: Set envelope delay (x: operator from 1 to 4 (0 for all ops); y: delay from 0 to 7)";
    strings["27xx: Set noise mode for operator 4 (x: mode from 0 to 3)"].plurals[0] = "=27xx: Set noise mode for operator 4 (x: mode from 0 to 3)";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 7)1"].plurals[0] = "=2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 7)";
    strings["2Fxy: Set fixed frequency block (x: operator from 1 to 4; y: octave from 0 to 7)"].plurals[0] = "=2Fxy: Set fixed frequency block (x: operator from 1 to 4; y: octave from 0 to 7)";
    strings["40xx: Set detune of operator 1 (80: center)"].plurals[0] = "=40xx: Set detune of operator 1 (80: center)";
    strings["41xx: Set detune of operator 2 (80: center)"].plurals[0] = "=41xx: Set detune of operator 2 (80: center)";
    strings["42xx: Set detune of operator 3 (80: center)"].plurals[0] = "=42xx: Set detune of operator 3 (80: center)";
    strings["43xx: Set detune of operator 4 (80: center)"].plurals[0] = "=43xx: Set detune of operator 4 (80: center)";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)2"].plurals[0] = "=50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)2"].plurals[0] = "=51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)2"].plurals[0] = "=52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)";
    strings["53xy: Set vibrato (x: operator from 1 to 4 (0 for all ops); y: enabled)1"].plurals[0] = "=53xy: Set vibrato (x: operator from 1 to 4 (0 for all ops); y: enabled)";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)2"].plurals[0] = "=54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)";
    strings["55xy: Set envelope sustain (x: operator from 1 to 4 (0 for all ops); y: enabled)1"].plurals[0] = "=55xy: Set envelope sustain (x: operator from 1 to 4 (0 for all ops); y: enabled)";
    strings["56xx: Set decay of all operators (0 to F)2"].plurals[0] = "=56xx: Set decay of all operators (0 to F)";
    strings["57xx: Set decay of operator 1 (0 to F)2"].plurals[0] = "=57xx: Set decay of operator 1 (0 to F)";
    strings["58xx: Set decay of operator 2 (0 to F)2"].plurals[0] = "=58xx: Set decay of operator 2 (0 to F)";
    strings["59xx: Set decay of operator 3 (0 to F)1"].plurals[0] = "=59xx: Set decay of operator 3 (0 to F)";
    strings["5Axx: Set decay of operator 4 (0 to F)1"].plurals[0] = "=5Axx: Set decay of operator 4 (0 to F)";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 4 (0 for all ops); y: enabled)1"].plurals[0] = "=5Bxy: Set whether key will scale envelope (x: operator from 1 to 4 (0 for all ops); y: enabled)";
    strings["3xyy: Set fixed frequency F-num of operator 1 (x: high 2 bits from 0 to 3; y: low 8 bits of F-num)"].plurals[0] = "=3xyy: Set fixed frequency F-num of operator 1 (x: high 2 bits from 0 to 3; y: low 8 bits of F-num)";
    strings["3xyy: Set fixed frequency F-num of operator 2 (x: high 2 bits from 4 to 7; y: low 8 bits of F-num)"].plurals[0] = "=3xyy: Set fixed frequency F-num of operator 2 (x: high 2 bits from 4 to 7; y: low 8 bits of F-num)";
    strings["3xyy: Set fixed frequency F-num of operator 3 (x: high 2 bits from 8 to B; y: low 8 bits of F-num)"].plurals[0] = "=3xyy: Set fixed frequency F-num of operator 3 (x: high 2 bits from 8 to B; y: low 8 bits of F-num)";
    strings["3xyy: Set fixed frequency F-num of operator 4 (x: high 2 bits from C to F; y: low 8 bits of F-num)"].plurals[0] = "=3xyy: Set fixed frequency F-num of operator 4 (x: high 2 bits from C to F; y: low 8 bits of F-num)";
    strings["10xx: Set waveform (bit 0: triangle; bit 1: saw; bit 2: pulse; bit 3: noise)1"].plurals[0] = "=10xx: Set waveform (bit 0: triangle; bit 1: saw; bit 2: pulse; bit 3: noise)";
    strings["11xx: Set resonance (0 to FF)"].plurals[0] = "=11xx: Set resonance (0 to FF)";
    strings["12xx: Set filter mode (bit 0: low pass; bit 1: band pass; bit 2: high pass)"].plurals[0] = "=12xx: Set filter mode (bit 0: low pass; bit 1: band pass; bit 2: high pass)";
    strings["13xx: Disable envelope reset for this channel (1 disables; 0 enables)"].plurals[0] = "=13xx: Disable envelope reset for this channel (1 disables; 0 enables)";
    strings["14xy: Reset cutoff (x: on new note; y: now)"].plurals[0] = "=14xy: Reset cutoff (x: on new note; y: now)";
    strings["15xy: Reset pulse width (x: on new note; y: now)"].plurals[0] = "=15xy: Reset pulse width (x: on new note; y: now)";
    strings["16xy: Change other parameters"].plurals[0] = "=16xy: Change other parameters";
    strings["17xx: Pulse width slide up"].plurals[0] = "=17xx: Pulse width slide up";
    strings["18xx: Pulse width slide down"].plurals[0] = "=18xx: Pulse width slide down";
    strings["19xx: Cutoff slide up"].plurals[0] = "=19xx: Cutoff slide up";
    strings["1Axx: Cutoff slide down"].plurals[0] = "=1Axx: Cutoff slide down";
    strings["3xxx: Set pulse width (0 to FFF)1"].plurals[0] = "=3xxx: Set pulse width (0 to FFF)";
    strings["4xxx: Set cutoff (0 to FFF)1"].plurals[0] = "=4xxx: Set cutoff (0 to FFF)";
    strings["a chip which found its way inside mobile phones in the 2000's.\nas proprietary as it is, it passed away after losing to MP3 in the mobile hardware battle."].plurals[0] = "=a chip which found its way inside mobile phones in the 2000's.\nas proprietary as it is, it passed away after losing to MP3 in the mobile hardware battle.";
    strings["<COMPOUND SYSTEM!>"].plurals[0] = "=<COMPOUND SYSTEM!>";
    strings["Sega Genesis Extended Channel 31"].plurals[0] = "=Sega Genesis Extended Channel 3";
    strings["<COMPOUND SYSTEM!>1"].plurals[0] = "=<COMPOUND SYSTEM!>";
    strings["a square/noise sound chip found on the Sega Master System, ColecoVision, Tandy, TI's own 99/4A and a few other places."].plurals[0] = "=a square/noise sound chip found on the Sega Master System, ColecoVision, Tandy, TI's own 99/4A and a few other places.";
    strings["20xy: Set noise mode (x: preset freq/ch3 freq; y: thin pulse/noise)"].plurals[0] = "=20xy: Set noise mode (x: preset freq/ch3 freq; y: thin pulse/noise)";
    strings["<COMPOUND SYSTEM!>2"].plurals[0] = "=<COMPOUND SYSTEM!>";
    strings["the most popular portable game console of the era."].plurals[0] = "=the most popular portable game console of the era.";
    strings["10xx: Set waveform1"].plurals[0] = "=10xx: Set waveform";
    strings["11xx: Set noise length (0: long; 1: short)"].plurals[0] = "=11xx: Set noise length (0: long; 1: short)";
    strings["12xx: Set duty cycle (0 to 3)"].plurals[0] = "=12xx: Set duty cycle (0 to 3)";
    strings["13xy: Setup sweep (x: time; y: shift)"].plurals[0] = "=13xy: Setup sweep (x: time; y: shift)";
    strings["14xx: Set sweep direction (0: up; 1: down)"].plurals[0] = "=14xx: Set sweep direction (0: up; 1: down)";
    strings["15xx: Set waveform (local)"].plurals[0] = "=15xx: Set waveform (local)";
    strings["an '80s game console with a wavetable sound chip, popular in Japan."].plurals[0] = "=an '80s game console with a wavetable sound chip, popular in Japan.";
    strings["10xx: Set waveform2"].plurals[0] = "=10xx: Set waveform";
    strings["11xx: Toggle noise mode"].plurals[0] = "=11xx: Toggle noise mode";
    strings["12xx: Setup LFO (0: disabled; 1: 1x depth; 2: 16x depth; 3: 256x depth)"].plurals[0] = "=12xx: Setup LFO (0: disabled; 1: 1x depth; 2: 16x depth; 3: 256x depth)";
    strings["13xx: Set LFO speed"].plurals[0] = "=13xx: Set LFO speed";
    strings["17xx: Toggle PCM mode (LEGACY)1"].plurals[0] = "=17xx: Toggle PCM mode (LEGACY)";
    strings["18xx: Set waveform (local)"].plurals[0] = "=18xx: Set waveform (local)";
    strings["also known as Famicom in Japan, it's the most well-known game console of the '80s."].plurals[0] = "=also known as Famicom in Japan, it's the most well-known game console of the '80s.";
    strings["11xx: Write to delta modulation counter (0 to 7F)"].plurals[0] = "=11xx: Write to delta modulation counter (0 to 7F)";
    strings["12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1)"].plurals[0] = "=12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1)";
    strings["13xy: Sweep up (x: time; y: shift)"].plurals[0] = "=13xy: Sweep up (x: time; y: shift)";
    strings["14xy: Sweep down (x: time; y: shift)"].plurals[0] = "=14xy: Sweep down (x: time; y: shift)";
    strings["15xx: Set envelope mode (0: envelope, 1: length, 2: looping, 3: constant)"].plurals[0] = "=15xx: Set envelope mode (0: envelope, 1: length, 2: looping, 3: constant)";
    strings["16xx: Set length counter (refer to manual for a list of values)"].plurals[0] = "=16xx: Set length counter (refer to manual for a list of values)";
    strings["17xx: Set frame counter mode (0: 4-step, 1: 5-step)"].plurals[0] = "=17xx: Set frame counter mode (0: 4-step, 1: 5-step)";
    strings["18xx: Select PCM/DPCM mode (0: PCM; 1: DPCM)"].plurals[0] = "=18xx: Select PCM/DPCM mode (0: PCM; 1: DPCM)";
    strings["19xx: Set triangle linear counter (0 to 7F; 80 and higher halt)"].plurals[0] = "=19xx: Set triangle linear counter (0 to 7F; 80 and higher halt)";
    strings["20xx: Set DPCM frequency (0 to F)"].plurals[0] = "=20xx: Set DPCM frequency (0 to F)";
    strings["<COMPOUND SYSTEM!>3"].plurals[0] = "=<COMPOUND SYSTEM!>";
    strings["<COMPOUND SYSTEM!>4"].plurals[0] = "=<COMPOUND SYSTEM!>";
    strings["this computer is powered by the SID chip, which had synthesizer features like a filter and ADSR."].plurals[0] = "=this computer is powered by the SID chip, which had synthesizer features like a filter and ADSR.";
    strings["this computer is powered by the SID chip, which had synthesizer features like a filter and ADSR.\nthis is the newer revision of the chip."].plurals[0] = "=this computer is powered by the SID chip, which had synthesizer features like a filter and ADSR.\nthis is the newer revision of the chip.";
    strings["<COMPOUND SYSTEM!>5"].plurals[0] = "=<COMPOUND SYSTEM!>";
    strings["like Neo Geo, but lacking the ADPCM-B channel since they couldn't connect the pins."].plurals[0] = "=like Neo Geo, but lacking the ADPCM-B channel since they couldn't connect the pins.";
    strings["Neo Geo CD Extended Channel 2"].plurals[0] = "=Neo Geo CD Extended Channel 2";
    strings["like Neo Geo, but lacking the ADPCM-B channel since they couldn't connect the pins.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies."].plurals[0] = "=like Neo Geo, but lacking the ADPCM-B channel since they couldn't connect the pins.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies.";
    strings["this chip is everywhere! ZX Spectrum, MSX, Amstrad CPC, Intellivision, Vectrex...\nthe discovery of envelope bass helped it beat the SN76489 with ease."].plurals[0] = "=this chip is everywhere! ZX Spectrum, MSX, Amstrad CPC, Intellivision, Vectrex...\nthe discovery of envelope bass helped it beat the SN76489 with ease.";
    strings["a computer from the '80s with full sampling capabilities, giving it a sound ahead of its time."].plurals[0] = "=a computer from the '80s with full sampling capabilities, giving it a sound ahead of its time.";
    strings["10xx: Toggle filter (0 disables; 1 enables)"].plurals[0] = "=10xx: Toggle filter (0 disables; 1 enables)";
    strings["11xx: Toggle AM with next channel"].plurals[0] = "=11xx: Toggle AM with next channel";
    strings["12xx: Toggle period modulation with next channel"].plurals[0] = "=12xx: Toggle period modulation with next channel";
    strings["13xx: Set waveform"].plurals[0] = "=13xx: Set waveform";
    strings["14xx: Set waveform (local)"].plurals[0] = "=14xx: Set waveform (local)";
    strings["this was Yamaha's first integrated FM chip.\nit was used in several synthesizers, computers and arcade boards."].plurals[0] = "=this was Yamaha's first integrated FM chip.\nit was used in several synthesizers, computers and arcade boards.";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer)."].plurals[0] = "=this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).";
    strings["it's a challenge to make music on this chip which barely has musical capabilities..."].plurals[0] = "=it's a challenge to make music on this chip which barely has musical capabilities...";
    strings["supposedly an upgrade from the AY-3-8910, this was present on the Creative Music System (Game Blaster) and SAM Coupé."].plurals[0] = "=supposedly an upgrade from the AY-3-8910, this was present on the Creative Music System (Game Blaster) and SAM Coupé.";
    strings["10xy: Set channel mode (x: noise; y: tone)"].plurals[0] = "=10xy: Set channel mode (x: noise; y: tone)";
    strings["11xx: Set noise frequency"].plurals[0] = "=11xx: Set noise frequency";
    strings["12xx: Setup envelope (refer to docs for more information)"].plurals[0] = "=12xx: Setup envelope (refer to docs for more information)";
    strings["an improved version of the AY-3-8910 with a bigger frequency range, duty cycles, configurable noise and per-channel envelopes!"].plurals[0] = "=an improved version of the AY-3-8910 with a bigger frequency range, duty cycles, configurable noise and per-channel envelopes!";
    strings["Commodore's successor to the PET.\nits square wave channels are more than just square..."].plurals[0] = "=Commodore's successor to the PET.\nits square wave channels are more than just square...";
    strings["one channel of 1-bit wavetable which is better (and worse) than the PC Speaker."].plurals[0] = "=one channel of 1-bit wavetable which is better (and worse) than the PC Speaker.";
    strings["FM? nah... samples! Nintendo's answer to Sega."].plurals[0] = "=FM? nah... samples! Nintendo's answer to Sega.";
    strings["18xx: Enable echo buffer"].plurals[0] = "=18xx: Enable echo buffer";
    strings["19xx: Set echo delay (0 to F)"].plurals[0] = "=19xx: Set echo delay (0 to F)";
    strings["1Axx: Set left echo volume"].plurals[0] = "=1Axx: Set left echo volume";
    strings["1Bxx: Set right echo volume"].plurals[0] = "=1Bxx: Set right echo volume";
    strings["1Cxx: Set echo feedback"].plurals[0] = "=1Cxx: Set echo feedback";
    strings["1Exx: Set dry output volume (left)"].plurals[0] = "=1Exx: Set dry output volume (left)";
    strings["1Fxx: Set dry output volume (right)"].plurals[0] = "=1Fxx: Set dry output volume (right)";
    strings["30xx: Set echo filter coefficient 0"].plurals[0] = "=30xx: Set echo filter coefficient 0";
    strings["31xx: Set echo filter coefficient 1"].plurals[0] = "=31xx: Set echo filter coefficient 1";
    strings["32xx: Set echo filter coefficient 2"].plurals[0] = "=32xx: Set echo filter coefficient 2";
    strings["33xx: Set echo filter coefficient 3"].plurals[0] = "=33xx: Set echo filter coefficient 3";
    strings["34xx: Set echo filter coefficient 4"].plurals[0] = "=34xx: Set echo filter coefficient 4";
    strings["35xx: Set echo filter coefficient 5"].plurals[0] = "=35xx: Set echo filter coefficient 5";
    strings["36xx: Set echo filter coefficient 6"].plurals[0] = "=36xx: Set echo filter coefficient 6";
    strings["37xx: Set echo filter coefficient 7"].plurals[0] = "=37xx: Set echo filter coefficient 7";
    strings["10xx: Set waveform3"].plurals[0] = "=10xx: Set waveform";
    strings["11xx: Toggle noise mode1"].plurals[0] = "=11xx: Toggle noise mode";
    strings["12xx: Toggle echo on this channel"].plurals[0] = "=12xx: Toggle echo on this channel";
    strings["13xx: Toggle pitch modulation"].plurals[0] = "=13xx: Toggle pitch modulation";
    strings["14xy: Toggle invert (x: left; y: right)"].plurals[0] = "=14xy: Toggle invert (x: left; y: right)";
    strings["15xx: Set envelope mode (0: ADSR, 1: gain/direct, 2: dec, 3: exp, 4: inc, 5: bent)"].plurals[0] = "=15xx: Set envelope mode (0: ADSR, 1: gain/direct, 2: dec, 3: exp, 4: inc, 5: bent)";
    strings["16xx: Set gain (00 to 7F if direct; 00 to 1F otherwise)"].plurals[0] = "=16xx: Set gain (00 to 7F if direct; 00 to 1F otherwise)";
    strings["17xx: Set waveform (local)"].plurals[0] = "=17xx: Set waveform (local)";
    strings["1Dxx: Set noise frequency (00 to 1F)"].plurals[0] = "=1Dxx: Set noise frequency (00 to 1F)";
    strings["20xx: Set attack (0 to F)"].plurals[0] = "=20xx: Set attack (0 to F)";
    strings["21xx: Set decay (0 to 7)"].plurals[0] = "=21xx: Set decay (0 to 7)";
    strings["22xx: Set sustain (0 to 7)"].plurals[0] = "=22xx: Set sustain (0 to 7)";
    strings["23xx: Set release (00 to 1F)"].plurals[0] = "=23xx: Set release (00 to 1F)";
    strings["an expansion chip for the Famicom, featuring a quirky sawtooth channel."].plurals[0] = "=an expansion chip for the Famicom, featuring a quirky sawtooth channel.";
    strings["12xx: Set duty cycle (pulse: 0 to 7)"].plurals[0] = "=12xx: Set duty cycle (pulse: 0 to 7)";
    strings["17xx: Toggle PCM mode (LEGACY)2"].plurals[0] = "=17xx: Toggle PCM mode (LEGACY)";
    strings["cost-reduced version of the OPL with 16 patches and only one of them is user-configurable."].plurals[0] = "=cost-reduced version of the OPL with 16 patches and only one of them is user-configurable.";
    strings["Famicom Disk System (chip)"].plurals[0] = "=Famicom Disk System (chip)";
    strings["a disk drive for the Famicom which also contains one wavetable channel."].plurals[0] = "=a disk drive for the Famicom which also contains one wavetable channel.";
    strings["10xx: Set waveform4"].plurals[0] = "=10xx: Set waveform";
    strings["11xx: Set modulation depth"].plurals[0] = "=11xx: Set modulation depth";
    strings["12xy: Set modulation speed high byte (x: enable; y: value)"].plurals[0] = "=12xy: Set modulation speed high byte (x: enable; y: value)";
    strings["13xx: Set modulation speed low byte"].plurals[0] = "=13xx: Set modulation speed low byte";
    strings["14xx: Set modulator position"].plurals[0] = "=14xx: Set modulator position";
    strings["15xx: Set modulator table to waveform"].plurals[0] = "=15xx: Set modulator table to waveform";
    strings["16xx: Set waveform (local)"].plurals[0] = "=16xx: Set waveform (local)";
    strings["an expansion chip for the Famicom, featuring a little-known PCM channel."].plurals[0] = "=an expansion chip for the Famicom, featuring a little-known PCM channel.";
    strings["12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1)1"].plurals[0] = "=12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1)";
    strings["an expansion chip for the Famicom, with full wavetable."].plurals[0] = "=an expansion chip for the Famicom, with full wavetable.";
    strings["18xx: Change channel limits (0 to 7, x + 1)"].plurals[0] = "=18xx: Change channel limits (0 to 7, x + 1)";
    strings["20xx: Load a waveform into memory"].plurals[0] = "=20xx: Load a waveform into memory";
    strings["21xx: Set position for wave load"].plurals[0] = "=21xx: Set position for wave load";
    strings["10xx: Select waveform"].plurals[0] = "=10xx: Select waveform";
    strings["11xx: Set waveform position in RAM"].plurals[0] = "=11xx: Set waveform position in RAM";
    strings["12xx: Set waveform length in RAM (04 to FC in steps of 4)"].plurals[0] = "=12xx: Set waveform length in RAM (04 to FC in steps of 4)";
    strings["15xx: Set waveform load position"].plurals[0] = "=15xx: Set waveform load position";
    strings["16xx: Set waveform load length (04 to FC in steps of 4)"].plurals[0] = "=16xx: Set waveform load length (04 to FC in steps of 4)";
    strings["17xx: Select waveform (local)1"].plurals[0] = "=17xx: Select waveform (local)";
    strings["cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)"].plurals[0] = "=cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)";
    strings["Yamaha YM2203 (OPN) Extended Channel 3"].plurals[0] = "=Yamaha YM2203 (OPN) Extended Channel 3";
    strings["cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies"].plurals[0] = "=cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies";
    strings["cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "=cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3.";
    strings["OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels."].plurals[0] = "=OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels.";
    strings["Yamaha YM2608 (OPNA) Extended Channel 3"].plurals[0] = "=Yamaha YM2608 (OPNA) Extended Channel 3";
    strings["OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies."].plurals[0] = "=OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.";
    strings["Yamaha YM2608 (OPNA) Extended Channel 3 and CSM"].plurals[0] = "=Yamaha YM2608 (OPNA) Extended Channel 3 and CSM";
    strings["OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "=OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3.";
    strings["OPN, but what if you only had two operators, no stereo, no detune and a lower ADSR parameter range?"].plurals[0] = "=OPN, but what if you only had two operators, no stereo, no detune and a lower ADSR parameter range?";
    strings["OPL, but what if you had more waveforms to choose than the normal sine?"].plurals[0] = "=OPL, but what if you had more waveforms to choose than the normal sine?";
    strings["OPL2, but what if you had twice the channels, 4-op mode, stereo and even more waveforms?"].plurals[0] = "=OPL2, but what if you had twice the channels, 4-op mode, stereo and even more waveforms?";
    strings["how many channels of PCM do you want?\nMultiPCM: yes"].plurals[0] = "=how many channels of PCM do you want?\nMultiPCM: yes";
    strings["PC Speaker"].plurals[0] = "=PC Speaker";
    strings["good luck! you get one square and no volume control."].plurals[0] = "=good luck! you get one square and no volume control.";
    strings["please don't use this chip. it was added as a joke."].plurals[0] = "=please don't use this chip. it was added as a joke.";
    strings["TIA, but better and more flexible.\nused in the Atari 8-bit family of computers (400/800/XL/XE)."].plurals[0] = "=TIA, but better and more flexible.\nused in the Atari 8-bit family of computers (400/800/XL/XE).";
    strings["10xx: Set waveform (0 to 7)"].plurals[0] = "=10xx: Set waveform (0 to 7)";
    strings["11xx: Set AUDCTL"].plurals[0] = "=11xx: Set AUDCTL";
    strings["12xx: Toggle two-tone mode"].plurals[0] = "=12xx: Toggle two-tone mode";
    strings["13xx: Set raw period"].plurals[0] = "=13xx: Set raw period";
    strings["14xx: Set raw period (higher byte; only for 16-bit mode)"].plurals[0] = "=14xx: Set raw period (higher byte; only for 16-bit mode)";
    strings["this is like SNES' sound chip but without interpolation and the rest of nice bits."].plurals[0] = "=this is like SNES' sound chip but without interpolation and the rest of nice bits.";
    strings["developed by the makers of the Game Boy and the Virtual Boy..."].plurals[0] = "=developed by the makers of the Game Boy and the Virtual Boy...";
    strings["10xx: Set waveform5"].plurals[0] = "=10xx: Set waveform";
    strings["11xx: Setup noise mode (0: disabled; 1-8: enabled/tap)"].plurals[0] = "=11xx: Setup noise mode (0: disabled; 1-8: enabled/tap)";
    strings["12xx: Setup sweep period (0: disabled; 1-20: enabled/period)"].plurals[0] = "=12xx: Setup sweep period (0: disabled; 1-20: enabled/period)";
    strings["13xx: Set sweep amount"].plurals[0] = "=13xx: Set sweep amount";
    strings["17xx: Toggle PCM mode (LEGACY)3"].plurals[0] = "=17xx: Toggle PCM mode (LEGACY)";
    strings["18xx: Set waveform (local)1"].plurals[0] = "=18xx: Set waveform (local)";
    strings["like OPM, but with more waveforms, fixed frequency mode and totally... undocumented.\nused in the Yamaha TX81Z and some other synthesizers."].plurals[0] = "=like OPM, but with more waveforms, fixed frequency mode and totally... undocumented.\nused in the Yamaha TX81Z and some other synthesizers.";
    strings["2Fxx: Toggle hard envelope reset on new notes"].plurals[0] = "=2Fxx: Toggle hard envelope reset on new notes";
    strings["this one is like PC Speaker but has duty cycles."].plurals[0] = "=this one is like PC Speaker but has duty cycles.";
    strings["used in some Sega arcade boards (like OutRun), and usually paired with a YM2151."].plurals[0] = "=used in some Sega arcade boards (like OutRun), and usually paired with a YM2151.";
    strings["a console which failed to sell well due to its headache-inducing features."].plurals[0] = "=a console which failed to sell well due to its headache-inducing features.";
    strings["10xx: Set waveform6"].plurals[0] = "=10xx: Set waveform";
    strings["11xx: Set noise length (0 to 7)"].plurals[0] = "=11xx: Set noise length (0 to 7)";
    strings["12xy: Setup envelope (x: enabled/loop (1: enable, 3: enable+loop); y: speed/direction (0-7: down, 8-F: up))"].plurals[0] = "=12xy: Setup envelope (x: enabled/loop (1: enable, 3: enable+loop); y: speed/direction (0-7: down, 8-F: up))";
    strings["13xy: Setup sweep (x: speed; y: shift; channel 5 only)"].plurals[0] = "=13xy: Setup sweep (x: speed; y: shift; channel 5 only)";
    strings["14xy: Setup modulation (x: enabled/loop (1: enable, 3: enable+loop); y: speed; channel 5 only)"].plurals[0] = "=14xy: Setup modulation (x: enabled/loop (1: enable, 3: enable+loop); y: speed; channel 5 only)";
    strings["15xx: Set modulation waveform (x: wavetable; channel 5 only)"].plurals[0] = "=15xx: Set modulation waveform (x: wavetable; channel 5 only)";
    strings["16xx: Set waveform (local)1"].plurals[0] = "=16xx: Set waveform (local)";
    strings["like OPLL, but even more cost reductions applied. three less FM channels, and no drums mode..."].plurals[0] = "=like OPLL, but even more cost reductions applied. three less FM channels, and no drums mode...";
    strings["so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip."].plurals[0] = "=so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip.";
    strings["ZX Spectrum Beeper"].plurals[0] = "=ZX Spectrum Beeper";
    strings["the ZX Spectrum only had a basic beeper capable of...\n...a bunch of thin pulses and tons of other interesting stuff!\nFurnace provides a thin pulse system."].plurals[0] = "=the ZX Spectrum only had a basic beeper capable of...\n...a bunch of thin pulses and tons of other interesting stuff!\nFurnace provides a thin pulse system.";
    strings["12xx: Set pulse width"].plurals[0] = "=12xx: Set pulse width";
    strings["17xx: Trigger overlay drum"].plurals[0] = "=17xx: Trigger overlay drum";
    strings["Yamaha YM2612 (OPN2) Extended Channel 3"].plurals[0] = "=Yamaha YM2612 (OPN2) Extended Channel 3";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies."].plurals[0] = "=this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "=this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis one includes CSM mode control for special effects on Channel 3.";
    strings["a wavetable chip made by Konami for use with the MSX.\nthe last channel shares its wavetable with the previous one though."].plurals[0] = "=a wavetable chip made by Konami for use with the MSX.\nthe last channel shares its wavetable with the previous one though.";
    strings["Yamaha YM3526 (OPL) with drums"].plurals[0] = "=Yamaha YM3526 (OPL) with drums";
    strings["the OPL chip but with drums mode enabled."].plurals[0] = "=the OPL chip but with drums mode enabled.";
    strings["Yamaha YM3812 (OPL2) with drums"].plurals[0] = "=Yamaha YM3812 (OPL2) with drums";
    strings["the OPL2 chip but with drums mode enabled."].plurals[0] = "=the OPL2 chip but with drums mode enabled.";
    strings["Yamaha YMF262 (OPL3) with drums"].plurals[0] = "=Yamaha YMF262 (OPL3) with drums";
    strings["the OPL3 chip but with drums mode enabled."].plurals[0] = "=the OPL3 chip but with drums mode enabled.";
    strings["this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing."].plurals[0] = "=this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing.";
    strings["Yamaha YM2610 (OPNB) Extended Channel 2"].plurals[0] = "=Yamaha YM2610 (OPNB) Extended Channel 2";
    strings["this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies."].plurals[0] = "=this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies.";
    strings["this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 2."].plurals[0] = "=this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 2.";
    strings["Yamaha YM2413 (OPLL) with drums"].plurals[0] = "=Yamaha YM2413 (OPLL) with drums";
    strings["the OPLL chip but with drums mode turned on."].plurals[0] = "=the OPLL chip but with drums mode turned on.";
    strings["3xxx: Load LFSR (0 to FFF)"].plurals[0] = "=3xxx: Load LFSR (0 to FFF)";
    strings["a portable console made by Atari. it has all of Atari's trademark waveforms."].plurals[0] = "=a portable console made by Atari. it has all of Atari's trademark waveforms.";
    strings["10xx: Set echo feedback level (00 to FF)"].plurals[0] = "=10xx: Set echo feedback level (00 to FF)";
    strings["11xx: Set channel echo level (00 to FF)"].plurals[0] = "=11xx: Set channel echo level (00 to FF)";
    strings["12xx: Toggle QSound algorithm (0: disabled; 1: enabled)"].plurals[0] = "=12xx: Toggle QSound algorithm (0: disabled; 1: enabled)";
    strings["3xxx: Set echo delay buffer length (000 to AA5)"].plurals[0] = "=3xxx: Set echo delay buffer length (000 to AA5)";
    strings["used in some of Capcom's arcade boards. surround-like sampled sound with echo."].plurals[0] = "=used in some of Capcom's arcade boards. surround-like sampled sound with echo.";
    strings["the chip used in a computer design created by The 8-Bit Guy."].plurals[0] = "=the chip used in a computer design created by The 8-Bit Guy.";
    strings["20xx: Set waveform"].plurals[0] = "=20xx: Set waveform";
    strings["22xx: Set duty cycle (0 to 3F)"].plurals[0] = "=22xx: Set duty cycle (0 to 3F)";
    strings["Yamaha YM2610B (OPNB2) Extended Channel 3"].plurals[0] = "=Yamaha YM2610B (OPNB2) Extended Channel 3";
    strings["so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies."].plurals[0] = "=so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.";
    strings["so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "=so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3.";
    strings["SegaPCM (compatible 5-channel mode)"].plurals[0] = "=SegaPCM (compatible 5-channel mode)";
    strings["this is the same thing as SegaPCM, but only exposes 5 of the channels for compatibility with DefleMask."].plurals[0] = "=this is the same thing as SegaPCM, but only exposes 5 of the channels for compatibility with DefleMask.";
    strings["a sound chip used in several Seta/Allumer-manufactured arcade boards with too many channels of wavetable sound, which also are capable of sampled sound."].plurals[0] = "=a sound chip used in several Seta/Allumer-manufactured arcade boards with too many channels of wavetable sound, which also are capable of sampled sound.";
    strings["10xx: Set waveform7"].plurals[0] = "=10xx: Set waveform";
    strings["11xx: Set envelope shape"].plurals[0] = "=11xx: Set envelope shape";
    strings["12xx: Set sample bank slot (0 to 7)"].plurals[0] = "=12xx: Set sample bank slot (0 to 7)";
    strings["17xx: Toggle PCM mode (LEGACY)4"].plurals[0] = "=17xx: Toggle PCM mode (LEGACY)";
    strings["18xx: Set waveform (local)2"].plurals[0] = "=18xx: Set waveform (local)";
    strings["20xx: Set PCM frequency (1 to FF)"].plurals[0] = "=20xx: Set PCM frequency (1 to FF)";
    strings["22xx: Set envelope mode (bit 0: enable; bit 1: one-shot; bit 2: split shape to L/R; bit 3/5: H.invert right/left; bit 4/6: V.invert right/left)"].plurals[0] = "=22xx: Set envelope mode (bit 0: enable; bit 1: one-shot; bit 2: split shape to L/R; bit 3/5: H.invert right/left; bit 4/6: V.invert right/left)";
    strings["23xx: Set envelope period"].plurals[0] = "=23xx: Set envelope period";
    strings["25xx: Envelope slide up1"].plurals[0] = "=25xx: Envelope slide up";
    strings["26xx: Envelope slide down1"].plurals[0] = "=26xx: Envelope slide down";
    strings["29xy: Set auto-envelope (x: numerator; y: denominator)1"].plurals[0] = "=29xy: Set auto-envelope (x: numerator; y: denominator)";
    strings["this is the wavetable part of the Bubble System, which also had two AY-3-8910s."].plurals[0] = "=this is the wavetable part of the Bubble System, which also had two AY-3-8910s.";
    strings["like OPL3, but this time it also has a 24-channel version of MultiPCM."].plurals[0] = "=like OPL3, but this time it also has a 24-channel version of MultiPCM.";
    strings["Yamaha YMF278B (OPL4) with drums"].plurals[0] = "=Yamaha YMF278B (OPL4) with drums";
    strings["the OPL4 but with drums mode turned on."].plurals[0] = "=the OPL4 but with drums mode turned on.";
    strings["11xx: Set filter mode (00 to 03)"].plurals[0] = "=11xx: Set filter mode (00 to 03)";
    strings["14xx: Set filter coefficient K1 low byte (00 to FF)"].plurals[0] = "=14xx: Set filter coefficient K1 low byte (00 to FF)";
    strings["15xx: Set filter coefficient K1 high byte (00 to FF)"].plurals[0] = "=15xx: Set filter coefficient K1 high byte (00 to FF)";
    strings["16xx: Set filter coefficient K2 low byte (00 to FF)"].plurals[0] = "=16xx: Set filter coefficient K2 low byte (00 to FF)";
    strings["17xx: Set filter coefficient K2 high byte (00 to FF)"].plurals[0] = "=17xx: Set filter coefficient K2 high byte (00 to FF)";
    strings["18xx: Set filter coefficient K1 slide up (00 to FF)"].plurals[0] = "=18xx: Set filter coefficient K1 slide up (00 to FF)";
    strings["19xx: Set filter coefficient K1 slide down (00 to FF)"].plurals[0] = "=19xx: Set filter coefficient K1 slide down (00 to FF)";
    strings["1Axx: Set filter coefficient K2 slide up (00 to FF)"].plurals[0] = "=1Axx: Set filter coefficient K2 slide up (00 to FF)";
    strings["1Bxx: Set filter coefficient K2 slide down (00 to FF)"].plurals[0] = "=1Bxx: Set filter coefficient K2 slide down (00 to FF)";
    strings["22xx: Set envelope left volume ramp (signed) (00 to FF)"].plurals[0] = "=22xx: Set envelope left volume ramp (signed) (00 to FF)";
    strings["23xx: Set envelope right volume ramp (signed) (00 to FF)"].plurals[0] = "=23xx: Set envelope right volume ramp (signed) (00 to FF)";
    strings["24xx: Set envelope filter coefficient k1 ramp (signed) (00 to FF)"].plurals[0] = "=24xx: Set envelope filter coefficient k1 ramp (signed) (00 to FF)";
    strings["25xx: Set envelope filter coefficient k1 ramp (signed, slower) (00 to FF)"].plurals[0] = "=25xx: Set envelope filter coefficient k1 ramp (signed, slower) (00 to FF)";
    strings["26xx: Set envelope filter coefficient k2 ramp (signed) (00 to FF)"].plurals[0] = "=26xx: Set envelope filter coefficient k2 ramp (signed) (00 to FF)";
    strings["27xx: Set envelope filter coefficient k2 ramp (signed, slower) (00 to FF)"].plurals[0] = "=27xx: Set envelope filter coefficient k2 ramp (signed, slower) (00 to FF)";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)1"].plurals[0] = "=DFxx: Set sample playback direction (0: normal; 1: reverse)";
    strings["120x: Set pause (bit 0)"].plurals[0] = "=120x: Set pause (bit 0)";
    strings["2xxx: Set envelope count (000 to 1FF)"].plurals[0] = "=2xxx: Set envelope count (000 to 1FF)";
    strings["3xxx: Set filter coefficient K1 (000 to FFF)"].plurals[0] = "=3xxx: Set filter coefficient K1 (000 to FFF)";
    strings["4xxx: Set filter coefficient K2 (000 to FFF)"].plurals[0] = "=4xxx: Set filter coefficient K2 (000 to FFF)";
    strings["a sample chip made by Ensoniq, which is the basis for the GF1 chip found in Gravis' Ultrasound cards."].plurals[0] = "=a sample chip made by Ensoniq, which is the basis for the GF1 chip found in Gravis' Ultrasound cards.";
    strings["like OPL but with an ADPCM channel."].plurals[0] = "=like OPL but with an ADPCM channel.";
    strings["Yamaha Y8950 with drums"].plurals[0] = "=Yamaha Y8950 with drums";
    strings["the Y8950 chip, in drums mode."].plurals[0] = "=the Y8950 chip, in drums mode.";
    strings["this is a variant of Konami's SCC chip with the last channel's wavetable being independent."].plurals[0] = "=this is a variant of Konami's SCC chip with the last channel's wavetable being independent.";
    strings["10xx: Set waveform (0 to 7)1"].plurals[0] = "=10xx: Set waveform (0 to 7)";
    strings["12xx: Set pulse width (0 to 7F)"].plurals[0] = "=12xx: Set pulse width (0 to 7F)";
    strings["13xx: Set resonance (0 to FF)"].plurals[0] = "=13xx: Set resonance (0 to FF)";
    strings["14xx: Set filter mode (bit 0: ring mod; bit 1: low pass; bit 2: high pass; bit 3: band pass)"].plurals[0] = "=14xx: Set filter mode (bit 0: ring mod; bit 1: low pass; bit 2: high pass; bit 3: band pass)";
    strings["15xx: Set frequency sweep period low byte"].plurals[0] = "=15xx: Set frequency sweep period low byte";
    strings["16xx: Set frequency sweep period high byte"].plurals[0] = "=16xx: Set frequency sweep period high byte";
    strings["17xx: Set volume sweep period low byte"].plurals[0] = "=17xx: Set volume sweep period low byte";
    strings["18xx: Set volume sweep period high byte"].plurals[0] = "=18xx: Set volume sweep period high byte";
    strings["19xx: Set cutoff sweep period low byte"].plurals[0] = "=19xx: Set cutoff sweep period low byte";
    strings["1Axx: Set cutoff sweep period high byte"].plurals[0] = "=1Axx: Set cutoff sweep period high byte";
    strings["1Bxx: Set frequency sweep boundary"].plurals[0] = "=1Bxx: Set frequency sweep boundary";
    strings["1Cxx: Set volume sweep boundary"].plurals[0] = "=1Cxx: Set volume sweep boundary";
    strings["1Dxx: Set cutoff sweep boundary"].plurals[0] = "=1Dxx: Set cutoff sweep boundary";
    strings["1Exx: Set phase reset period low byte"].plurals[0] = "=1Exx: Set phase reset period low byte";
    strings["1Fxx: Set phase reset period high byte"].plurals[0] = "=1Fxx: Set phase reset period high byte";
    strings["20xx: Toggle frequency sweep (bit 0-6: speed; bit 7: direction is up)"].plurals[0] = "=20xx: Toggle frequency sweep (bit 0-6: speed; bit 7: direction is up)";
    strings["21xx: Toggle volume sweep (bit 0-4: speed; bit 5: direction is up; bit 6: loop; bit 7: alternate)"].plurals[0] = "=21xx: Toggle volume sweep (bit 0-4: speed; bit 5: direction is up; bit 6: loop; bit 7: alternate)";
    strings["22xx: Toggle cutoff sweep (bit 0-6: speed; bit 7: direction is up)"].plurals[0] = "=22xx: Toggle cutoff sweep (bit 0-6: speed; bit 7: direction is up)";
    strings["4xxx: Set cutoff (0 to FFF)"].plurals[0] = "=4xxx: Set cutoff (0 to FFF)";
    strings["tildearrow's fantasy sound chip. put SID, AY and VERA in a blender, and you get this!"].plurals[0] = "=tildearrow's fantasy sound chip. put SID, AY and VERA in a blender, and you get this!";
    strings["an ADPCM sound chip manufactured by OKI and used in many arcade boards."].plurals[0] = "=an ADPCM sound chip manufactured by OKI and used in many arcade boards.";
    strings["20xx: Set chip output rate (0: clock/132; 1: clock/165)"].plurals[0] = "=20xx: Set chip output rate (0: clock/132; 1: clock/165)";
    strings["an ADPCM sound chip manufactured by OKI and used in the Sharp X68000."].plurals[0] = "=an ADPCM sound chip manufactured by OKI and used in the Sharp X68000.";
    strings["20xx: Set frequency divider (0-2)"].plurals[0] = "=20xx: Set frequency divider (0-2)";
    strings["21xx: Select clock rate (0: full; 1: half)"].plurals[0] = "=21xx: Select clock rate (0: full; 1: half)";
    strings["used in some arcade boards. Can play back either 4-bit ADPCM, 8-bit PCM or 16-bit PCM."].plurals[0] = "=used in some arcade boards. Can play back either 4-bit ADPCM, 8-bit PCM or 16-bit PCM.";
    strings["10xx: Set waveform8"].plurals[0] = "=10xx: Set waveform";
    strings["11xx: Select waveform (local)1"].plurals[0] = "=11xx: Select waveform (local)";
    strings["10xx: Set waveform9"].plurals[0] = "=10xx: Set waveform";
    strings["11xx: Toggle noise mode2"].plurals[0] = "=11xx: Toggle noise mode";
    strings["a wavetable sound chip used in Pac-Man, among other early Namco arcade games."].plurals[0] = "=a wavetable sound chip used in Pac-Man, among other early Namco arcade games.";
    strings["successor of the original Namco WSG chip, used in later Namco arcade games."].plurals[0] = "=successor of the original Namco WSG chip, used in later Namco arcade games.";
    strings["like Namco C15 but with stereo sound."].plurals[0] = "=like Namco C15 but with stereo sound.";
    strings["a square wave additive synthesis chip made by OKI. used in some arcade machines and instruments."].plurals[0] = "=a square wave additive synthesis chip made by OKI. used in some arcade machines and instruments.";
    strings["10xy: Set group control (x: sustain; y: part toggle bitmask)"].plurals[0] = "=10xy: Set group control (x: sustain; y: part toggle bitmask)";
    strings["11xx: Set noise mode"].plurals[0] = "=11xx: Set noise mode";
    strings["12xx: Set group attack (0 to 5)"].plurals[0] = "=12xx: Set group attack (0 to 5)";
    strings["13xx: Set group decay (0 to 11)"].plurals[0] = "=13xx: Set group decay (0 to 11)";
    strings["Yamaha YM2612 (OPN2) with DualPCM"].plurals[0] = "=Yamaha YM2612 (OPN2) with DualPCM";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis system uses software mixing to provide two sample channels."].plurals[0] = "=this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis system uses software mixing to provide two sample channels.";
    strings["Yamaha YM2612 (OPN2) Extended Channel 3 with DualPCM and CSM"].plurals[0] = "=Yamaha YM2612 (OPN2) Extended Channel 3 with DualPCM and CSM";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis system uses software mixing to provide two sample channels.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "=this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis system uses software mixing to provide two sample channels.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3.";
    strings["an SN76489 derivative used in Neo Geo Pocket, has independent stereo volume and noise channel frequency."].plurals[0] = "=an SN76489 derivative used in Neo Geo Pocket, has independent stereo volume and noise channel frequency.";
    strings["20xx: Set noise length (0: short, 1: long)"].plurals[0] = "=20xx: Set noise length (0: short, 1: long)";
    strings["Generic PCM DAC"].plurals[0] = "=Generic PCM DAC";
    strings["as generic sample playback as it gets."].plurals[0] = "=as generic sample playback as it gets.";
    strings["this PCM chip was widely used at Konami arcade boards in 1986-1990."].plurals[0] = "=this PCM chip was widely used at Konami arcade boards in 1986-1990.";
    strings["yet another PCM chip from Irem. like Amiga, but less pitch resolution and no sample loop."].plurals[0] = "=yet another PCM chip from Irem. like Amiga, but less pitch resolution and no sample loop.";
    strings["a SoC with wavetable sound hardware."].plurals[0] = "=a SoC with wavetable sound hardware.";
    strings["a game console with 3 channels of square wave. it's what happens after fusing TIA and VIC together."].plurals[0] = "=a game console with 3 channels of square wave. it's what happens after fusing TIA and VIC together.";
    strings["10xx: Set ring modulation (0: disable, 1: enable)"].plurals[0] = "=10xx: Set ring modulation (0: disable, 1: enable)";
    strings["11xx: Raw frequency (0-3E)"].plurals[0] = "=11xx: Raw frequency (0-3E)";
    strings["ZX Spectrum Beeper (QuadTone Engine)"].plurals[0] = "=ZX Spectrum Beeper (QuadTone Engine)";
    strings["another ZX Spectrum beeper system with full PWM pulses and 3-level volume per channel. it also has a pitchable overlay sample channel."].plurals[0] = "=another ZX Spectrum beeper system with full PWM pulses and 3-level volume per channel. it also has a pitchable overlay sample channel.";
    strings["12xx: Set pulse width1"].plurals[0] = "=12xx: Set pulse width";
    strings["this PCM chip was widely used at Konami arcade boards in 1990-1992."].plurals[0] = "=this PCM chip was widely used at Konami arcade boards in 1990-1992.";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)2"].plurals[0] = "=DFxx: Set sample playback direction (0: normal; 1: reverse)";
    strings["two square waves (one may be turned into noise). used in the Commodore Plus/4, 16 and 116."].plurals[0] = "=two square waves (one may be turned into noise). used in the Commodore Plus/4, 16 and 116.";
    strings["Namco's first PCM chip from 1987. it's pretty good for being so."].plurals[0] = "=Namco's first PCM chip from 1987. it's pretty good for being so.";
    strings["Namco's PCM chip used in their NA-1/2 hardware.\nvery similar to C140, but has noise generator."].plurals[0] = "=Namco's PCM chip used in their NA-1/2 hardware.\nvery similar to C140, but has noise generator.";
    strings["11xx: Set noise mode1"].plurals[0] = "=11xx: Set noise mode";
    strings["12xy: Set invert mode (x: surround; y: invert)"].plurals[0] = "=12xy: Set invert mode (x: surround; y: invert)";
    strings["ESS ES1xxx series (ESFM)"].plurals[0] = "=ESS ES1xxx series (ESFM)";
    strings["a unique FM synth featured in PC sound cards.\nbased on the OPL3 design, but with lots of its features extended."].plurals[0] = "=a unique FM synth featured in PC sound cards.\nbased on the OPL3 design, but with lots of its features extended.";
    strings["2Exx: Toggle hard envelope reset on new notes"].plurals[0] = "=2Exx: Toggle hard envelope reset on new notes";
    strings["first Ensoniq chip used in their synths and Apple IIGS computer. Has 32 hard-panned 8-bit wavetable/sample channels, can do oscillator sync (like SID) and amplitude modulation. Can have up to 128 KiB (2 banks of 64 KiB) of memory for wavetables/samples.\nAs Robert Yannes (SID chip creator) said, it's more or less what SID chip could be if he was given enough time for its development."].plurals[0] = "=first Ensoniq chip used in their synths and Apple IIGS computer. Has 32 hard-panned 8-bit wavetable/sample channels, can do oscillator sync (like SID) and amplitude modulation. Can have up to 128 KiB (2 banks of 64 KiB) of memory for wavetables/samples.\nAs Robert Yannes (SID chip creator) said, it's more or less what SID chip could be if he was given enough time for its development.";
    strings["11xx: Set number of enabled oscillators (2-1F)"].plurals[0] = "=11xx: Set number of enabled oscillators (2-1F)";
    strings["12xx: Set oscillator output (0-7, 0=left, 1=right)"].plurals[0] = "=12xx: Set oscillator output (0-7, 0=left, 1=right)";
    strings["13xx: Set wave/sample length (0-7, 0=256, 1=512, 2=1024, etc.)"].plurals[0] = "=13xx: Set wave/sample length (0-7, 0=256, 1=512, 2=1024, etc.)";
    strings["14xx: Set wave/sample position in memory (xx*256 offset)"].plurals[0] = "=14xx: Set wave/sample position in memory (xx*256 offset)";
    strings["15xx: Set oscillator mode (0-3)"].plurals[0] = "=15xx: Set oscillator mode (0-3)";
    strings["a fantasy sound chip designed by jvsTSX and The Beesh-Spweesh!\nused in the Hexheld fantasy console."].plurals[0] = "=a fantasy sound chip designed by jvsTSX and The Beesh-Spweesh!\nused in the Hexheld fantasy console.";
    strings["20xx: Load low byte of noise channel LFSR (00 to FF) or slope channel accumulator (00 to 7F)"].plurals[0] = "=20xx: Load low byte of noise channel LFSR (00 to FF) or slope channel accumulator (00 to 7F)";
    strings["21xx: Load high byte of noise channel LFSR (00 to FF)"].plurals[0] = "=21xx: Load high byte of noise channel LFSR (00 to FF)";
    strings["22xx: Write to I/O port A"].plurals[0] = "=22xx: Write to I/O port A";
    strings["23xx: Write to I/O port B"].plurals[0] = "=23xx: Write to I/O port B";
    strings["this chip was featured in the Enterprise 128 computer. it is similar to POKEY, but with stereo output, more features and frequency precision and the ability to turn left or right (or both) channel into a 6-bit DAC for sample playback."].plurals[0] = "=this chip was featured in the Enterprise 128 computer. it is similar to POKEY, but with stereo output, more features and frequency precision and the ability to turn left or right (or both) channel into a 6-bit DAC for sample playback.";
    strings["10xx: Set waveform (0 to 4; 0 to 3 on noise)"].plurals[0] = "=10xx: Set waveform (0 to 4; 0 to 3 on noise)";
    strings["11xx: Set noise frequency source (0: fixed; 1-3: channels 1 to 3)"].plurals[0] = "=11xx: Set noise frequency source (0: fixed; 1-3: channels 1 to 3)";
    strings["12xx: Toggle high-pass with next channel"].plurals[0] = "=12xx: Toggle high-pass with next channel";
    strings["13xx: Toggle ring modulation with channel+2"].plurals[0] = "=13xx: Toggle ring modulation with channel+2";
    strings["14xx: Toggle swap counters (noise only)"].plurals[0] = "=14xx: Toggle swap counters (noise only)";
    strings["15xx: Toggle low pass (noise only)"].plurals[0] = "=15xx: Toggle low pass (noise only)";
    strings["16xx: Set clock divider (0: /2; 1: /3)"].plurals[0] = "=16xx: Set clock divider (0: /2; 1: /3)";
    strings["a fictional sound chip by LTVA. like SID, but with many of its problems fixed. also features extended functionality like more wave mixing modes, tonal noise, filter and volume per channel."].plurals[0] = "=a fictional sound chip by LTVA. like SID, but with many of its problems fixed. also features extended functionality like more wave mixing modes, tonal noise, filter and volume per channel.";
    strings["a fictional sound chip by Euly. similar to Ricoh 2A03, but all the duty cycles are different, noise has 32 pitches instead of 16 and you have four hard-coded waveforms on triangle channel."].plurals[0] = "=a fictional sound chip by Euly. similar to Ricoh 2A03, but all the duty cycles are different, noise has 32 pitches instead of 16 and you have four hard-coded waveforms on triangle channel.";
    strings["12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1, wave: 0 to 3)"].plurals[0] = "=12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1, wave: 0 to 3)";
    strings["19xx: Set wave linear counter (0 to 7F; 80 and higher halt)"].plurals[0] = "=19xx: Set wave linear counter (0 to 7F; 80 and higher halt)";
    strings["additional PCM FIFO channels in Game Boy Advance driven directly by its DMA hardware."].plurals[0] = "=additional PCM FIFO channels in Game Boy Advance driven directly by its DMA hardware.";
    strings["additional PCM FIFO channels in Game Boy Advance driven by software mixing to provide up to sixteen sample channels."].plurals[0] = "=additional PCM FIFO channels in Game Boy Advance driven by software mixing to provide up to sixteen sample channels.";
    strings["11xy: Set echo channel (x: left/right source; y: delay (0 disables))"].plurals[0] = "11xy: =Set echo channel (x: left/right source; y: delay (0 disables))";
    strings["12xy: Toggle invert (x: left; y: right)"].plurals[0] = "12xy: =Toggle invert (x: left; y: right)";
    strings["a handheld video game console with two screens. it uses a stylus."].plurals[0] = "=a handheld video game console with two screens. it uses a stylus.";
    strings["12xx: Set duty cycle (pulse: 0 to 7)"].plurals[0] = "12xx: =Set duty cycle (pulse: 0 to 7)";
    strings["1Fxx: Set global volume (0 to 7F)"].plurals[0] = "1Fxx: =Set global volume (0 to 7F)";
    strings["FZT sound source"].plurals[0] = "=FZT sound source";
    strings["a software synth core by LTVA used in Flizzer Tracker (Flipper Zero chiptune tracker)."].plurals[0] = "=a software synth core by LTVA used in Flizzer Tracker (Flipper Zero chiptune tracker).";
    strings["10xx: Set wave (bits: 0: noise, 1: pulse, 2: triangle, 3: sawtooth, 4: metallic noise, 5: sine)"].plurals[0] = "=10xx: Set wave (bits: 0: noise, 1: pulse, 2: triangle, 3: sawtooth, 4: metallic noise, 5: sine)";
    strings["11xy: PWM (pulsolo) with speed x and depth y"].plurals[0] = "=11xy: PWM (pulsolo) with speed x and depth y";
    strings["12xx: Set pulse width"].plurals[0] = "=12xx: Set pulse width";
    strings["13xx: Pulse width up"].plurals[0] = "=13xx: Pulse width up";
    strings["14xx: Pulse width down"].plurals[0] = "=14xx: Pulse width down";
    strings["15xx: Set filter cutoff"].plurals[0] = "=15xx: Set filter cutoff";
    strings["16xx: Set volume"].plurals[0] = "=16xx: Set volume";
    strings["17xx: Toggle filter"].plurals[0] = "=17xx: Toggle filter";
    strings["18xx: Set filter mode"].plurals[0] = "=18xx: Set filter mode";
    strings["19xx: Phase reset"].plurals[0] = "=19xx: Phase reset";
    strings["1Axx: Filter cutoff up"].plurals[0] = "=1Axx: Filter cutoff up";
    strings["1Bxx: Filter cutoff down"].plurals[0] = "=1Bxx: Filter cutoff down";
    strings["1Cxx: Set filter resonance"].plurals[0] = "=1Cxx: Set filter resonance";
    strings["1Dxx: Filter resonance up"].plurals[0] = "=1Dxx: Filter resonance up";
    strings["1Exx: Filter resonance down"].plurals[0] = "=1Exx: Filter resonance down";
    strings["1Fxx: Ring mod source (FF = self)"].plurals[0] = "=1Fxx: Ring mod source (FF = self)";
    strings["20xx: Hard sync source (FF = self)"].plurals[0] = "=20xx: Hard sync source (FF = self)";
    strings["21xx: Set attack speed"].plurals[0] = "=21xx: Set attack speed";
    strings["22xx: Set decay speed"].plurals[0] = "=22xx: Set decay speed";
    strings["23xx: Set sustain level"].plurals[0] = "=23xx: Set sustain level";
    strings["24xx: Set release rate"].plurals[0] = "=24xx: Set release rate";
    strings["25xx: Restart instrument program"].plurals[0] = "=25xx: Restart instrument program";
    strings["26xx: Portamento up (semitones)"].plurals[0] = "=26xx: Portamento up (semitones)";
    strings["27xx: Portamento down (semitones)"].plurals[0] = "=27xx: Portamento down (semitones)";
    strings["28xx: Absolute arpeggio note"].plurals[0] = "=28xx: Absolute arpeggio note";
    strings["29xx: Trigger envelope release"].plurals[0] = "=29xx: Trigger envelope release";
    strings["a fantasy sound chip using logistic map iterations to generate sound."].plurals[0] = "=a fantasy sound chip using logistic map iterations to generate sound.";
    strings["10xx: Load low byte of channel sample state"].plurals[0] = "10xx: =Load low byte of channel sample state";
    strings["11xx: Load high byte of channel sample state"].plurals[0] = "11xx: =Load high byte of channel sample state";
    strings["12xx: Set low byte of channel parameter"].plurals[0] = "12xx: =Set low byte of channel parameter";
    strings["13xx: Set high byte of channel parameter"].plurals[0] = "13xx: =Set high byte of channel parameter";
    strings["Dummy System"].plurals[0] = "=Dummy System";
    strings["this is a system designed for testing purposes."].plurals[0] = "=this is a system designed for testing purposes.";

    //channel names

    strings["Channel 1"].plurals[0] = "=Channel 1";
    strings["Channel 2"].plurals[0] = "=Channel 2";
    strings["Channel 3"].plurals[0] = "=Channel 3";
    strings["Channel 4"].plurals[0] = "=Channel 4";
    strings["Channel 5"].plurals[0] = "=Channel 5";
    strings["Channel 6"].plurals[0] = "=Channel 6";
    strings["Channel 7"].plurals[0] = "=Channel 7";
    strings["Channel 8"].plurals[0] = "=Channel 8";
    strings["Channel 9"].plurals[0] = "=Channel 9";
    strings["Channel 10"].plurals[0] = "=Channel 10";
    strings["Channel 11"].plurals[0] = "=Channel 11";
    strings["Channel 12"].plurals[0] = "=Channel 12";
    strings["Channel 13"].plurals[0] = "=Channel 13";
    strings["Channel 14"].plurals[0] = "=Channel 14";
    strings["Channel 15"].plurals[0] = "=Channel 15";
    strings["Channel 16"].plurals[0] = "=Channel 16";
    strings["Channel 17"].plurals[0] = "=Channel 17";
    strings["Channel 18"].plurals[0] = "=Channel 18";
    strings["Channel 19"].plurals[0] = "=Channel 19";
    strings["Channel 20"].plurals[0] = "=Channel 20";
    strings["Channel 21"].plurals[0] = "=Channel 21";
    strings["Channel 22"].plurals[0] = "=Channel 22";
    strings["Channel 23"].plurals[0] = "=Channel 23";
    strings["Channel 24"].plurals[0] = "=Channel 24";
    strings["Channel 25"].plurals[0] = "=Channel 25";
    strings["Channel 26"].plurals[0] = "=Channel 26";
    strings["Channel 27"].plurals[0] = "=Channel 27";
    strings["Channel 28"].plurals[0] = "=Channel 28";
    strings["Channel 29"].plurals[0] = "=Channel 29";
    strings["Channel 30"].plurals[0] = "=Channel 30";
    strings["Channel 31"].plurals[0] = "=Channel 31";
    strings["Channel 32"].plurals[0] = "=Channel 32";

    strings["Square"].plurals[0] = "=Square";

    strings["Square 1"].plurals[0] = "=Square 1";
    strings["Square 2"].plurals[0] = "=Square 2";
    strings["Square 3"].plurals[0] = "=Square 3";

    strings["Pulse"].plurals[0] = "=Pulse";

    strings["Pulse 1"].plurals[0] = "=Pulse 1";
    strings["Pulse 2"].plurals[0] = "=Pulse 2";

    strings["Wave"].plurals[0] = "=Wave";
    ...
    strings["DAC Left"].plurals[0] = "=DAC Left";
    strings["DAC Right"].plurals[0] = "=DAC Right";

    strings["Noise"].plurals[0] = "=Noise";

    strings["Noise 1"].plurals[0] = "=Noise 1";
    strings["Noise 2"].plurals[0] = "=Noise 2";
    strings["Noise 3"].plurals[0] = "=Noise 3";

    strings["Slope"].plurals[0] = "=Slope";
    
    strings["FM 6/PCM 1"].plurals[0] = "=FM 6/PCM 1";
    strings["CSM Timer"].plurals[0] = "=CSM Timer";

    strings["VRC6 Saw"].plurals[0] = "=VRC6 Saw";
    ...
    strings["Kick/FM 7"].plurals[0] = "=Kick/FM 7";
    strings["Kick/FM 16"].plurals[0] = "=Kick/FM 16";
    strings["Kick"].plurals[0] = "=Kick";
    strings["Snare"].plurals[0] = "=Snare";
    strings["Top"].plurals[0] = "=Top";
    strings["HiHat"].plurals[0] = "=HiHat";
    strings["Tom"].plurals[0] = "=Tom";
    strings["Rim"].plurals[0] = "=Rim";

    // channel short names

    strings["CH1"].plurals[0] = "=CH1";
    strings["CH2"].plurals[0] = "=CH2";
    strings["CH3"].plurals[0] = "=CH3";
    strings["CH4"].plurals[0] = "=CH4";
    strings["CH5"].plurals[0] = "=CH5";
    strings["CH6"].plurals[0] = "=CH6";
    strings["CH7"].plurals[0] = "=CH7";
    strings["CH8"].plurals[0] = "=CH8";
    strings["CH9"].plurals[0] = "=CH9";

    strings["NO"].plurals[0] = "=NO";
    strings["N1"].plurals[0] = "=N1";
    strings["N2"].plurals[0] = "=N2";
    strings["N3"].plurals[0] = "=N3";

    strings["SL"].plurals[0] = "=SL";

    strings["S1"].plurals[0] = "=S1";
    strings["S2"].plurals[0] = "=S2";
    strings["S3"].plurals[0] = "=S3";
    strings["S4"].plurals[0] = "=S4";
    strings["S5"].plurals[0] = "=S5";
    strings["S6"].plurals[0] = "=S6";

    strings["P1"].plurals[0] = "=P1";
    strings["P2"].plurals[0] = "=P2";
    strings["P3"].plurals[0] = "=P3";
    strings["P4"].plurals[0] = "=P4";
    strings["P5"].plurals[0] = "=P5";
    strings["P6"].plurals[0] = "=P6";
    strings["P7"].plurals[0] = "=P7";
    strings["P8"].plurals[0] = "=P8";
    strings["P9"].plurals[0] = "=P9";
    strings["P10"].plurals[0] = "=P10";
    strings["P11"].plurals[0] = "=P11";
    strings["P12"].plurals[0] = "=P12";
    strings["P13"].plurals[0] = "=P13";
    strings["P14"].plurals[0] = "=P14";
    strings["P15"].plurals[0] = "=P15";
    strings["P16"].plurals[0] = "=P16";
    strings["P17"].plurals[0] = "=P17";
    strings["P18"].plurals[0] = "=P18";
    strings["P19"].plurals[0] = "=P19";
    strings["P20"].plurals[0] = "=P20";
    strings["P21"].plurals[0] = "=P21";
    strings["P22"].plurals[0] = "=P22";
    strings["P23"].plurals[0] = "=P23";
    strings["P24"].plurals[0] = "=P24";

    strings["BD"].plurals[0] = "=BD";
    strings["SD"].plurals[0] = "=SD";
    strings["TP"].plurals[0] = "=TP";
    strings["HH"].plurals[0] = "=HH";
    strings["TM"].plurals[0] = "=TM";
    strings["RM"].plurals[0] = "=RM";
