...
void DivLocale::addTranslationsRussian()
{
    ...
    strings["save (.dmp)##sgdl"].plurals[0] = "сохранить (.dmp)";
    ...
    strings["interpolate##sggu0"].plurals[0] = "интерполирование";
    ...
    strings["randomize##sggu"].plurals[0] = "заполнение случ. значениями";
    ...
    strings["Set##sggu"].plurals[0] = "Задать";
    ...
    strings["Scale##sggu"].plurals[0] = "Масштабировать";
    strings["randomize...##sggu"].plurals[0] = "заполнить случ. значениями...";
    ...
    strings["%d years ##sggu"].plurals[0] = "%d лет ";
    strings["%d year ##sggu"].plurals[0] = "%d год ";
    strings["%d months ##sggu"].plurals[0] = "%d месяцев ";
    strings["%d month ##sggu"].plurals[0] = "%d месяц ";
    strings["%d days ##sggu"].plurals[0] = "%d дней ";
    strings["%d day ##sggu"].plurals[0] = "%d день ";
