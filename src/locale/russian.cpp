...
void DivLocale::addTranslationsRussian()
{
    ...
    strings["Pretty please one more compat flag when I use arpeggio and my sound length##sgsc"].plurals[0] = "Ну пожалуйста ещё один флаг совместимости когда я использую арпеджио и мою длину звука";
    ...
    strings["direction##sgistru"].plurals[0] = "направление";
    strings["enable##sgistru"].plurals[0] = "вкл.";
