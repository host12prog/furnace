...
void DivLocale::addTranslationsRussian()
{
    ...
    strings["tap B##sgistru"].plurals[0] = "отвод B";
    strings["slope AM##sgistru"].plurals[0] = "АМ ската";
    strings["down B##sgistru"].plurals[0] = "вниз B";
    strings["down A##sgistru"].plurals[0] = "вниз A";
