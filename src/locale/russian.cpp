...
void DivLocale::addTranslationsRussian()
{
    ...
    strings["Search..."].plurals[0] = "Поиск...";
    strings["Search recent files..."].plurals[0] = "Искать в недавних файлах...";
    strings["Search instruments..."].plurals[0] = "Искать инструменты...";
    strings["Search samples..."].plurals[0] = "Искать сэмплы...";
    strings["Search instruments (to change to)..."].plurals[0] = "Искать инструменты (для замены)...";
    strings["Search chip (to add)..."].plurals[0] = "Искать чипы (для добавления)...";
    strings["Cancel"].plurals[0] = "Отмена";
    strings["cannot add chip! ("].plurals[0] = "не могу добавить чип! (";
    ...
    strings["Bug!"].plurals[0] = "Баг!";
    strings["Unknown"].plurals[0] = "Неизвестный тип инструмента";
    ...
    strings["export (.dmp)"].plurals[0] = "экспортировать в .dmp";
    strings["delete##sgdl0"].plurals[0] = "удалить";
    strings["%.2X: <INVALID>"].plurals[0] = "%.2X: <НЕДЕЙСТВ.>";
    strings["- None -"].plurals[0] = "- Нет -";
    strings["out of memory for this sample!"].plurals[0] = "недостаточно памяти для этого сэмпла!";
    strings["make instrument"].plurals[0] = "создать инструмент";
    strings["make me a drum kit"].plurals[0] = "создать инструмент с набором ударных";
    ...
    strings["replace instrument..."].plurals[0] = "заменить инструмент...";
    strings["load instrument from TX81Z"].plurals[0] = "загрузить инструмент с TX81Z";
    strings["replace wavetable..."].plurals[0] = "заменить волновую таблицу...";
    strings["replace sample..."].plurals[0] = "заменить сэмпл...";
    strings["import raw sample..."].plurals[0] = "загрузить сырые данные сэмпла...";
    strings["import raw sample (replace)..."].plurals[0] = "загрузить сырые данные сэмпла (заменить)...";
    strings["replace...##sgdl2"].plurals[0] = "заменить...";
    strings["load from TX81Z"].plurals[0] = "загрузить с TX81Z";
    strings["Open (insert; right-click to replace)"].plurals[0] = "Открыть (вставить; ПКМ для замены)";
    strings["Save##sgdl2"].plurals[0] = "Сохранить";
    strings["save instrument as .dmp..."].plurals[0] = "сохранить инструмент как .dmp...";
    strings["save wavetable as .dmw..."].plurals[0] = "сохранить волновую таблицу как .dmw...";
    strings["save raw wavetable..."].plurals[0] = "сохранить сырые данные волновой таблицы...";
    strings["save raw sample..."].plurals[0] = "сохранить сырые данные сэмпла...";
    strings["save as .dmp..."].plurals[0] = "сохранить как .dmp...";
    ...
    strings["Instruments"].plurals[0] = "Инструменты";
    ...
    strings["Wavetables"].plurals[0] = "Волновые таблицы";
    strings["Samples"].plurals[0] = "Сэмплы";
    ...
    strings["save as .dmw..."].plurals[0] = "сохранить как .dmw...";
    ...
    strings["import raw..."].plurals[0] = "импорт сырых данных...";
    strings["import raw (replace)..."].plurals[0] = "импорт сырых данных (заменить)...";
    ...
    strings["Instrument %d"].plurals[0] = "Инструмент %d";
    strings["Sample %d"].plurals[0] = "Сэмпл %d";
    strings["the song is over!0"].plurals[0] = "трек закончился!";
    strings["the song is over!1"].plurals[0] = "трек закончился!";
    strings["Open File"].plurals[0] = "Открыть файл";
    strings["compatible files0"].plurals[0] = "совместимые файлы";
    strings["all files0"].plurals[0] = "все файлы";
    strings["no backups made yet!"].plurals[0] = "резервных копий пока нет!";
    strings["Restore Backup"].plurals[0] = "Загрузить резервную копию";
    strings["Furnace or Furnace-B song"].plurals[0] = "модуль Furnace или Furnace-B";
    strings["Furnace song0"].plurals[0] = "модуль Furnace";
    strings["Save File0"].plurals[0] = "Сохранить файл";
    strings["DefleMask 1.1.3 module"].plurals[0] = "модуль DefleMask 1.1.3";
    strings["Save File1"].plurals[0] = "Сохранить файл";
    strings["DefleMask 1.0/legacy module"].plurals[0] = "модуль DefleMask 1.0/legacy";
    strings["Save File2"].plurals[0] = "Сохранить файл";
    strings["Furnace-B song"].plurals[0] = "модуль Furnace-B";
    strings["Load Instrument"].plurals[0] = "загрузить инструмент";
    strings["all compatible files1"].plurals[0] = "все совместимые файлы";
    strings["Furnace instrument0"].plurals[0] = "инструмент Furnace";
    strings["DefleMask preset0"].plurals[0] = "пресет DefleMask";
    strings["TFM Music Maker instrument"].plurals[0] = "инструмент из программы TFM Music Maker";
    strings["VGM Music Maker instrument"].plurals[0] = "инструмент из программы VGM Music Maker";
    strings["Scream Tracker 3 instrument"].plurals[0] = "инструмент из программы Scream Tracker 3";
    strings["SoundBlaster instrument"].plurals[0] = "инструмент SoundBlaster";
    strings["Wohlstand OPL instrument"].plurals[0] = "инструмент из программы Wohlstand OPL";
    strings["Wohlstand OPN instrument"].plurals[0] = "инструмент из программы Wohlstand OPN";
    strings["Gens KMod patch dump"].plurals[0] = "дамп патчей Gens KMod";
    strings["BNK file (AdLib)"].plurals[0] = "файл BNK (AdLib)";
    strings["FF preset bank"].plurals[0] = "банк пресетов FF";
    strings["2612edit GYB preset bank"].plurals[0] = "банк пресетов 2612edit GYB";
    strings["VOPM preset bank"].plurals[0] = "банк пресетов VOPM";
    strings["Wohlstand WOPL bank"].plurals[0] = "банк Wohlstand WOPL";
    strings["Wohlstand WOPN bank"].plurals[0] = "банк Wohlstand WOPN";
    strings["all files1"].plurals[0] = "все файлы";
    strings["Save Instrument0"].plurals[0] = "Сохранить инструмент";
    strings["Furnace instrument1"].plurals[0] = "инструмент Furnace";
    strings["Save Instrument1"].plurals[0] = "Сохранить инструмент";
    strings["DefleMask preset1"].plurals[0] = "пресет DefleMask";
    strings["Load Wavetable"].plurals[0] = "Загрузить волновую таблицу";
    strings["compatible files2"].plurals[0] = "совместимые файлы";
    strings["all files2"].plurals[0] = "все файлы";
    strings["Save Wavetable0"].plurals[0] = "Сохранить волновую таблицу";
    strings["Furnace wavetable"].plurals[0] = "волновая таблица Furnace";
    strings["Save Wavetable1"].plurals[0] = "Сохранить волновую таблицу";
    strings["DefleMask wavetable"].plurals[0] = "волновая таблица DefleMask";
    strings["Save Wavetable2"].plurals[0] = "Сохранить волновую таблицу";
    strings["raw data"].plurals[0] = "сырые данные";
    strings["Load Sample"].plurals[0] = "Загрузить сэмпл";
    strings["compatible files3"].plurals[0] = "совместимые файлы";
    strings["all files3"].plurals[0] = "все файлы";
    strings["NES DPCM data"].plurals[0] = "Данные ДИКМ для NES";
    strings["SNES Bit Rate Reduction"].plurals[0] = "SNES Bit Rate Reduction";
    strings["Load Raw Sample"].plurals[0] = "Загрузить сырые данные сэмпла";
    strings["all files4"].plurals[0] = "все файлы";
    strings["Save Sample"].plurals[0] = "Сохранить сэмпл";
    strings["Wave file0"].plurals[0] = "файл WAV";
    strings["Save Raw Sample"].plurals[0] = "Сохранить сырые данные сэмпла";
    strings["all files5"].plurals[0] = "все файлы";
    strings["Export Audio0"].plurals[0] = "Экспорт аудио";
    strings["Wave file1"].plurals[0] = "файл WAV";
    strings["Export Audio1"].plurals[0] = "Экспорт аудио";
    strings["Wave file2"].plurals[0] = "файл WAV";
    strings["Export Audio2"].plurals[0] = "Экспорт аудио";
    strings["Wave file3"].plurals[0] = "файл WAV";
    strings["Export VGM"].plurals[0] = "Экспорт VGM";
    strings["VGM file"].plurals[0] = "Файл VGM";
    strings["Export ZSM"].plurals[0] = "Экспорт ZSM";
    strings["ZSM file"].plurals[0] = "Файл ZSM";
    strings["Export Command Stream0"].plurals[0] = "Экспорт потока команд";
    strings["text file0"].plurals[0] = "текстовый файл";
    strings["Export Command Stream1"].plurals[0] = "Экспорт потока команд";
    strings["text file1"].plurals[0] = "текстовый файл";
    strings["Export Command Stream2"].plurals[0] = "Экспорт потока команд";
    strings["Export FZT module"].plurals[0] = "Экспорт модуля FZT";
    strings["FZT module"].plurals[0] = "Модуль FZT";
    strings["binary file"].plurals[0] = "бинарный файл";
    strings["Export Furnace song"].plurals[0] = "Экспорт модуля Furnace";
    strings["Furnace song2"].plurals[0] = "Модуль Furnace";
    strings["Coming soon!"].plurals[0] = "скоро появится!";
    strings["Select Font0"].plurals[0] = "Выберите шрифт";
    strings["compatible files4"].plurals[0] = "совместимые файлы";
    strings["Select Font1"].plurals[0] = "Выберите шрифт";
    strings["compatible files5"].plurals[0] = "совместимые файлы";
    strings["Select Font2"].plurals[0] = "Выберите шрифт";
    strings["compatible files6"].plurals[0] = "совместимые файлы";
    strings["Select Color File"].plurals[0] = "Выберите файл с настройками цветов";
    strings["configuration files0"].plurals[0] = "файлы конфигурации";
    strings["Select Keybind File"].plurals[0] = "Выберите файл с настройками клавиатуры";
    strings["configuration files1"].plurals[0] = "файлы конфигурации";
    strings["Select Layout File"].plurals[0] = "Выберите файл с настройками компоновки окон интерфейса";
    strings[".ini files0"].plurals[0] = "файлы .ini";
    strings["Select User Presets File"].plurals[0] = "Выберите файл пользовательских пресетов";
    strings["configuration files4"].plurals[0] = "файлы конфигурации";
    strings["Select Settings File"].plurals[0] = "Выберите файл с настройками";
    strings["configuration files5"].plurals[0] = "файлы конфигурации";
    strings["Export Colors"].plurals[0] = "Экспортировать настройки цветов";
    strings["configuration files2"].plurals[0] = "файлы конфигурации";
    strings["Export Keybinds"].plurals[0] = "Экспортировать настройки клавиатуры";
    strings["configuration files3"].plurals[0] = "файлы конфигурации";
    strings["Export Layout"].plurals[0] = "Экспортировать компоновку окон интерфейса";
    strings["Export User Presets"].plurals[0] = "Экспортировать пользовательские пресеты";
    strings["configuration files6"].plurals[0] = "файлы конфигурации";
    strings["Export Settings"].plurals[0] = "Экспортировать настройки";
    strings["configuration files7"].plurals[0] = "файлы конфигурации";
    strings[".ini files1"].plurals[0] = "файлы .ini";
    strings["Load ROM"].plurals[0] = "Загрузить ROM";
    strings["compatible files7"].plurals[0] = "совместимые файлы";
    strings["all files6"].plurals[0] = "все файлы";
    strings["Play Command Stream"].plurals[0] = "Воспроизвести поток команд";
    strings["command stream"].plurals[0] = "поток команд";
    strings["all files7"].plurals[0] = "все файлы";
    strings["Open Test"].plurals[0] = "Открыть (тест)";
    strings["compatible files8"].plurals[0] = "совместимые файлы";
    strings["another option0"].plurals[0] = "другая опция";
    strings["all files8"].plurals[0] = "все файлы";
    strings["Open Test (Multi)"].plurals[0] = "Открыть (тест, несколько файлов)";
    strings["compatible files9"].plurals[0] = "совместимые файлы";
    strings["another option1"].plurals[0] = "другая опция";
    strings["all files9"].plurals[0] = "все файлы";
    strings["Save Test"].plurals[0] = "Сохранить (тест)";
    strings["Furnace song"].plurals[0] = "Модуль Furnace";
    strings["DefleMask module"].plurals[0] = "Модуль DefleMask";
    strings["you have loaded a backup!\nif you need to, please save it somewhere.\n\nDO NOT RELY ON THE BACKUP SYSTEM FOR AUTO-SAVE!\nFurnace will not save backups of backups."].plurals[0] = "вы загрузили резервную копию!\nесли необходимо, сохраните её где-то ещё.\n\nСИСТЕМА РЕЗЕРВНОГО КОПИРОВАНИЯ НЕ ЯВЛЯЕТСЯ СИСТЕМОЙ АВТОСОХРАНЕНИЯ!\nFurnace не сохраняет резервные копии резервных копий.";
    strings["cut"].plurals[0] = "вырезать";
    strings["copy"].plurals[0] = "копировать";
    strings["paste0"].plurals[0] = "вставить";
    strings["paste special..."].plurals[0] = "вставить...";
    strings["paste mix"].plurals[0] = "вставить поверх";
    strings["paste mix (background)"].plurals[0] = "вставить поверх (с заменой существующего)";
    strings["paste with ins (foreground)"].plurals[0] = "вставить поверх с инстр. (без замены существующего)";
    strings["no instruments available0"].plurals[0] = "нет доступных инструментов";
    strings["paste with ins (background)"].plurals[0] = "вставить поверх с инстр. (с заменой существующего)";
    strings["no instruments available1"].plurals[0] = "нет доступных инструментов";
    strings["paste flood"].plurals[0] = "вставить с цикл. повт. буфера (до конца патт.)";
    strings["paste overflow"].plurals[0] = "вставить (с возможным переходом в след. паттерн)";
    strings["delete0"].plurals[0] = "удалить";
    strings["select all"].plurals[0] = "выбрать всё";
    strings["operation mask..."].plurals[0] = "маска операций...";
    strings["delete1"].plurals[0] = "удаление";
    strings["pull delete"].plurals[0] = "удал. с подтяг. след. строк";
    strings["insert"].plurals[0] = "вставка пустой строки";
    strings["paste1"].plurals[0] = "вставка";
    strings["transpose (note)"].plurals[0] = "транспонирование (нота)";
    strings["transpose (value)"].plurals[0] = "транспонирование (других параметров)";
    strings["interpolate0"].plurals[0] = "интерполяция";
    strings["fade"].plurals[0] = "градиент/затухание";
    strings["invert values0"].plurals[0] = "инверсия значений";
    strings["scale"].plurals[0] = "масштабирование";
    strings["randomize"].plurals[0] = "заполнение случайными значениями";
    strings["flip"].plurals[0] = "переворот";
    strings["collapse/expand"].plurals[0] = "сжать/расширить";
    strings["input latch"].plurals[0] = "буфер ввода";
    strings["&&: selected instrument\n..: no instrument"].plurals[0] = "&&: выбранный инструмент\n..: без инструмента";
    strings["Set"].plurals[0] = "Очистить";
    strings["Reset"].plurals[0] = "Сбросить";
    strings["note up"].plurals[0] = "на полутон вверх";
    strings["note down"].plurals[0] = "на полутон вниз";
    strings["octave up"].plurals[0] = "на октаву вверх";
    strings["octave down"].plurals[0] = "на октаву вниз";
    strings["values up"].plurals[0] = "параметры вверх";
    strings["values down"].plurals[0] = "параметры вниз";
    strings["values up (+16)"].plurals[0] = "параметры вверх (+16)";
    strings["values down (-16)"].plurals[0] = "параметры вниз (-16)";
    strings["transpose"].plurals[0] = "транспонировать";
    strings["Notes"].plurals[0] = "Ноты";
    strings["Values"].plurals[0] = "Параметры";
    strings["interpolate1"].plurals[0] = "транспонировать";
    strings["change instrument..."].plurals[0] = "заменить инструмент...";
    strings["no instruments available"].plurals[0] = "нет доступных инструментов";
    strings["gradient/fade..."].plurals[0] = "градиент/затухание...";
    strings["Start"].plurals[0] = "Начало";
    strings["End"].plurals[0] = "Конец";
    strings["Nibble mode0"].plurals[0] = "Режим тетрад";
    strings["Go ahead"].plurals[0] = "Применить";
    strings["scale..."].plurals[0] = "масштабировать...";
    strings["Scale"].plurals[0] = "Масштабировать";
    strings["randomize..."].plurals[0] = "заполнить случайными значениями...";
    strings["Minimum"].plurals[0] = "Нижняя граница";
    strings["Maximum"].plurals[0] = "Верхняя граница";
    strings["Nibble mode1"].plurals[0] = "Режим тетрад";
    strings["Randomize"].plurals[0] = "Заполнить";
    strings["invert values1"].plurals[0] = "инвертировать параметры";
    strings["flip selection"].plurals[0] = "перевернуть выделенную область";
    strings["collapse/expand amount##CollapseAmount"].plurals[0] = "коэффициент сжатия/расширения##CollapseAmount";
    strings["collapse"].plurals[0] = "сжать";
    strings["expand"].plurals[0] = "расширить";
    strings["collapse pattern"].plurals[0] = "сжать паттерн";
    strings["expand pattern"].plurals[0] = "расширить паттерн";
    strings["collapse song"].plurals[0] = "сжать трек";
    strings["expand song"].plurals[0] = "расширить трек";
    strings["find/replace"].plurals[0] = "найти/заменить";
    strings["clone pattern"].plurals[0] = "клонировать паттерн";
    strings["Furnace has been started in Safe Mode.\nthis means that:\n\n- software rendering is being used\n- audio output may not work\n- font loading is disabled\n\ncheck any settings which may have made Furnace start up in this mode.\nfont loading is one of these."].plurals[0] = "Furnace был запущен в безопасном режиме.\nэто означает:\n\n- используется программная отрисовка\n- может не работать вывод звука\n- отключена загрузка шрифтов\n\nпроверьте, какие настройки могли привести к запуску программы в этом режиме.\nзагрузка шрифтов может быть одной из таких.";
    strings["Unsaved changes! Save changes before opening file?0"].plurals[0] = "Остались несохранённые изменения! Сохранить их перед открытием файла?";
    strings["Unsaved changes! Save changes before opening file?2"].plurals[0] = "Остались несохранённые изменения! Сохранить их перед открытием файла?";
    strings["Error while loading file! (%s)0"].plurals[0] = "Ошибка при загрузке файла! (%s)";
    strings["Unsaved changes! Save changes before quitting?"].plurals[0] = "Остались несохранённые изменения! Сохранить их перед выходом?";
    strings["error while loading fonts! please check your settings.0"].plurals[0] = "Ошибка при загрузке шрифтов! Проверьте свои настройки.";
    strings["File##menubar"].plurals[0] = "Файл##menubar";
    strings["file##menubar"].plurals[0] = "файл##menubar";
    strings["new..."].plurals[0] = "новый...";
    strings["Unsaved changes! Save changes before creating a new song?"].plurals[0] = "Остались несохранённые изменения! Сохранить их перед созданием нового трека?";
    strings["open..."].plurals[0] = "открыть...";
    strings["Unsaved changes! Save changes before opening another file?"].plurals[0] = "Остались несохранённые изменения! Сохранить их перед открытием другого файла?";
    strings["open recent"].plurals[0] = "открыть недавние";
    strings["Unsaved changes! Save changes before opening file?1"].plurals[0] = "Остались несохранённые изменения! Сохранить их перед открытием файла?";
    strings["nothing here yet"].plurals[0] = "пока здесь ничего нет";
    strings["clear history"].plurals[0] = "очистить историю";
    strings["Are you sure you want to clear the recent file list?"].plurals[0] = "Вы уверены, что хотите очистить список недавних файлов?";
    strings["save"].plurals[0] = "сохранить";
    strings["Error while saving file! (%s)0"].plurals[0] = "Ошибка при сохранении файла! (%s)";
    strings["save as..."].plurals[0] = "сохранить как...";
    strings["export audio...0"].plurals[0] = "экспорт аудио...";
    strings["export VGM...0"].plurals[0] = "экспорт VGM...";
    strings["export .dmf (1.1.3+)...0"].plurals[0] = "экспорт .dmf (1.1.3+)...";
    strings["export .dmf (1.0/legacy)...0"].plurals[0] = "экспорт .dmf (1.0/legacy)...";
    strings["export ZSM...0"].plurals[0] = "экспорт ZSM...";
    strings["export Amiga validation data...0"].plurals[0] = "экспорт проверочного файла для компьютера Amiga...";
    strings["export text...0"].plurals[0] = "экспорт текста...";
    strings["export command stream...0"].plurals[0] = "экспорт потока команд...";
    strings["export FZT module..."].plurals[0] = "экспорт модуля FZT...";
    strings["export FZT module...1"].plurals[0] = "экспорт модуля FZT...";
    strings["export Furnace module..."].plurals[0] = "экспорт модуля Furnace...";
    strings["export audio...1"].plurals[0] = "экспорт аудио...";
    strings["export VGM...1"].plurals[0] = "экспорт VGM...";
    strings["export .dmf (1.1.3+)...1"].plurals[0] = "экспорт .dmf (1.1.3+)...";
    strings["export .dmf (1.0/legacy)...1"].plurals[0] = "экспорт .dmf (1.0/legacy)...";
    strings["export ZSM...1"].plurals[0] = "экспорт ZSM...";
    strings["export Amiga validation data...1"].plurals[0] = "экспорт проверочного файла для компьютера Amiga...";
    strings["export text...1"].plurals[0] = "экспорт текста...";
    strings["export command stream...1"].plurals[0] = "экспорт потока команд...";
    strings["export..."].plurals[0] = "экспорт...";
    strings["manage chips"].plurals[0] = "менеджер чипов";
    strings["add chip..."].plurals[0] = "добавить чип...";
    strings["cannot add chip! ("].plurals[0] = "не могу добавить чип! (";
    strings["configure chip..."].plurals[0] = "настроить чип...";
    strings["change chip..."].plurals[0] = "сменить чип...";
    strings["Preserve channel positions0"].plurals[0] = "Сохранить положение каналов";
    strings["remove chip..."].plurals[0] = "убрать чип...";
    strings["Preserve channel positions1"].plurals[0] = "Сохранить положение каналов";
    strings["cannot remove chip! ("].plurals[0] = "не могу убрать чип! (";
    strings["cannot change chip! ("].plurals[0] = "не могу сменить чип! (";
    strings["open built-in assets directory"].plurals[0] = "открыть внутреннюю папку с ресурсами";
    strings["restore backup"].plurals[0] = "загрузить резервную копию";
    strings["exit..."].plurals[0] = "выйти...";
    strings["Unsaved changes! Save before quitting?"].plurals[0] = "Остались несохранённые изменения! Сохранить их перед выходом?";
    strings["Edit##menubar"].plurals[0] = "Правка##menubar";
    strings["edit##menubar"].plurals[0] = "правка##menubar";
    strings["undo"].plurals[0] = "отменить";
    strings["redo"].plurals[0] = "вернуть";
    strings["clear..."].plurals[0] = "очистить...";
    strings["Settings##menubar"].plurals[0] = "Настройки##menubar";
    strings["settings##menubar"].plurals[0] = "настройки##menubar";
    strings["full screen"].plurals[0] = "полноэкранный режим";
    strings["lock layout"].plurals[0] = "зафиксировать компоновку окон";
    strings["pattern visualizer"].plurals[0] = "визуализатор эффектов в паттерне";
    strings["reset layout"].plurals[0] = "сбросить компоновку окон";
    strings["Are you sure you want to reset the workspace layout?"].plurals[0] = "Вы уверены, что хотите сброить компоновку окон интерфейса?";
    strings["switch to mobile view"].plurals[0] = "переключиться на мобильный интерфейс";
    strings["user systems..."].plurals[0] = "пользовательские системы...";
    strings["settings..."].plurals[0] = "настройки...";
    strings["Window##menubar"].plurals[0] = "Окно##menubar";
    strings["window##menubar"].plurals[0] = "окно##menubar";
    strings["song information"].plurals[0] = "о треке";
    strings["subsongs"].plurals[0] = "подпесни";
    strings["speed"].plurals[0] = "скорость";
    strings["assets"].plurals[0] = "ресурсы";
    strings["instruments"].plurals[0] = "инструменты";
    strings["wavetables"].plurals[0] = "волновые таблицы";
    strings["samples"].plurals[0] = "сэмплы";
    strings["orders"].plurals[0] = "матрица паттернов";
    strings["pattern"].plurals[0] = "паттерны";
    strings["mixer"].plurals[0] = "микшер";
    strings["grooves"].plurals[0] = "ритм-паттерны";
    strings["channels"].plurals[0] = "каналы";
    strings["pattern manager"].plurals[0] = "менеджер паттернов";
    strings["chip manager"].plurals[0] = "менеджер чипов";
    strings["compatibility flags"].plurals[0] = "флаги совместимости";
    strings["song comments"].plurals[0] = "комментарии трека";
    strings["song"].plurals[0] = "трек";
    strings["visualizers"].plurals[0] = "визуализаторы";
    strings["tempo"].plurals[0] = "темп";
    strings["debug"].plurals[0] = "отладка";
    strings["instrument editor"].plurals[0] = "редактор инструментов";
    strings["wavetable editor"].plurals[0] = "редактор волновых таблиц";
    strings["sample editor"].plurals[0] = "редактор сэмплов";
    strings["play/edit controls"].plurals[0] = "управление редактированием/воспроизведением";
    strings["piano/input pad"].plurals[0] = "клавиатура пианино/панель ввода";
    strings["oscilloscope (master)"].plurals[0] = "осциллограф";
    strings["oscilloscope (per-channel)"].plurals[0] = "осциллографы (для отдельных каналов)";
    strings["oscilloscope (X-Y)"].plurals[0] = "осциллограф (X-Y)";
    strings["volume meter"].plurals[0] = "измеритель громкости";
    strings["clock"].plurals[0] = "часы";
    strings["register view"].plurals[0] = "регистры";
    strings["log viewer"].plurals[0] = "просмотр логов";
    strings["statistics"].plurals[0] = "статистика";
    strings["memory composition"].plurals[0] = "содержание памяти";
    strings["spoiler"].plurals[0] = "спойлер";
    strings["Help##menubar"].plurals[0] = "Справка##menubar";
    strings["help##menubar"].plurals[0] = "справка##menubar";
    strings["effect list"].plurals[0] = "список эффектов";
    strings["debug menu"].plurals[0] = "отладка";
    strings["inspector"].plurals[0] = "отладка ImGUI";
    strings["panic"].plurals[0] = "паника";
    strings["about..."].plurals[0] = "о программе...";
    strings["| Speed %d:%d"].plurals[0] = "| Скорость %d:%d";
    strings["| Speed %d"].plurals[0] = "| Скорость %d";
    strings["| Groove"].plurals[0] = "| Ритм-паттерн";
    strings[" @ %gHz (%g BPM) "].plurals[0] = " @ %g Гц (%g BPM) ";
    strings["| Order %.2X/%.2X "].plurals[0] = "| Строка матр. патт. %.2X/%.2X ";
    strings["| Order %d/%d "].plurals[0] = "| Строка матр. патт. %d/%d ";
    strings["| Row %.2X/%.2X "].plurals[0] = "| Строка %.2X/%.2X ";
    strings["| Row %d/%d "].plurals[0] = "| Строка %d/%d ";
    strings["Don't you have anything better to do?"].plurals[0] = "Вам точно больше нечем заняться?";
    strings["%d years "].plurals[0] = "%d год ";
    strings["%d years "].plurals[1] = "%d года ";
    strings["%d years "].plurals[2] = "%d лет ";
    strings["%d months "].plurals[0] = "%d месяц ";
    strings["%d months "].plurals[1] = "%d месяца ";
    strings["%d months "].plurals[2] = "%d месяцев ";
    strings["%d days "].plurals[0] = "%d день ";
    strings["%d days "].plurals[1] = "%d дня ";
    strings["%d days "].plurals[2] = "%d дней ";
    strings["Note off (cut)"].plurals[0] = "\"Отпускание клавиши\" (резкое)";
    strings["Note off (release)"].plurals[0] = "\"Отпускание клавиши\" (с включением фазы затухания огибающей)";
    strings["Macro release only"].plurals[0] = "\"Отпускание клавиши\" (только для макросов)";
    strings["Note on: %s"].plurals[0] = "Нота: %s";
    strings["Ins %d: <invalid>"].plurals[0] = "Инструмент %d: <недейств.>";
    strings["Ins %d: %s"].plurals[0] = "Инструмент %d: %s";
    strings["Set volume: %d (%.2X, INVALID!)"].plurals[0] = "Громкость: %d (%.2X, НЕДЕЙСТВИТЕЛЬНА!)";
    strings["Set volume: %d (%.2X, %d%%)"].plurals[0] = "Громкость: %d (%.2X, %d%%)";
    strings["| modified"].plurals[0] = "| изменено";
    strings["there was an error in the file dialog! you may want to report this issue to:\nhttps://github.com/tildearrow/furnace/issues\ncheck the Log Viewer (window > log viewer) for more information.\n\nfor now please disable the system file picker in Settings > General."].plurals[0] = "возникла ошибка в окне файлового диалога! возможно, вы захотите сообщить об ошибке:\nhttps://github.com/tildearrow/furnace/issues\nвы можете открыть просмотр логов (окно > просмотр логов) для получения дополнительной информации.\n\nпока можете отключить файловый диалог ОС в настройки > основные.";
    strings["can't do anything without Storage permissions!"].plurals[0] = "не могу ничего сделать без разрешения \"Хранилище\"!";
    strings["Zenity/KDialog not available!\nplease install one of these, or disable the system file picker in Settings > General."].plurals[0] = "Zenity/KDialog недоступны!\nпожалуйста, установите один из них, или отключите файловый диалог ОС в настройки > основные.";
    strings["Error while loading file! (%s)2"].plurals[0] = "Ошибка при загрузке файла! (%s)";
    strings["Error while saving file! (%s)1"].plurals[0] = "Ошибка при сохранении файла! (%s)";
    strings["Error while loading file! (%s)3"].plurals[0] = "Ошибка при загрузке файла! (%s)";
    strings["Error while saving file! (%s)2"].plurals[0] = "Ошибка при сохранении файла! (%s)";
    strings["Error while saving file! (%s)3"].plurals[0] = "Ошибка при сохранении файла! (%s)";
    strings["error while saving instrument! only the following instrument types are supported:\n- FM (OPN)\n- SN76489/Sega PSG\n- Game Boy\n- PC Engine\n- NES\n- C64\n- FM (OPLL)\n- FDS"].plurals[0] = "ошибка при сохранении инструмента! поддерживаются только следующие типы инструментов:\n- FM (OPN)\n- SN76489/Sega PSG\n- Game Boy\n- PC Engine\n- NES\n- C64\n- FM (OPLL)\n- FDS";
    strings["there were some errors while loading samples:\n#sggu"].plurals[0] = "при загрузке сэмплов возникли следующие ошибки:\n";
    strings["...but you haven't selected a sample!0"].plurals[0] = "...но вы не выбрали сэмпл!";
    strings["could not save sample! open Log Viewer for more information.0"].plurals[0] = "не удалось сохранить сэмпл! откройте просмотрщик логов для получения дополнительной информации.";
    strings["could not save sample! open Log Viewer for more information.1"].plurals[0] = "не удалось сохранить сэмпл! откройте просмотрщик логов для получения дополнительной информации.";
    ...
    strings["...but you haven't selected an instrument!0"].plurals[0] = "...но вы не выбрали инструмент!";
    strings["cannot load instrument! ("].plurals[0] = "не могу загрузить инструмент! (";
    strings["congratulations! you managed to load nothing.\nyou are entitled to a bug report."].plurals[0] = "поздравляю! вам удалось загрузить ничто.\nвы приглашаетесь к написанию отчёта об ошибке.";
    strings["there were some errors while loading wavetables:\n"].plurals[0] = "при загрузке волновых таблиц возникли следующие ошибки:\n";
    strings["cannot load wavetable! ("].plurals[0] = "не могу загрузить волновую таблицу! (";
    strings["...but you haven't selected a wavetable!"].plurals[0] = "...но вы не выбрали волновую таблицу!";
    strings["could not open file!"].plurals[0] = "не удалось открыть файл!";
    strings["could not write FZT module!"].plurals[0] = "не удалось записать модуль FZT!";
    strings["could not import user presets!"].plurals[0] = "не удалось импортировать пользовательские пресеты!";
    strings["could not import user presets! (%s)"].plurals[0] = "не удалось импортировать пользовательские пресеты! (%s)";
    strings["Could not write ZSM! (%s)"].plurals[0] = "Не удалось записать файл ZSM! (%s)";
    strings["could not write text! (%s)"].plurals[0] = "не удалось записать текстовый файл! (%s)";
    strings["could not write command stream! (%s)"].plurals[0] = "не удалось записать файл с потоком команд! (%s)";
    strings["could not write tildearrow version Furnace module! (%s)"].plurals[0] = "не удалось записать файл модуля для версии tildearrow! (%s)";
    strings["Error while loading file! (%s)4"].plurals[0] = "Ошибка при загрузке файла! (%s)";
    strings["You opened: %s"].plurals[0] = "Вы открыли: %s";
    strings["You opened:"].plurals[0] = "Вы открыли:";
    strings["You saved: %s"].plurals[0] = "Вы сохранили: %s";
    strings["Rendering...###Rendering..."].plurals[0] = "Рендер...###Rendering...";
    strings["Please wait..."].plurals[0] = "Пожалуйста, подождите...";
    strings["Abort"].plurals[0] = "Прервать";
    ...
    strings["OK0"].plurals[0] = "ОК";
    strings["Warning###Warning"].plurals[0] = "Внимание###Warning";
    strings["Yes0"].plurals[0] = "Да";
    strings["No0"].plurals[0] = "Нет";
    strings["Yes1"].plurals[0] = "Да";
    strings["No1"].plurals[0] = "Нет";
    strings["Yes2"].plurals[0] = "Да";
    strings["No2"].plurals[0] = "Нет";
    strings["Yes3"].plurals[0] = "Да";
    strings["No3"].plurals[0] = "Нет";
    strings["Cancel0"].plurals[0] = "Отмена";
    strings["Erasing"].plurals[0] = "Удалить:";
    strings["All subsongs"].plurals[0] = "Все подпесни";
    strings["Current subsong"].plurals[0] = "Текущую подпесню";
    strings["Orders"].plurals[0] = "Матрицу паттернов";
    strings["Pattern"].plurals[0] = "Паттерны";
    strings["Instruments"].plurals[0] = "Инструменты";
    strings["Wavetables"].plurals[0] = "Волновые таблицы";
    strings["Samples"].plurals[0] = "Сэмплы";
    strings["Optimization"].plurals[0] = "Оптимизировать:";
    strings["De-duplicate patterns"].plurals[0] = "Удалить дубликаты паттернов";
    strings["Remove unused instruments"].plurals[0] = "Удалить неиспользуемые инструменты";
    strings["Remove unused samples"].plurals[0] = "Удалить неиспользуемые сэмплы";
    strings["Never mind! Cancel1"].plurals[0] = "Не надо! Отмена";
    strings["Yes4"].plurals[0] = "Да";
    strings["No4"].plurals[0] = "Нет";
    strings["Yes5"].plurals[0] = "Да";
    strings["No5"].plurals[0] = "Нет";
    strings["Yes6"].plurals[0] = "Да";
    strings["No6"].plurals[0] = "Нет";
    strings["Yes7"].plurals[0] = "Да";
    strings["Yes8"].plurals[0] = "Да";
    strings["Yes9"].plurals[0] = "Да";
    strings["Yes10"].plurals[0] = "Да";
    strings["Yes11"].plurals[0] = "Да";
    strings["No8"].plurals[0] = "Нет";
    strings["No9"].plurals[0] = "Нет";
    strings["No10"].plurals[0] = "Нет";
    strings["No11"].plurals[0] = "Нет";
    strings["No12"].plurals[0] = "Нет";
    strings["Cancel4"].plurals[0] = "Отмена";
    strings["Cancel5"].plurals[0] = "Отмена";
    strings["Cancel6"].plurals[0] = "Отмена";
    strings["Cancel7"].plurals[0] = "Отмена";
    strings["Cancel8"].plurals[0] = "Отмена";
    strings["OK1"].plurals[0] = "ОК";
    strings["Drum kit mode:"].plurals[0] = "Режим создания набора ударных:";
    strings["Normal"].plurals[0] = "Обычный";
    strings["12 samples per octave"].plurals[0] = "12 сэмплов на октаву";
    strings["Starting octave"].plurals[0] = "Начальная октава";
    strings["too many instruments!"].plurals[0] = "слишком много инструментов!";
    ...
    strings["this is an instrument bank! select which one to use:"].plurals[0] = "это банк инструментов! выберите, какой вы хотите использовать:";
    strings["this is an instrument bank! select which ones to load:"].plurals[0] = "это банк инструментов! выберите, какой вы хотите загрузить";
    strings["Search..."].plurals[0] = "Поиск...";
    strings["All"].plurals[0] = "Все";
    strings["None"].plurals[0] = "Никакой";
    strings["OK2"].plurals[0] = "ОК";
    strings["Cancel2"].plurals[0] = "Отмена";
    strings["...but you haven't selected an instrument!1"].plurals[0] = "...но вы не выбрали инструмент!";
    strings["Import Raw Sample###Import Raw Sample"].plurals[0] = "Импортировать сырые данные сэмпла###Import Raw Sample";
    strings["Data type:"].plurals[0] = "Тип данных:";
    strings["Sample rate"].plurals[0] = "Частота квантования";
    strings["Channels"].plurals[0] = "Число каналов";
    strings["(will be mixed down to mono)"].plurals[0] = "(будет сведено в моно)";
    strings["Unsigned"].plurals[0] = "Беззнаковый";
    strings["Big endian"].plurals[0] = "Обратный порядок байтов (Big endian)";
    strings["Swap nibbles"].plurals[0] = "Поменять местами тетрады";
    strings["Swap words"].plurals[0] = "Поменять местами машинные слова";
    strings["Encoding:"].plurals[0] = "Кодировка:";
    strings["Reverse bit order"].plurals[0] = "Обратный порядок битов";
    strings["OK3"].plurals[0] = "ОК";
    strings["...but you haven't selected a sample!1"].plurals[0] = "...но вы не выбрали сэмпл!";
    strings["Cancel3"].plurals[0] = "Отмена";
    strings["Error! No string provided!"].plurals[0] = "Ошибка! Не предоставлена строка!";
    strings["OK4"].plurals[0] = "ОК";
    strings["%.0fµs"].plurals[0] = "%.0f мс";
    strings["error while loading fonts! please check your settings.1"].plurals[0] = "Ошибка при загрузке шрифтов! пожалуйста, проверьте настройки.";
    strings["it appears I couldn't load these fonts. any setting you can check?"].plurals[0] = "кажется, я не могу загрузить эти шрифты. проверьте настройки?";
    strings["could not init renderer!\r\nfalling back to software renderer. please restart Furnace."].plurals[0] = "не получилось инициализировать движок отрисовки!\r\nперехожу на программную отрисовку. пожалуйста, перезапустите Furnace.";
    strings["could not init renderer! %s\r\nfalling back to software renderer. please restart Furnace."].plurals[0] = "не получилось инициализировать движок отрисовки! %s\r\nперехожу на программную отрисовку. пожалуйста, перезапустите Furnace.";
    strings["\r\nfalling back to software renderer. please restart Furnace."].plurals[0] = "\r\nперехожу на программную отрисовку. пожалуйста, перезапустите Furnace.";
    strings["could not init renderer! %s"].plurals[0] = "не получилось инициализировать движок отрисовки! %s";
    ...
    strings["could not open window! %s"].plurals[0] = "не удалось открыть окно! %s";
    strings["error while loading fonts! please check your settings.2"].plurals[0] = "Ошибка при загрузке шрифтов! пожалуйста, проверьте настройки.";
    strings["could NOT save layout! %s"].plurals[0] = "Не получилось сохранить компоновку окон! %s";
    ...
    strings["%s: maximum sample rate is %d"].plurals[0] = "%s: максимальная частота квантования равна %d";
    strings["%s: minimum sample rate is %d"].plurals[0] = "%s: минимальная частота квантования равна %d";
    strings["%s: sample rate must be %d"].plurals[0] = "%s: частота квантования должна быть равна %d";
    strings["Sample Editor###Sample Editor"].plurals[0] = "Редактор сэмплов###Sample Editor";
    strings["no sample selected"].plurals[0] = "сэмпл не выбран";
    strings["select one..."].plurals[0] = "выберите сэмпл...";
    strings["or##sgsed0"].plurals[0] = "или";
    strings["Open##sgsed0"].plurals[0] = "Откройте";
    strings["or##sgsed1"].plurals[0] = "или";
    strings["Create New"].plurals[0] = "Создайте новый";
    ...
    strings["import raw..."].plurals[0] = "импорт сырых данных...";
    strings["Save"].plurals[0] = "Сохранить";
    strings["save raw..."].plurals[0] = "сохранить сырые данные...";
    strings["Name"].plurals[0] = "Название";
    strings["SNES: loop start must be a multiple of 16 (try with %d)"].plurals[0] = "SNES: начало цикла должно быть кратно 16 (попробуйте %d)";
    strings["SNES: loop end must be a multiple of 16 (try with %d)"].plurals[0] = "SNES: конец цикла должен быть кратен 16 (попробуйте %d)";
    strings["SNES: sample length will be padded to multiple of 16"].plurals[0] = "SNES: длина сэмпла будет скорректирована до кратности 16";
    strings["QSound: loop cannot be longer than 32767 samples"].plurals[0] = "QSound: цикл не может быть длиннее 32767 сэмплов";
    strings["QSound: maximum sample length is 65535"].plurals[0] = "QSound: максимальная длина сэмпла: 65535";
    strings["NES: loop start must be a multiple of 512 (try with %d)"].plurals[0] = "NES: начало цикла должно быть кратно 512 (попробуйте %d)";
    strings["NES: loop end must be a multiple of 128 (try with %d)"].plurals[0] = "NES: конец цикла должен быть кратен 128 (попробуйте %d)";
    strings["NES: maximum DPCM sample length is 32648"].plurals[0] = "NES: максимальная длина ДИКМ-сэмпла равна 32648";
    strings["X1-010: samples can't loop"].plurals[0] = "X1-010: сэмплы не могут быть зациклены";
    strings["X1-010: maximum sample length is 131072"].plurals[0] = "X1-010: максимальная длина сэмпла равна 131072";
    strings["GA20: samples can't loop"].plurals[0] = "GA20: сэмплы не могут быть зациклены";
    strings["YM2608: loop point ignored on ADPCM (may only loop entire sample)"].plurals[0] = "YM2608: точка зацикливания игнорируется для АДИКМ (зациклить можно только сэмпл целиком)";
    strings["YM2608: sample length will be padded to multiple of 512"].plurals[0] = "YM2608: длина сэмпла будет скорректирована до кратности 512";
    strings["YM2610: ADPCM-A samples can't loop"].plurals[0] = "YM2610: ADPCM-A сэмплы не могут быть зациклены";
    strings["YM2610: loop point ignored on ADPCM-B (may only loop entire sample)"].plurals[0] = "YM2610: точка зацикливания игнорируется для АДИКМ-B (зациклить можно только сэмпл целиком)";
    strings["YM2610: sample length will be padded to multiple of 512"].plurals[0] = "YM2610: длина сэмпла будет скорректирована до кратности 512";
    strings["YM2610: maximum ADPCM-A sample length is 2097152"].plurals[0] = "YM2610: максимальная длина АДИКМ-A сэмпла равна 2097152";
    strings["Y8950: loop point ignored on ADPCM (may only loop entire sample)"].plurals[0] = "Y8950: точка зацикливания игнорируется для АДИКМ (зациклить можно только сэмпл целиком)";
    strings["Y8950: sample length will be padded to multiple of 512"].plurals[0] = "Y8950: длина сэмпла будет скорректирована до кратности 512";
    strings["Amiga: loop start must be a multiple of 2"].plurals[0] = "Amiga: начало зацикливания должно быть кратно 2";
    strings["Amiga: loop end must be a multiple of 2"].plurals[0] = "Amiga: конец зацикливания должен быть кратен 2";
    strings["Amiga: maximum sample length is 131070"].plurals[0] = "Amiga: максимальная длина сэмпла равна 131070";
    strings["SegaPCM: maximum sample length is 65280"].plurals[0] = "SegaPCM: максимальная длина сэмпла равна 65280";
    strings["K053260: loop point ignored (may only loop entire sample)"].plurals[0] = "K053260: точка зацикливания игнорируется (зациклить можно только сэмпл целиком)";
    strings["K053260: maximum sample length is 65535"].plurals[0] = "K053260: максимальная длина сэмпла равна 65535";
    strings["C140: maximum sample length is 65535"].plurals[0] = "C140: максимальная длина сэмпла равна 65535";
    strings["C219: loop start must be a multiple of 2"].plurals[0] = "C219: начало зацикливания должно быть кратно 2";
    strings["C219: loop end must be a multiple of 2"].plurals[0] = "C219: конец зацикливания должен быть кратен 2";
    strings["C219: maximum sample length is 131072"].plurals[0] = "C219: максимальная длина сэмпла равна 131072";
    strings["MSM6295: samples can't loop"].plurals[0] = "MSM6295: сэмплы не могут быть зациклены";
    strings["MSM6295: maximum bankswitched sample length is 129024"].plurals[0] = "MSM6295: максимальная длина сэмпла с заменой банков равна 129024";
    strings["GBA DMA: loop start must be a multiple of 4"].plurals[0] = "GBA DMA: начало цикла должно быть кратно 4";
    strings["GBA DMA: loop length must be a multiple of 16"].plurals[0] = "GBA DMA: длина зацикленной части должна быть кратна 16";
    strings["GBA DMA: sample length will be padded to multiple of 16"].plurals[0] = "GBA DMA: длина сэмпла будет скорректирована до кратности 16";
    strings["ES5506: backward loop mode isn't supported"].plurals[0] = "ES5506: режим обратного зацикливания не поддерживается";
    strings["backward/ping-pong only supported in Generic PCM DAC\nping-pong also on ES5506"].plurals[0] = "режим обратного и \"туда-обратно\" зацикливания поддерживается только для универсального ИКМ ЦАП\n\"туда-обратно\" также поддерживается для ES5506";
    strings["Info"].plurals[0] = "Информация";
    strings["Rate##sgsed0"].plurals[0] = "Частота";
    strings["Compat Rate"].plurals[0] = "Совместимая частота";
    strings["used in DefleMask-compatible sample mode (17xx), in where samples are mapped to an octave."].plurals[0] = "используется при воспроизведении в режиме совместимости с DefleMask (17xx), в котором сэмплы соответствуют октаве.";
    ...
    strings["Chips"].plurals[0] = "Чипы";
    strings["Type"].plurals[0] = "Тип";
    strings["BRR emphasis"].plurals[0] = "Постобработка для BRR";
    strings["this is a BRR sample.\nenabling this option will muffle it (only affects non-SNES chips)."].plurals[0] = "это сэмпл BRR.\nвключение этой опции \"приглушит\" его (на всех чипах кроме SNES).";
    strings["enable this option to slightly boost high frequencies\nto compensate for the SNES' Gaussian filter's muffle."].plurals[0] = "включите эту опцию для небольшого усиления высоких частот\nдля компенсации фильтрующего свойства гауссовой интерполяции, из-за которого сэмпл \"приглушается\".";
    strings["8-bit dither"].plurals[0] = "8-битный дизеринг";
    strings["dither the sample when used on a chip that only supports 8-bit samples."].plurals[0] = "произвести дизеринг для сэмпла при его использовании для чипа, поддерживающего только 8-битные сэмплы.";
    strings["Hz"].plurals[0] = "Гц";
    strings["Note"].plurals[0] = "Нота";
    strings["%s"].plurals[0] = "%s";
    strings["Fine"].plurals[0] = "Расстройка";
    strings["Mode"].plurals[0] = "Режим";
    strings["Start"].plurals[0] = "Начало";
    ...
    strings["%s\n%d bytes free"].plurals[0] = "%s\nсвободен %d байт";
    strings["%s\n%d bytes free"].plurals[1] = "%s\nсвободно %d байта";
    strings["%s\n%d bytes free"].plurals[2] = "%s\nсвободно %d байт";
    strings["%s (%s)\n%d bytes free"].plurals[0] = "%s (%s)\nсвободен %d байт";
    strings["%s (%s)\n%d bytes free"].plurals[1] = "%s (%s)\nсвободно %d байта";
    strings["%s (%s)\n%d bytes free"].plurals[2] = "%s (%s)\nсвободно %d байт";
    strings["\n\nnot enough memory for this sample!"].plurals[0] = "\n\nнедостаточно памяти для этого сэмпла!";
    strings["Edit mode: Select"].plurals[0] = "Режим редактирования: выделение";
    strings["Edit mode: Draw"].plurals[0] = "Режим редактирования: рисование";
    ...
    strings["couldn't resize! make sure your sample is 8 or 16-bit."].plurals[0] = "не получилось отмасштабировать! убедитесь, что это 8- или 16-битный сэмпл.";
    strings["Resample##sgsed0"].plurals[0] = "Изменить частоту дискретизации";
    strings["Rate##sgsed1"].plurals[0] = "Частота";
    strings["Factor"].plurals[0] = "Коэффициент";
    strings["Filter"].plurals[0] = "Фильтр";
    strings["Resample##sgsed1"].plurals[0] = "Применить";
    strings["couldn't resample! make sure your sample is 8 or 16-bit."].plurals[0] = "не получилось изменить частоту дискретизации! убедитесь, что это 8- или 16-битный сэмпл.";
    strings["Undo"].plurals[0] = "Отменить";
    strings["Redo"].plurals[0] = "Повторить";
    strings["Amplify"].plurals[0] = "Усилить";
    strings["Volume"].plurals[0] = "Громкость";
    strings["Apply##sgsed0"].plurals[0] = "Применить";
    strings["Normalize"].plurals[0] = "Нормализовать";
    strings["Fade in"].plurals[0] = "Плавное нарастание";
    strings["Fade out"].plurals[0] = "Плавное затухание";
    strings["Insert silence"].plurals[0] = "Вставить тишину";
    strings["Samples##sgsed1"].plurals[0] = "Сэмплов";
    strings["Go"].plurals[0] = "Применить";
    strings["couldn't insert! make sure your sample is 8 or 16-bit."].plurals[0] = "не получилось вставить! убедитесь, что это 8- или 16-битный сэмпл.";
    strings["Apply silence"].plurals[0] = "Применить тишину";
    strings["Delete"].plurals[0] = "Удалить";
    strings["Trim"].plurals[0] = "Обрезать";
    strings["Reverse"].plurals[0] = "Реверс";
    strings["Invert"].plurals[0] = "Инвертировать";
    strings["Signed/unsigned exchange"].plurals[0] = "Знаковый <-> беззнаковый";
    strings["Apply filter"].plurals[0] = "Применить фильтр";
    strings["Cutoff:"].plurals[0] = "Частота среза:";
    strings["From"].plurals[0] = "От";
    strings["To"].plurals[0] = "До";
    strings["Resonance"].plurals[0] = "Резонанс (добротность)";
    strings["Power"].plurals[0] = "Порядок фильтра";
    strings["Low-pass"].plurals[0] = "ФНЧ";
    strings["Band-pass"].plurals[0] = "ППФ";
    strings["High-pass"].plurals[0] = "ФВЧ";
    strings["Apply##sgsed1"].plurals[0] = "Применить";
    strings["Crossfade loop points"].plurals[0] = "Сделать плавный переход между началом и концом зацикленной части";
    strings["Number of samples"].plurals[0] = "Число сэмплов";
    strings["Linear <-> Equal power"].plurals[0] = "Линейный <-> Одинаковая степень";
    strings["Apply##sgsed2"].plurals[0] = "Применить";
    strings["Crossfade: length would go out of bounds. Aborted..."].plurals[0] = "Плавный переход: длина выйдет за границы. Действие отменено.";
    strings["Crossfade: length would overflow loopStart. Try a smaller random value."].plurals[0] = "Плавный переход: длина выйдет за пределы начала цикла. Попробуйте с меньшим случайным значением.";
    strings["Preview sample"].plurals[0] = "Превью сэмпла";
    strings["Stop sample preview"].plurals[0] = "Остановить превью сэмпла";
    strings["Create instrument from sample"].plurals[0] = "Создать инструмент из сэмпла";
    strings["Zoom##sgsed0"].plurals[0] = "Масштаб";
    strings["Zoom##sgsed1"].plurals[0] = "Масштаб";
    strings["%dms"].plurals[0] = "%d мс";
    strings["Auto"].plurals[0] = "Автоматически";
    strings["cut"].plurals[0] = "вырезать";
    strings["copy"].plurals[0] = "копировать";
    strings["paste"].plurals[0] = "вставить";
    strings["paste (replace)"].plurals[0] = "вставить (с заменой)";
    strings["paste (mix)"].plurals[0] = "вставить со смешением";
    strings["select all"].plurals[0] = "выбрать всё";
    strings["set loop to selection"].plurals[0] = "зациклить по выделенной части";
    strings["create wavetable from selection"].plurals[0] = "создать волновую таблицу из выделенной части";
    strings["Draw"].plurals[0] = "Рисовать";
    strings["Select"].plurals[0] = "Выделить";
    strings["%d samples"].plurals[0] = "%d сэмпл";
    strings["%d samples"].plurals[1] = "%d сэмпла";
    strings["%d samples"].plurals[2] = "%d сэмплов";
    strings["%d bytes"].plurals[0] = "%d байт";
    strings["%d bytes"].plurals[1] = "%d байта";
    strings["%d bytes"].plurals[2] = "%d байтов";
    strings[" (%d-%d: %d samples)"].plurals[0] = " (%d-%d: %d сэмпл)";
    strings[" (%d-%d: %d samples)"].plurals[1] = " (%d-%d: %d сэмпла)";
    strings[" (%d-%d: %d samples)"].plurals[2] = " (%d-%d: %d сэмплов)";
    strings["%.2fHz"].plurals[0] = "%.2f Гц";
    strings["Non-8/16-bit samples cannot be edited without prior conversion."].plurals[0] = "Сэмплы в формате, отличающемся от 8- или 16-битной ИКМ, невозможно редактировать\nбез предварительной конвертации в один из этих форматов.";
    ...
    strings["Auto-fill file name when saving"].plurals[0] = "Автоматически подставлять имя файла при сохранении";
    strings["fill the file name field with an appropriate file name when saving or exporting."].plurals[0] = "подставлять соответствующее имя файла при экспорте или сохранении.";
    ...
    strings["Base note"].plurals[0] = "Базовая нота";
    strings["Finetune"].plurals[0] = "Расстройка";
    strings["Slide speed"].plurals[0] = "Скорость слайда";
    strings["Set PW"].plurals[0] = "Уст. скважн.";
    strings["Set pulse width on keydown"].plurals[0] = "Установить скважность на новой ноте";
    strings["Initial pulse width"].plurals[0] = "Начальная скважность";
    strings["Set cutoff"].plurals[0] = "Устан. част. среза";
    strings["Set filter cutoff on keydown"].plurals[0] = "Установить частоту среза фильтра на новой ноте";
    strings["Waveform"].plurals[0] = "Волна";
    strings["noise"].plurals[0] = "шум";
    strings["pulse"].plurals[0] = "прямоуг.";
    strings["triangle"].plurals[0] = "треуг.";
    strings["saw"].plurals[0] = "пила";
    strings["metal"].plurals[0] = "\"металл.\"";
    strings["sine"].plurals[0] = "синус";
    strings["Enable filter"].plurals[0] = "Включить фильтр";
    strings["Cutoff"].plurals[0] = "Частота среза";
    strings["Resonance"].plurals[0] = "Резонанс";
    strings["Type"].plurals[0] = "Тип";
    strings["Enable ring modulation"].plurals[0] = "Включить кольцевую модуляцию";
    strings["Ring mod source"].plurals[0] = "Источник кольцевой модуляции";
    strings["FF = self-modulation"].plurals[0] = "FF = самомодуляция";
    strings["Enable hard sync"].plurals[0] = "Включить синхронизацию осцилляторов";
    strings["Hard sync source"].plurals[0] = "Источник синхронизации";
    strings["FF = self-sync"].plurals[0] = "FF = самосинхронизация";
    strings["Retrigger on slide"].plurals[0] = "Перезапуск на слайде";
    strings["Restart instrument and envelope even if slide command (03xx) is placed with the note."].plurals[0] = "Перезапустить инструмент и огибающую, даже если у ноты стоит эффект слайда (03xx).";
    strings["Sync osc. on keydown"].plurals[0] = "Синхр. осц. на новой ноте";
    strings["Reset phase of oscillator each time new note is played.\nDoes not happen when slide (03xx) or legato command is placed."].plurals[0] = "Сбросить фазу осциллятора на каждой новой ноте.\nНе выполняется при наличии команды слайда (03xx) или легато.";
    strings["Vibrato"].plurals[0] = "Вибрато";
    strings["Speed0"].plurals[0] = "Скорость0";
    strings["Depth0"].plurals[0] = "Глубина0";
    strings["Delay0"].plurals[0] = "Задержка0";
    strings["PWM"].plurals[0] = "ШИМ";
    strings["Speed1"].plurals[0] = "Скорость1";
    strings["Depth1"].plurals[0] = "Глубина1";
    strings["Delay1"].plurals[0] = "Задержка1";
    strings["A"].plurals[0] = "А";
    strings["D"].plurals[0] = "С";
    strings["S"].plurals[0] = "С";
    strings["R"].plurals[0] = "Р";
    strings["VOL"].plurals[0] = "ГР";
    strings["Envelope"].plurals[0] = "Огибающая";
    strings["Instrument program"].plurals[0] = "Программа инструмента";
    strings["Program period22"].plurals[0] = "Период программы";
    strings["Do not restart instrument program on keydown"].plurals[0] = "Не перезапускать программу инструмента на новой ноте";
    strings["Tick"].plurals[0] = "Шаг";
    strings["Command"].plurals[0] = "Команда";
    strings["Move/Remove"].plurals[0] = "Перем./Удал.";
    strings["Unite"].plurals[0] = "Объед.";
    strings["Value"].plurals[0] = "Значение";
    strings["Semitones"].plurals[0] = "Полутонов";
    strings["First external arpeggio note"].plurals[0] = "Первая внешняя нота арпеджио";
    strings["Second external arpeggio note1"].plurals[0] = "Вторая внешняя нота арпеджио";
    strings["Speed2"].plurals[0] = "Скорость";
    strings["Depth11"].plurals[0] = "Глубина";
    strings["Value"].plurals[0] = "Значение";
    strings["Up2"].plurals[0] = "Вверх";
    strings["Down11"].plurals[0] = "Вниз";
    strings["Source channel"].plurals[0] = "Канал-источник";
    strings["Source is self"].plurals[0] = "Текущий канал является источником";
    strings["Loops"].plurals[0] = "Циклов";
    strings["Step to jump to"].plurals[0] = "Шаг программы, на который совершается переход";
    strings["No operation"].plurals[0] = "Ничего не делать";
    strings["Program end"].plurals[0] = "Конец программы";
    strings["Execute next command at the same tick"].plurals[0] = "Выполнить следующую команду в этом же шаге";
    strings["Macros"].plurals[0] = "Макросы";
    strings["Warning! Macros are NOT supported by FZT file format! Do not use them if you want to export .fzt file!"].plurals[0] = "Внимание! Макросы НЕ ПОДДЕРЖИВАЮТСЯ форматом файла FZT! Не используйте их, если хотите экспортировать модуль в файл .fzt!";
    strings["Volume"].plurals[0] = "Громкость";
    strings["Arpeggio"].plurals[0] = "Арпеджио";
    strings["Pitch"].plurals[0] = "Частота";
    strings["Duty"].plurals[0] = "Скважность";
    strings["Waveform"].plurals[0] = "Волна";
    strings["Cutoff"].plurals[0] = "Частота среза";
    strings["Filter Mode"].plurals[0] = "Режим фильтра";
    strings["Filter Toggle"].plurals[0] = "Фильтр вкл./выкл.";
    strings["Resonance"].plurals[0] = "Резонанс";
    strings["Phase Reset"].plurals[0] = "Сброс фазы";
    strings["Envelope Reset/Key Control"].plurals[0] = "Упр. огибающей";
    strings["Ring mod toggle"].plurals[0] = "Кольц. мод. вкл./выкл.";
    strings["Ring mod source"].plurals[0] = "Источник кольц. мод.";
    strings["Hard sync toggle"].plurals[0] = "Синхр. осц. вкл./выкл.";
    strings["Hard sync source"].plurals[0] = "Источник синхр. осц.";
    strings["Attack"].plurals[0] = "Атака";
    strings["Decay"].plurals[0] = "Спад";
    strings["Sustain"].plurals[0] = "Сустейн";
    strings["Release"].plurals[0] = "Релиз";
    ...
    strings["Game Boy"].plurals[0] = "Game Boy";
    strings["Use software envelope"].plurals[0] = "Использовать программную огибающую громкости";
    strings["Initialize envelope on every note"].plurals[0] = "Инициализировать огибающую на каждой ноте";
    strings["Volume##sgiGB0"].plurals[0] = "Громкость";
    strings["Length"].plurals[0] = "Длина";
    strings["Sound Length##sgiGB0"].plurals[0] = "Длина звука";
    strings["Infinity"].plurals[0] = "Бесконечность";
    strings["Direction"].plurals[0] = "Направление";
    strings["Up##sgiGB0"].plurals[0] = "Вверх";
    strings["Down##sgiGB0"].plurals[0] = "Вниз";
    strings["Hardware Sequence"].plurals[0] = "Аппаратная последовательность";
    strings["Tick"].plurals[0] = "Шаг движка";
    strings["Command"].plurals[0] = "Команда";
    strings["Move/Remove"].plurals[0] = "Перем./Удал.";
    strings["Volume"].plurals[0] = "Громкость";
    strings["Env Length"].plurals[0] = "Длина огибающей";
    strings["Sound Length"].plurals[0] = "Длина звука";
    strings["Up"].plurals[0] = "Вверх";
    strings["Down"].plurals[0] = "Вниз";
    strings["Shift"].plurals[0] = "На сколько";
    strings["Speed"].plurals[0] = "Скорость";
    strings["Up"].plurals[0] = "Вверх";
    strings["Down"].plurals[0] = "Вниз";
    strings["Ticks"].plurals[0] = "Шагов";
    strings["Position"].plurals[0] = "Положение";
    strings["Macros"].plurals[0] = "Макросы";
    strings["Volume"].plurals[0] = "Громкость";
    strings["Arpeggio"].plurals[0] = "Арпеджио";
    strings["Pitch"].plurals[0] = "Частота";
    strings["Duty/Noise"].plurals[0] = "Скважность/режим шума";
    strings["Waveform"].plurals[0] = "Волна";
    ...
    strings["20xx: Set channel mode (bit 0: square; bit 1: noise; bit 2: envelope)"].plurals[0] = "20xx: Режим канала (бит 0: меандр; бит 1: шум; бит 2: огибающая)";
    strings["21xx: Set noise frequency (0 to 1F)"].plurals[0] = "21xx: Частота шума (0-1F)";
    strings["21xx: Set noise frequency (0 to FF)"].plurals[0] = "21xx: Частота шума (0-FF)";
    strings["22xy: Set envelope mode (x: shape, y: enable for this channel)"].plurals[0] = "22xy: Режим огибающей (x: форма, y: включить для этого канала)";
    strings["23xx: Set envelope period low byte"].plurals[0] = "23xx: Младший байт периода огибающей";
    strings["24xx: Set envelope period high byte"].plurals[0] = "24xx: Старший байт периода огибающей";
    strings["25xx: Envelope slide up"].plurals[0] = "25xx: Портаменто огибающей вверх";
    strings["26xx: Envelope slide down"].plurals[0] = "26xx: Портаменто огибающей вниз";
    strings["29xy: Set auto-envelope (x: numerator; y: denominator)"].plurals[0] = "29xy: Авто-огибающая (x: числитель; y: знаменатель)";
    strings["2Exx: Write to I/O port A"].plurals[0] = "2Exx: Запись в порт ввода-вывода A";
    strings["2Fxx: Write to I/O port B"].plurals[0] = "2Fxx: Запись в порт ввода-вывода B";
    strings["12xx: Set duty cycle (0 to 8)"].plurals[0] = "12xx: Скважность (0-8)";
    strings["16xx: Set raw period higher byte"].plurals[0] = "16xx: \"Сырое\" значение периода (старший байт)";
    strings["27xx: Set noise AND mask"].plurals[0] = "27xx: Маска шума И";
    strings["28xx: Set noise OR mask"].plurals[0] = "28xx: Маска шума ИЛИ";
    strings["2Cxy: Automatic noise frequency (auto-PWM) (x: mode (0: disable, 1: freq, 2: freq + OR mask); y: offset"].plurals[0] = "2Cxy: Автоматическая частота шума (авто-ШИМ) (x: режим (0: выкл., 1: частота, 2: частота + маска ИЛИ); y: сдвиг";
    strings["2Dxx: NOT TO BE EMPLOYED BY THE COMPOSER"].plurals[0] = "2Dxx: НЕ ДЛЯ ИСПОЛЬЗОВАНИЯ КОМПОЗИТОРОМ";
    strings["30xx: Toggle hard envelope reset on new notes"].plurals[0] = "30xx: Переключить жёсткий перезапуск огибающей на новой ноте";
    strings["18xx: Toggle extended channel 3 mode"].plurals[0] = "18xx: Переключить расширенный режим 3-го канала";
    strings["17xx: Toggle PCM mode (LEGACY)"].plurals[0] = "17xx: Переключить режим ИКМ (СОВМЕСТИМОСТЬ)";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)"].plurals[0] = "DFxx: Направление проигрывания сэмпла (0: обычное; 1: обратное)";
    strings["18xx: Toggle drums mode (1: enabled; 0: disabled)"].plurals[0] = "18xx: Переключить режим ударных (1: включить; 0: выключить)";
    strings["11xx: Set feedback (0 to 7)"].plurals[0] = "11xx: Обратная связь (0-7)";
    strings["12xx: Set level of operator 1 (0 highest, 7F lowest)"].plurals[0] = "12xx: Уровень оператора 1 (0 макс., 7F мин.)";
    strings["13xx: Set level of operator 2 (0 highest, 7F lowest)"].plurals[0] = "13xx: Уровень оператора 2 (0 макс., 7F мин.)";
    strings["14xx: Set level of operator 3 (0 highest, 7F lowest)"].plurals[0] = "14xx: Уровень оператора 3 (0 макс., 7F мин.)";
    strings["15xx: Set level of operator 4 (0 highest, 7F lowest)"].plurals[0] = "15xx: Уровень оператора 4 (0 макс., 7F мин.)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)"].plurals[0] = "16xy: Множитель частоты (x: оператор (1-4); y: множитель)";
    strings["19xx: Set attack of all operators (0 to 1F)"].plurals[0] = "19xx: Атака всех операторов (0-1F)";
    strings["1Axx: Set attack of operator 1 (0 to 1F)"].plurals[0] = "1Axx: Атака оператора 1 (0-1F)";
    strings["1Bxx: Set attack of operator 2 (0 to 1F)"].plurals[0] = "1Bxx: Атака оператора 2 (0-1F)";
    strings["1Cxx: Set attack of operator 3 (0 to 1F)"].plurals[0] = "1Cxx: Атака оператора 3 (0-1F)";
    strings["1Dxx: Set attack of operator 4 (0 to 1F)"].plurals[0] = "1Dxx: Атака оператора 4 (0-1F)";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)"].plurals[0] = "50xy: Включить АМ (x: оператор 1-4 (0 для всех операторов); y: АМ)";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)"].plurals[0] = "51xy: Уровень сустейна (x: оператор 1-4 (0 для всех операторов); y: уровень)";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)"].plurals[0] = "52xy: Релиз (x: оператор 1-4 (0 для всех операторов); y: релиз)";
    strings["53xy: Set detune (x: operator from 1 to 4 (0 for all ops); y: detune where 3 is center)"].plurals[0] = "53xy: Расстройка (x: оператор 1-4 (0 для всех операторов); y: расстройка (3 - без расстройки))";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)"].plurals[0] = "54xy: Масш. огиб. (x: оператор 1-4 (0 для всех операторов); y: масш. 0-3)";
    strings["56xx: Set decay of all operators (0 to 1F)"].plurals[0] = "56xx: Спад всех операторов (0-1F)";
    strings["57xx: Set decay of operator 1 (0 to 1F)"].plurals[0] = "57xx: Спад оператора 1 (0-1F)";
    strings["58xx: Set decay of operator 2 (0 to 1F)"].plurals[0] = "58xx: Спад оператора 2 (0-1F)";
    strings["59xx: Set decay of operator 3 (0 to 1F)"].plurals[0] = "59xx: Спад оператора 3 (0-1F)";
    strings["5Axx: Set decay of operator 4 (0 to 1F)"].plurals[0] = "5Axx: Спад оператора 4 (0-1F)";
    strings["5Bxx: Set decay 2 of all operators (0 to 1F)"].plurals[0] = "5Bxx: Спад 2 всех операторов (0-1F)";
    strings["5Cxx: Set decay 2 of operator 1 (0 to 1F)"].plurals[0] = "5Cxx: Спад 2 оператора 1 (0-1F)";
    strings["5Dxx: Set decay 2 of operator 2 (0 to 1F)"].plurals[0] = "5Dxx: Спад 2 оператора 2 (0-1F)";
    strings["5Exx: Set decay 2 of operator 3 (0 to 1F)"].plurals[0] = "5Exx: Спад 2 оператора 3 (0-1F)";
    strings["5Fxx: Set decay 2 of operator 4 (0 to 1F)"].plurals[0] = "5Fxx: Спад 2 оператора 4 (0-1F)";
    strings["10xx: Set noise frequency (xx: value; 0 disables noise)"].plurals[0] = "10xx: Частота шума (xx: частота; 0 отключает шум)";
    strings["17xx: Set LFO speed"].plurals[0] = "17xx: Установить частоту ГНЧ";
    strings["18xx: Set LFO waveform (0 saw, 1 square, 2 triangle, 3 noise)"].plurals[0] = "18xx: Форма волны ГНЧ (0 пила, 1 меандр, 2 треуг., 3 шум)";
    strings["1Exx: Set AM depth (0 to 7F)"].plurals[0] = "1Exx: Глубина АМ (0-7F)";
    strings["1Fxx: Set PM depth (0 to 7F)"].plurals[0] = "1Fxx: Глубина ФМ (0-7F)";
    strings["55xy: Set detune 2 (x: operator from 1 to 4 (0 for all ops); y: detune from 0 to 3)"].plurals[0] = "55xy: Расстройка 2 (x: оператор 1-4 (0 для всех операторов); y: расстройка 0-3)";
    strings["24xx: Set LFO 2 speed"].plurals[0] = "24xx: Установить частоту ГНЧ 2";
    strings["25xx: Set LFO 2 waveform (0 saw, 1 square, 2 triangle, 3 noise)"].plurals[0] = "25xx: Форма волны ГНЧ 2 (0 пила, 1 меандр, 2 треуг., 3 шум)";
    strings["26xx: Set AM 2 depth (0 to 7F)"].plurals[0] = "26xx: Глубина АМ 2 (0-7F)";
    strings["27xx: Set PM 2 depth (0 to 7F)"].plurals[0] = "27xx: Глубина ФМ 2 (0-7F)";
    strings["28xy: Set reverb (x: operator from 1 to 4 (0 for all ops); y: reverb from 0 to 7)"].plurals[0] = "28xy: Реверб (x: оператор 1-4 (0 для всех операторов); y: реверб 0-7)";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 7)"].plurals[0] = "2Axy: Форма волны (x: оператор 1-4 (0 для всех операторов); y: форма волны 0-7)";
    strings["2Bxy: Set envelope generator shift (x: operator from 1 to 4 (0 for all ops); y: shift from 0 to 3)"].plurals[0] = "2Bxy: Сдвиг генератора огибающей (x: оператор 1-4 (0 для всех операторов); y: сдвиг 0-3)";
    strings["2Cxy: Set fine multiplier (x: operator from 1 to 4 (0 for all ops); y: fine)"].plurals[0] = "2Cxy: Точный множитель (x: оператор 1-4 (0 для всех операторов); y: множитель)";
    strings["3xyy: Set fixed frequency of operator 1 (x: octave from 0 to 7; y: frequency)"].plurals[0] = "3xyy: Установить фиксированную частоту оператора 1 (x: октава 0-7; y: частота)";
    strings["3xyy: Set fixed frequency of operator 2 (x: octave from 8 to F; y: frequency)"].plurals[0] = "3xyy: Установить фиксированную частоту оператора 2 (x: октава 8-F; y: частота)";
    strings["4xyy: Set fixed frequency of operator 3 (x: octave from 0 to 7; y: frequency)"].plurals[0] = "4xyy: Установить фиксированную частоту оператора 3 (x: октава 0-7; y: частота)";
    strings["4xyy: Set fixed frequency of operator 4 (x: octave from 8 to F; y: frequency)"].plurals[0] = "4xyy: Установить фиксированную частоту оператора 4 (x: октава 8-F; y: частота)";
    strings["10xy: Setup LFO (x: enable; y: speed)"].plurals[0] = "10xy: Настройка ГНЧ (x: включить; y: скорость)";
    strings["55xy: Set SSG envelope (x: operator from 1 to 4 (0 for all ops); y: 0-7 on, 8 off)"].plurals[0] = "55xy: Огибающая SSG (x: оператор 1-4 (0 для всех операторов); y: 0-7 вкл., 8 выкл.)";
    strings["1Fxx: Set ADPCM-A global volume (0 to 3F)"].plurals[0] = "1Fxx: Глобальная громкость ADPCM-A (0-3F)";
    strings["11xx: Set feedback (0 to 7)1"].plurals[0] = "11xx: Обратная связь (0-7)";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)"].plurals[0] = "12xx: Уровень оператора 1 (0 макс., 3F мин.)";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)"].plurals[0] = "13xx: Уровень оператора 2 (0 макс., 3F мин.)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 2; y: multiplier)"].plurals[0] = "16xy: Множитель частоты (x: оператор 1-2; y: множитель)";
    strings["19xx: Set attack of all operators (0 to F)"].plurals[0] = "19xx: Атака всех операторов (0-F)";
    strings["1Axx: Set attack of operator 1 (0 to F)"].plurals[0] = "1Axx: Атака оператора 1 (0-F)";
    strings["1Bxx: Set attack of operator 2 (0 to F)"].plurals[0] = "1Bxx: Атака оператора 2 (0-F)";
    strings["10xx: Set patch (0 to F)"].plurals[0] = "10xx: Патч (0-F)";
    strings["50xy: Set AM (x: operator from 1 to 2 (0 for all ops); y: AM)"].plurals[0] = "50xy: Включить АМ (x: оператор 1-2 (0 для всех операторов); y: АМ)";
    strings["51xy: Set sustain level (x: operator from 1 to 2 (0 for all ops); y: sustain)"].plurals[0] = "51xy: Уровень сустейна (x: оператор 1-2 (0 для всех операторов); y: сустейн)";
    strings["52xy: Set release (x: operator from 1 to 2 (0 for all ops); y: release)"].plurals[0] = "52xy: Релиз (x: оператор 1-2 (0 для всех операторов); y: релиз)";
    strings["53xy: Set vibrato (x: operator from 1 to 2 (0 for all ops); y: enabled)"].plurals[0] = "53xy: Вибрато (x: оператор 1-2 (0 для всех операторов); y: вкл.)";
    strings["54xy: Set envelope scale (x: operator from 1 to 2 (0 for all ops); y: scale from 0 to 3)"].plurals[0] = "54xy: Масш. огиб. (x: оператор 1-2 (0 для всех операторов); y: масш. 0-3)";
    strings["55xy: Set envelope sustain (x: operator from 1 to 2 (0 for all ops); y: enabled)"].plurals[0] = "55xy: Сустейн огибающей (x: оператор 1-2 (0 для всех операторов); y: вкл.)";
    strings["56xx: Set decay of all operators (0 to F)"].plurals[0] = "56xx: Спад всех операторов (0-F)";
    strings["57xx: Set decay of operator 1 (0 to F)"].plurals[0] = "57xx: Спад оператора 1 (0-F)";
    strings["58xx: Set decay of operator 2 (0 to F)"].plurals[0] = "58xx: Спад оператора 2 (0-F)";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 2 (0 for all ops); y: enabled)"].plurals[0] = "5Bxy: Масштаб. огиб. в зав. от ноты (x: оператор 1-2 (0 для всех операторов); y: вкл.)";
    strings["10xx: Set global AM depth (0: 1dB, 1: 4.8dB)"].plurals[0] = "10xx: Глобальная глубина АМ (0: 1 дБ, 1: 4.8 дБ)";
    strings["11xx: Set feedback (0 to 7)2"].plurals[0] = "11xx: Обратная связь (0-7)";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)1"].plurals[0] = "12xx: Уровень оператора 1 (0 макс., 3F мин.)";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)1"].plurals[0] = "13xx: Уровень оператора 2 (0 макс., 3F мин.)";
    strings["14xx: Set level of operator 3 (0 highest, 3F lowest)"].plurals[0] = "14xx: Уровень оператора 3 (0 макс., 3F мин.)";
    strings["15xx: Set level of operator 4 (0 highest, 3F lowest)"].plurals[0] = "15xx: Уровень оператора 4 (0 макс., 3F мин.)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)1"].plurals[0] = "16xy: Множитель частоты (x: оператор 1-4; y: множитель)";
    strings["17xx: Set global vibrato depth (0: normal, 1: double)"].plurals[0] = "17xx: Глобальная глубина вибрато (0: нормальная, 1: двойная)";
    strings["19xx: Set attack of all operators (0 to F)1"].plurals[0] = "19xx: Атака всех операторов (0-F)";
    strings["1Axx: Set attack of operator 1 (0 to F)1"].plurals[0] = "1Axx: Атака оператора 1 (0-F)";
    strings["1Bxx: Set attack of operator 2 (0 to F)1"].plurals[0] = "1Bxx: Атака оператора 2 (0-F)";
    strings["1Cxx: Set attack of operator 3 (0 to F)"].plurals[0] = "1Cxx: Атака оператора 3 (0-F)";
    strings["1Dxx: Set attack of operator 4 (0 to F)"].plurals[0] = "1Dxx: Атака оператора 4 (0-F)";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 3 in OPL2 and 0 to 7 in OPL3)"].plurals[0] = "2Axy: Форма волны (x: оператор 1-4 (0 для всех операторов); y: форма волны 0-3 для OPL2 и 0-7 для OPL3)";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)1"].plurals[0] = "50xy: Включить АМ (x: оператор 1-4 (0 для всех операторов); y: АМ)";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)1"].plurals[0] = "51xy: Уровень сустейна (x: оператор 1-4 (0 для всех операторов); y: сустейн)";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)1"].plurals[0] = "52xy: Релиз (x: оператор 1-4 (0 для всех операторов); y: релиз)";
    strings["53xy: Set vibrato (x: operator from 1 to 4 (0 for all ops); y: enabled)"].plurals[0] = "53xy: Вибрато (x: оператор 1-4 (0 для всех операторов); y: вкл.)";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)1"].plurals[0] = "54xy: Масш. огиб. (x: оператор 1-4 (0 для всех операторов); y: масш. 0-3)";
    strings["55xy: Set envelope sustain (x: operator from 1 to 4 (0 for all ops); y: enabled)"].plurals[0] = "55xy: Сустейн огибающей (x: оператор 1-4 (0 для всех операторов); y: вкл.)";
    strings["56xx: Set decay of all operators (0 to F)1"].plurals[0] = "56xx: Спад всех операторов (0-F)";
    strings["57xx: Set decay of operator 1 (0 to F)1"].plurals[0] = "57xx: Спад оператора 1 (0-F)";
    strings["58xx: Set decay of operator 2 (0 to F)1"].plurals[0] = "58xx: Спад оператора 2 (0-F)";
    strings["59xx: Set decay of operator 3 (0 to F)"].plurals[0] = "59xx: Спад оператора 3 (0-F)";
    strings["5Axx: Set decay of operator 4 (0 to F)"].plurals[0] = "5Axx: Спад оператора 4 (0-F)";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 4 (0 for all ops); y: enabled)"].plurals[0] = "5Bxy: Масштаб. огиб. в зав. от ноты (x: оператор 1-4 (0 для всех операторов); y: вкл.)";
    strings["10xx: Set waveform (bit 0: triangle; bit 1: saw; bit 2: pulse; bit 3: noise)"].plurals[0] = "10xx: Форма волны (бит 0: треуг.; бит 1: пила; бит 2: прямоуг.; бит 3: шум)";
    strings["11xx: Set coarse cutoff (not recommended; use 4xxx instead)"].plurals[0] = "11xx: Грубая частота среза (не рекомендуется; используйте 4xxx)";
    strings["12xx: Set coarse pulse width (not recommended; use 3xxx instead)"].plurals[0] = "12xx: Грубая скважность (не рекомендуется; используйте 3xxx)";
    strings["13xx: Set resonance (0 to F)"].plurals[0] = "13xx: Резонанс (0-F)";
    strings["14xx: Set filter mode (bit 0: low pass; bit 1: band pass; bit 2: high pass)"].plurals[0] = "14xx: Режим фильтра (бит 0: ФНЧ; бит 1: ППФ; бит 2: ФВЧ)";
    strings["15xx: Set envelope reset time"].plurals[0] = "15xx: Установить время ресета огибающей";
    strings["1Axx: Disable envelope reset for this channel (1 disables; 0 enables)"].plurals[0] = "1Axx: Отключить ресет огибающей для этого канала (1 выкл.; 0 вкл.)";
    strings["1Bxy: Reset cutoff (x: on new note; y: now)"].plurals[0] = "1Bxy: Сбросить частоту среза (x: на след. ноте; y: сейчас)";
    strings["1Cxy: Reset pulse width (x: on new note; y: now)"].plurals[0] = "1Cxy: Сбросить скважность (x: на след. ноте; y: сейчас)";
    strings["1Exy: Change other parameters (LEGACY)"].plurals[0] = "1Exy: Изменить другие параметры (СОВМЕСТИМОСТЬ)";
    strings["20xy: Set attack/decay (x: attack; y: decay)"].plurals[0] = "20xy: Установить атаку/спад (x: атака; y: спад)";
    strings["21xy: Set sustain/release (x: sustain; y: release)"].plurals[0] = "21xy: Установить сустейн/релиз (x: сустейн; y: релиз)";
    strings["22xx: Pulse width slide up"].plurals[0] = "22xx: Изменение скважности вверх";
    strings["23xx: Pulse width slide down"].plurals[0] = "23xx: Изменение скважности вниз";
    strings["24xx: Cutoff slide up"].plurals[0] = "24xx: Изменение частоты среза вверх";
    strings["25xx: Cutoff slide down"].plurals[0] = "25xx: Изменение частоты среза вниз";
    strings["3xxx: Set pulse width (0 to FFF)"].plurals[0] = "3xxx: Скважность (0-FFF)";
    strings["4xxx: Set cutoff (0 to 7FF)"].plurals[0] = "4xxx: Частота среза (0-7FF)";
    strings["10xx: Set waveform"].plurals[0] = "10xx: Волна";
    strings["13xx: Set waveform (local)"].plurals[0] = "13xx: Волна (локальная)";
    strings["11xx: Set raw period (0-1F)"].plurals[0] = "11xx: \"Сырое\" значение периода (0-1F)";
    strings["11xx: Set waveform (local)"].plurals[0] = "11xx: Волна (локальная)";
    strings["20xx: Set PCM frequency"].plurals[0] = "20xx: Частота ИКМ";
    strings["10xy: Set AM depth (x: operator from 1 to 4 (0 for all ops); y: depth (0: 1dB, 1: 4.8dB))"].plurals[0] = "10xy: Глубина АМ (x: оператор 1-4 (0 для всех операторов); y: глубина (0: 1 дБ, 1: 4.8 дБ))";
    strings["12xx: Set level of operator 1 (0 highest, 3F lowest)2"].plurals[0] = "12xx: Уровень оператора 1 (0 макс., 3F мин.)";
    strings["13xx: Set level of operator 2 (0 highest, 3F lowest)2"].plurals[0] = "13xx: Уровень оператора 2 (0 макс., 3F мин.)";
    strings["14xx: Set level of operator 3 (0 highest, 3F lowest)1"].plurals[0] = "14xx: Уровень оператора 3 (0 макс., 3F мин.)";
    strings["15xx: Set level of operator 4 (0 highest, 3F lowest)1"].plurals[0] = "15xx: Уровень оператора 4 (0 макс., 3F мин.)";
    strings["16xy: Set operator multiplier (x: operator from 1 to 4; y: multiplier)2"].plurals[0] = "16xy: Множитель частоты (x: оператор 1-4; y: мнжитель)";
    strings["17xy: Set vibrato depth (x: operator from 1 to 4 (0 for all ops); y: depth (0: normal, 1: double))"].plurals[0] = "17xy: Глубина вибрато (x: оператор 1-4 (0 для всех операторов); y: глубина (0: нормальная, 1: удвоенная))";
    strings["19xx: Set attack of all operators (0 to F)"].plurals[0] = "19xx: Атака всех операторов (0-F)";
    strings["1Axx: Set attack of operator 1 (0 to F)2"].plurals[0] = "1Axx: Атака оператора 1 (0-F)";
    strings["1Bxx: Set attack of operator 2 (0 to F)2"].plurals[0] = "1Bxx: Атака оператора 1 (0-F)";
    strings["1Cxx: Set attack of operator 3 (0 to F)1"].plurals[0] = "1Cxx: Атака оператора 1 (0-F)";
    strings["1Dxx: Set attack of operator 4 (0 to F)1"].plurals[0] = "1Dxx: Атака оператора 1 (0-F)";
    strings["20xy: Set panning of operator 1 (x: left; y: right)"].plurals[0] = "20xy: Панорамирование оператора 1 (x: лево; y: право)";
    strings["21xy: Set panning of operator 2 (x: left; y: right)"].plurals[0] = "21xy: Панорамирование оператора 2 (x: лево; y: право)";
    strings["22xy: Set panning of operator 3 (x: left; y: right)"].plurals[0] = "22xy: Панорамирование оператора 3 (x: лево; y: право)";
    strings["23xy: Set panning of operator 4 (x: left; y: right)"].plurals[0] = "23xy: Панорамирование оператора 4 (x: лево; y: право)";
    strings["24xy: Set output level register (x: operator from 1 to 4 (0 for all ops); y: level from 0 to 7)"].plurals[0] = "24xy: Регистр выходного уровня (громкости) (x: оператор 1-4 (0 для всех операторов); y: уровень 0-7)";
    strings["25xy: Set modulation input level (x: operator from 1 to 4 (0 for all ops); y: level from 0 to 7)"].plurals[0] = "25xy: Уровень входной модуляции (x: оператор 1-4 (0 для всех операторов); y: уровень 0-7)";
    strings["26xy: Set envelope delay (x: operator from 1 to 4 (0 for all ops); y: delay from 0 to 7)"].plurals[0] = "26xy: Задержка огибающей (x: оператор 1-4 (0 для всех операторов); y: задержка 0-7)";
    strings["27xx: Set noise mode for operator 4 (x: mode from 0 to 3)"].plurals[0] = "27xx: Режим шума для оператора 4 (x: режим 0-3)";
    strings["2Axy: Set waveform (x: operator from 1 to 4 (0 for all ops); y: waveform from 0 to 7)1"].plurals[0] = "2Axy: Форма волны (x: оператор 1-4 (0 для всех операторов); y: форма волны 0-7)";
    strings["2Fxy: Set fixed frequency block (x: operator from 1 to 4; y: octave from 0 to 7)"].plurals[0] = "2Fxy: Блок в режиме фиксированной частоты (x: оператор 1-4; y: октава 0-7)";
    strings["40xx: Set detune of operator 1 (80: center)"].plurals[0] = "40xx: Расстройка оператора 1 (80: без расстройки)";
    strings["41xx: Set detune of operator 2 (80: center)"].plurals[0] = "41xx: Расстройка оператора 2 (80: без расстройки)";
    strings["42xx: Set detune of operator 3 (80: center)"].plurals[0] = "42xx: Расстройка оператора 3 (80: без расстройки)";
    strings["43xx: Set detune of operator 4 (80: center)"].plurals[0] = "43xx: Расстройка оператора 4 (80: без расстройки)";
    strings["50xy: Set AM (x: operator from 1 to 4 (0 for all ops); y: AM)2"].plurals[0] = "50xy: Включить АМ (x: оператор 1-4 (0 для всех операторов); y: АМ)";
    strings["51xy: Set sustain level (x: operator from 1 to 4 (0 for all ops); y: sustain)2"].plurals[0] = "51xy: Уровень сустейна (x: оператор 1-4 (0 для всех операторов); y: сустейн)";
    strings["52xy: Set release (x: operator from 1 to 4 (0 for all ops); y: release)2"].plurals[0] = "52xy: Релиз (x: оператор 1-4 (0 для всех операторов); y: релиз)";
    strings["53xy: Set vibrato (x: operator from 1 to 4 (0 for all ops); y: enabled)1"].plurals[0] = "53xy: Вибрато (x: оператор 1-4 (0 для всех операторов); y: вкл.)";
    strings["54xy: Set envelope scale (x: operator from 1 to 4 (0 for all ops); y: scale from 0 to 3)2"].plurals[0] = "54xy: Масш. огиб. (x: оператор 1-4 (0 для всех операторов); y: масш. 0-3)";
    strings["55xy: Set envelope sustain (x: operator from 1 to 4 (0 for all ops); y: enabled)1"].plurals[0] = "55xy: Сустейн огибающей (x: оператор 1-4 (0 для всех операторов); y: вкл.)";
    strings["56xx: Set decay of all operators (0 to F)2"].plurals[0] = "56xx: Спад всех операторов (0-F)";
    strings["57xx: Set decay of operator 1 (0 to F)2"].plurals[0] = "57xx: Спад оператора 1 (0-F)";
    strings["58xx: Set decay of operator 2 (0 to F)2"].plurals[0] = "58xx: Спад оператора 2 (0-F)";
    strings["59xx: Set decay of operator 3 (0 to F)1"].plurals[0] = "59xx: Спад оператора 3 (0-F)";
    strings["5Axx: Set decay of operator 4 (0 to F)1"].plurals[0] = "5Axx: Спад оператора 4 (0-F)";
    strings["5Bxy: Set whether key will scale envelope (x: operator from 1 to 4 (0 for all ops); y: enabled)1"].plurals[0] = "5Bxy: Масштаб. огиб. в зав. от ноты (x: оператор 1-4 (0 для всех операторов); y: вкл.)";
    strings["3xyy: Set fixed frequency F-num of operator 1 (x: high 2 bits from 0 to 3; y: low 8 bits of F-num)"].plurals[0] = "3xyy: Частота в режиме фиксированной частоты для оператора 1 (x: два старших бита 0-3; y: 8 младших битов частоты)";
    strings["3xyy: Set fixed frequency F-num of operator 2 (x: high 2 bits from 4 to 7; y: low 8 bits of F-num)"].plurals[0] = "3xyy: Частота в режиме фиксированной частоты для оператора 2 (x: два старших бита 4-7; y: 8 младших битов частоты)";
    strings["3xyy: Set fixed frequency F-num of operator 3 (x: high 2 bits from 8 to B; y: low 8 bits of F-num)"].plurals[0] = "3xyy: Частота в режиме фиксированной частоты для оператора 3 (x: два старших бита 8-B; y: 8 младших битов частоты)";
    strings["3xyy: Set fixed frequency F-num of operator 4 (x: high 2 bits from C to F; y: low 8 bits of F-num)"].plurals[0] = "3xyy: Частота в режиме фиксированной частоты для оператора 4 (x: два старших бита C-F; y: 8 младших битов частоты)";
    strings["10xx: Set waveform (bit 0: triangle; bit 1: saw; bit 2: pulse; bit 3: noise)1"].plurals[0] = "10xx: Форма волны (бит 0: треуг.; бит 1: пила; бит 2: прямоуг.; бит 3: шум)";
    strings["11xx: Set resonance (0 to FF)"].plurals[0] = "11xx: Резонанс (0-FF)";
    strings["12xx: Set filter mode (bit 0: low pass; bit 1: band pass; bit 2: high pass)"].plurals[0] = "12xx: Режим фильтра (бит 0: ФНЧ; бит 1: ППФ; бит 2: ФВЧ)";
    strings["13xx: Disable envelope reset for this channel (1 disables; 0 enables)"].plurals[0] = "13xx: Отключить ресет огибающей для этого канала (1 выкл.; 0 вкл.)";
    strings["14xy: Reset cutoff (x: on new note; y: now)"].plurals[0] = "14xy: Сбросить частоту среза (x: на след. ноте; y: сейчас)";
    strings["15xy: Reset pulse width (x: on new note; y: now)"].plurals[0] = "15xy: Сбросить скважность (x: на след. ноте; y: сейчас)";
    strings["16xy: Change other parameters"].plurals[0] = "16xy: Изменить другие параметры";
    strings["17xx: Pulse width slide up"].plurals[0] = "17xx: Изменение скважности вверх";
    strings["18xx: Pulse width slide down"].plurals[0] = "18xx: Изменение скважности вниз";
    strings["19xx: Cutoff slide up"].plurals[0] = "19xx: Изменение частоты среза вверх";
    strings["1Axx: Cutoff slide down"].plurals[0] = "1Axx: Изменение частоты среза вниз";
    strings["3xxx: Set pulse width (0 to FFF)1"].plurals[0] = "3xxx: Скважность (0-FFF)";
    strings["4xxx: Set cutoff (0 to FFF)1"].plurals[0] = "4xxx: Частота среза (0-FFF)";
    strings["a chip which found its way inside mobile phones in the 2000's.\nas proprietary as it is, it passed away after losing to MP3 in the mobile hardware battle."].plurals[0] = "чип, начавший появляться в мобильных телефонах в 2000-ые.\nнесмотря на проприетарность, он проиграл формату MP3 во время соперничества разных видов мобильного железа.";
    strings["<COMPOUND SYSTEM!>"].plurals[0] = "<СОСТАВНАЯ СИСТЕМА!>";
    strings["<COMPOUND SYSTEM!>1"].plurals[0] = "<СОСТАВНАЯ СИСТЕМА!>";
    strings["a square/noise sound chip found on the Sega Master System, ColecoVision, Tandy, TI's own 99/4A and a few other places."].plurals[0] = "чип с квадратными волнами и шумом, который был установлен в Sega Master System, ColecoVision, Tandy, собственном устройстве TI 99/4A и некоторых других местах.";
    strings["20xy: Set noise mode (x: preset freq/ch3 freq; y: thin pulse/noise)"].plurals[0] = "20xy: Режим шума (x: фикс. част./част. 3-го кан.; y: \"тонкая\" прямоуг. аолна/шум)";
    strings["<COMPOUND SYSTEM!>2"].plurals[0] = "<СОСТАВНАЯ СИСТЕМА!>";
    strings["the most popular portable game console of the era."].plurals[0] = "самая популярная портативная игровая консоль той эпохи.";
    strings["10xx: Set waveform1"].plurals[0] = "10xx: Волна";
    strings["11xx: Set noise length (0: long; 1: short)"].plurals[0] = "11xx: Длина шума (0: длинный; 1: короткий)";
    strings["12xx: Set duty cycle (0 to 3)"].plurals[0] = "12xx: Скважность (0-3)";
    strings["13xy: Setup sweep (x: time; y: shift)"].plurals[0] = "13xy: Сконфигурировать аппаратное портаменто (x: длительность; y: расстояние)";
    strings["14xx: Set sweep direction (0: up; 1: down)"].plurals[0] = "14xx: Направление аппаратного портаменто (0: вверх; 1: вниз)";
    strings["15xx: Set waveform (local)"].plurals[0] = "15xx: Волна (локальная)";
    strings["an '80s game console with a wavetable sound chip, popular in Japan."].plurals[0] = "игровая консоль из 80-ых с чипом на волновых таблицах. Была популярна в Японии.";
    strings["10xx: Set waveform2"].plurals[0] = "10xx: Волна";
    strings["11xx: Toggle noise mode"].plurals[0] = "11xx: Переключить режим шума";
    strings["12xx: Setup LFO (0: disabled; 1: 1x depth; 2: 16x depth; 3: 256x depth)"].plurals[0] = "12xx: Настроить ГНЧ (0: выкл.; 1: глубина 1x; 2: глубина 16x; 3: глубина 256x)";
    strings["13xx: Set LFO speed"].plurals[0] = "13xx: Частота ГНЧ";
    strings["17xx: Toggle PCM mode (LEGACY)1"].plurals[0] = "17xx: Переключить режим ИКМ (СОВМЕСТИМОСТЬ)";
    strings["18xx: Set waveform (local)"].plurals[0] = "18xx: Волна (локальная)";
    strings["also known as Famicom in Japan, it's the most well-known game console of the '80s."].plurals[0] = "также известная в Японии как Famicom. Самая известная игровая консоль 80-ых.";
    strings["11xx: Write to delta modulation counter (0 to 7F)"].plurals[0] = "11xx: Запись в регистр дельта-счётчика (0-7F)";
    strings["12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1)"].plurals[0] = "12xx: Скважность/режим шума (меандр: 0-3; шум: 0 или 1)";
    strings["13xy: Sweep up (x: time; y: shift)"].plurals[0] = "13xy: Аппаратное портаменто вверх (x: время; y: сдвиг)";
    strings["14xy: Sweep down (x: time; y: shift)"].plurals[0] = "14xy: Аппаратное портаменто вниз (x: время; y: сдвиг)";
    strings["15xx: Set envelope mode (0: envelope, 1: length, 2: looping, 3: constant)"].plurals[0] = "15xx: Режим огибающей (0: огибающая, 1: длина, 2: цикл, 3: постоянная)";
    strings["16xx: Set length counter (refer to manual for a list of values)"].plurals[0] = "16xx: Счётчик длины (список значений см. в инструкции)";
    strings["17xx: Set frame counter mode (0: 4-step, 1: 5-step)"].plurals[0] = "17xx: Режим счётчика кадров (0: 4 шага, 1: 5 шагов)";
    strings["18xx: Select PCM/DPCM mode (0: PCM; 1: DPCM)"].plurals[0] = "18xx: Выбрать режим ИКМ/ДИКМ (0: ИКМ; 1: ДИКМ)";
    strings["19xx: Set triangle linear counter (0 to 7F; 80 and higher halt)"].plurals[0] = "19xx: Линейный счётчик треуг. волны (0-7F; 80 и выше мгновенно останавливают волну)";
    strings["20xx: Set DPCM frequency (0 to F)"].plurals[0] = "20xx: Частота ДИКМ (0-F)";
    strings["<COMPOUND SYSTEM!>3"].plurals[0] = "<СОСТАВНАЯ СИСТЕМА!>";
    strings["<COMPOUND SYSTEM!>4"].plurals[0] = "<СОСТАВНАЯ СИСТЕМА!>";
    strings["this computer is powered by the SID chip, which had synthesizer features like a filter and ADSR."].plurals[0] = "в этом компьютере стоит чип SID, который имеет продвинутый функционал, присущий синтезаторам, например, фильтр и ADSR-огибающую.";
    strings["this computer is powered by the SID chip, which had synthesizer features like a filter and ADSR.\nthis is the newer revision of the chip."].plurals[0] = "в этом компьютере стоит чип SID, который имеет продвинутый функционал, присущий синтезаторам, например, фильтр и ADSR-огибающую.\nЭто более новая ревизия чипа.";
    strings["<COMPOUND SYSTEM!>5"].plurals[0] = "<СОСТАВНАЯ СИСТЕМА!>";
    strings["like Neo Geo, but lacking the ADPCM-B channel since they couldn't connect the pins."].plurals[0] = "как Neo Geo, но без канала АДИКМ-B, потому что они не смогли подключить пины.";
    strings["like Neo Geo, but lacking the ADPCM-B channel since they couldn't connect the pins.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies."].plurals[0] = "как Neo Geo, но без канала АДИКМ-B, потому что они не смогли подключить пины.\nЭто версия в режиме расширенного канала, который превращает второй FM-канал в четыре оператора с независимыми нотами/частотами.";
    strings["this chip is everywhere! ZX Spectrum, MSX, Amstrad CPC, Intellivision, Vectrex...\nthe discovery of envelope bass helped it beat the SN76489 with ease."].plurals[0] = "этот чип везде! ZX Spectrum, MSX, Amstrad CPC, Intellivision, Vectrex...\nОткрытие метода использования огибающей для баса легко позволило этому чипу победить SN76489.";
    strings["a computer from the '80s with full sampling capabilities, giving it a sound ahead of its time."].plurals[0] = "компьютер из 80-ых с полноценными возможностями сэмплирования, что давало ему звучание, опережавшее его эпоху.";
    strings["10xx: Toggle filter (0 disables; 1 enables)"].plurals[0] = "10xx: Переключить фильтр (0 выкл.; 1 вкл.)";
    strings["11xx: Toggle AM with next channel"].plurals[0] = "11xx: Переключить АМ со следующим каналом";
    strings["12xx: Toggle period modulation with next channel"].plurals[0] = "12xx: Переключить модуляцию периода со следующим каналом";
    strings["13xx: Set waveform"].plurals[0] = "13xx: Волна";
    strings["14xx: Set waveform (local)"].plurals[0] = "14xx: Волна (локлаьная)";
    ...
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer)."].plurals[0] = "этот чип в основном известен по причине того, что он находился в Sega Genesis (но он также использовался в компьютере FM Towns).";
    strings["it's a challenge to make music on this chip which barely has musical capabilities..."].plurals[0] = "на этом чипе очень сложно писать музыку, ведь он едва ли обладает музыкальными возможностями...";
    strings["supposedly an upgrade from the AY-3-8910, this was present on the Creative Music System (Game Blaster) and SAM Coupé."].plurals[0] = "этот чип, судя по всему, улучшенная версия AY-3-8910, использовался в Creative Music System (Game Blaster) и SAM Coupé.";
    strings["10xy: Set channel mode (x: noise; y: tone)"].plurals[0] = "10xy: Режим канала (x: шум; y: тон)";
    strings["11xx: Set noise frequency"].plurals[0] = "11xx: Частота шума";
    strings["12xx: Setup envelope (refer to docs for more information)"].plurals[0] = "12xx: Настройка огибающей (см. инструкцию)";
    strings["an improved version of the AY-3-8910 with a bigger frequency range, duty cycles, configurable noise and per-channel envelopes!"].plurals[0] = "улучшенная версия AY-3-8910 с большим диапазоном частот, настройкой скважности, настраиваемым шумом и огибающей на каждый канал!";
    strings["Commodore's successor to the PET.\nits square wave channels are more than just square..."].plurals[0] = "Компьютер Commodore, вышедший после PET.\nего каналы квадратных волн могут играть не только лишь квадратные волны...";
    strings["one channel of 1-bit wavetable which is better (and worse) than the PC Speaker."].plurals[0] = "один канал 1-битной волновой таблицы, что лучше (или хуже), чем PC Speaker (пищалка).";
    strings["FM? nah... samples! Nintendo's answer to Sega."].plurals[0] = "FM? не... сэмплы! Ответ Nintendo в сторону Sega.";
    strings["18xx: Enable echo buffer"].plurals[0] = "18xx: Включить эхо-буфер";
    strings["19xx: Set echo delay (0 to F)"].plurals[0] = "19xx: Задержка эхо (0-F)";
    strings["1Axx: Set left echo volume"].plurals[0] = "1Axx: Громкость эхо на левом канале";
    strings["1Bxx: Set right echo volume"].plurals[0] = "1Bxx: Громкость эхо на правом канале";
    strings["1Cxx: Set echo feedback"].plurals[0] = "1Cxx: Обратная связь эхо";
    strings["1Exx: Set dry output volume (left)"].plurals[0] = "1Exx: Громкость канала (лево)";
    strings["1Fxx: Set dry output volume (right)"].plurals[0] = "1Fxx: Громкость канала (право)";
    strings["30xx: Set echo filter coefficient 0"].plurals[0] = "30xx: Коэффициент 0 фильтра эхо";
    strings["31xx: Set echo filter coefficient 1"].plurals[0] = "31xx: Коэффициент 1 фильтра эхо";
    strings["32xx: Set echo filter coefficient 2"].plurals[0] = "32xx: Коэффициент 2 фильтра эхо";
    strings["33xx: Set echo filter coefficient 3"].plurals[0] = "33xx: Коэффициент 3 фильтра эхо";
    strings["34xx: Set echo filter coefficient 4"].plurals[0] = "34xx: Коэффициент 4 фильтра эхо";
    strings["35xx: Set echo filter coefficient 5"].plurals[0] = "35xx: Коэффициент 5 фильтра эхо";
    strings["36xx: Set echo filter coefficient 6"].plurals[0] = "36xx: Коэффициент 6 фильтра эхо";
    strings["37xx: Set echo filter coefficient 7"].plurals[0] = "37xx: Коэффициент 7 фильтра эхо";
    strings["10xx: Set waveform3"].plurals[0] = "10xx: Волна";
    strings["11xx: Toggle noise mode1"].plurals[0] = "11xx: Переключить режим шума";
    strings["12xx: Toggle echo on this channel"].plurals[0] = "12xx: Переключить эхо наэтом канале";
    strings["13xx: Toggle pitch modulation"].plurals[0] = "13xx: Переключить частотную модуляцию";
    strings["14xy: Toggle invert (x: left; y: right)"].plurals[0] = "14xy: Переключить инвертирование сигнала (x: левый; y: правый)";
    strings["15xx: Set envelope mode (0: ADSR, 1: gain/direct, 2: dec, 3: exp, 4: inc, 5: bent)"].plurals[0] = "15xx: Режим огибающей (0: ADSR, 1: усиление/прямой, 2: спад, 3: экспоненциальная, 4: нарастание, 5: изогн.)";
    strings["16xx: Set gain (00 to 7F if direct; 00 to 1F otherwise)"].plurals[0] = "16xx: Усиление (00-7F в прямом режиме; иначе 00-1F)";
    strings["17xx: Set waveform (local)"].plurals[0] = "17xx: Волна (локальная)";
    strings["1Dxx: Set noise frequency (00 to 1F)"].plurals[0] = "1Dxx: Частота шума (00-1F)";
    strings["20xx: Set attack (0 to F)"].plurals[0] = "20xx: Атака (0-F)";
    strings["21xx: Set decay (0 to 7)"].plurals[0] = "21xx: Спад (0-7)";
    strings["22xx: Set sustain (0 to 7)"].plurals[0] = "22xx: Сустейн (0-7)";
    strings["23xx: Set release (00 to 1F)"].plurals[0] = "23xx: Релиз (00-1F)";
    strings["an expansion chip for the Famicom, featuring a quirky sawtooth channel."].plurals[0] = "чип расширения для Famicom, содержащий своеобразный канал пилообразной волны.";
    strings["12xx: Set duty cycle (pulse: 0 to 7)"].plurals[0] = "12xx: Скважность (меандр: 0-7)";
    strings["17xx: Toggle PCM mode (LEGACY)2"].plurals[0] = "17xx: Переключить режим ИКМ (СОВМЕСТИМОСТЬ)";
    strings["cost-reduced version of the OPL with 16 patches and only one of them is user-configurable."].plurals[0] = "удешевлённая версия OPL с 16-ю патчами, причём только один из них доступен для настройки пользователем.";
    strings["a disk drive for the Famicom which also contains one wavetable channel."].plurals[0] = "дисковый привод для Famicom, также содержащий один канал волновых таблиц.";
    strings["10xx: Set waveform4"].plurals[0] = "10xx: Волна";
    strings["11xx: Set modulation depth"].plurals[0] = "11xx: Глубина модуляции";
    strings["12xy: Set modulation speed high byte (x: enable; y: value)"].plurals[0] = "12xy: Старший байт скорости модуляции (x: вкл.; y: значение)";
    strings["13xx: Set modulation speed low byte"].plurals[0] = "13xx: Младший байт скорости модуляции";
    strings["14xx: Set modulator position"].plurals[0] = "14xx: Положение модулятора";
    strings["15xx: Set modulator table to waveform"].plurals[0] = "15xx: Назначить таблицу модуляции волны";
    strings["16xx: Set waveform (local)"].plurals[0] = "16xx: Волна (локальная)";
    strings["an expansion chip for the Famicom, featuring a little-known PCM channel."].plurals[0] = "чип расширения для Famicom, имеющий малоизвестный канал ИКМ-сэмплов.";
    strings["12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1)1"].plurals[0] = "12xx: Скважность/режим шума (меандр: 0-3; шум: 0 или 1)";
    strings["an expansion chip for the Famicom, with full wavetable."].plurals[0] = "чип расширения для Famicom, полностью на волновых таблицах.";
    strings["18xx: Change channel limits (0 to 7, x + 1)"].plurals[0] = "18xx: Изменить лимит каналов (0-7, x + 1)";
    strings["20xx: Load a waveform into memory"].plurals[0] = "20xx: Загрузить волну в память";
    strings["21xx: Set position for wave load"].plurals[0] = "21xx: Задать начальное смещение для загрузки волны";
    strings["10xx: Select waveform"].plurals[0] = "10xx: Выбрать волну";
    strings["11xx: Set waveform position in RAM"].plurals[0] = "11xx: Задать положение волны в ОЗУ";
    strings["12xx: Set waveform length in RAM (04 to FC in steps of 4)"].plurals[0] = "12xx: Задать длину волны в ОЗУ (04-FC с шагом 4)";
    strings["15xx: Set waveform load position"].plurals[0] = "15xx: Задать положение для загрузки волны";
    strings["16xx: Set waveform load length (04 to FC in steps of 4)"].plurals[0] = "16xx: Задать длину загружаемой волны (04-FC с шагом 4)";
    strings["17xx: Select waveform (local)1"].plurals[0] = "17xx: Волна (локальная)";
    strings["cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)"].plurals[0] = "удешевлённая версия OPM с другим расположением регистров и отсутствием стерео...\n...но у неё внутри AY-3-8910! (на самом деле YM2149)";
    strings["cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies"].plurals[0] = "удешевлённая версия OPM с другим расположением регистров и отсутствием стерео...\n...но у неё внутри AY-3-8910! (на самом деле YM2149)\nЭто версия в режиме расширенного канала, который превращает третий FM-канал в четыре оператора с независимыми нотами/частотами.";
    strings["cost-reduced version of the OPM with a different register layout and no stereo...\n...but it has a built-in AY-3-8910! (actually an YM2149)\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "удешевлённая версия OPM с другим расположением регистров и отсутствием стерео...\n...но у неё внутри AY-3-8910! (на самом деле YM2149)\nЭто версия в режиме расширенного канала, который превращает третий FM-канал в четыре оператора с независимыми нотами/частотами.\nУ этой версии есть контроль режима CSM для специальных эффектов на третьем канале.";
    strings["OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels."].plurals[0] = "OPN, но вдвое больше FM-каналов, возвращённое стерео, ритм- и АДИКМ каналы.";
    strings["OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies"].plurals[0] = "OPN, но вдвое больше FM-каналов, возвращённое стерео, ритм- и АДИКМ каналы.\nЭто версия в режиме расширенного канала, который превращает третий FM-канал в четыре оператора с независимыми нотами/частотами.";
    strings["OPN but twice the FM channels, stereo makes a come-back and has rhythm and ADPCM channels.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "OPN, но вдвое больше FM-каналов, возвращённое стерео, ритм- и АДИКМ каналы.\nЭто версия в режиме расширенного канала, который превращает третий FM-канал в четыре оператора с независимыми нотами/частотами.\nУ этой версии есть контроль режима CSM для специальных эффектов на третьем канале.";
    strings["OPN, but what if you only had two operators, no stereo, no detune and a lower ADSR parameter range?"].plurals[0] = "OPN, но что если у него всего два оператора, нет стерео, нет расстройки и меньший диапазон регулировки параметров ADSR?";
    strings["OPL, but what if you had more waveforms to choose than the normal sine?"].plurals[0] = "OPL, но что если у него есть ещё волны, помимо синусоиды?";
    strings["OPL2, but what if you had twice the channels, 4-op mode, stereo and even more waveforms?"].plurals[0] = "OPL2, но что если у него вдвое больше каналов, 4-оп режим, стерео и ещё больше волн?";
    strings["how many channels of PCM do you want?\nMultiPCM: yes"].plurals[0] = "Сколько каналов ИКМ-сэмплов вам нужно?\nMultiPCM: да";
    strings["good luck! you get one square and no volume control."].plurals[0] = "удачи! у вас один канал меандра и нет регулировки громкости.";
    strings["please don't use this chip. it was added as a joke."].plurals[0] = "пожалуйста, не используйте этот чип. он был добавлен в качестве шутки.";
    strings["TIA, but better and more flexible.\nused in the Atari 8-bit family of computers (400/800/XL/XE)."].plurals[0] = "TIA, но лучше и более гибкий.\nиспользовался в семействе 8-битных компьютеров Atari (400/800/XL/XE).";
    strings["10xx: Set waveform (0 to 7)"].plurals[0] = "10xx: Волна (0-7)";
    strings["11xx: Set AUDCTL"].plurals[0] = "11xx: Установить AUDCTL";
    strings["12xx: Toggle two-tone mode"].plurals[0] = "12xx: Переключить двухголосый режим";
    strings["13xx: Set raw period"].plurals[0] = "13xx: \"Сырое\" значение периода";
    strings["14xx: Set raw period (higher byte; only for 16-bit mode)"].plurals[0] = "14xx: \"Сырое\" значение периода (старший байт; только для 16-битного режима)";
    strings["this is like SNES' sound chip but without interpolation and the rest of nice bits."].plurals[0] = "похоже на звуковой чип SNES, но без интерполяции и других приятных вещей.";
    strings["developed by the makers of the Game Boy and the Virtual Boy..."].plurals[0] = "от создателей Game Boy и Virtual Boy...";
    strings["10xx: Set waveform5"].plurals[0] = "10xx: Волна";
    strings["11xx: Setup noise mode (0: disabled; 1-8: enabled/tap)"].plurals[0] = "11xx: Настроить режим шума (0: выкл.; 1-8: вкл./отвод)";
    strings["12xx: Setup sweep period (0: disabled; 1-20: enabled/period)"].plurals[0] = "12xx: Настроить период аппаратного портаменто (0: выкл.; 1-20: вкл./период)";
    strings["13xx: Set sweep amount"].plurals[0] = "13xx: Скорость аппаратного портаменто";
    strings["17xx: Toggle PCM mode (LEGACY)3"].plurals[0] = "17xx: Переключить режим ИКМ (СОВМЕСТИМОСТЬ)";
    strings["18xx: Set waveform (local)1"].plurals[0] = "18xx: Волна (локальная)";
    strings["like OPM, but with more waveforms, fixed frequency mode and totally... undocumented.\nused in the Yamaha TX81Z and some other synthesizers."].plurals[0] = "как OPM, но с большим количеством волн, режимом фиксированной частоты, и полным... отсутствием сведений о его устройстве.\nиспользовался в Yamaha TX81Z и некоторых других синтезаторах.";
    strings["2Fxx: Toggle hard envelope reset on new notes"].plurals[0] = "2Fxx: Переключить жёсткий перезапуск огибающей на новой ноте";
    strings["this one is like PC Speaker but has duty cycles."].plurals[0] = "Похож на PC Speaker, но имеет настройку скважности.";
    strings["used in some Sega arcade boards (like OutRun), and usually paired with a YM2151."].plurals[0] = "использовался в некоторых аркадных автоматах Sega (например, OutRun), и обычно использовался в связке с YM2151.";
    strings["a console which failed to sell well due to its headache-inducing features."].plurals[0] = "консоль, продажи которой не удались из-за того, что её особенности вызывали головную боль у игроков.";
    strings["10xx: Set waveform6"].plurals[0] = "10xx: Волна";
    strings["11xx: Set noise length (0 to 7)"].plurals[0] = "11xx: Длина шума (0-7)";
    strings["12xy: Setup envelope (x: enabled/loop (1: enable, 3: enable+loop); y: speed/direction (0-7: down, 8-F: up))"].plurals[0] = "12xy: Настройка огибающей (x: вкл./цикл (1: вкл., 3: вкл.+цикл); y: скорость/направление (0-7: вниз, 8-F: вверх))";
    strings["13xy: Setup sweep (x: speed; y: shift; channel 5 only)"].plurals[0] = "13xy: Настройка аппаратного портаменто (x: скорость; y: количество; только для 5-го канала)";
    strings["14xy: Setup modulation (x: enabled/loop (1: enable, 3: enable+loop); y: speed; channel 5 only)"].plurals[0] = "14xy: Настроить модуляцию (x: вкл./цикл (1: вкл., 3: вкл.+цикл); y: скорость; только для 5-го канала)";
    strings["15xx: Set modulation waveform (x: wavetable; channel 5 only)"].plurals[0] = "15xx: Настройка волны модулятора (x: волновая таблица; только для 5-го канала)";
    strings["16xx: Set waveform (local)1"].plurals[0] = "16xx: Волна (локальная)";
    strings["like OPLL, but even more cost reductions applied. three less FM channels, and no drums mode..."].plurals[0] = "как OPLL, но ещё более удешевлённый. на три канала меньше, нет режима ударных...";
    strings["so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip."].plurals[0] = "Taito попросили Yamaha вернуть два отсутствующих FM-канала, и Yamaha с радостью предоставила им этот чип.";
    strings["the ZX Spectrum only had a basic beeper capable of...\n...a bunch of thin pulses and tons of other interesting stuff!\nFurnace provides a thin pulse system."].plurals[0] = "ZX Spectrum имел только пищалку, способную на...\n...несколько \"тонких\" прямоугольных волн и множество других интересных вещей!\nFurnace предоставляет систему с \"тонкими\" прямоугольными волнами.";
    strings["12xx: Set pulse width"].plurals[0] = "12xx: Скважность";
    strings["17xx: Trigger overlay drum"].plurals[0] = "17xx: Запуск перекрывающего ударного инструмента";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies."].plurals[0] = "этот чип в основном известен по причине того, что он находился в Sega Genesis (но он также использовался в компьютере FM Towns).\nЭто версия в режиме расширенного канала, который превращает третий FM-канал в четыре оператора с независимыми нотами/частотами.";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "этот чип в основном известен по причине того, что он находился в Sega Genesis (но он также использовался в компьютере FM Towns).\nУ этой версии есть контроль режима CSM для специальных эффектов на третьем канале.";
    strings["a wavetable chip made by Konami for use with the MSX.\nthe last channel shares its wavetable with the previous one though."].plurals[0] = "чип с волновыми таблицами, сделанный Konami для использования с MSX.\nправда, последний и предпоследний каналы используют одну и ту же таблицу.";
    strings["the OPL chip but with drums mode enabled."].plurals[0] = "чип OPL, но с включённым режимом ударных.";
    strings["the OPL2 chip but with drums mode enabled."].plurals[0] = "чип OPL2, но с включённым режимом ударных.";
    strings["the OPL3 chip but with drums mode enabled."].plurals[0] = "чип OPL3, но с включённым режимом ударных.";
    strings["this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing."].plurals[0] = "этот чип использовался в аркадном автомате и игровой консоли Neo Geo от SNK.\nпохож на OPNA, но ритм-каналы теперь стали АДИКМ-каналами, и пропали два FM-канала.";
    strings["this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies."].plurals[0] = "этот чип использовался в аркадном автомате и игровой консоли Neo Geo от SNK.\nпохож на OPNA, но ритм-каналы теперь стали АДИКМ-каналами, и пропали два FM-канала.\nЭто версия в режиме расширенного канала, который превращает второй FM-канал в четыре оператора с независимыми нотами/частотами.";
    strings["this chip was used in SNK's Neo Geo arcade board and video game console.\nit's like OPNA but the rhythm channels are ADPCM channels and two FM channels went missing.\nthis one is in Extended Channel mode, which turns the second FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 2."].plurals[0] = "этот чип использовался в аркадном автомате и игровой консоли Neo Geo от SNK.\nпохож на OPNA, но ритм-каналы теперь стали АДИКМ-каналами, и пропали два FM-канала.\nЭто версия в режиме расширенного канала, который превращает второй FM-канал в четыре оператора с независимыми нотами/частотами.\nУ этой версии есть контроль режима CSM для специальных эффектов на втором канале.";
    strings["the OPLL chip but with drums mode turned on."].plurals[0] = "чип OPLL с включённым режимом ударных.";
    strings["3xxx: Load LFSR (0 to FFF)"].plurals[0] = "3xxx: Загрузить в РСЛОС (0-FFF)";
    strings["a portable console made by Atari. it has all of Atari's trademark waveforms."].plurals[0] = "портативная игровая консоль от Atari. у неё есть все фирменные волны Atari.";
    strings["10xx: Set echo feedback level (00 to FF)"].plurals[0] = "10xx: Уровень обратной связи эхо (00-FF)";
    strings["11xx: Set channel echo level (00 to FF)"].plurals[0] = "11xx: Уровень эхо на канале (00-FF)";
    strings["12xx: Toggle QSound algorithm (0: disabled; 1: enabled)"].plurals[0] = "12xx: Переключить алгоритм QSound (0: выкл.; 1: вкл.)";
    strings["3xxx: Set echo delay buffer length (000 to AA5)"].plurals[0] = "3xxx: Длина буфера задержки эхо (000-AA5)";
    strings["used in some of Capcom's arcade boards. surround-like sampled sound with echo."].plurals[0] = "использовался в некоторых аркадных автоматах Capcom. сэмпилрованный звук с эхо и эффектом окружающего звучания.";
    strings["the chip used in a computer design created by The 8-Bit Guy."].plurals[0] = "чип, используемый в модели компьютера, разработанного 8-Bit Guy.";
    strings["20xx: Set waveform"].plurals[0] = "20xx: Волна";
    strings["22xx: Set duty cycle (0 to 3F)"].plurals[0] = "22xx: Скважность (0-3F)";
    strings["so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies."].plurals[0] = "Taito попросили Yamaha вернуть два отсутствующих FM-канала, и Yamaha с радостью предоставила им этот чип.\nЭто версия в режиме расширенного канала, который превращает третий FM-канал в четыре оператора с независимыми нотами/частотами.";
    strings["so Taito asked Yamaha if they could get the two missing FM channels back, and Yamaha gladly provided them with this chip.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "Taito попросили Yamaha вернуть два отсутствующих FM-канала, и Yamaha с радостью предоставила им этот чип.\nЭто версия в режиме расширенного канала, который превращает третий FM-канал в четыре оператора с независимыми нотами/частотами.\nУ этой версии есть контроль режима CSM для специальных эффектов на третьем канале.";
    strings["this is the same thing as SegaPCM, but only exposes 5 of the channels for compatibility with DefleMask."].plurals[0] = "это то же самое, что и SegaPCM, но доступно всего пять каналов для совместимости с DefleMask.";
    strings["a sound chip used in several Seta/Allumer-manufactured arcade boards with too many channels of wavetable sound, which also are capable of sampled sound."].plurals[0] = "звуковой чип, использовавшийся в нескольких аркадных автоматах Seta/Allumer. имеет слишком много каналов волновых таблиц, способных так же воспроизводить сэмплы.";
    strings["10xx: Set waveform7"].plurals[0] = "10xx: Волна";
    strings["11xx: Set envelope shape"].plurals[0] = "11xx: Форма огибающей";
    strings["12xx: Set sample bank slot (0 to 7)"].plurals[0] = "12xx: Слот банка сэмплов (0-7)";
    strings["17xx: Toggle PCM mode (LEGACY)4"].plurals[0] = "17xx: Переключить режим ИКМ (СОВМЕСТИМОСТЬ)";
    strings["18xx: Set waveform (local)2"].plurals[0] = "18xx: Волна (локальная)";
    strings["20xx: Set PCM frequency (1 to FF)"].plurals[0] = "20xx: Частота ИКМ (1-FF)";
    strings["22xx: Set envelope mode (bit 0: enable; bit 1: one-shot; bit 2: split shape to L/R; bit 3/5: H.invert right/left; bit 4/6: V.invert right/left)"].plurals[0] = "22xx: Режим огибающей (бит 0: вкл.; бит 1: однокр.; бит 2: разделить форму на лево/право; биты 3/5: Г.инвертир. право/лево; бит 4/6: В.инвертир. право/лево)";
    strings["23xx: Set envelope period"].plurals[0] = "23xx: Период огибающей";
    strings["25xx: Envelope slide up1"].plurals[0] = "25xx: Портаменто огибающей вверх";
    strings["26xx: Envelope slide down1"].plurals[0] = "26xx: Портаменто огибающей вниз";
    strings["29xy: Set auto-envelope (x: numerator; y: denominator)1"].plurals[0] = "29xy: Авто-огибающая (x: числитель; y: знаменатель)";
    strings["this is the wavetable part of the Bubble System, which also had two AY-3-8910s."].plurals[0] = "это таблично-волновая часть Bubble System, которая так же имела два AY-3-8910.";
    strings["like OPL3, but this time it also has a 24-channel version of MultiPCM."].plurals[0] = "как OPL3, но на этот раз также имеется 24-канальная версия MultiPCM.";
    strings["the OPL4 but with drums mode turned on."].plurals[0] = "OPL4 с включёным режимом ударных.";
    strings["11xx: Set filter mode (00 to 03)"].plurals[0] = "11xx: Режим фильтра (00-03)";
    strings["14xx: Set filter coefficient K1 low byte (00 to FF)"].plurals[0] = "14xx: Младший байт коэффициента фильтра K1 (00-FF)";
    strings["15xx: Set filter coefficient K1 high byte (00 to FF)"].plurals[0] = "15xx: Старыший байт коэффициента фильтра K1 (00-FF)";
    strings["16xx: Set filter coefficient K2 low byte (00 to FF)"].plurals[0] = "16xx: Младший байт коэффициента фильтра K2 (00-FF)";
    strings["17xx: Set filter coefficient K2 high byte (00 to FF)"].plurals[0] = "17xx: Старыший байт коэффициента фильтра K2 (00-FF)";
    strings["18xx: Set filter coefficient K1 slide up (00 to FF)"].plurals[0] = "18xx: Нарастание коэффициента фильтра K1 (00-FF)";
    strings["19xx: Set filter coefficient K1 slide down (00 to FF)"].plurals[0] = "19xx: Уменьшение коэффициента фильтра K1 (00-FF)";
    strings["1Axx: Set filter coefficient K2 slide up (00 to FF)"].plurals[0] = "1Axx: Нарастание коэффициента фильтра K2 (00-FF)";
    strings["1Bxx: Set filter coefficient K2 slide down (00 to FF)"].plurals[0] = "1Bxx: Уменьшение коэффициента фильтра K2 (00 to FF)";
    strings["22xx: Set envelope left volume ramp (signed) (00 to FF)"].plurals[0] = "22xx: Нарастание огибающей громкости левого канала (знаковое) (00-FF)";
    strings["23xx: Set envelope right volume ramp (signed) (00 to FF)"].plurals[0] = "23xx: Нарастание огибающей громкости правого канала (знаковое) (00-FF)";
    strings["24xx: Set envelope filter coefficient k1 ramp (signed) (00 to FF)"].plurals[0] = "24xx: Нарастание огибающей коэффициента фильтра K1 (знаковое) (00-FF)";
    strings["25xx: Set envelope filter coefficient k1 ramp (signed, slower) (00 to FF)"].plurals[0] = "25xx: Нарастание огибающей коэффициента фильтра K1 (знаковое, медленнее) (00-FF)";
    strings["26xx: Set envelope filter coefficient k2 ramp (signed) (00 to FF)"].plurals[0] = "26xx: Нарастание огибающей коэффициента фильтра K2 (знаковое) (00-FF)";
    strings["27xx: Set envelope filter coefficient k2 ramp (signed, slower) (00 to FF)"].plurals[0] = "27xx: 25xx: Нарастание огибающей коэффициента фильтра K2 (знаковое, медленнее) (00-FF)";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)1"].plurals[0] = "DFxx: Направление проигрывания сэмпла (0: обычное; 1: обратное)";
    strings["120x: Set pause (bit 0)"].plurals[0] = "120x: Пауза (бит 0)";
    strings["2xxx: Set envelope count (000 to 1FF)"].plurals[0] = "2xxx: Отсчёт огибающей (000-1FF)";
    strings["3xxx: Set filter coefficient K1 (000 to FFF)"].plurals[0] = "3xxx: Коэффициент фильтра K1 (000-FFF)";
    strings["4xxx: Set filter coefficient K2 (000 to FFF)"].plurals[0] = "4xxx: Коэффициент фильтра K2 (000-FFF)";
    strings["a sample chip made by Ensoniq, which is the basis for the GF1 chip found in Gravis' Ultrasound cards."].plurals[0] = "сэмплерный чип от Ensoniq, на основе которго была сделан чип GF1, применявшийся в звуковых картах Gravis Ultrasound.";
    strings["like OPL but with an ADPCM channel."].plurals[0] = "как OPL, но с каналом АДИКМ-сэмплов.";
    strings["the Y8950 chip, in drums mode."].plurals[0] = "Чип Y8950 в режиме ударных.";
    strings["this is a variant of Konami's SCC chip with the last channel's wavetable being independent."].plurals[0] = "вариант чипа Konami SCC с независимой волновой таблицей последнего канала.";
    strings["10xx: Set waveform (0 to 7)1"].plurals[0] = "10xx: Волна (0-7)";
    strings["12xx: Set pulse width (0 to 7F)"].plurals[0] = "12xx: Скважность (0-7F)";
    strings["13xx: Set resonance (0 to FF)"].plurals[0] = "13xx: Резонанс (0-FF)";
    strings["14xx: Set filter mode (bit 0: ring mod; bit 1: low pass; bit 2: high pass; bit 3: band pass)"].plurals[0] = "14xx: Режим фильтра (бит 0: кольцевая модуляция; бит 1: ФНЧ; бит 2: ФВЧ; бит 3: ППФ)";
    strings["15xx: Set frequency sweep period low byte"].plurals[0] = "15xx: Младший байт аппаратного портаменто";
    strings["16xx: Set frequency sweep period high byte"].plurals[0] = "16xx: Старший байт аппаратного портаменто";
    strings["17xx: Set volume sweep period low byte"].plurals[0] = "17xx: Младший байт аппаратного изменения громкости";
    strings["18xx: Set volume sweep period high byte"].plurals[0] = "18xx: Старший байт аппаратного изменения громкости";
    strings["19xx: Set cutoff sweep period low byte"].plurals[0] = "19xx: Младший байт аппаратного изменения частоты среза";
    strings["1Axx: Set cutoff sweep period high byte"].plurals[0] = "1Axx: Старший байт аппаратного изменения частоты среза";
    strings["1Bxx: Set frequency sweep boundary"].plurals[0] = "1Bxx: Граница аппаратного портаменто";
    strings["1Cxx: Set volume sweep boundary"].plurals[0] = "1Cxx: Граница аппаратного изменения громкости";
    strings["1Dxx: Set cutoff sweep boundary"].plurals[0] = "1Dxx: Граница аппаратного изменения частоты среза";
    strings["1Exx: Set phase reset period low byte"].plurals[0] = "1Exx: Младший байт периода сброса фазы";
    strings["1Fxx: Set phase reset period high byte"].plurals[0] = "1Fxx: Старший байт периода сброса фазы";
    strings["20xx: Toggle frequency sweep (bit 0-6: speed; bit 7: direction is up)"].plurals[0] = "20xx: Переключить аппаратное портаменто (биты 0-6: скорость; бит 7: направление вверх)";
    strings["21xx: Toggle volume sweep (bit 0-4: speed; bit 5: direction is up; bit 6: loop; bit 7: alternate)"].plurals[0] = "21xx: Переключить аппаратное изменение громкости (биты 0-4: скорость; бит 5: направление вверх; бит 6: цикл; бит 7: вверх-вниз)";
    strings["22xx: Toggle cutoff sweep (bit 0-6: speed; bit 7: direction is up)"].plurals[0] = "22xx: Переключить аппаратное изменение частоты среза фильтра (бит 0-6: скорость; бит 7: направление вверх)";
    strings["4xxx: Set cutoff (0 to FFF)"].plurals[0] = "4xxx: Частота среза (0-FFF)";
    strings["tildearrow's fantasy sound chip. put SID, AY and VERA in a blender, and you get this!"].plurals[0] = "вымышленный звуковой чип tildearrow. загрузите в блендер SID, AY и VERA, и вы получите этот чип!";
    strings["an ADPCM sound chip manufactured by OKI and used in many arcade boards."].plurals[0] = "АДИКМ звуковой чип фирмы OKI. Использовался во многих аркадных автоматах.";
    strings["20xx: Set chip output rate (0: clock/132; 1: clock/165)"].plurals[0] = "20xx: Частота дискретизации выходного сигнала (0: тактовая частота/132; 1: тактовая частота/165)";
    strings["an ADPCM sound chip manufactured by OKI and used in the Sharp X68000."].plurals[0] = "АДИКМ звуковой чип фирмы OKI, использовавшийся в Sharp X68000.";
    strings["20xx: Set frequency divider (0-2)"].plurals[0] = "20xx: Делитель частоты (0-2)";
    strings["21xx: Select clock rate (0: full; 1: half)"].plurals[0] = "21xx: Тактовая частота (0: полная; 1: половинная)";
    strings["used in some arcade boards. Can play back either 4-bit ADPCM, 8-bit PCM or 16-bit PCM."].plurals[0] = "использовался в некоторых аркадных автоматах. Может воспроизводить 4-битные АДИКМ, 8- и 16-битные ИКМ сэмплы.";
    strings["10xx: Set waveform8"].plurals[0] = "10xx: Волна";
    strings["11xx: Select waveform (local)1"].plurals[0] = "11xx: Волна (локальная)";
    strings["10xx: Set waveform9"].plurals[0] = "10xx: Волна";
    strings["11xx: Toggle noise mode2"].plurals[0] = "11xx: Переключить режим шума";
    strings["a wavetable sound chip used in Pac-Man, among other early Namco arcade games."].plurals[0] = "таблично-волновой чип, использовавшийся в игровом автомате Pac-Man и других ранних автоматах Namco.";
    strings["successor of the original Namco WSG chip, used in later Namco arcade games."].plurals[0] = "следующая модель после Namco WSG, использовался в поздних игровых автоматах Namco.";
    strings["like Namco C15 but with stereo sound."].plurals[0] = "похож на Namco C15, но с поддержкой стерео.";
    strings["a square wave additive synthesis chip made by OKI. used in some arcade machines and instruments."].plurals[0] = "чип с меандрами и аддитивным синтезом от фирмы OKI. использовался в некоторых игровых автоматах и инструментах.";
    strings["10xy: Set group control (x: sustain; y: part toggle bitmask)"].plurals[0] = "10xy: Контроль группы (x: сустейн; y: битовая маска частей)";
    strings["11xx: Set noise mode"].plurals[0] = "11xx: Режим шума";
    strings["12xx: Set group attack (0 to 5)"].plurals[0] = "12xx: Атака группы (0-5)";
    strings["13xx: Set group decay (0 to 11)"].plurals[0] = "13xx: Спад группы (0-11)";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis system uses software mixing to provide two sample channels."].plurals[0] = "этот чип в основном известен по причине того, что он находился в Sega Genesis (но он также использовался в компьютере FM Towns).\nэта версия использует программное смешение сигналов, за счёт чего возможно использование двух каналов сэмплов.";
    strings["this chip is mostly known for being in the Sega Genesis (but it also was on the FM Towns computer).\nthis system uses software mixing to provide two sample channels.\nthis one is in Extended Channel mode, which turns the third FM channel into four operators with independent notes/frequencies.\nthis one includes CSM mode control for special effects on Channel 3."].plurals[0] = "этот чип в основном известен по причине того, что он находился в Sega Genesis (но он также использовался в компьютере FM Towns).\nэта версия использует программное смешение сигналов, за счёт чего возможно использование двух каналов сэмплов.\nЭто версия в режиме расширенного канала, который превращает третий FM-канал в четыре оператора с независимыми нотами/частотами.\nУ этой версии есть контроль режима CSM для специальных эффектов на третьем канале.";
    strings["an SN76489 derivative used in Neo Geo Pocket, has independent stereo volume and noise channel frequency."].plurals[0] = "вариант SN76489, использовавшийся в Neo Geo Pocket. Имеет независимую регулировку громкости стереоканалов и частоты канала шума.";
    strings["20xx: Set noise length (0: short, 1: long)"].plurals[0] = "20xx: Длина шума (0: короткий, 1: длинный)";
    strings["as generic sample playback as it gets."].plurals[0] = "настолько типичное воспроизведение сэмплов, насколько это возможно.";
    strings["this PCM chip was widely used at Konami arcade boards in 1986-1990."].plurals[0] = "этот ИКМ чип широко использовался в игровых автоматах Konami с 1986 по 1990 год.";
    strings["yet another PCM chip from Irem. like Amiga, but less pitch resolution and no sample loop."].plurals[0] = "ещё один ИКМ чип от Irem. как Amiga, но с меньшим разрешением регулировки частоты и без зацикливания сэмплов.";
    strings["a SoC with wavetable sound hardware."].plurals[0] = "СнК с таблично-волновым синтезатором звука.";
    strings["a game console with 3 channels of square wave. it's what happens after fusing TIA and VIC together."].plurals[0] = "игровая консоль с тремя каналами квадратных волн. вот что получается, если скрестить TIA и VIC.";
    strings["10xx: Set ring modulation (0: disable, 1: enable)"].plurals[0] = "10xx: Кольцевая модуляция (0: выкл., 1: вкл.)";
    strings["11xx: Raw frequency (0-3E)"].plurals[0] = "11xx: Сырая частота (0-3E)";
    strings["another ZX Spectrum beeper system with full PWM pulses and 3-level volume per channel. it also has a pitchable overlay sample channel."].plurals[0] = "ещё одна система с пищалкой ZX Spectrum, на этот раз содержащая полноценные прямоугольные волны с регулировкой скважности и тремя уровнями громкости для каждого канала. Также имеется перекрывающий канал сэмплов с регулировкой частоты.";
    strings["12xx: Set pulse width1"].plurals[0] = "12xx: Скважность";
    strings["this PCM chip was widely used at Konami arcade boards in 1990-1992."].plurals[0] = "этот ИКМ чип широко использовался в игровых автоматах Konami с 1990 по 1992.";
    strings["DFxx: Set sample playback direction (0: normal; 1: reverse)2"].plurals[0] = "DFxx: Направление проигрывания сэмпла (0: обычное; 1: обратное)";
    strings["two square waves (one may be turned into noise). used in the Commodore Plus/4, 16 and 116."].plurals[0] = "два канала квадратных волн (один из них может играть шум). использовался в Commodore Plus/4, 16 и 116.";
    strings["Namco's first PCM chip from 1987. it's pretty good for being so."].plurals[0] = "первый ИКМ чип Namco из 1987 года. для своего времени он весьма неплох.";
    strings["Namco's PCM chip used in their NA-1/2 hardware.\nvery similar to C140, but has noise generator."].plurals[0] = "ИКМ чип Namco, использовавшийся в их устройствах NA-1/2.\nочень похож на C140, но имеет генератор шума.";
    strings["11xx: Set noise mode1"].plurals[0] = "11xx: Режим шума";
    strings["12xy: Set invert mode (x: surround; y: invert)"].plurals[0] = "12xy: Режим инвертирования (x: окруж. звук; y: инверт.)";
    strings["a unique FM synth featured in PC sound cards.\nbased on the OPL3 design, but with lots of its features extended."].plurals[0] = "уникальный чип с FM-синтезом, применявшийся в звуковых картах для PC.\nоснован на OPL3, но с сильно расширенным функционалом.";
    strings["2Exx: Toggle hard envelope reset on new notes"].plurals[0] = "2Exx: Переключить жёсткий перезапуск огибающей на новой ноте";
    strings["first Ensoniq chip used in their synths and Apple IIGS computer. Has 32 hard-panned 8-bit wavetable/sample channels, can do oscillator sync (like SID) and amplitude modulation. Can have up to 128 KiB (2 banks of 64 KiB) of memory for wavetables/samples.\nAs Robert Yannes (SID chip creator) said, it's more or less what SID chip could be if he was given enough time for its development."].plurals[0] = "первый чип Ensoniq, использовавшийся в их синтезаторах и в компьютере Apple IIGS. Имеет 32 канала волновых таблиц/сэмплов с жёстким панорамированием, имеется синхронизация осцилляторов (как SID) и амплитудная модуляция. Может иметь до 128 КиБ (2 банка по 64 КиБ) памяти для волновых таблиц/сэмплов.\nКак сказал Robert Yannes (создатель чипа SID), это более-менее то, чем мог быть чип SID, если бы ему дали достаточно времени для его разработки.";
    strings["11xx: Set number of enabled oscillators (2-1F)"].plurals[0] = "11xx: Количество включённых осцилляторов (2-1F)";
    strings["12xx: Set oscillator output (0-7, 0=left, 1=right)"].plurals[0] = "12xx: Вывод сигнала осциллятора (0-7, 0=лево, 1=право)";
    strings["13xx: Set wave/sample length (0-7, 0=256, 1=512, 2=1024, etc.)"].plurals[0] = "13xx: Длина волны/сэмпла (0-7, 0=256, 1=512, 2=1024 и т.д.)";
    strings["14xx: Set wave/sample position in memory (xx*256 offset)"].plurals[0] = "14xx: Начальное смещение волны/сэмпла в памяти (смещение xx*256)";
    strings["15xx: Set oscillator mode (0-3)"].plurals[0] = "15xx: Режим осциллятора (0-3)";
    strings["a fantasy sound chip designed by jvsTSX and The Beesh-Spweesh!\nused in the Hexheld fantasy console."].plurals[0] = "вымышленный звуковой чип, разработанный jvsTSX и The Beesh-Spweesh!\nиспользуется в вымышленной игровой консоли Hexheld.";
    strings["20xx: Load low byte of noise channel LFSR (00 to FF) or slope channel accumulator (00 to 7F)"].plurals[0] = "20xx: Загрузить младший байт в РСЛОС канала шума (00-FF) или в аккумулятор канала ската (00-7F)";
    strings["21xx: Load high byte of noise channel LFSR (00 to FF)"].plurals[0] = "21xx: Загрузить старший байт в РСЛОС канала шума (00-FF)";
    strings["22xx: Write to I/O port A"].plurals[0] = "22xx: Записать в порт ввода-вывода A";
    strings["23xx: Write to I/O port B"].plurals[0] = "23xx: Записать в порт ввода-вывода B";
    strings["this chip was featured in the Enterprise 128 computer. it is similar to POKEY, but with stereo output, more features and frequency precision and the ability to turn left or right (or both) channel into a 6-bit DAC for sample playback."].plurals[0] = "этот чип стоял в компьютере Enterprise 128. он похож на POKEY, но имеет стерео звук, больше функций, более точную настройку частоты и возможность превращать левый или правый (или оба) канал в 6-битный ЦАП для проигрывания сэмплов.";
    strings["10xx: Set waveform (0 to 4; 0 to 3 on noise)"].plurals[0] = "10xx: Волна (0-4; 0-3 на канале шума)";
    strings["11xx: Set noise frequency source (0: fixed; 1-3: channels 1 to 3)"].plurals[0] = "11xx: Источник частоты шума (0: фикс.; 1-3: каналы 1-3)";
    strings["12xx: Toggle high-pass with next channel"].plurals[0] = "12xx: Переключить ФВЧ от следующего канала";
    strings["13xx: Toggle ring modulation with channel+2"].plurals[0] = "13xx: Переключить кольцевую модуляцию от канал+2";
    strings["14xx: Toggle swap counters (noise only)"].plurals[0] = "14xx: Переключить смену счётчиков (только шум)";
    strings["15xx: Toggle low pass (noise only)"].plurals[0] = "15xx: Переключить ФНЧ (только шум)";
    strings["16xx: Set clock divider (0: /2; 1: /3)"].plurals[0] = "16xx: Делитель частоты (0: /2; 1: /3)";
    strings["a fictional sound chip by LTVA. like SID, but with many of its problems fixed. also features extended functionality like more wave mixing modes, tonal noise, filter and volume per channel."].plurals[0] = "вымышленный звуковой чип за авторством LTVA. похож на SID, но в нём исправлены многие его проблемы. также в этом чипе имеется дополнительный функционал, например, новые способы смешения волн, тональный зацикленный шум, отдельные регулировка громкости и фильтр на каждом канале.";
    strings["a fictional sound chip by Euly. similar to Ricoh 2A03, but all the duty cycles are different, noise has 32 pitches instead of 16 and you have four hard-coded waveforms on triangle channel."].plurals[0] = "вымышленный звуковой чип за авторством Euly. почти как Ricoh 2A03, но все четыре скважности разные, у шума 32 частоты вместо 16, а на канале треугольной волны можно играть четыре предопределённые волны.";
    strings["12xx: Set duty cycle/noise mode (pulse: 0 to 3; noise: 0 or 1, wave: 0 to 3)"].plurals[0] = "12xx: Скважность/режим шума (меандр: 0-3; шум: 0 или 1; волна: 0-3)";
    strings["19xx: Set wave linear counter (0 to 7F; 80 and higher halt)"].plurals[0] = "19xx: Линейный счётчик канала волны (0-7F; 80 и выше мгновенно останавливают волну)";
    strings["additional PCM FIFO channels in Game Boy Advance driven directly by its DMA hardware."].plurals[0] = "дополнительные ИКМ FIFO-каналы в Game Boy Advance с сигналом напрямую от аппаратного контроллера DMA.";
    strings["additional PCM FIFO channels in Game Boy Advance driven by software mixing to provide up to sixteen sample channels."].plurals[0] = "дополнительные ИКМ FIFO-каналы в Game Boy Advance, управляемые при помощи программного микширования, что даёт до 16 каналов сэмплов.";
    strings["11xy: Set echo channel (x: left/right source; y: delay (0 disables))"].plurals[0] = "11xy: Канал эхо (x: левый/правый источник; y: задержка (0 отключает))";
    strings["12xy: Toggle invert (x: left; y: right)"].plurals[0] = "12xy: Инверсия сигнала (x: лево; y: право)";
    strings["a handheld video game console with two screens. it uses a stylus."].plurals[0] = "портативная игровая консоль с двумя экранами. необходим стилус.";
    strings["12xx: Set duty cycle (pulse: 0 to 7)"].plurals[0] = "12xx: Скважность (прямоуг.: 0-7)";
    strings["1Fxx: Set global volume (0 to 7F)"].plurals[0] = "1Fxx: Глобальная громкость (0-7F)";
    strings["FZT sound source"].plurals[0] = "Источник звука FZT";
    strings["a software synth core by LTVA used in Flizzer Tracker (Flipper Zero chiptune tracker)."].plurals[0] = "ядро программного синтеза за авторством LTVA, используемое в программе Flizzer Tracker (чиптюн-трекер для Flipper Zero).";
    strings["10xx: Set wave (bits: 0: noise, 1: pulse, 2: triangle, 3: sawtooth, 4: metallic noise, 5: sine)"].plurals[0] = "10xx: Волна (биты: 0: шум, 1: прямоуг., 2: треуг., 3: пила, 4: \"металлический\" шум, 5: синус)";
    strings["11xy: PWM (pulsolo) with speed x and depth y"].plurals[0] = "11xy: ШИМ (пульсоло) со скоростью x и глубиной y";
    strings["12xx: Set pulse width"].plurals[0] = "12xx: Скважность";
    strings["13xx: Pulse width up"].plurals[0] = "13xx: Изменение скважности вверх";
    strings["14xx: Pulse width down"].plurals[0] = "14xx: Изменение скважности вниз";
    strings["15xx: Set filter cutoff"].plurals[0] = "15xx: Частота среза фильтра";
    strings["16xx: Set volume"].plurals[0] = "16xx: Громкость";
    strings["17xx: Toggle filter"].plurals[0] = "17xx: Вкл./выкл. фильтр";
    strings["18xx: Set filter mode"].plurals[0] = "18xx: Режим фильтра";
    strings["19xx: Phase reset"].plurals[0] = "19xx: Сброс фазы";
    strings["1Axx: Filter cutoff up"].plurals[0] = "1Axx: Частота среза вверх";
    strings["1Bxx: Filter cutoff down"].plurals[0] = "1Bxx: Частота среза вниз";
    strings["1Cxx: Set filter resonance"].plurals[0] = "1Cxx: Резонанс фильтра";
    strings["1Dxx: Filter resonance up"].plurals[0] = "1Dxx: Резонанс вверх";
    strings["1Exx: Filter resonance down"].plurals[0] = "1Exx: Резонанс вниз";
    strings["1Fxx: Ring mod source (FF = self)"].plurals[0] = "1Fxx: Источник кольцевой модуляции (FF = самомодуляция)";
    strings["20xx: Hard sync source (FF = self)"].plurals[0] = "20xx: Источник синхронизации осцилляторов (FF = самосинхронизация)";
    strings["21xx: Set attack speed"].plurals[0] = "21xx: Скорость атаки";
    strings["22xx: Set decay speed"].plurals[0] = "22xx: Скорость спада";
    strings["23xx: Set sustain level"].plurals[0] = "23xx: Уровень сустейна";
    strings["24xx: Set release rate"].plurals[0] = "24xx: Скорость релиза";
    strings["25xx: Restart instrument program"].plurals[0] = "25xx: Перезапустить программу инструмента";
    strings["26xx: Portamento up (semitones)"].plurals[0] = "26xx: Портаменто вверх (полутонов)";
    strings["27xx: Portamento down (semitones)"].plurals[0] = "27xx: Портаменто вниз (полутонов)";
    strings["28xx: Absolute arpeggio note"].plurals[0] = "28xx: Абсолютная нота арпеджио";
    strings["29xx: Trigger envelope release"].plurals[0] = "29xx: Релиз огибающей";
    strings["a fantasy sound chip using logistic map iterations to generate sound."].plurals[0] = "вымышленный звуковой чип, использующий итерации логистического отображения для генерации звука.";
    strings["10xx: Load low byte of channel sample state"].plurals[0] = "10xx: Загрузить младший байт сэмплового состояния канала";
    strings["11xx: Load high byte of channel sample state"].plurals[0] = "11xx: Загрузить старший байт сэмплового состояния канала";
    strings["12xx: Set low byte of channel parameter"].plurals[0] = "12xx: Младший байт параметра канала";
    strings["13xx: Set high byte of channel parameter"].plurals[0] = "13xx: Старший байт параметра канала";
    strings["this is a system designed for testing purposes."].plurals[0] = "это система, разработанная для тестирования.";

    strings["help! what's going on!"].plurals[0] = "помогите! что происходит!";
    strings["Sunsoft 5B standalone"].plurals[0] = "Sunsoft 5B отдельно";
    strings["Sunsoft 5B standalone (PAL)"].plurals[0] = "Sunsoft 5B отдельно (PAL)";
    strings["Overclocked Sunsoft 5B"].plurals[0] = "Разогнанный Sunsoft 5B";
    strings["Sega Genesis Extended Channel 3"].plurals[0] = "Sega Genesis расширенный 3-ий канал";
    strings["NTSC-J Sega Master System + drums"].plurals[0] = "NTSC-J Sega Master System + ударные";
    strings["MSX-MUSIC + drums"].plurals[0] = "MSX-MUSIC + ударные";
    strings["Commodore 64 with dual 6581"].plurals[0] = "Commodore 64 с двумя 6581";
    strings["Commodore 64 with dual 8580"].plurals[0] = "Commodore 64 с двумя 8580";
    strings["YM2151 + SegaPCM Arcade (compatibility)"].plurals[0] = "YM2151 + SegaPCM Arcade (совместимость)";
    strings["YM2151 + SegaPCM Arcade"].plurals[0] = "YM2151 + SegaPCM Arcade";
    strings["Game Boy with AY expansion"].plurals[0] = "Game Boy с расширением AY";
    strings["multi-system"].plurals[0] = "мульти-система";
    strings["Unknown"].plurals[0] = "Неизвестно";
    strings["15xx: Set raw period"].plurals[0] = "15xx: \"Сырое\" значение периода";
    strings["16xx: Set raw period higher nybble (0-F)"].plurals[0] = "16xx: \"Сырое\" значение периода, старшая тетрада (0-F)";
    strings["Sega Genesis Extended Channel 31"].plurals[0] = "Sega Genesis расширенный 3-ий канал";
    strings["Neo Geo CD Extended Channel 2"].plurals[0] = "Neo Geo CD расширенный 2-ой канал";
    strings["Famicom Disk System (chip)"].plurals[0] = "Famicom Disk System (чип)";
    strings["Yamaha YM2203 (OPN) Extended Channel 3"].plurals[0] = "Yamaha YM2203 (OPN) расширенный 3-ий канал";
    strings["Yamaha YM2608 (OPNA) Extended Channel 3"].plurals[0] = "Yamaha YM2608 (OPNA) расширенный 3-ий канал";
    strings["Yamaha YM2608 (OPNA) Extended Channel 3 and CSM"].plurals[0] = "Yamaha YM2608 (OPNA) расширенный 3-ий канал и CSM";
    strings["PC Speaker"].plurals[0] = "PC Speaker (пищалка)";
    strings["ZX Spectrum Beeper"].plurals[0] = "ZX Spectrum пищалка";
    strings["Yamaha YM2612 (OPN2) Extended Channel 3"].plurals[0] = "Yamaha YM2612 (OPN2) расширенный 3-ий канал";
    strings["Yamaha YM3526 (OPL) with drums"].plurals[0] = "Yamaha YM3526 (OPL) с ударными";
    strings["Yamaha YM3812 (OPL2) with drums"].plurals[0] = "Yamaha YM3812 (OPL2) с ударными";
    strings["Yamaha YMF262 (OPL3) with drums"].plurals[0] = "Yamaha YMF262 (OPL3) с ударными";
    strings["Yamaha YM2610 (OPNB) Extended Channel 2"].plurals[0] = "Yamaha YM2610 (OPNB) расширенный 2-ой канал";
    strings["Yamaha YM2413 (OPLL) with drums"].plurals[0] = "Yamaha YM2413 (OPLL) с ударными";
    strings["Yamaha YM2610B (OPNB2) Extended Channel 3"].plurals[0] = "Yamaha YM2610B (OPNB2) расширенный 3-ий канал";
    strings["SegaPCM (compatible 5-channel mode)"].plurals[0] = "SegaPCM (совместимый 5-канальный режим)";
    strings["Yamaha YMF278B (OPL4) with drums"].plurals[0] = "Yamaha YMF278B (OPL4) с ударными";
    strings["Yamaha Y8950 with drums"].plurals[0] = "Yamaha Y8950 с ударными";
    strings["Yamaha YM2612 (OPN2) with DualPCM"].plurals[0] = "Yamaha YM2612 (OPN2) с DualPCM";
    strings["Yamaha YM2612 (OPN2) Extended Channel 3 with DualPCM and CSM"].plurals[0] = "Yamaha YM2612 (OPN2) расширенный 3-ий канал с DualPCM и CSM";
    strings["Generic PCM DAC"].plurals[0] = "Типичный ИКМ ЦАП";
    strings["ZX Spectrum Beeper (QuadTone Engine)"].plurals[0] = "ZX Spectrum пищалка (движок QuadTone)";
    strings["ESS ES1xxx series (ESFM)"].plurals[0] = "ESS серия ES1xxx (ESFM)";
    strings["Dummy System"].plurals[0] = "Система-болванка";
    
    //channel names

    strings["Channel 1"].plurals[0] = "Канал 1";
    strings["Channel 2"].plurals[0] = "Канал 2";
    strings["Channel 3"].plurals[0] = "Канал 3";
    strings["Channel 4"].plurals[0] = "Канал 4";
    strings["Channel 5"].plurals[0] = "Канал 5";
    strings["Channel 6"].plurals[0] = "Канал 6";
    strings["Channel 7"].plurals[0] = "Канал 7";
    strings["Channel 8"].plurals[0] = "Канал 8";
    strings["Channel 9"].plurals[0] = "Канал 9";
    strings["Channel 10"].plurals[0] = "Канал 10";
    strings["Channel 11"].plurals[0] = "Канал 11";
    strings["Channel 12"].plurals[0] = "Канал 12";
    strings["Channel 13"].plurals[0] = "Канал 13";
    strings["Channel 14"].plurals[0] = "Канал 14";
    strings["Channel 15"].plurals[0] = "Канал 15";
    strings["Channel 16"].plurals[0] = "Канал 16";
    strings["Channel 17"].plurals[0] = "Канал 17";
    strings["Channel 18"].plurals[0] = "Канал 18";
    strings["Channel 19"].plurals[0] = "Канал 19";
    strings["Channel 20"].plurals[0] = "Канал 20";
    strings["Channel 21"].plurals[0] = "Канал 21";
    strings["Channel 22"].plurals[0] = "Канал 22";
    strings["Channel 23"].plurals[0] = "Канал 23";
    strings["Channel 24"].plurals[0] = "Канал 24";
    strings["Channel 25"].plurals[0] = "Канал 25";
    strings["Channel 26"].plurals[0] = "Канал 26";
    strings["Channel 27"].plurals[0] = "Канал 27";
    strings["Channel 28"].plurals[0] = "Канал 28";
    strings["Channel 29"].plurals[0] = "Канал 29";
    strings["Channel 30"].plurals[0] = "Канал 30";
    strings["Channel 31"].plurals[0] = "Канал 31";
    strings["Channel 32"].plurals[0] = "Канал 32";

    strings["Square"].plurals[0] = "Меандр";

    strings["Square 1"].plurals[0] = "Меандр 1";
    strings["Square 2"].plurals[0] = "Меандр 2";
    strings["Square 3"].plurals[0] = "Меандр 3";

    strings["Pulse"].plurals[0] = "Прямоуг.";

    strings["Pulse 1"].plurals[0] = "Прямоуг. 1";
    strings["Pulse 2"].plurals[0] = "Прямоуг. 2";

    strings["Wave"].plurals[0] = "Волна";
    strings["Wavetable"].plurals[0] = "Волн. т.";

    strings["Triangle"].plurals[0] = "Треуг.";

    strings["PCM"].plurals[0] = "ИКМ";

    strings["PCM 1"].plurals[0] = "ИКМ 1";
    strings["PCM 2"].plurals[0] = "ИКМ 2";
    strings["PCM 3"].plurals[0] = "ИКМ 3";
    strings["PCM 4"].plurals[0] = "ИКМ 4";
    strings["PCM 5"].plurals[0] = "ИКМ 5";
    strings["PCM 6"].plurals[0] = "ИКМ 6";
    strings["PCM 7"].plurals[0] = "ИКМ 7";
    strings["PCM 8"].plurals[0] = "ИКМ 8";
    strings["PCM 9"].plurals[0] = "ИКМ 9";
    strings["PCM 10"].plurals[0] = "ИКМ 10";
    strings["PCM 11"].plurals[0] = "ИКМ 11";
    strings["PCM 12"].plurals[0] = "ИКМ 12";
    strings["PCM 13"].plurals[0] = "ИКМ 13";
    strings["PCM 14"].plurals[0] = "ИКМ 14";
    strings["PCM 15"].plurals[0] = "ИКМ 15";
    strings["PCM 16"].plurals[0] = "ИКМ 16";
    strings["PCM 17"].plurals[0] = "ИКМ 17";
    strings["PCM 18"].plurals[0] = "ИКМ 18";
    strings["PCM 19"].plurals[0] = "ИКМ 19";
    strings["PCM 20"].plurals[0] = "ИКМ 20";
    strings["PCM 21"].plurals[0] = "ИКМ 21";
    strings["PCM 22"].plurals[0] = "ИКМ 22";
    strings["PCM 23"].plurals[0] = "ИКМ 23";
    strings["PCM 24"].plurals[0] = "ИКМ 24";

    strings["DPCM"].plurals[0] = "ДИКМ";

    strings["ADPCM"].plurals[0] = "АДИКМ";

    strings["ADPCM 1"].plurals[0] = "АДИКМ 1";
    strings["ADPCM 2"].plurals[0] = "АДИКМ 2";
    strings["ADPCM 3"].plurals[0] = "АДИКМ 3";

    strings["ADPCM-A 1"].plurals[0] = "АДИКМ-A 1";
    strings["ADPCM-A 2"].plurals[0] = "АДИКМ-A 2";
    strings["ADPCM-A 3"].plurals[0] = "АДИКМ-A 3";
    strings["ADPCM-A 4"].plurals[0] = "АДИКМ-A 4";
    strings["ADPCM-A 5"].plurals[0] = "АДИКМ-A 5";
    strings["ADPCM-A 6"].plurals[0] = "АДИКМ-A 6";

    strings["ADPCM-B"].plurals[0] = "АДИКМ-B";

    strings["Sample"].plurals[0] = "Сэмплы";

    strings["DAC Left"].plurals[0] = "ЦАП левый";
    strings["DAC Right"].plurals[0] = "ЦАП правый";

    strings["Noise"].plurals[0] = "Шум";

    strings["Noise 1"].plurals[0] = "Шум 1";
    strings["Noise 2"].plurals[0] = "Шум 2";
    strings["Noise 3"].plurals[0] = "Шум 3";

    strings["Slope"].plurals[0] = "Скат";

    strings["FM 6/PCM 1"].plurals[0] = "FM 6/ИКМ 1";
    strings["CSM Timer"].plurals[0] = "CSM таймер";

    strings["VRC6 Saw"].plurals[0] = "VRC6 пила";
    
    strings["4OP 1"].plurals[0] = "4ОП 1";
    strings["4OP 3"].plurals[0] = "4ОП 3";
    strings["4OP 5"].plurals[0] = "4ОП 5";
    strings["4OP 7"].plurals[0] = "4ОП 7";
    strings["4OP 9"].plurals[0] = "4ОП 9";
    strings["4OP 11"].plurals[0] = "4ОП 11";

    strings["Kick/FM 7"].plurals[0] = "Бочка/FM7";
    strings["Kick/FM 16"].plurals[0] = "Бочка/FM16";
    strings["Kick"].plurals[0] = "Бочка";
    strings["Snare"].plurals[0] = "М. бараб.";
    strings["Top"].plurals[0] = "Тарелка";
    strings["HiHat"].plurals[0] = "Хай-хэт";
    strings["Tom"].plurals[0] = "Том-том";
    strings["Rim"].plurals[0] = "Римшот";

    // channel short names

    strings["CH1"].plurals[0] = "КН1";
    strings["CH2"].plurals[0] = "КН2";
    strings["CH3"].plurals[0] = "КН3";
    strings["CH4"].plurals[0] = "КН4";
    strings["CH5"].plurals[0] = "КН5";
    strings["CH6"].plurals[0] = "КН6";
    strings["CH7"].plurals[0] = "КН7";
    strings["CH8"].plurals[0] = "КН8";
    strings["CH9"].plurals[0] = "КН9";

    strings["NO"].plurals[0] = "ШУ";
    strings["N1"].plurals[0] = "Ш1";
    strings["N2"].plurals[0] = "Ш2";
    strings["N3"].plurals[0] = "Ш3";

    strings["SL"].plurals[0] = "СК";

    strings["S1"].plurals[0] = "М1";
    strings["S2"].plurals[0] = "М2";
    strings["S3"].plurals[0] = "М3";
    strings["S4"].plurals[0] = "М4";
    strings["S5"].plurals[0] = "М5";
    strings["S6"].plurals[0] = "М6";

    strings["P1"].plurals[0] = "И1";
    strings["P2"].plurals[0] = "И2";
    strings["P3"].plurals[0] = "И3";
    strings["P4"].plurals[0] = "И4";
    strings["P5"].plurals[0] = "И5";
    strings["P6"].plurals[0] = "И6";
    strings["P7"].plurals[0] = "И7";
    strings["P8"].plurals[0] = "И8";
    strings["P9"].plurals[0] = "И9";
    strings["P10"].plurals[0] = "И10";
    strings["P11"].plurals[0] = "И11";
    strings["P12"].plurals[0] = "И12";
    strings["P13"].plurals[0] = "И13";
    strings["P14"].plurals[0] = "И14";
    strings["P15"].plurals[0] = "И15";
    strings["P16"].plurals[0] = "И16";
    strings["P17"].plurals[0] = "И17";
    strings["P18"].plurals[0] = "И18";
    strings["P19"].plurals[0] = "И19";
    strings["P20"].plurals[0] = "И20";
    strings["P21"].plurals[0] = "И21";
    strings["P22"].plurals[0] = "И22";
    strings["P23"].plurals[0] = "И23";
    strings["P24"].plurals[0] = "И24";

    strings["BD"].plurals[0] = "ББ";
    strings["SD"].plurals[0] = "РБ";
    strings["TP"].plurals[0] = "ТР";
    strings["HH"].plurals[0] = "ХХ";
    strings["TM"].plurals[0] = "ТМ";
    strings["RM"].plurals[0] = "РМ";

    strings["P"].plurals[0] = "И";

    strings["VS"].plurals[0] = "VП";

    strings["TR"].plurals[0] = "ТР";
    strings["DMC"].plurals[0] = "ДМК";

    strings["WA"].plurals[0] = "ВТ";
}