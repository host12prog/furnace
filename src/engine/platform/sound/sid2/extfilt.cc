...
// Constructor.
// ----------------------------------------------------------------------------
ExternalFilter2::ExternalFilter2()
{
  reset();
  enable_filter(true);
...
// Enable filter.
// ----------------------------------------------------------------------------
void ExternalFilter2::enable_filter(bool enable)
{
  enabled = enable;
}
...
// Set chip model.
// ----------------------------------------------------------------------------
void ExternalFilter2::set_chip_model(chip_model model)
{
  if (model == MOS6581) {
