...
void FurnaceGUI::drawInsES5503(DivInstrument* ins)
{
  ...
  if (ImGui::BeginTabItem(_L("Macros##sgi5503"))) 
  {
    ...
    macroList.push_back(FurnaceGUIMacroDesc(_L("Osc. mode##sgi5503"),ins,DIV_MACRO_DUTY,0xff,0,3,32,uiColors[GUI_COLOR_MACRO_OTHER]));
    ...
    {
      macroList.push_back(FurnaceGUIMacroDesc(_L("Waveform##sgi5503"),ins,DIV_MACRO_WAVE,0xff,0,WAVE_MACRO_MAX,160,uiColors[GUI_COLOR_MACRO_WAVE],false,NULL,NULL,false,NULL,true));
    }
