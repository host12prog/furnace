...
void FurnaceGUI::drawInsAY(DivInstrument* ins)
{
  ...
  if (!ins->amiga.useSample)
  {
    ...
    {
      macroList.push_back(FurnaceGUIMacroDesc(_("Timer FX##sgiAY"),ins,DIV_MACRO_EX6,0xff,0,3,32,uiColors[GUI_COLOR_MACRO_OTHER]));
      ...
      macroList.push_back(FurnaceGUIMacroDesc(_("PWM Boundary##sgiAY"),ins,DIV_MACRO_EX10,0xff,0,15,64,uiColors[GUI_COLOR_MACRO_OTHER]));
