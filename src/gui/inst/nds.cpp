...
void FurnaceGUI::drawInsNDS(DivInstrument* ins)
{
  ...
  if (ImGui::BeginTabItem(_L("Macros##sgiNDS"))) 
  {
    panMin = -64;
    panMax = 63;
    
    macroList.push_back(FurnaceGUIMacroDesc(_L("Volume##sgiNDS"),ins,DIV_MACRO_VOL,0xff,0,127,160,uiColors[GUI_COLOR_MACRO_VOLUME]));
