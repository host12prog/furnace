...
void FurnaceGUI::drawInsSNES(DivInstrument* ins)
{
  ...
  if (ImGui::BeginTabItem(_L("Macros##sgiSNES"))) 
  {
    ...
    macroList.push_back(FurnaceGUIMacroDesc(_L("Arpeggio##sgiSNES"),ins,DIV_MACRO_ARP,0xff,-120,120,160,uiColors[GUI_COLOR_MACRO_PITCH],true,NULL,macroHoverNote,false,NULL,0,true,ins->std.get_macro(DIV_MACRO_ARP, true)->val));
    ...
    macroList.push_back(FurnaceGUIMacroDesc(_L("Waveform##sgiSNES"),ins,DIV_MACRO_WAVE,0xff,0,MAX(1,e->song.waveLen-1),160,uiColors[GUI_COLOR_MACRO_WAVE],false,NULL,NULL));
