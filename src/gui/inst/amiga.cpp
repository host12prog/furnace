...
void FurnaceGUI::drawInsAmiga(DivInstrument* ins)
{
  ...
  if (ImGui::BeginTabItem(_L("Macros##sgiSAMPLE"))) 
  {
    ...
    macroList.push_back(FurnaceGUIMacroDesc(_L("Waveform##sgiSAMPLE"),ins,DIV_MACRO_WAVE,0xff,0,WAVE_MACRO_MAX,160,uiColors[GUI_COLOR_MACRO_WAVE],false,NULL,NULL));
