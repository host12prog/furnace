...
void FurnaceGUI::drawInsX1_010(DivInstrument* ins)
{
  ...
  if (ImGui::BeginTabItem(_L("Macros##sgiX1"))) 
  {
    ...
    macroList.push_back(FurnaceGUIMacroDesc(_L("Arpeggio##sgiX1"),ins,DIV_MACRO_ARP,0xff,-120,120,160,uiColors[GUI_COLOR_MACRO_PITCH],true,NULL,macroHoverNote,false,NULL,0,true,ins->std.get_macro(DIV_MACRO_ARP, true)->val));
    ...
    macroList.push_back(FurnaceGUIMacroDesc(_L("Waveform##sgiX1"),ins,DIV_MACRO_WAVE,0xff,0,MAX(1,e->song.waveLen-1),160,uiColors[GUI_COLOR_MACRO_WAVE],false,NULL,NULL));
