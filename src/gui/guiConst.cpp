...
const FurnaceGUIActionDef guiActions[GUI_ACTION_MAX]={
  ...
  D("PAT_SELECT_ALL", "Select all##sggc", FURKMOD_CMD|SDLK_a),
  D("PAT_CUT", "Cut##sggc", FURKMOD_CMD|SDLK_x),
  D("PAT_COPY", "Copy##sggc", FURKMOD_CMD|SDLK_c),
  D("PAT_PASTE", "Paste##sggc", FURKMOD_CMD|SDLK_v),
  ...
  D("INS_LIST_ADD", "Add##sggc", SDLK_INSERT),
  D("INS_LIST_DUPLICATE", "Duplicate##sggc", FURKMOD_CMD|SDLK_d),
  D("INS_LIST_OPEN", "Open##sggc", 0),
  D("INS_LIST_OPEN_REPLACE", "Open (replace current)##sggc", 0),
  D("INS_LIST_SAVE", "Save##sggc", 0),
  D("INS_LIST_SAVE_DMP", "Save (.dmp)##sggc", 0),
  D("INS_LIST_MOVE_UP", "Move up##sggc", FURKMOD_SHIFT|SDLK_UP),
  D("INS_LIST_MOVE_DOWN", "Move down##sggc", FURKMOD_SHIFT|SDLK_DOWN),
  D("INS_LIST_DELETE", "Delete##sggc", 0),
  D("INS_LIST_EDIT", "Edit##sggc", FURKMOD_SHIFT|SDLK_RETURN),
  D("INS_LIST_UP", "Cursor up##sggc", SDLK_UP),
  D("INS_LIST_DOWN", "Cursor down##sggc", SDLK_DOWN),
  D("INS_LIST_DIR_VIEW", "Toggle folders/standard view##sggc", FURKMOD_CMD|SDLK_v),
  D("INS_LIST_MAX", "", NOT_AN_ACTION),

  D("WAVE_LIST_MIN", "---Wavetable list##sggc", NOT_AN_ACTION),
  D("WAVE_LIST_ADD", "Add##sggc", SDLK_INSERT),
  D("WAVE_LIST_DUPLICATE", "Duplicate##sggc", FURKMOD_CMD|SDLK_d),
  D("WAVE_LIST_OPEN", "Open##sggc", 0),
  D("WAVE_LIST_OPEN_REPLACE", "Open (replace current)##sggc", 0),
  D("WAVE_LIST_SAVE", "Save##sggc", 0),
  D("WAVE_LIST_SAVE_DMW", "Save (.dmw)##sggc", 0),
  D("WAVE_LIST_SAVE_RAW", "Save (raw)##sggc", 0),
  D("WAVE_LIST_MOVE_UP", "Move up##sggc", FURKMOD_SHIFT|SDLK_UP),
  D("WAVE_LIST_MOVE_DOWN", "Move down##sggc", FURKMOD_SHIFT|SDLK_DOWN),
  D("WAVE_LIST_DELETE", "Delete##sggc", 0),
  D("WAVE_LIST_EDIT", "Edit##sggc", FURKMOD_SHIFT|SDLK_RETURN),
  D("WAVE_LIST_UP", "Cursor up##sggc", SDLK_UP),
  D("WAVE_LIST_DOWN", "Cursor down##sggc", SDLK_DOWN),
  D("WAVE_LIST_DIR_VIEW", "Toggle folders/standard view##sggc", FURKMOD_CMD|SDLK_v),
  D("WAVE_LIST_MAX", "", NOT_AN_ACTION),

  D("SAMPLE_LIST_MIN", "---Sample list##sggc", NOT_AN_ACTION),
  D("SAMPLE_LIST_ADD", "Add##sggc", SDLK_INSERT),
  D("SAMPLE_LIST_DUPLICATE", "Duplicate##sggc", FURKMOD_CMD|SDLK_d),
  D("SAMPLE_LIST_OPEN", "Open##sggc", 0),
  D("SAMPLE_LIST_OPEN_REPLACE", "Open (replace current)##sggc", 0),
  D("SAMPLE_LIST_OPEN_RAW", "Import raw data##sggc", 0),
  D("SAMPLE_LIST_OPEN_REPLACE_RAW", "Import raw data (replace current)##sggc", 0),
  D("SAMPLE_LIST_SAVE", "Save##sggc", 0),
  D("SAMPLE_LIST_SAVE_RAW", "Save (raw)##sggc", 0),
  D("SAMPLE_LIST_MOVE_UP", "Move up##sggc", FURKMOD_SHIFT|SDLK_UP),
  D("SAMPLE_LIST_MOVE_DOWN", "Move down##sggc", FURKMOD_SHIFT|SDLK_DOWN),
  D("SAMPLE_LIST_DELETE", "Delete##sggc", 0),
  D("SAMPLE_LIST_EDIT", "Edit##sggc", FURKMOD_SHIFT|SDLK_RETURN),
  D("SAMPLE_LIST_UP", "Cursor up##sggc", SDLK_UP),
  D("SAMPLE_LIST_DOWN", "Cursor down##sggc", SDLK_DOWN),
  D("SAMPLE_LIST_PREVIEW", "Preview##sggc", 0),
  D("SAMPLE_LIST_STOP_PREVIEW", "Stop preview##sggc", 0),
  D("SAMPLE_LIST_DIR_VIEW", "Toggle folders/standard view##sggc", FURKMOD_CMD|SDLK_v),
  ...
  D("SAMPLE_CUT", "Cut##sggc", FURKMOD_CMD|SDLK_x),
  D("SAMPLE_COPY", "Copy##sggc", FURKMOD_CMD|SDLK_c),
  D("SAMPLE_PASTE", "Paste##sggc", FURKMOD_CMD|SDLK_v),
  ...
  D("SAMPLE_SELECT_ALL", "Select all##sggc", FURKMOD_CMD|SDLK_a),
  ...
  D("SAMPLE_DELETE", "Delete##sggc", SDLK_DELETE),
  ...
  D("ORDERS_ADD", "Add##sggc", SDLK_INSERT),
  D("ORDERS_DUPLICATE", "Duplicate##sggc", FURKMOD_CMD|SDLK_d),
  ...
  D("ORDERS_MOVE_UP", "Move up##sggc", FURKMOD_SHIFT|SDLK_UP),
  D("ORDERS_MOVE_DOWN", "Move down##sggc", FURKMOD_SHIFT|SDLK_DOWN),
