...
const char* insTypes[][3]={
  ...
  {"Attiny85APU",ICON_FA_LINE_CHART,ICON_FUR_INS_AT85APU},
...
const FurnaceGUIActionDef guiActions[GUI_ACTION_MAX]={
  ...
  D("COMMAND_PALETTE", "Command Palette##sggc", FURKMOD_CMD|SDLK_p),
  D("CMDPAL_MIN", "", NOT_AN_ACTION),
  D("CMDPAL_RECENT", "Recent files (Palette)##sggc", 0),
  D("CMDPAL_INSTRUMENTS", "Instruments (Palette)##sggc", 0),
  D("CMDPAL_SAMPLES", "Samples (Palette)##sggc", 0),
  D("CMDPAL_INSTRUMENT_CHANGE", "Change instrument (Palette)##sggc", 0),
  D("CMDPAL_ADD_CHIP", "Add chip (Palette)##sggc", 0),
  ...
  D("WINDOW_USER_PRESETS", "User Presets##sggc", 0),
  ...
  D("PAT_MOVE_UP", "Move selection up##sggc", FURKMOD_ALT|SDLK_UP),
  D("PAT_MOVE_DOWN", "Move selection down##sggc", FURKMOD_ALT|SDLK_DOWN),
  D("PAT_MOVE_LEFT_CHANNEL", "Move selection to previous channel##sggc", FURKMOD_ALT|SDLK_LEFT),
  D("PAT_MOVE_RIGHT_CHANNEL", "Move selection to next channel##sggc", FURKMOD_ALT|SDLK_RIGHT),
  ...
  D("PAT_CLONE", "Clone pattern##sggc", FURKMOD_CMD|SDLK_k),
  D("PAT_MAX", "", NOT_AN_ACTION),

  D("INS_LIST_MIN", "---Instrument list##sggc", NOT_AN_ACTION),
  D("INS_LIST_ADD", "Add instrument##sggc0", SDLK_INSERT),
  D("INS_LIST_DUPLICATE", "Duplicate instrument##sggc0", FURKMOD_CMD|SDLK_d),
  D("INS_LIST_OPEN", "Open instrument##sggc0", 0),
  D("INS_LIST_OPEN_REPLACE", "Open instrument (replace current)##sggc0", 0),
  D("INS_LIST_SAVE", "Save instrument##sggc0", 0),
  D("INS_LIST_SAVE_DMP", "Export instrument (.dmp)##sggc", 0),
  D("INS_LIST_MOVE_UP", "Move instrument up in list##sggc0", FURKMOD_SHIFT|SDLK_UP),
  D("INS_LIST_MOVE_DOWN", "Move instrument down in list##sggc0", FURKMOD_SHIFT|SDLK_DOWN),
  D("INS_LIST_DELETE", "Delete instrument##sggc0", 0),
  D("INS_LIST_EDIT", "Edit instrument##sggc0", FURKMOD_SHIFT|SDLK_RETURN),
  D("INS_LIST_UP", "Instrument cursor up##sggc0", SDLK_UP),
  D("INS_LIST_DOWN", "Instrument cursor down##sggc0", SDLK_DOWN),
  D("INS_LIST_DIR_VIEW", "Instruments: toggle folders/standard view##sggc0", FURKMOD_CMD|SDLK_v),
  D("INS_LIST_MAX", "", NOT_AN_ACTION),

  D("WAVE_LIST_MIN", "---Wavetable list##sggc", NOT_AN_ACTION),
  D("WAVE_LIST_ADD", "Add wavetable##sggc1", SDLK_INSERT),
  D("WAVE_LIST_DUPLICATE", "Duplicate wavetable##sggc1", FURKMOD_CMD|SDLK_d),
  D("WAVE_LIST_OPEN", "Open wavetable##sggc1", 0),
  D("WAVE_LIST_OPEN_REPLACE", "Open wavetable (replace current)##sggc1", 0),
  D("WAVE_LIST_SAVE", "Save wavetable##sggc1", 0),
  D("WAVE_LIST_SAVE_DMW", "Save wavetable (.dmw)##sggc", 0),
  D("WAVE_LIST_SAVE_RAW", "Save wavetable (raw)##sggc0", 0),
  D("WAVE_LIST_MOVE_UP", "Move wavetable up in list##sggc1", FURKMOD_SHIFT|SDLK_UP),
  D("WAVE_LIST_MOVE_DOWN", "Move wavetable down in list##sggc1", FURKMOD_SHIFT|SDLK_DOWN),
  D("WAVE_LIST_DELETE", "Delete wavetable##sggc1", 0),
  D("WAVE_LIST_EDIT", "Edit wavetable##sggc1", FURKMOD_SHIFT|SDLK_RETURN),
  ...
  D("SAMPLE_LIST_DUPLICATE", "Duplicate sample##sggc2", FURKMOD_CMD|SDLK_d),
  D("SAMPLE_LIST_OPEN", "Open sample##sggc2", 0),
  D("SAMPLE_LIST_OPEN_REPLACE", "Open sample (replace current)##sggc2", 0),
  D("SAMPLE_LIST_OPEN_RAW", "Import raw sample data##sggc", 0),
  D("SAMPLE_LIST_OPEN_REPLACE_RAW", "Import raw sample data (replace current)##sggc", 0),
  D("SAMPLE_LIST_SAVE", "Save sample##sggc2", 0),
  D("SAMPLE_LIST_SAVE_RAW", "Save sample (raw)##sggc1", 0),
  D("SAMPLE_LIST_MOVE_UP", "Move sample up in list##sggc2", FURKMOD_SHIFT|SDLK_UP),
  D("SAMPLE_LIST_MOVE_DOWN", "Move sample down in list##sggc2", FURKMOD_SHIFT|SDLK_DOWN),
  D("SAMPLE_LIST_DELETE", "Delete sample##sggc2", 0),
  D("SAMPLE_LIST_EDIT", "Edit sample##sggc2", FURKMOD_SHIFT|SDLK_RETURN),
  D("SAMPLE_LIST_UP", "Sample cursor up##sggc2", SDLK_UP),
  D("SAMPLE_LIST_DOWN", "Sample cursor down##sggc2", SDLK_DOWN),
  D("SAMPLE_LIST_PREVIEW", "Sample preview##sggc", 0),
  D("SAMPLE_LIST_STOP_PREVIEW", "Stop sample preview##sggc", 0),
  D("SAMPLE_LIST_DIR_VIEW", "Samples: Toggle folders/standard view##sggc2", FURKMOD_CMD|SDLK_v),
  D("SAMPLE_LIST_MAKE_MAP", "Samples: Make me a drum kit##sggc", 0),
  D("SAMPLE_LIST_MAX", "", NOT_AN_ACTION),

  D("SAMPLE_MIN", "---Sample editor##sggc", NOT_AN_ACTION),
  D("SAMPLE_SELECT", "Sample editor mode: Select##sggc", FURKMOD_SHIFT|SDLK_i),
  D("SAMPLE_DRAW", "Sample editor mode: Draw##sggc", FURKMOD_SHIFT|SDLK_d),
  D("SAMPLE_CUT", "Sample editor: Cut##sggc1", FURKMOD_CMD|SDLK_x),
  D("SAMPLE_COPY", "Sample editor: Copy##sggc1", FURKMOD_CMD|SDLK_c),
  D("SAMPLE_PASTE", "Sample editor: Paste##sggc1", FURKMOD_CMD|SDLK_v),
  D("SAMPLE_PASTE_REPLACE", "Sample editor: Paste replace##sggc", FURKMOD_CMD|FURKMOD_SHIFT|SDLK_v),
  D("SAMPLE_PASTE_MIX", "Sample editor: Paste mix##sggc", FURKMOD_CMD|FURKMOD_ALT|SDLK_v),
  D("SAMPLE_SELECT_ALL", "Sample editor: Select all##sggc1", FURKMOD_CMD|SDLK_a),
  D("SAMPLE_RESIZE", "Sample editor: Resize##sggc", FURKMOD_CMD|SDLK_r),
  D("SAMPLE_RESAMPLE", "Sample editor: Resample##sggc", FURKMOD_CMD|SDLK_e),
  D("SAMPLE_AMPLIFY", "Sample editor: Amplify##sggc", FURKMOD_CMD|SDLK_b),
  D("SAMPLE_NORMALIZE", "Sample editor: Normalize##sggc", FURKMOD_CMD|SDLK_n),
  D("SAMPLE_FADE_IN", "Sample editor: Fade in##sggc", FURKMOD_CMD|SDLK_i),
  D("SAMPLE_FADE_OUT", "Sample editor: Fade out##sggc", FURKMOD_CMD|SDLK_o),
  D("SAMPLE_SILENCE", "Sample editor: Apply silence##sggc", FURKMOD_SHIFT|SDLK_DELETE),
  D("SAMPLE_INSERT", "Sample editor: Insert silence##sggc", SDLK_INSERT),
  D("SAMPLE_DELETE", "Sample editor: Delete##sggc3", SDLK_DELETE),
  D("SAMPLE_TRIM", "Sample editor: Trim##sggc", FURKMOD_CMD|SDLK_DELETE),
  D("SAMPLE_REVERSE", "Sample editor: Reverse##sggc", FURKMOD_CMD|SDLK_t),
  D("SAMPLE_INVERT", "Sample editor: Invert##sggc", FURKMOD_CMD|FURKMOD_SHIFT|SDLK_t),
  D("SAMPLE_SIGN", "Sample editor: Signed/unsigned exchange##sggc", FURKMOD_CMD|SDLK_u),
  D("SAMPLE_FILTER", "Sample editor: Apply filter##sggc", FURKMOD_CMD|SDLK_f),
  D("SAMPLE_CROSSFADE_LOOP", "Sample editor: Crossfade loop points##sggc", NOT_AN_ACTION),
  D("SAMPLE_PREVIEW", "Sample editor: Preview sample##sggc", 0),
  D("SAMPLE_STOP_PREVIEW", "Sample editor: Stop sample preview##sggc", 0),
  D("SAMPLE_ZOOM_IN", "Sample editor: Zoom in##sggc", FURKMOD_CMD|SDLK_EQUALS),
  D("SAMPLE_ZOOM_OUT", "Sample editor: Zoom out##sggc", FURKMOD_CMD|SDLK_MINUS),
  D("SAMPLE_ZOOM_AUTO", "Sample editor: Toggle auto-zoom##sggc", FURKMOD_CMD|SDLK_0),
  D("SAMPLE_MAKE_INS", "Sample editor: Create instrument from sample##sggc", 0),
  D("SAMPLE_SET_LOOP", "Sample editor: Set loop to selection##sggc", FURKMOD_CMD|SDLK_l),
  D("SAMPLE_CREATE_WAVE", "Sample editor: Create wavetable from selection##sggc", FURKMOD_CMD|SDLK_w),
  ...
  D("ORDERS_LEFT", "Order cursor left##sggc", SDLK_LEFT),
  D("ORDERS_RIGHT", "Order cursor right##sggc", SDLK_RIGHT),
  D("ORDERS_INCREASE", "Increase order value##sggc", 0),
  D("ORDERS_DECREASE", "Decrease order value##sggc", 0),
  D("ORDERS_EDIT_MODE", "Switch order edit mode##sggc", 0),
  D("ORDERS_LINK", "Order: toggle alter entire row##sggc", FURKMOD_CMD|SDLK_l),
  ...
  D("ORDERS_REPLAY", "Replay order##sggc", 0),
...
const FurnaceGUIColorDef guiColors[GUI_COLOR_MAX]={
  ...
  D(GUI_COLOR_INSTR_GBA_DMA,"",ImVec4(0.0f,0.7f,0.8f,1.0f)),
  ...
  D(GUI_COLOR_INSTR_AT85APU,"",ImVec4(0.0f,0.8925f,0.8925f,1.0f)),
