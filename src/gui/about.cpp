...
const char* aboutLine[]={
  ...
  "adpcm-xq by David Bryant##sgab",
  "Nuked-OPL3/OPLL/OPM/OPN2/PSG by nukeykt##sgab",
  "YM3812-LLE, YMF262-LLE, YMF276-LLE and YM2608-LLE by nukeykt##sgab",
  "ESFMu emulator (modified version) by Kagamiin~##sgab",
  ...
  "ATTiny85APU emulator by AlexMush##sgab",
  "",
  "greetings to:##sgab",
